<?php
	 ...
	 * @access public
	 */
	class Radar3d implements iChart {
		...
		private function build_radar3d_chart() {
            ...
            $def_3d = '<ChartThreeDProperties><Enabled>true</Enabled></ChartThreeDProperties>';
        ...
        public function get_chart_rdl() {
			return $this->build_radar3d_chart();
		}	  
	}
