<?php
     ...
     * @access public
     */
    class ColumnAndLine implements iChart {
        ...
        private function build_series($series) {
            ...
            return $series_xml . '<CompositeSeries>';
        }
		
        private function build_column_and_line_chart() {
        ...
        public function get_chart_rdl() {
            return $this->build_column_and_line_chart();
        }	  
    }
