<?php
	...
	/**
	 *  @brief Doughnut shape chart type
	 *
	 *  @par Description
	 *  This class handles shape chartype : Doughnut
	 *  @copyright Pioneer Solutions
	 */
	class Doughnut implements iChart {
        ...
        /**
		 * builds doughnut chart
		 *
		 * @return  string  xml string for doughnut chart
		 */
		private function build_doughnut_chart() {
		 ...
		 *
		 * @return  string  returns doughnut chart rdl string
		 */
        public function get_chart_rdl() {
			return $this->build_doughnut_chart();
		}	  
	}
