<?php
	 ...
	 * @access public
	 */
	class DoughnutExploded implements iChart {
            ...
            foreach ($series as $val) {
				if ($count < 1) {			
					$series_xml .= '<ChartSeries Name="' . $val . '">
                                        ...
                                        <Type>Shape</Type>
                                        <Subtype>ExplodedDoughnut</Subtype>
                                        <Style />
                                        <ChartEmptyPoints>
                                            <Style />
                                            <ChartMarker>
		...
		private function build_doughnut_exploded_chart() {
        ...
        public function get_chart_rdl() {
			return $this->build_doughnut_exploded_chart();
		}	  
	}
