<?php
	 ...
	 * @access public
	 */
	class Pyramid3d implements iChart {
		...
		private function build_pyramid3d_chart() {
            $this->xml_str = '<Chart Name="' . $this->name . '">
                					...
                					<ChartData><ChartSeriesCollection>' . $this->build_series($this->members) . '</ChartSeriesCollection></ChartData>';
        ...
        public function get_chart_rdl() {
			return $this->build_pyramid3d_chart();
		}	  
	}
