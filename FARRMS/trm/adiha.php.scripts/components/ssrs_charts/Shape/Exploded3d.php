<?php
	 ...
	 * @access public
	 */
	class Exploded3d implements iChart {
            ...
            foreach ($series as $val) {
				if ($count < 1) {			
					$series_xml .= '<ChartSeries Name="' . $val . '">
                                        <ChartDataPoints>
                                            <ChartDataPoint>
                                            <ChartDataPointValues><Y>=iif(Sum(CDbl(Fields!' . $val . '.Value))>0,Sum(CDbl(Fields!' . $val . '.Value)),"")</Y></ChartDataPointValues>
                                            <ChartDataLabel>
                                                <Style />
                                                <Label>#PERCENT</Label>
		...
		private function build_exploded3d_chart() {
        ...
        public function get_chart_rdl() {
			return $this->build_exploded3d_chart();
		}	  
	}
