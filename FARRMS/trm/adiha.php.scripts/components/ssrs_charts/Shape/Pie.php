...
/**
 *  @brief Pie shape chart type
 *
 *  @par Description
 *  This class handles shape chartype : Pie
 *  @copyright Pioneer Solutions
 */
class Pie implements iChart {
     ...
     * builds Pie chart
     *
     * @return  string  xml string for Pie chart
     */
    private function build_pie_chart() {
     ...
     *
     * @return  string  returns Pie chart rdl string
     */
    public function get_chart_rdl() {
        return $this->build_pie_chart();
    }
