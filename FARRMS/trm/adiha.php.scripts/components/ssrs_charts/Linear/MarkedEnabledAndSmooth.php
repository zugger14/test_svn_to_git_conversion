<?php
	 ...
	 * @access public
	 */
	class MarkedEnabledAndSmooth implements iChart {
		...
		private function build_marked_enabled_and_smooth_chart() {
        ...
        public function get_chart_rdl() {
			return $this->build_marked_enabled_and_smooth_chart();
		}	  
	}
