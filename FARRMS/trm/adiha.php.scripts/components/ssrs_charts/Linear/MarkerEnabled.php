<?php
	...
	/**
    *  @brief MarkerEnabled Marked Enabled Chart
    *
    *  @par Description
    *  This Class includes Chart Operation implmenting iChart Interface.
    *  @copyright Pioneer Solutions
    */
	class MarkerEnabled implements iChart {
		...
		/**
		 * Build XML of MarkedEnabled Chart
		 *
		 * @return  XML  MarkedEnabled Chart
		 */
		private function build_marker_enabled_chart() {
		...
		/**
		 * Get MarkedEnabled Chart RDL
		 *
		 * @return  XML  MarkedEnabled Chart XML Block
		 */
        public function get_chart_rdl() {
			return $this->build_marker_enabled_chart();
		}	  
	}
