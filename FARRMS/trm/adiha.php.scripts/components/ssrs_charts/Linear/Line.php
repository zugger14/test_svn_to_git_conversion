<?php
	...
	/**
    *  @brief Line Line Class
    *
    *  @par Description
    *  This Class includes Line Chart Operation implmenting iChart Interface.
    *  @copyright Pioneer Solutions
    */
	class Line implements iChart {
		...
		/**
		 * Build XML of Line Chart
		 *
		 * @return  XML  Line Chart
		 */
		private function build_line_chart() {
            ...
            #use for simple line type only
            $chart_tick_marks_enabled = false;                    
		 ...
		 * Get Line Chart RDL
		 *
		 * @return  XML  Line Chart XML Block
		 */
        public function get_chart_rdl() {
            return $this->build_line_chart();
		}	  
	}
