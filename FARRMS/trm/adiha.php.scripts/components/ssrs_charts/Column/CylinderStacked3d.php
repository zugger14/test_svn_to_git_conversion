<?php
	 ...
	 * @access public
	 */
	class CylinderStacked3d implements iChart {
		...
		private function build_cylinder_stacked3d_chart() {
        ...
        public function get_chart_rdl() {
			return $this->build_cylinder_stacked3d_chart();
		}	  
	}
