<?php
	...
	/**
	 *  @brief Column column chart type
	 *
	 *  @par Description
	 *  This class handles column chartype : column
	 *  @copyright Pioneer Solutions
	 */
	class Column implements iChart {
		 ...
		 * builds column chart
		 *
		 * @return  string  xml string for column chart
		 */
		private function build_column_chart() {
		 ...
		 *
		 * @return  string  returns column chart rdl string
		 */
        public function get_chart_rdl() {
			return $this->build_column_chart();
		}	  
	}
