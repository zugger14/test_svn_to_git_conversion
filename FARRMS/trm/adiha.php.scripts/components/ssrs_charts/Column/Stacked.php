<?php
	...
	/**
	 *  @brief Stacked column chart type
	 *
	 *  @par Description
	 *  This class handles column chartype : Stacked
	 *  @copyright Pioneer Solutions
	 */
	class Stacked implements iChart {
		 ...
		 *
		 * @return  string  xml string for Stacked chart
		 */
		private function build_stacked_chart() {
		 ...
		 *
		 * @return  string  returns Stacked chart rdl string
		 */
        public function get_chart_rdl() {
			return $this->build_stacked_chart();
		}	  
	}
