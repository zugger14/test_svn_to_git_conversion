<?php
	 ...
	 * @access public
	 */
	class CylinderPercentStacked3d implements iChart {
	    private $xml_str;
		...
		private function build_cylinder_percent_stacked3d_chart(){
        ...
        public function get_chart_rdl() {
			return $this->build_cylinder_percent_stacked3d_chart();
		}	  
	}
