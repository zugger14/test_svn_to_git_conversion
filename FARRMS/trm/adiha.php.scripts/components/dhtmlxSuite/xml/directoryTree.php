	...
	function outputDir($dirPath){
		...
		foreach($dirContent as $file){
			if($file!=".." && $file!="." && is_dir($gl_starting_directory."".$dirPath."/".$file)){
				...
				echo "<item id='".$dirPath."/".$file."' text='".$file.count(scandir($gl_starting_directory."".$dirPath."/".$file))."' child='".$children."' im0='folderClosed.gif' im1='folderOpen.gif' im2='folderClosed.gif'/>";
			}
