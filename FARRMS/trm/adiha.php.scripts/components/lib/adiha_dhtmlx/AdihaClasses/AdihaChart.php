<?php
    Class AdihaChart {
         ...
         */
        public function init_chart($view, $xaxis_col, $xaxis_label, $yaxis_col, $yaxis_label, $yaxis_series_label = '',$origin) {
