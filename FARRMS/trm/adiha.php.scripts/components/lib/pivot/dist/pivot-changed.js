...
(function() {
  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
    ...
    try {
	  ...
	  agd1 = $("<td class='agg_td'>").appendTo(tr1);
	  
	  add_remove = (function(_this) {
		  ...
		  return function() {
			  if ($(this).attr('id') == 'add') {
				  aggregator = $("<select class='pvtAggregator'>").bind("change", function() {
					//return refresh();
					var that = $(this);
					pvtVals = that.closest(".pvtVals");
					numInputsToProcess = (_ref5 = opts.aggregators[$(this).val()]([])().numInputs) != null ? _ref5 : 0;
					pvtVals.find(".pvtAttrDropdown").each(function() {
				  ...
				  $("<li class='pvtVals'>").appendTo(agd_ol).append(aggregator).append($('<br />'));
	  ...
	  add_remove_toolbar = $('<div id="toolbar">');
	  add_remove_toolbar.appendTo(agd1);	  
	  $('<img id="add" class="add" src="../dist/add.png"/>').appendTo(add_remove_toolbar).bind("click", add_remove);		  
	  $('<img id="remove" class="remove" src="../dist/remove.png"/>').appendTo(add_remove_toolbar).bind("click", add_remove);
	  agd_ol = $("<ol id='selectable'>").appendTo(agd1);	  
	  agd_ol.selectable();
      ...
      refreshDelayed = (function(_this) {
        ...
        return function() {
          ...
          //numInputsToProcess = (_ref5 = opts.aggregators[$(aggregator, $(this)).val()]([])().numInputs) != null ? _ref5 : 0;
          vals = [];
