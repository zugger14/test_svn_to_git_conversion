...
$as_of_date_value = ($as_of_date_value == 'NULL') ? date('Y-m-d') : date('Y-m-d');
...
if ($flag == 'x') {
    $sp_url = "EXEC batch_report_process @flag='x', @jobId='" . $job_id . "'"; 
...
if ($flag == 'u') {
    ...
    echo $sp_url_non = "EXEC batch_report_process @flag='f', @report_name='" . $job_name . "'"; 
...
if ($report_type == 'Standard Report') {
    $export_format_array_value = array('.csv', '.txt', '.xml');
    $export_format_array_label = array('CSV', 'Text', 'XML');
} else {
   $export_format_array_value = array('.xlsx', '.csv', '.txt', '.xml');
   $export_format_array_label = array('Excel', 'CSV', 'Text', 'XML'); 
}

$cmb_option_count = count($export_format_array_label);
$export_format = ($batch_type == 'remit') ? '.xml' : '.csv';
$export_format = ($report_type == 'Report Manager') ? '.csv' : $export_format;
...
echo "cmb_export_format = ".  $form_obj->create_static_combo_box($export_format_array_value, $export_format_array_label, $export_format, $cmb_option_count) . ";"."\n";
echo "cmb_delimiter = ".  $form_obj->create_static_combo_box($delim_array_value, $delim_array_label, '', 5) . ";"."\n";
...
$form_structure = "[    
    {type:'input', name:'txt_job_name', label:'Job Name ', position:'label-top', value: '$job_name', inputWidth:440, offsetLeft: 0, inputHeight: 29},
    ...
    {type: 'fieldset', label: 'Job Schedule', name:'job_schedule', inputWidth: 720, list:[
        ...
        {type: 'fieldset', label: 'One Time Occurance', inputWidth: 680, name: 'one_time_occurance', disabled: true, list:[
            { type:'calendar', dateFormat: '$date_format', name:'dt_date', label:'Date ', labelTop:200, position: 'label-top', inputWidth: 180, inputHeight: 25, required: true},
            { type:'combo' , name:'cmb_hour_c', label:'Hour ', inputWidth:80, position: 'absolute', options: cmb_hour, inputLeft: 220, labelLeft: 220, inputTop: 19, labelTop: 0},
            { type:'combo' , name:'cmb_min_c', label:'Minute ', inputWidth:80, position: 'absolute', options: cmb_min, inputTop: 19, labelTop: 0, inputLeft: 320, labelLeft: 320},
        ]},

        {type: 'settings', position: 'label-right'},
        {type: 'fieldset', label: 'Recurring', name: 'recurring', disabled: true, inputWidth: 680, list:[
            { type:'calendar', dateFormat: '$date_format', name:'dt_start_date', label:'Start Date ', inputHeight: 25, inputWidth:180, position: 'label-top', required:true},
            { type:'calendar', dateFormat: '$date_format', name:'dt_end_date', label:'End Date ', inputWidth:180, inputHeight: 25, position: 'absolute', labelLeft: 220, inputLeft: 220, inputTop: 20, labelTop: 0},
            ...
            { type:'combo' , name:'cmb_holiday_calendar_c', label:'Holiday Calendar ', inputWidth:180, position: 'absolute', options: cmb_holiday_calendar, labelLeft: 220, inputLeft: 220, inputTop: 67, labelTop: 47},
            { type:'combo' , name:'cmb_recurring_c', label:'Recurs Every ', required: true, inputWidth:180, position: 'label-top', options: cmb_recurring},
            { type:'combo' , name:'cmb_hour_rec', label:'Hour ', inputWidth:80, position: 'absolute', options: cmb_hour_r, labelLeft: 220, inputLeft: 220, inputTop: 115, labelTop: 95},
            { type:'combo' , name:'cmb_minute_rec', label:'Minute ', inputWidth:80, position: 'absolute', options: cmb_min_r, labelLeft: 320, inputLeft: 320, inputTop: 115, labelTop: 95},
            ...
            {type: 'label', name: 'notes_of_every', labelWidth: 150, label: 'Month(s)', position: 'absolute', labelTop: 233},
            ...
            {type: 'fieldset', name: 'week_days', label: 'Week Days', inputWidth: 640, hidden: true, list:[
                ...
                { type:'checkbox', name:'chk_monday', label:'Monday', position: 'absolute', labelTop: 0, checked: '$day2', inputTop: 0, inputLeft: 70, labelLeft: 85},
                { type:'checkbox', name:'chk_tuesday', label:'Tuesday', position: 'absolute', labelTop: 0, checked: '$day3', inputTop: 0, inputLeft: 150, labelLeft: 165},
                { type:'checkbox', name:'chk_wednesday', label:'Wednesday', position: 'absolute', labelTop: 0, checked: '$day4', inputTop: 0, inputLeft: 230, labelLeft: 245},
                { type:'checkbox', name:'chk_thursday', label:'Thursday', position: 'absolute', labelTop: 0, inputTop: 0, checked: '$day5', inputLeft: 330, labelLeft: 345},
                { type:'checkbox', name:'chk_friday', label:'Friday', position: 'absolute', labelTop: 0, inputTop: 0, checked: '$day6', inputLeft: 410, labelLeft: 425},
                { type:'checkbox', name:'chk_saturday', label:'Saturday', position: 'absolute', labelTop: 0, inputTop: 0, checked: '$day7', inputLeft: 470, labelLeft: 485},
            ]},
        ]},
    ]},
]";
...
$export_file_path = ($batch_type == 'remit') ? str_replace('\\', '\\\\',$BATCH_FILE_EXPORT_PATH) : '';
...
$form_structure = "[
                    {type: 'fieldset', label: 'Format', inputWidth: 700, disabled: " . $format_export_enabled . ", list:[
                        {type: 'combo', name: 'cmb_export_format', label: 'Export Format', position: 'label-top', width: 180, options: cmb_export_format, offsetLeft: 20},
                        {type: 'newcolumn'},
                        {type: 'combo', name: 'cmb_delimiter_c', label: 'Delimiter', position: 'label-top', width: 180, options: cmb_delimiter, offsetLeft: 20},
                        {type: 'newcolumn'},
                        {type: 'combo', name: 'cmb_xml_format_c', label: 'XML Format', position: 'label-top', width: 180, options: cmb_xml_format, offsetLeft: 20},
                        {type: 'newcolumn'},
                        {type: 'checkbox', name: 'chk_display_header', label: 'Display Header', position: 'label-right', offsetLeft: 20, checked: true, label_width :180, offsetTop : 26},
                        {type: 'newcolumn'},
                        {type: 'checkbox', name: 'chk_compress_file', label: 'Compress File', position: 'label-right', offsetLeft: 20, label_width :180, offsetTop : 26},
                        
                        
                    ]},
                    {type: 'fieldset', label: 'Export', inputWidth: 700, list:[
                    {type: 'input', name: 'txt_export_to_directory',inputHeight: 25, label: 'Export to Directory', position: 'label-top', width: 600, labelWidth: 150, value: '$export_file_path'},
                    {type: 'label', labelWidth: 600, label: '$local_file_path', position: 'absolute', labelTop: 42},
                    {type: 'label', labelWidth: 600, label: '$network_file_path'},
                    {type: 'input', name: 'txt_export_to_table', inputHeight: 25, label: 'Export to Table', position: 'label-top', width: 600, labelWidth: 150, disabled: " . $format_export_enabled . "},
                    {type: 'label', labelWidth: 600, label: '(Special characters except space are not allowed.)', position: 'absolute', labelTop: 122, disabled: " . $format_export_enabled . "},
                    ]}
                    ]";
...
$sp_url_user_list = "EXEC spa_application_users @flag='v'";
echo "user_list_array = " . $form_obj->adiha_form_dropdown($sp_url_user_list, 0, 1) . ";" . "\n";
$sp_url_role_list = "EXEC spa_application_security_role @flag='s'";
echo "role_list_array = " . $form_obj->adiha_form_dropdown($sp_url_role_list, 0, 1) . ";" . "\n";
$sp_url_user_list_update = "EXEC batch_report_process @flag='n', @report_name='" . $job_name . "'";
echo "user_list_array_update = " . $form_obj->adiha_form_dropdown($sp_url_user_list_update, 0, 1) . ";" . "\n";
$sp_url_role_list_update = "EXEC batch_report_process @flag='v', @report_name='" . $job_name . "'";
echo "role_list_array_update = " . $form_obj->adiha_form_dropdown($sp_url_role_list_update, 0, 1) . ";" . "\n";
...
$form_structure = "[
    			    ...
    			    { type: 'fieldset', label: 'Users and Roles', width: 700, list: [
                        {type: 'block', width:680, list:[
        	    			{type: 'multiselect', label: 'User List', name: 'user_from', size:6,  options: user_list_array, inputWidth:250},
    	    			...
    	    			{type: 'newcolumn', offset:10},
    	    			{type: 'multiselect', label: 'Notify Users', name: 'user_to', size:6, inputWidth: 250, options: user_list_array_update},
        			]}, 
                    
                    {type: 'block', width:680, list:[
        	    			{type: 'multiselect', label: 'Role List', name: 'role_from', size:6,  options: role_list_array, inputWidth:250},
        	    			{type: 'newcolumn', offset:10},
        	    			{type: 'block', width:100, list:[
    	    			...
    	    			{type: 'newcolumn', offset:10},
    	    			{type: 'multiselect', label: 'Notify Roles', name: 'role_to', size:6, inputWidth: 250, options: role_list_array_update},
        			]}, 
    ...
    function btn_ok_click (arg) {
        switch (arg) {
            case 'ok':
                ...
                var exec_call = "<?php echo $exec_call; ?>";
                exec_call = (flag != 'x') ? exec_call.replace(/'/g, "''") : exec_call;
                ...
                exec_call = exec_call + ", @report_file=''" + report_file + "''" + ", @report_file_path=''" + report_file_path + "''" + ", @output_file_format=''" + export_ext + "''" + ", @csv_field_delimiter=''"+delimiter+"''" + ", @csv_include_header=''" + display_header + "''";
                }
                ...
                if (run_mode == 'r') {
                    ...
                    if (call_from == 'invoice') {
                        ...
                        data = {        "action":                       "batch_report_process",
                                        "spa":							exec_call,
                                        "flag":                         flag,
                                        "jobId":                        job_id,
