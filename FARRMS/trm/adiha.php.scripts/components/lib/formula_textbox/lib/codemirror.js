...
window.CodeMirror = (function() {
  ...
  function onContextMenu(cm, e) {
    ...
    display.input.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) +
      "px; left: " + (e.clientX - 5) + "px; z-index: 999999; background: " +
      (ie ? "rgba(255, 0, 255, .05)" : "transparent") +
    ...
    //if (ie && !ie_lt9){alert('her0'); prepareSelectAllHack();}
  ...
  function e_defaultPrevented(e) {
    return e.defaultPrevented != null ? e.defaultPrevented : e.returnValue == true;
  }
