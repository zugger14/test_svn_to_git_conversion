<?php
/**
* Maintain transportation contract screen
...
<meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <html>
       ...
       echo 'nonstandard.new_layout.cells("a").attachURL("maintain.contract.template.php?call_from=transportation&call_from_combo=' . $call_from_combo . '&contract_id=' . $link_contract_id . '&link_contract_name=' . $link_contract_name . '", null, true);';
