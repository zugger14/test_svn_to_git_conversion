...
<body>
    ...
    $rights_view_expected_return = 20004500;
    $rights_view_expected_return_edit = 20004500;

    list (
        $has_rights_view_expected_return,
        $has_rights_view_expected_return_edit
    )  = build_security_rights(
        $rights_view_expected_return,
        $rights_view_expected_return_edit
    );

    $namespace = 'view_expected_return';
    $json = '[
                {
                    id:             "a",
                    text:           "Risk Buckets",
                ...
                {
                    id:             "d",
                    text:           "Expected Return Values",
                    header:         true,
                    collapse:       false,
                    undock:         true
                }
            ]';
    $view_expected_return_layout_obj = new AdihaLayout();
    echo $view_expected_return_layout_obj->init_layout('view_expected_return_layout', '', '4C', $json, $namespace);
    echo $view_expected_return_layout_obj->attach_event('', 'onDock', 'view_expected_return.on_dock_event');
    echo $view_expected_return_layout_obj->attach_event('', 'onUnDock', 'view_expected_return.on_undock_event');
    
    $view_expected_return_menu = 'view_expected_return_menu';
    $view_expected_return_menu_json = '[
    ...
    echo $view_expected_return_layout_obj->attach_menu_layout_cell($view_expected_return_menu, 'a', $view_expected_return_menu_json, $namespace.'.view_expected_return_menu_click');

    //attach grid
    $curve_grid_name = 'curve_grid';
    echo $view_expected_return_layout_obj->attach_status_bar("a", true);
    echo $view_expected_return_layout_obj->attach_grid_cell($curve_grid_name, 'a');
    ...
    echo $curve_grid_obj->load_grid_data("EXEC spa_source_price_curve_def_maintain 't', @granularity = '30'");
    
    echo $curve_grid_obj->enable_paging(100, 'pagingArea_a', 'true');
    
    $form_sql = "EXEC spa_create_application_ui_json @flag='j', @application_function_id='20004500', @template_name='View Expected Return', @parse_xml=''";
    $form_arr = readXMLURL2($form_sql);
    $tab_id = $form_arr[0]['tab_id'];
    $form_json = $form_arr[0]['form_json'];
    echo $view_expected_return_layout_obj->attach_form('view_expected_return_filter_form', 'c');
    $view_expected_return_filter_form_obj = new AdihaForm();
    echo $view_expected_return_filter_form_obj->init_by_attach('view_expected_return_filter_form', $namespace);
    echo $view_expected_return_filter_form_obj->load_form($form_json);

    $view_expected_return_menu = 'view_expected_return_menu';
    $view_expected_return_menu_json = '[
                                {id:"refresh", text:"Refresh", img:"refresh.gif", imgdis:"refresh_dis.gif"},
                                {id:"save", text:"Save", img:"save.gif", imgdis:"save_dis.gif", enabled: "'. $has_rights_view_expected_return_edit .'"},
                                {id:"edit", text:"Edit", img:"edit.gif", imgdis:"edit_dis.gif", items:[
                                    {id:"add", text:"Add", img:"new.gif", imgdis:"new_dis.gif", enabled: "'. $has_rights_view_expected_return_edit .'"},
                                    {id:"delete", text:"Delete", img:"delete.gif", imgdis:"delete_dis.gif", enabled: "'. $has_rights_view_expected_return_edit .'"}
                                ]},
                                {id:"export", text:"Export", img:"export.gif", imgdis:"export_dis.gif", items:[
                                    ...
                                    {id:"batch", text:"Batch", img:"batch.gif", imgdis:"batch_dis.gif", enabled: "' . $has_rights_view_expected_return_edit . '"}
                                ]},
    ...
    echo $view_expected_return_layout_obj->attach_menu_layout_cell($view_expected_return_menu, 'd', $view_expected_return_menu_json, $namespace.'.view_expected_menu_click');
    echo $view_expected_return_layout_obj->close_layout();
    ?>
</body>
    
<script>
    var has_rights_view_expected_return_edit = <?php echo (($has_rights_view_expected_return_edit) ? $has_rights_view_expected_return_edit : '0'); ?>;
    var expand_state = 0;
    ...
    $(function() {      
        view_expected_return.view_expected_return_menu.setItemDisabled('delete');
        view_expected_return.view_expected_return_menu.setItemDisabled('save');   
        view_expected_return.view_expected_return_menu.setItemDisabled('add');  
        view_expected_return.view_expected_return_menu.setItemDisabled('export');   
        view_expected_return.view_expected_return_menu.setItemDisabled('excel');   
        view_expected_return.view_expected_return_menu.setItemDisabled('pdf');  
        view_expected_return.view_expected_return_menu.setItemDisabled('batch');
        view_expected_return.view_expected_return_menu.setItemDisabled('select_unselect');   
        view_expected_return.view_expected_return_menu.setItemDisabled('pivot');  
        view_expected_return.view_expected_return_menu.setItemDisabled('edit');

        var curve_source_obj = view_expected_return.view_expected_return_filter_form.getCombo('curve_source');
        ...
        view_expected_return.view_expected_return_filter_form.setItemValue('as_of_date_from', as_of_date);

        var filter_obj = view_expected_return.view_expected_return_layout.cells('b').attachForm();
        var layout_cell_obj = view_expected_return.view_expected_return_layout.cells('c');
        var function_id =  '<?php echo $rights_view_expected_return; ?>';
        load_form_filter(filter_obj, layout_cell_obj, function_id, 2, '', view_expected_return); 

        view_expected_return.curve_grid.attachEvent("onRowDblClicked", function(rId,cInd){
            view_expected_return.expand_price_curve(rId,cInd);
        });
    });

    view_expected_return.view_expected_return_menu_click = function(id) {
        switch(id) {
            case 'excel':
                view_expected_return.export('excel', view_expected_return.curve_grid);
            break;
            case 'pdf':
                view_expected_return.export('pdf', view_expected_return.curve_grid);
            break;
            case 'select_unselect':
                view_expected_return.select_unselect(view_expected_return.curve_grid);
            break;
            case 'expand_collapse':
                view_expected_return.expand_collapse(view_expected_return.curve_grid);
            break;
        }
    }
    
    view_expected_return.view_expected_menu_click = function(id, zoneId, cas) {
        switch(id) {
            case 'refresh':
                view_expected_return_refresh();
                break;
            case 'save':
                if (forward_del_flag == 1) {
                    var gname;
                    if (forward_del_flag == 1) { gname = 'Expected Return'; }
            ...
            case 'add':
                ...
                break;
            case 'delete':
                expected_return_values_delete();
                break;
            case 'excel':
                view_expected_return.export('excel', forward_grid);
                break;
            case 'pdf':
                view_expected_return.export('pdf', forward_grid);
                break;  
            case 'select_unselect':
                view_expected_return.select_unselect(forward_grid);
                break;
            case 'pivot':
                view_expected_return.click_pivot();
                break;
             case 'batch':
                expected_return_values_batch();
                break;
        }
    }
    
    view_expected_return_refresh = function() {
        var form_obj = view_expected_return.view_expected_return_layout.cells('c').getAttachedObject();
        var status = validate_form(form_obj);
        if (status == false) { return; }
        
        var source_price_curve_arr = new Array();
        var selected_row = view_expected_return.curve_grid.getSelectedId();
        ...
        if (selected_row != null) {
            ...
            for(i = 0; i < selected_row_arr.length; i++) {
                if ((view_expected_return.curve_grid.cells(selected_row_arr[i],view_expected_return.curve_grid.getColIndexById('s_granularity')).getValue()) != (view_expected_return.curve_grid.cells(selected_row_arr[0],view_expected_return.curve_grid.getColIndexById('s_granularity')).getValue())) {
                    granularity_check = 1;
                }
                var tree_level = view_expected_return.curve_grid.getLevel(selected_row_arr[i]);
                
                if (tree_level == 1) {
                    
                    var value = view_expected_return.curve_grid.cells(selected_row_arr[i], view_expected_return.curve_grid.getColIndexById('source_curve_def_id')).getValue();
                    source_price_curve_arr.push(value);
                }
                granularity = view_expected_return.curve_grid.cells(selected_row_arr[0],view_expected_return.curve_grid.getColIndexById('s_granularity')).getValue();
            }
        }
        ...
        var as_of_date_from = view_expected_return.view_expected_return_filter_form.getItemValue('as_of_date_from', true);
        var as_of_date_to = view_expected_return.view_expected_return_filter_form.getItemValue('as_of_date_to', true);
        ...
        var tenor_from = view_expected_return.view_expected_return_filter_form.getItemValue('tenor_from', true);
        var tenor_to = view_expected_return.view_expected_return_filter_form.getItemValue('tenor_to', true);
        ...
        var curve_source_value_obj = view_expected_return.view_expected_return_filter_form.getCombo('curve_source');
        ...
        var round_value = view_expected_return.view_expected_return_filter_form.getItemValue('round_value');
        
        var data = {
                        "action": "spa_view_expected_return",
                        "flag": "s",
        ...
        adiha_post_data('return_json', data, '', '', 'view_expected_return_refresh_callback', '', '');
        
    }
    
    function view_expected_return_refresh_callback(result) {
        forward_del_flag = 0;
        view_expected_return.view_expected_return_layout.cells('d').progressOn();
        ...
        var forward_col_rounding = forward_col_rounding.toString();
        var forward_col_data_type = forward_col_data_type.toString();

        view_expected_return.view_expected_return_layout.cells('d').attachStatusBar({
            height: 30,
            text: '<div id="pagingArea_d"></div>'
        });

        forward_grid = view_expected_return.view_expected_return_layout.cells('d').attachGrid();
        ...
        forward_grid.enableRounding(forward_col_rounding);
        
        forward_grid.attachEvent("onRowSelect", function(id,ind){
            if (has_rights_view_expected_return_edit) {
                view_expected_return.view_expected_return_menu.setItemEnabled('delete');
                view_expected_return.view_expected_return_menu.setItemEnabled('save');
            }
        });
    ...
    load_forward_grid = function(process_id) {
        ...
        forward_grid.loadXML(forward_url, function() {
            view_expected_return.view_expected_return_layout.cells('d').progressOff();
        });

    }
    
    view_expected_return_save = function() {
        maturity_date_flag = 0;
        
        forward_grid.clearSelection();
        cell_validation();
        
        var f_grid_status = view_expected_return.validate_form_grid(forward_grid, 'Expected Return');
        ...
        if (maturity_date_flag == 1) {
            dhtmlx.alert({
                title:"Alert",
                type:"alert",
                text:"Data Error in <strong>Expected Return Values</strong> grid. Please check the data in column <strong>Maturity Date</strong> and resave."
            }); 
            return;
        }
    ...
    /*
     * expected_return_values_delete [Build the XML of deleted data]
     */
    expected_return_values_delete = function() {
    ...
    build_forward_xml = function(save_delete) { 
        ...
        for (count =1; count < row_col_arr.length; count++) {
            ...
            grid_xml = grid_xml + ' source_price_curve="' + escapeXML(fh2[cellIndex]) + '"';
            
            grid_xml = grid_xml + ' curve_source="' + escapeXML(fh3[cellIndex]) + '"';
    ...
    enable_menu_items = function() {
        if (has_rights_view_expected_return_edit) {
            // view_expected_return.view_expected_return_menu.setItemEnabled("save");
            view_expected_return.view_expected_return_menu.setItemEnabled("add");
            view_expected_return.view_expected_return_menu.setItemEnabled('edit');
        } else {
            view_expected_return.view_expected_return_menu.setItemDisabled("save");
            view_expected_return.view_expected_return_menu.setItemDisabled("add");
            view_expected_return.view_expected_return_menu.setItemDisabled("delete");
        ...
        view_expected_return.view_expected_return_menu.setItemEnabled('export');   
        view_expected_return.view_expected_return_menu.setItemEnabled('excel');   
        view_expected_return.view_expected_return_menu.setItemEnabled('pdf');  
        view_expected_return.view_expected_return_menu.setItemEnabled('batch');
        view_expected_return.view_expected_return_menu.setItemEnabled('select_unselect');   
        view_expected_return.view_expected_return_menu.setItemEnabled('pivot');   
    }
    
    /**
     * [Function to expand/collapse price curve Grid when double clicked]
     */
    view_expected_return.expand_price_curve = function(r_id, col_id) {
        var selected_row = view_expected_return.curve_grid.getSelectedRowId();
        var state = view_expected_return.curve_grid.getOpenState(selected_row);

        if (state)
            view_expected_return.curve_grid.closeItem(selected_row);
        else
            view_expected_return.curve_grid.openItem(selected_row);
    }   
    
    
    view_expected_return.validate_form_grid = function(attached_obj,grid_label) {
        var status = true;
    ...
    expected_return_values_batch = function() {
        var selected_row = view_expected_return.curve_grid.getSelectedId();
        ...
        var from_date = view_expected_return.view_expected_return_filter_form.getItemValue('as_of_date_from', true);
        var to_date = view_expected_return.view_expected_return_filter_form.getItemValue('as_of_date_to', true);
        ...
        var exec_call = "EXEC spa_view_expected_return @flag='p', @source_price_curve='" + curve_id 
        ...
        adiha_run_batch_process(exec_call, param, 'View Expected Return');
    }
    ...
    view_expected_return.export = function(format, grid_obj) {
        switch(format) {
            case 'excel':
    ...
    view_expected_return.expand_collapse = function(grid_obj) {
        if(expand_state == 0) {
            grid_obj.expandAll();
            expand_state = 1;
        } else {
    ...
    view_expected_return.select_unselect = function(grid_obj) {
    ...
    view_expected_return.click_pivot = function() {
        var selected_row = view_expected_return.curve_grid.getSelectedId();
        var source_price_curve_arr = new Array();
        ...
        var pivot_exec_spa = "EXEC spa_view_expected_return @flag='p', @source_price_curve='" + source_price_curve 
                                                + "',@curve_source_value='" + curve_source_value 
                                                + "',@as_of_date_from='" + as_of_date_from 
                                                + "',@as_of_date_to='" + as_of_date_to 
                                                + "',@tenor_from='" + tenor_from 
        ...
        open_grid_pivot('', 'view_expected_return_grid', 1, pivot_exec_spa, 'View Expected Return');
    }
