         ...
         function report_parameter(is_batch) {
            ...
            inner_tab_obj.forEachTab(function(tab){
                ...
                if (tab_name == 'General') {
                    ...
                    deal_id_from = form_obj.getItemValue('deal_date_from');
                    ...
                    match_id = form_obj.isItemChecked('mapped');
            ...
            param_list.push("'" + discount_option + "'");
            ...
            param_list.push("'" + show_firstday_gain_loss + "'");
            ...
            param_list.push(" n ");
            param_list.push(" n ");
            param_list.push("'" + show_only_for_deal_date + "'");
            param_list.push(" n ");
            param_list.push("'" + round_value + "'");
            param_list.push(" NULL ");
            param_list.push("'" + mapped + "'");
            ...
            if (is_batch) {                
                if (enable_paging == 1) {
                    var exec_call  = "EXEC spa_Create_MTM_Period_Report " + param_string + '&enable_paging=true&np=1' + '&applied_filters='+ filter_list + '&gen_as_of_date=0';
                } else {
                    var exec_call  = "EXEC spa_Create_MTM_Period_Report " + param_string + '&applied_filters='+ filter_list + '&gen_as_of_date=0';
                }
            } else {
                if (enable_paging == 1) {
                    var exec_call  = "EXEC spa_Create_MTM_Period_Report " + param_string + '&enable_paging=true&np=1' + '&applied_filters='+ filter_list ;
                } else {
                    var exec_call  = "EXEC spa_Create_MTM_Period_Report " + param_string + '&applied_filters='+ filter_list ;
                }
            }
