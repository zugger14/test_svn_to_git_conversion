...
<body>
    <?php
        ...
        $spa_html_menu_json = '[
								...
								{ type: "separator" },
								{ id: "rp", img: "pivot.gif", text: "Pivot", title: "Pivot"}	
                             ]';
...
<script>
    ...
    spa_html_template.spa_html_template_menu_click = function(id, zoneId, cas) {
        if (id == 'html') {
			...
			//exec_sql = exec_sql.replace('@minor_location',',@minor_location'); //commented since exec call string had issue with extra "," before @minor_lcoation
