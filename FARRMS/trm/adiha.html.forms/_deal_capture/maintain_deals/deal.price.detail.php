...
<?php 
    ...
    $sp_url = "EXEC spa_deal_pricing_filter @flag = 's'";
    ...
    $xml_file = "EXEC spa_create_application_ui_json @flag='j', @application_function_id='$form_function_id', @template_name='deal_price'";
    ...
    $menu_json =    '[  
                    ...
                    {id:"pricing_report", text:"Pricing Report", img:"report.gif", imgdis:"report_dis.gif", title: "Pricing Report", enabled: true},
                ]';
    ...
    $sp_url = "EXEC [spa_deal_pricing_quality_filter] @flag = 's'";
	$view_dropdown_json = $filter_form->adiha_form_dropdown($sp_url, 0, 1, true);
...
<script type="text/javascript">
    ...
    deal_pricing_detail.hide_show_item = function(status) { 
        if(status == 's') {
            if (typeof price_type_form !== 'undefined') {
                ...
                price_type_form.showItem('volume_from')
            }
        } else {
            if (typeof price_type_form !== 'undefined') {
                ...
                price_type_form.hideItem('volume_from');
                price_type_form.setItemValue('volume_from', '');
            }
        }
    }
    ...
    deal_pricing_detail.save_grid_data =function (new_row,old_row,new_col_index) { 
        ...
        if (price_type_form instanceof dhtmlXForm) {
            ...
            if (price_type == 103600) {
                ...
                deal_price_deemed[old_row].volume_from =  price_type_form.getItemValue('volume_from');
                ...
                deal_std_event[old_row].volume_from =  price_type_form.getItemValue('volume_from');
                ...
                deal_custom_event[old_row].volume_from =  price_type_form.getItemValue('volume_from');
    ...
    deal_pricing_detail.open_pricing_form = function(group_name, price_type) { 
        data = {"action": "spa_create_application_ui_json",
            "flag": "j",
            "application_function_id": 10131047,
            "template_name": "deal_pricing_type",
                ...
                if (deal_price_deemed[rid] || deal_std_event[rid] || deal_custom_event[rid]) {
                    ...
                    if (price_type_form instanceof dhtmlXForm) {
                        if (price_type == 103600) {
                            ...
                            price_type_form.setItemValue('volume_from', deal_price_deemed[rid].volume_from);   
                            ...
                            price_type_form.setItemValue('volume_from', deal_std_event[rid].volume_from);   
                            ...
                            price_type_form.setItemValue('volume_from', deal_custom_event[rid].volume_from);   
    ...
    deal_pricing_detail.menu_click = function(id) {
        switch (id) {
            ...
            case 'add_multiple':
                ...
                break;
            case 'pricing_report':
                general_tab = parent.dealDetail.deal_tab.getAllTabs()
                    .filter(function(e) {
                        return parent.dealDetail.deal_tab.tabs(e).getText() == 'General'
                    })[0]
                form_obj = parent.dealDetail.deal_tab.tabs(general_tab).getAttachedObject()
                sub_book = form_obj.getItemValue('sub_book')

                data = {
                    "action": "spa_deal_pricing_detail",
                    "flag": 'e',
                    "report_name": 'Deal Price Detail Report', 
                    "sub_book_id": sub_book
                };

                adiha_post_data('return_json', data, '', '', 'deal_pricing_detail.report_callback', '');  
                break; 
            default:
                dhtmlx.alert({
    ...
    deal_pricing_detail.report_callback = function(result) {
        data = JSON.parse(result);

        var paramset_id = data[0]['paramset_id']
        var items_combined = data[0]['items_combined']
        var sub_id = data[0]['sub_id']
        var stra_id = data[0]['stra_id']
        var book_id = data[0]['book_id']
        var sub_book_id = data[0]['sub_book_id']
        var process_id = data[0]['process_id']

        var url = '../../_reporting/report_manager_dhx/report.viewer.php?report_name=Deal%20Price%20Detail%20Report_Deal%20Price%20Detail%20Report&items_combined=' + items_combined + '&paramset_id=' + paramset_id + '&export_type=HTML4.0'
        ...
        w2.setText("Pricing Report");
        w2.setModal(true);
        w2.maximize();

        var param = {
            'sec_filters_info': 'sub_id=' + sub_id + ',stra_id=' + stra_id + ',book_id=' + book_id + ',sub_book_id=' + sub_book_id + ',source_deal_header_id=NULL,deal_id=' + parent.parent.deal_id + ',as_of_date=NULL,deal_date_from=NULL,deal_date_to=NULL,term_start=NULL,term_end=NULL,counterparty_id=NULL,contract_id=NULL,trader_id=NULL,location_id=NULL,buy_sell_flag=NULL,detail_phy_fin_flag=NULL,commodity_id=NULL,source_deal_type_id=NULL,curve_id=NULL,pricing_index=NULL,pricing_type=NULL,pricing_period=NULL,confirm_status_type_id=NULL,deal_status_id=NULL_-_' + process_id + ''
        }
    ...
    deal_pricing_detail.save_data = function (flag) {
        ...
        data = {"action": "spa_deal_pricing_detail",
                "flag": flag,
                "source_deal_detail_id": source_deal_detail_id, 
                "xml": xml,
                "mode": 'fetch',
    ...
    deal_pricing_detail.filter_form_change = function(name, value, state) {
        if (name == 'filter') {
            var data = {
                "action":"spa_deal_pricing_filter",
                "flag":"t",
                "filter_id":value
            }
        ...
        switch (id) {
            ...
            case "delete":
                ...
                if (filter_id == null) {
                    ...
                    data = {"action": "spa_deal_pricing_filter", "flag":'d', "filter_id":filter_id};
            ...
            case "copy":
                ...
                data = {"action": "spa_deal_pricing_filter", "flag":'p', "filter_id":filter_id};
    ...
    deal_pricing_detail.quality_filter_form_change = function(name, value, state) {
        if (name == 'filter') {
            var data = {
                "action":"spa_deal_pricing_quality_filter",
                "flag":"t",
                "filter_id":value
            }
        ...
        switch (id) {
            ...
            case "delete":
                ...
                if (filter_id == null) {
                    ...
                    data = {"action": "spa_deal_pricing_quality_filter", "flag":'d', "filter_id":filter_id};
            ...
            case "copy":
                ...
                data = {"action": "spa_deal_pricing_quality_filter", "flag":'p', "filter_id":filter_id};
