...
<body> 
    <?php 
        ...
        $layout_json = '[
                            {
                                id:             "a",
                                text:           "Gas Storage Position Report",
                                header:         false
                            }
                        ]';
;
        $layout_name = 'gas_storage_position_report_layout';
        $name_space = 'gas_storage_position_report';
...
<script>
    ...
    function load_report_detail(result) {
        ...
        report_ui["report_tabs_" + active_object_id] = gas_storage_position_report.gas_storage_position_report_layout.cells("a").attachTabbar();
        ...
        var att_obj = gas_storage_position_report.gas_storage_position_report_layout.cells('a');
        parent.set_apply_filter(att_obj);
    }

    function report_parameter() {
            var inner_tab_obj = gas_storage_position_report.gas_storage_position_report_layout.cells("a").getAttachedObject();
