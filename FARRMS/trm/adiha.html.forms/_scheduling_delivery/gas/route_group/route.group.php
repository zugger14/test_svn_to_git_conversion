...
$single_route_form_structure = '[
                                    ...
                                    {type: "block", blockOffset:' . $ui_settings['block_offset'] . ', list: 
                                        ...
                                        {"type":"newcolumn"},
                                        {"type":"numeric","name":"fuel_loss","label":"Fuel Loss","tooltip":"Fuel Loss","validate":"ValidateIsRange0to1","hidden":"false","disabled":"false","value":"","position":"label-top","offsetLeft":' . $ui_settings['offset_left'] . ',"labelWidth":"auto","inputWidth":' . $ui_settings['field_size'] . ',"userdata":{"validation_message":"Fuel loss should be 0 to 1."}},
                                        {"type":"newcolumn"},
