...
<head>
    ...
    <?php
        ...
        $form_obj = new AdihaStandardForm($form_namespace, 20009000);
        $form_obj->define_grid("other_rate_code");
        $form_obj->define_custom_functions('', '', '', 'grid_activities');
        echo $form_obj->init_form('Rate Schedules', 'Rate Schedules');
        echo $form_obj->close_form();
        $grid_sp = "EXEC spa_adiha_grid 's', 'other_rate_code'";
                ...
                layout_obj.forEachItem(function(cell) {
                    ...
                    if (attached_obj instanceof dhtmlXForm) {                    
                        ...
                        grid_object.attachEvent('onRowSelect', function(id, ind) {
                            ...
                            grid_object.cells(id, grid_object.getColIndexById('rate_schedule_type')).setValue('o');
                        ...
                        grid_object_c.attachEvent('onRowSelect', function(id, ind) {
                            ...
                            // set rate schedule type.
                            grid_object_c.cells(id, grid_object_c.getColIndexById('rate_schedule_type')).setValue('o');
