BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 197,'commodity_type_form','commodity_type','commodity_type_id','exec spa_commodity_type_form @flag=''s'', @commodity_type_id=<ID>',NULL,'g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 197,'commodity_type_form_id','Commodity Type Form ID','ro',NULL,'n','y',NULL,'y',NULL,NULL,'y',NULL,NULL,NULL,'left' UNION ALL 
												SELECT 197,'commodity_type_id','Commodity Type ID','ro',NULL,'n','y',NULL,'y','commodity_type','commodity_type_id',NULL,NULL,NULL,NULL,'left' UNION ALL 
												SELECT 197,'commodity_form_value','Name','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 43700','y','y',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'left'
