 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 196,'commodity_attribute_form','commodity_attribute','commodity_attribute_id','exec spa_commodity_attribute_form @flag=''s'', @commodity_attribute_id=<ID>',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 196,'commodity_attribute_value','Commodity Attribute','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 43200','y','y',NULL,NULL,NULL,NULL,NULL,'300',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 196,'commodity_attribute_form_id','Commodity Attribute Form ID','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y',NULL,'int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 196,'commodity_attribute_id','Commodity Attribute ID','ro_int',NULL,'n','y',NULL,'y','commodity_attribute','commodity_attribute_id',NULL,NULL,'int',NULL,'left', NULL,'n',NULL
