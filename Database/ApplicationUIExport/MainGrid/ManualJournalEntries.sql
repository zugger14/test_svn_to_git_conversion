 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 161,'ManualJournalEntries',NULL,NULL,'EXEC spa_manual_je_header @flag=''s''','Summary','g',NULL,'10237010','10237012',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 161,'as_of_date','As of Date','ro',NULL,'y','n','1','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 161,'occurance_frequency','Frequency','ro',NULL,'n','n','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 161,'end_date','End Date','ro',NULL,'n','n','3','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 161,'manual_je_id','ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL
