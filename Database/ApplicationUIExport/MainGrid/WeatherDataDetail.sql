 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 190,'weather_data_detail','','','',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 190,'currency','currency','combo','EXEC spa_getcurrencyunit ''s''','y','n','5','n',NULL,NULL,NULL,'100',NULL,NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 190,'uom','UOM','combo','EXEC spa_getsourceuom @flag = ''s''','y','n','6','n',NULL,NULL,NULL,'100',NULL,NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 190,'static_data','Static Data','combo','SELECT [type_id], [type_name] FROM static_data_type ORDER BY [type_name] ASC','y','n','7','n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 190,'value_required','Required','combo','SELECT 1 AS [id], ''Yes'' AS [name] UNION ALL SELECT  0 AS [id], ''No'' AS [name]','y','y','8','n',NULL,NULL,NULL,'80',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 190,'time_series_name','Name','ed',NULL,'y','y','2','n',NULL,NULL,NULL,'100',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 190,'series_id','Series ID','ed',NULL,'y','y','3','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 190,'description','Description','ed',NULL,'y','y','4','n',NULL,NULL,NULL,'190',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 190,'time_series_definition_id','System ID','ro_int',NULL,'y','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL
