 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 120,'maintain_scenario_grid','maintain_scenario_group','scenario_group_id','',NULL,NULL,NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 120,'Group Name','Scenario Group','ro',NULL,'y','y','2',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'scenario_group_description','Group Description','ro',NULL,'y','y','3',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'User','User','ro',NULL,'y','y','4','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'Role','Role','ro',NULL,'y','y','5','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'Active','Active','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'Public','Public','ro',NULL,'y','y','7','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'curve_source','Curve Source','ro',NULL,'y','y','8','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'scenario_type','Scenario Type','ro',NULL,'y','y','10','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'Id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'200','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 120,'volatility_source','Volatility Source','ro',NULL,'y','y','9','y',NULL,NULL,NULL,'200','int',NULL,'left', NULL,'n',NULL
