BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 408,'AccrualFinalGLReport',NULL,NULL,NULL,'Accrual Final GL Report','g','counterparty',NULL,NULL,NULL  
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 408,'counterparty','Counterparty','ro',NULL,'n','n','1','n',NULL,NULL,'y','210','int',NULL,'left' UNION ALL 
												SELECT 408,'charge_type','Charge Type','ro',NULL,'n','n','2','n',NULL,NULL,'n','210','str',NULL,'left' UNION ALL 
												SELECT 408,'account_name','Account Name','ro',NULL,'n','n','3','n',NULL,NULL,'n','190','str',NULL,'left' UNION ALL 
												SELECT 408,'account_number','Account Number','ro',NULL,'n','n','4','n',NULL,NULL,'n','190','str',NULL,'left' UNION ALL 
												SELECT 408,'debit','Debit','ro_p',NULL,'n','n','5','n',NULL,NULL,'n','160','str',NULL,'right' UNION ALL 
												SELECT 408,'credit','Credit','ro_p',NULL,'n','n','6','n',NULL,NULL,'n','160','str',NULL,'right'  
