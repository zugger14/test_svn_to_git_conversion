BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 408,'StmtVolumeReport',NULL,NULL,NULL,'Settlement Volume Report','g',NULL,NULL,NULL,NULL  
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 408,'date','Date','ro',NULL,'n','n','1','n',NULL,NULL,'y','150','date',NULL,'left' UNION ALL
												SELECT 408,'Hour','Hour','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','str',NULL,'left' UNION ALL  
												SELECT 408,'Deal_Volume','Deal Volume','ro_no',NULL,'n','n','3','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 408,'Schedule_Volume','Schedule Volume','ro_no',NULL,'n','n','4','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 408,'Actual_Volume','Actual Volume','ro_no',NULL,'n','n','5','n',NULL,NULL,'n','150','int',NULL,'left'   
