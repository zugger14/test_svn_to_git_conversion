BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 408,'account_code_mapping_grid',NULL,NULL,'EXEC spa_stmt_account_code_mapping @flag = ''main_grid'' ','Account Code Mapping','g','stmt_account_code_mapping_id','20011501','20011502',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 408,'stmt_account_code_mapping_id','Inventory ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','120','int',NULL,'left' UNION ALL 
												SELECT 408,'account_code_group_name','Group Name','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 408,'buy_sell_flag','Buy/Sell','ro',NULL,'n','n','3','n',NULL,NULL,'n','80','str',NULL,'left' UNION ALL 
												SELECT 408,'source_deal_type_id','Deal Type','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 408,'source_deal_sub_type_id','Deal Sub Type','ro',NULL,'n','n','5','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL 
												SELECT 408,'commodity_id','Commodity','ro',NULL,'n','n','6','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL 
												SELECT 408,'location_id','Location','ro',NULL,'n','n','7','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'location_group','Location Group','ro',NULL,'n','n','8','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'template','Template','ro',NULL,'n','n','9','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'currency_id','Currency','ro',NULL,'n','n','10','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'contract_name','Contract','ro',NULL,'n','n','11','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'counterparty_type','Counterparty Type','ro',NULL,'n','n','12','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'counterparty_entity_type','Counterparty Entity Type','ro',NULL,'n','n','13','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'region','Region','ro',NULL,'n','n','14','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'priority','Priority','ro',NULL,'n','n','15','n',NULL,NULL,'n','160','str',NULL,'left'  
