BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 408,'StmtPriceReport',NULL,NULL,NULL,'Settlement Price Report','g',NULL,NULL,NULL,NULL  
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 408,'source_deal_header_id','Deal ID','ro',NULL,'n','n','1','n',NULL,NULL,'y','120','int',NULL,'left' UNION ALL 
												SELECT 408,'term_start','Term Start','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','date',NULL,'left' UNION ALL 
												SELECT 408,'Curve','Curve','ro',NULL,'n','n','3','n',NULL,NULL,'n','80','str',NULL,'left' UNION ALL 
												SELECT 408,'As_of_Date','As of Date','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','date',NULL,'left' UNION ALL 
												SELECT 408,'maturity_date','Maturity Date','ro',NULL,'n','n','5','n',NULL,NULL,'n','160','date',NULL,'left' UNION ALL 
												SELECT 408,'Price','Price','ro_p',NULL,'n','n','6','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL 
												SELECT 408,'Price_Currency','Price Currency','ro',NULL,'n','n','7','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'Price_UOM','Price UOM','ro',NULL,'n','n','8','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'Multiplier','Multiplier','ro',NULL,'n','n','9','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'Adder','Adder','ro',NULL,'n','n','10','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'Adder_Currency','Adder Currency','ro',NULL,'n','n','11','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'Invoice_Currency','Invoice Currency','ro',NULL,'n','n','12','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'Deal_UOM','Deal UOM','ro',NULL,'n','n','13','n',NULL,NULL,'n','160','str',NULL,'left' UNION ALL
												SELECT 408,'UOM_Conversion_Factor','UOM Conversion Factor','ro',NULL,'n','n','14','n',NULL,NULL,'n','160','int',NULL,'left' UNION ALL
												SELECT 408,'FX_Rate_Curve','FX Rate Curve','ro',NULL,'n','n','15','n',NULL,NULL,'n','160','int',NULL,'left' UNION ALL
												SELECT 408,'FX_Rate_Adder','FX Rate Adder','ro',NULL,'n','n','16','n',NULL,NULL,'n','160','int',NULL,'left' UNION ALL
												SELECT 408,'Curve_Value','Curve Value','ro_p',NULL,'n','n','17','n',NULL,NULL,'n','160','int',NULL,'left' UNION ALL
												SELECT 408,'Adder_Value','Adder Value','ro_p',NULL,'n','n','18','n',NULL,NULL,'n','160','int',NULL,'left' UNION ALL
												SELECT 408,'final_price','Final Price','ro_p',NULL,'n','n','19','n',NULL,NULL,'n','160','int',NULL,'left'  
