BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 4,'recorder_properties',NULL,NULL,'EXEC spa_recorder_properties @flag=''s'', @meter_id=<ID>','Meter Channel','g',NULL,'10103010','10103010',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 4,'mult_factor','Multiplier','edn',NULL,'y','y','5','n',NULL,NULL,NULL,'100','int','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 4,'meter_id','Meter ID','ro_int',NULL,'n','y','2','y','meter_id','meter_id',NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 4,'recorder_property_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL
