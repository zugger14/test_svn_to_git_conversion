 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 66,'contract_charge_type_detail',NULL,NULL,'EXEC spa_contract_charge_type_detail @flag = ''g'', @template_id = ''<ID>''',NULL,'a',NULL,'10211112','10211113',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 66,'volume_granularity','Calculation Granularity','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 978','n','y','4',NULL,NULL,NULL,NULL,'210','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'aggregation_level','Aggregation Level','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 19000','n','y','5',NULL,NULL,NULL,NULL,'210','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'gl_account','Type','ro',NULL,'n','y','2',NULL,NULL,NULL,NULL,'178','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'contract_components','Contract Component','ro',NULL,'n','y','3',NULL,NULL,NULL,NULL,'210','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'contract_charge_type_group','Contract Component Group','ro',NULL,'n','y','5',NULL,NULL,NULL,NULL,'110','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'true_up_applies_to','Applies To','ro',NULL,'n','n','6','y',NULL,NULL,NULL,'110','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'is_true_up','True Up','ro',NULL,'n','n','7','y',NULL,NULL,NULL,'110','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'charge_type','Charge Type','ro',NULL,'n','n','8','y',NULL,NULL,NULL,'110','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'id','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 66,'flat_fee','Flat Fee','ro_no',NULL,'n','n','4','y',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL
