 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 248,'compliance_jurisdiction',NULL,NULL,'EXEC(''SET NOCOUNT ON SELECT sdv.value_id, sdv.code, sdv.[description], sdv.[type_id] FROM static_data_value AS sdv WHERE  sdv.[type_id] = 10002 ORDER BY 2 ASC'')','Compliance Jurisdiction','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 248,'code','Code','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 248,'description','Description','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 248,'value_id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'175','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 248,'type_id','Source ID','ro_int',NULL,'n','y','4','y',NULL,NULL,NULL,'175','int',NULL,'left', NULL,'n',NULL
