BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 324,'SetupWacogProcess',NULL,NULL,'EXEC spa_wacog_group ''s''','WACOG Group','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 324,'wacog_group_id','Wacog Group ID','ro',NULL,'n','y','1','y',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'wacog_group_name','Wacog Group Name','ro',NULL,'n','y','1','n',NULL,NULL,'n','100','str',NULL,'left' UNION ALL 
												SELECT 324,'source_counterparty_id','Counterparty','ro',NULL,'n','y','2','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'contract_id','Contract','ro',NULL,'n','y','3','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'trader_id','Trader','ro',NULL,'n','y','4','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'template_id','Template','ro',NULL,'n','y','5','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'deal_type','Deal Type','ro',NULL,'n','y','6','n',NULL,NULL,'n','100','str',NULL,'left' UNION ALL 
												SELECT 324,'source_commodity_id','Commodity','ro',NULL,'n','y','7','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'location_id','Location','ro',NULL,'n','y','8','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'curve_id','Index','ro',NULL,'n','y','9','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 324,'physical_financial_flag','Physical/Financial','ro',NULL,'n','y','10','n',NULL,NULL,'n','100','str',NULL,'left' UNION ALL 
												SELECT 324,'buy_sell_flag','Buy/Sell','ro',NULL,'n','y','11','n',NULL,NULL,'n','100','str',NULL,'left' UNION ALL 
												SELECT 324,'frequency','Frequency','ro',NULL,'n','y','12','n',NULL,NULL,'n','100','str',NULL,'left'
