 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 198,'documents_type','static_data_value','value_id',NULL,'Documents','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 198,'document_name','Name','ed',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 198,'document_description','Description','ed',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 198,'document_id','Document ID','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y',NULL,'int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 198,'document_type_id','Document Type ID','ro_int',NULL,'n','y',NULL,'y','static_data_type','type_id',NULL,NULL,'int',NULL,'left', NULL,'n',NULL
