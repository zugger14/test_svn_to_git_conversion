 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 183,'SetupAlerts',NULL,NULL,'EXEC spa_alert_sql ''s'', NULL, NULL, NULL, NULL, NULL, NULL, NULL,NULL, NULL, NULL','Alerts','t','Category,Rule_Name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 183,'notification_type','Notification Type','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'workflow_only','Workflow Only','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'is_active','Active','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'alert_type','Workflow Type','ro',NULL,'n','n','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'rule_category','Category','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'system_rule','System Workflow','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'updateable','Updateable','ro',NULL,'n','n','9','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'alert_sql_id','ID','ro_int',NULL,'n','n','2','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'module_events_id','Module Event ID','ro_int',NULL,'n','n','10','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 183,'alert_sql_name','Simple Workflow','tree',NULL,'n','n','1','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL
