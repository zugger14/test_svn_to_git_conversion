BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 69,'storage_assets','','','EXEC spa_storage_assets ''t''','','t','asset_description,location_name','10162310','10162311',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 69,'location_name','Assets/Location','tree',NULL,'y','y','1','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 69,'id','ID','ro',NULL,'n','y','2','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 69,'contract_name','Contract','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												--SELECT 69,'counterparty_name','Counterparty','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 69,'storage_type','Storage Type','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left'-- UNION ALL 
												--SELECT 69,'fees','Fees','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left'
