BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 187,'maintain_criteria_grid',NULL,NULL,'EXEC spa_maintain_criteria_dhx @flag = ''g''',NULL,NULL,NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 187,'Id','System ID','ron',NULL,'n','y',NULL,'y',NULL,NULL,NULL,'200','int',NULL,'left' UNION ALL 
												SELECT 187,'criteria_name','Criteria Name','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'criteria_description','Criteria Description','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'User','User','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'Role','Role','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'Active','Active','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'Public','Public','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'curve_source','Curve Source','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 187,'volatility_source','Volatility Source','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'200','str',NULL,'left'
