BEGIN
	...
	INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
							...
							SELECT 1386,'TermMapping',NULL,NULL,'EXEC spa_term_map_detail @flag=''s''','Term Mapping','g',NULL,NULL,NULL,NULL
	...
	FROM #temp_all_grids
					...
					INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
										...
										SELECT 1386,'term_map_id','Mapping ID','ro',NULL,'n','y','1','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'term_code','Term Code','ro',NULL,'n','y','2','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'date_or_block','Date/Block/Relative','ro',NULL,'n','y','3','n',NULL,NULL,'n','130','int',NULL,'left' UNION ALL 
										SELECT 1386,'term_start','Term Start','ro',NULL,'n','y','4','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'term_end','Term End','ro',NULL,'n','y','5','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'working_day_id','Working Days','ro',NULL,'n','y','6','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'holiday_calendar_id','Holiday Calendar','ro',NULL,'n','y','7','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
										SELECT 1386,'relative_days','Relative Days','ro',NULL,'n','y','8','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'no_of_days','No of Days','ro',NULL,'n','y','9','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
										SELECT 1386,'holiday_include_exclude','Holiday Include/Exclude','ro',NULL,'n','y','10','n',NULL,NULL,'n','150','int',NULL,'left'
