BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 352,'MarginAnalysis',NULL,NULL,'EXEC spa_margin_analysis @flag = ''g'' ','Margin Analysis','t','counterparty_id,contract_id,product_id',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 352,'counterparty_id','Counterparty','tree',NULL,'n','y','1','n',NULL,NULL,'n','345','str',NULL,'left' UNION ALL 
												SELECT 352,'process_margin_header_id','ID','ro',NULL,'n','y','2','y',NULL,NULL,'n','250','int',NULL,'left' UNION ALL 
												SELECT 352,'source_counterparty_id','Source Counterparty ID','ro',NULL,'n','y','3','n',NULL,NULL,'n','250','int',NULL,'left' UNION ALL 
												SELECT 352,'source_contract_id','Source Contract ID','ro',NULL,'n','y','4','n',NULL,NULL,'n','250','int',NULL,'left' UNION ALL 
												SELECT 352,'source_product_id','Source Product ID','ro',NULL,'n','y','5','y',NULL,NULL,'n','250','int',NULL,'left' UNION ALL 
												SELECT 352,'contract_id','Contract','ro',NULL,'n','y','6','y',NULL,NULL,'n','250','str',NULL,'left' UNION ALL 
												SELECT 352,'product_id','Product','ro',NULL,'n','y','7','y',NULL,NULL,'n','250','str',NULL,'left'
