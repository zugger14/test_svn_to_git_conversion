 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 379,'DealPrepay',NULL,NULL,NULL,'Prepay','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 379,'prepay','Prepay','combo','SELECT udf_template_id, field_label FROM user_defined_fields_template WHERE internal_field_type IN (18724, 18736)','y','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'settlement_calendar','Settlement Rule','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 20000','y','n','8','n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'payment_calendar','Payment Rule','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 20000','y','n','11','n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'granularity','Granularity','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 978','y','n','13','y',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'settlement_date','Settlement Date','dhxCalendarA',NULL,'y','n','7','n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'payment_date','Payment Date','dhxCalendarA',NULL,'y','n','10','n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'settlement_days','Settlement Days','ed_int',NULL,'y','n','9','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'payment_days','Payment Days','ed_int',NULL,'y','n','12','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'value','Value','ed_no',NULL,'y','n','3','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'percentage','Percentage','ed_no',NULL,'y','n','4','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'formula_id','Formula ID','ro',NULL,'y','n','5','y',NULL,NULL,NULL,'200',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'formula_name','Formula','ro',NULL,'y','n','6','y',NULL,NULL,NULL,'300',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 379,'source_deal_prepay_id','Prepay ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
