BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 197,'static_data_privilege',NULL,NULL,NULL,'Static Data Privilege','t','code,disabled','10101020','10101020',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 197,'code','Code','tree',NULL,'y','y','1',NULL,NULL,NULL,NULL,'250','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'value_id','Value ID','ro',NULL,'y','y','2','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'type_id','Type ID','ro',NULL,'y','y','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'description','Description','ro',NULL,'y','y','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'user','User','ro',NULL,'y','y','5','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'user_name','User Name','ro',NULL,'y','y','6',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'role','Role','ro',NULL,'y','y','7',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'role_id','Role ID','ro',NULL,'y','y','8','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL UNION ALL 
												SELECT 197,'action','Action','ro',NULL,'y','y','9',NULL,NULL,NULL,NULL,'100','str',NULL,'left', NULL,NULL
