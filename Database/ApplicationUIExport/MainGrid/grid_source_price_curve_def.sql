 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 116,'grid_source_price_curve_def',NULL,NULL,'EXEC spa_monte_carlo_model ''x'', @monte_carlo_model_parameter_id=<ID>',NULL,NULL,NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 116,'Curve Type','Curve Type','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 116,'Curve ID','Curve ID','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 116,'Curve Name','Curve Name','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 116,'Granularity','Granularity','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 116,'ID','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'160','int',NULL,'left', NULL,'n',NULL
