 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 3,'meter_id',NULL,NULL,NULL,'Meter','g',NULL,'10103010','10103011',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 3,'recorderid','Meter ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'description','Description','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'granularity','Granularity','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'uom','UOM','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 3,'counterparty','Counterparty','ro',NULL,'n','y','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'commodity','Commodity','ro',NULL,'n','y','7','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'country','Country','ro',NULL,'n','y','8','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'submeter','Sub Meter','ro',NULL,'n','y','9','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'multiple_location','Multiple Location','ro',NULL,'n','y','10','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'allocation_type','Allocation Type','ro',NULL,'n','y','11','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'manufacturer','Manufacturer','ro',NULL,'n','y','12','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'type','Type','ro',NULL,'n','y','13','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'inspection_date','Inspection Date','ro',NULL,'n','y','15','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'is_privilege_active','Privilege','ro',NULL,'n','y','17','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'meter_id','System ID','ro_int',NULL,'n','y','1','Y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'type_id','Type ID','ro_int',NULL,'n','y','16','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 3,'serial_number','Serial Number','ro_int',NULL,'n','y','14','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
