...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 81,'SetupDeliveryPath',NULL,NULL,'EXEC spa_setup_delivery_path @flag=''g''','Setup delivery Path','t','group_path','10161110','10161111'
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 81,'group_path','Group Path','tree',NULL,'n','y','1','n',NULL,NULL,'y','170',NULL,NULL,'left' UNION ALL 
												SELECT 81,'path_id','path_id','ron',NULL,'n','y','2','y',NULL,NULL,'y','50','int',NULL,'left' UNION ALL 
												SELECT 81,'path_name','Path Name','ro',NULL,'n','y','3','n',NULL,NULL,'y','150',NULL,NULL,'left' UNION ALL 
												SELECT 81,'path_code','Path Code','ro',NULL,'n','y','4','n',NULL,NULL,'y','150',NULL,NULL,'left' UNION ALL 
												SELECT 81,'receipt_location','Receipt Location','ro',NULL,'n','y','5','n',NULL,NULL,'y','150',NULL,NULL,'left' UNION ALL 
												SELECT 81,'delivery_location','Delivery Location','ron',NULL,'n','y','6','n',NULL,NULL,'y','150','int',NULL,'left' UNION ALL 
												SELECT 81,'counterparty_name','Counterparty','ro',NULL,'n','y','7','n',NULL,NULL,'y','150',NULL,NULL,'left' UNION ALL 
												SELECT 81,'contract_name','Contract','ro',NULL,'n','y','8','n',NULL,NULL,'y','150',NULL,NULL,'left' UNION ALL 
												SELECT 81,'mdq','MDQ','ron',NULL,'n','y','9','n',NULL,NULL,'y','100','int',NULL,'left' UNION ALL 
												SELECT 81,'priority','Priority','ro',NULL,'n','y','10','n',NULL,NULL,'y','100',NULL,NULL,'left' UNION ALL 
												SELECT 81,'rate_schedule','Rates','ron',NULL,'n','y','11','n',NULL,NULL,'y','100','int',NULL,'left'
