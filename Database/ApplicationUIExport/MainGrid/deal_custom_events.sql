 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 153,'deal_custom_events',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 153,'event_type','Event Type','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 37800','y','y','2','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 153,'event_date','Event Date','dhxCalendarA',NULL,'y','y','3','n',NULL,NULL,NULL,'150','date',NULL,'left' UNION ALL 
												SELECT 153,'pricing_index','Pricing Index','combo','EXEC spa_GetAllPriceCurveDefinitions @flag=''a'', @is_active=''y''','y','y','4','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 153,'skip_days','Skip Days','combo','EXEC spa_generate_numbers 365','y','y','5','n',NULL,NULL,NULL,'180','int',NULL,'left' UNION ALL 
												SELECT 153,'quotes_before','Quotes Before','combo','EXEC spa_generate_numbers 365','y','y','6','n',NULL,NULL,NULL,'180','int',NULL,'left' UNION ALL 
												SELECT 153,'quotes_after','Quotes After','combo','EXEC spa_generate_numbers 365','y','y','7','n',NULL,NULL,NULL,'180','int',NULL,'left' UNION ALL 
												SELECT 153,'include_event_date','Include Event Date','combo','SELECT ''y'' [value], ''Yes'' [name] UNION ALL SELECT ''n'', ''No''','y','y','8','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 153,'include_holidays','Include Holidays','combo','SELECT ''y'' [value], ''Yes'' [name] UNION ALL SELECT ''n'', ''No''','y','y','9','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 153,'adder','Adder','ed',NULL,'y','y','10','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 153,'currency','Currency','combo','EXEC spa_getcurrencyunit ''s''','y','y','11','n',NULL,NULL,NULL,'150','str',NULL,'right' UNION ALL 
												SELECT 153,'multiplier','Multiplier','ed',NULL,'y','y','12','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 153,'volume','Volume','ed',NULL,'y','y','13','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 153,'uom','UOM','combo','EXEC spa_getsourceuom @flag = ''s''','y','y','14','n',NULL,NULL,NULL,'150','int',NULL,'right' UNION ALL 
												SELECT 153,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'100','int',NULL,'left'
