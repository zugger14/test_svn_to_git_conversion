 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 356,'SetupTransportationPath',NULL,NULL,'EXEC spa_setup_delivery_path ''g'', 1','Transportation Path','g','path_type,grouping_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 356,'path_code','Path Code','ro',NULL,'n','y','2','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'receipt_location','Receipt Location','ro',NULL,'n','y','4','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'delivery_location','Delivery Location','ro',NULL,'n','y','5','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'grid','Counterparty','ro',NULL,'n','y','6','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'contract','Contract','ro',NULL,'n','y','7','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'effective_date','Effective Date','ro',NULL,'n','n','9','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'priority','Priority','ro',NULL,'n','y','10','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'group_path','Group Path','ro',NULL,'n','y','12','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'contract_id','Contract ID','ro',NULL,'n','y','13','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'delivery_means','Method of Transportation','ro',NULL,'n','y','14','n',NULL,NULL,'n','160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'isactive','Active','ro',NULL,'n','y','15','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'path_id','Path ID','ro_int',NULL,'n','y','3','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'mdq','MDQ','ro_no',NULL,'n','y','8','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'rates','Rates','ro_no',NULL,'n','y','11','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 356,'path_name','Transportation Path Name','tree',NULL,'n','y','1','n',NULL,NULL,'n','210','str',NULL,'left', NULL,'n',NULL
