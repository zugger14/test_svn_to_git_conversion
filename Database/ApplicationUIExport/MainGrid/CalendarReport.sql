BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 1238,'calendar_report',NULL,NULL,'EXEC spa_calendar @flag = ''j''','Calendar Report','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 1238,'calendar_event_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,NULL,'80','int',NULL,'left' UNION ALL 
												SELECT 1238,'event_name','Event Name','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'300','str',NULL,'left' UNION ALL 
												SELECT 1238,'event_desc','Event Description','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 1238,'start_datetime','Datetime','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'150','date',NULL,'left' UNION ALL 
												SELECT 1238,'create_user','Create User','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 1238,'create_time','Create Time','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'150','date',NULL,'left' UNION ALL 
												SELECT 1238,'role','Role','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 1238,'module','Module','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 1238,'source_id','Source ID','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'120','int',NULL,'left' UNION ALL 
												SELECT 1238,'source_desc','Source Desc','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 1238,'status','Status','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'120','str',NULL,'left'
