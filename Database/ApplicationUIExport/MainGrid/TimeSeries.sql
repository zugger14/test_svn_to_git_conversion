 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 100,'time_series','','','',NULL,'t','curve_type',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 100,'series_id','Series ID','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 100,'granularity','Granularity','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 100,'effective_date_applicable','Effective Date Applicable','ro',NULL,'y','y','5','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 100,'maturity_applicable','Maturity Applicable','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 100,'description','Description','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 100,'uom','UOM','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 100,'currency','Currency','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 100,'time_series_definition_id','System ID','ro_int',NULL,'y','y','2','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 100,'name','Series Type/ Name','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL
