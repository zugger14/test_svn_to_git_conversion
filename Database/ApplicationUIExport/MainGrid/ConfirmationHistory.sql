 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 93,'confirmation_history',NULL,NULL,'EXEC spa_confirm_status @flag=''s'', @source_deal_header_id=<ID>','Confirmation History','g',NULL,'10131013','10131013',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 93,'confirm_status','Confirm Status','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'120','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 93,'as_of_date','As of Date','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'120','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 93,'comment1','Comment1','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'comment2','Comment2','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'user_id','User Id','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'time_stamp','Time Stamp','ro',NULL,'n','n','9','n',NULL,NULL,NULL,'120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'attachment_file','Confirmation File','ro',NULL,'n','n','10','n',NULL,NULL,NULL,'120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'attachment_file2','Confirmation File 2','ro',NULL,'n','n','10','n',NULL,NULL,NULL,'120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'deal_id','Deal ID','ro_int',NULL,'n','y','2','n',NULL,NULL,NULL,'120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 93,'confirm_id','Confirm ID','ro_int',NULL,'n','n','7','n',NULL,NULL,NULL,'120','int',NULL,'left', NULL,'n',NULL
