 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 61,'gl_system_mapping',NULL,NULL,'EXEC spa_gl_system_mapping @flag = ''n''',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 61,'gl_account_name','Account Name','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'account_name','COA Name','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'account_type','COA Type','ro',NULL,'n','y','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_account_desc1','Description 1','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_account_desc2','Description 2','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_account_number','Account Number','ro',NULL,'n','y','7','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'estimated_actual','GL Type','ro',NULL,'n','y','8','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'is_reversal','Reversal','ro',NULL,'n','y','13','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'is_active','Active','ro',NULL,'n','y','14','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_number_id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'fas_subsidiary_id','Subsidiary','ro_int',NULL,'n','y','9','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_code1_value_id','Category 1','ro_int',NULL,'n','y','10','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_code2_value_id','Category 2','ro_int',NULL,'n','y','11','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 61,'gl_code3_value_id','Category 3','ro_int',NULL,'n','y','12','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
