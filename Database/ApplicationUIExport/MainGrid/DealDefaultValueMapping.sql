BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 288,'DealDefaultValueMapping',NULL,NULL,'EXEC spa_deal_default_value_maping @flag = ''s''','Deal Default Value Mapping','g','20002501','20002502',NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 288,'deal_default_value_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'n','80','int',NULL,'left' UNION ALL 
												SELECT 288,'deal_type_id','Deal Type','ro',NULL,'n','y','2','n',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'pricing_type','Pricing Type','ro',NULL,'n','y','3','n',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'commodity','Commodity','ro',NULL,'n','y','4','n',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'internal_deal_type','Internal Deal Type','ro',NULL,'n','y','6','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'internal_deal_sub_type','Internal Deal Sub Type','ro',NULL,'n','y','7','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'actual_granularity','Actual Granualarity','ro',NULL,'n','y','8','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'volume_frequency','Volume Frequency','ro',NULL,'n','y','9','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'term_frequency','Term Frequency','ro',NULL,'n','y','10','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'pay_opposite','Pay Opposite','ro',NULL,'n','y','11','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'deal_sub_type_type_id','Deal Sub Type','ro',NULL,'n','y','12','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'underlying_options','Underlying Options','ro',NULL,'n','y','13','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'physical_financial_flag','Physical Financial Flag','ro',NULL,'n','y','14','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 288,'buy_sell_flag','Buy/Sell','ro',NULL,'n','y','5','n',NULL,NULL,'n','150','str',NULL,'left'
