BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 340,'transportation_contract_grid',NULL,NULL,NULL,'Contract Group Transportation','t','pipeline,contract_type,contract_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 340,'contract_name','Pipeline/Contract Type/Contract Grouping/Contract Name','tree',NULL,'n','y','1','n',NULL,NULL,'n','250','int',NULL,'left' UNION ALL 
												SELECT 340,'contract_id','ID','ro',NULL,'n','y','2','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'mdq','Mdq','ro',NULL,'n','y','3','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'flow_start_date','Flow Start Date','ro',NULL,'n','y','4','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'flow_end_date','Flow End Date','ro',NULL,'n','y','5','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'capacity_release','Capacity Release','ro',NULL,'n','y','6','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'maintain_rate_schedule','Maintain Rate Schedule','ro',NULL,'n','y','7','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'segmentation','Segmentation','ro',NULL,'n','y','8','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'is_active','Active','ro',NULL,'n','y','9','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'type_id','Type Id','ro',NULL,'n','y','10','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 340,'is_privilege_active','Active Privilege','ro',NULL,'n','y','11','n',NULL,NULL,'n','150','int',NULL,'left'
