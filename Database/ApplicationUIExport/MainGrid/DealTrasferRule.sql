 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 297,'deal_trasfer_rule',NULL,NULL,'EXEC spa_deal_confirmation_rule ''x''',NULL,NULL,NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 297,'logical_name','Logical Name','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 297,'counterparty_id_from','From Counterparty','ro',NULL,'n','n','3','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 297,'source_book_mapping_id_from','From Sub Book','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 297,'counterparty_id_to','To Counterparty','ro',NULL,'n','n','5','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 297,'trader_id_from','From Trader','ro',NULL,'n','n','6','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 297,'deal_transfer_mapping_id','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL
