BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 154,'deal_std_events',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 154,'event_type','Event Type','combo','SELECT sdv.value_id, sdv.code FROM static_data_value AS sdv WHERE sdv.[type_id] = 37800','y','y','3','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 154,'event_date','Event Date','dhxCalendarA',NULL,'y','y','4','n',NULL,NULL,NULL,'150','date',NULL,'left' UNION ALL 
												SELECT 154,'event_pricing_type','Pricing Type','combo','
SELECT gmv.generic_mapping_values_id, gmv.clm1_value
...
','y','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 154,'pricing_index','Pricing Index','combo','EXEC spa_GetAllPriceCurveDefinitions @flag=''a'', @is_active=''y''','y','y','6','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 154,'adder','Adder','ed',NULL,'y','y','7','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'currency','Currency','combo','EXEC spa_getcurrencyunit ''s''','y','y','8','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 154,'multiplier','Multiplier','ed',NULL,'y','y','9','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'volume','Volume','ed_no',NULL,'y','y','10','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'uom','UOM','combo','EXEC spa_getsourceuom @flag = ''s''','y','y','11','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'80','str',NULL,'left' UNION ALL 
												SELECT 154,'id2','ID2','ro',NULL,'n','n','2','y',NULL,NULL,NULL,'80','str',NULL,'left'
