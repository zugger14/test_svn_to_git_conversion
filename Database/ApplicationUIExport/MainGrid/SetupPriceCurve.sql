BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 82,'setup_price_curve',NULL,NULL,NULL,'Price Curve','t','s_curve_type,curve_name','10102610','10102611',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 82,'is_active','Active','ro',NULL,'n','n','14',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 82,'index_group','Index Group','ro',NULL,'n','n','13',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 82,'market_value_id','Market Value ID','ro',NULL,'n','n','19',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 82,'Forward_settle','Forward/Settlement','ro',NULL,'n','n','11',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 82,'formula_id','Formula','ro',NULL,'n','n','12',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 82,'is_privilege_active','Privilege','ro',NULL,'n','n','16','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 82,'effective_date','Effective Date','ro',NULL,'n','n','17',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												...
												SELECT 82,'type_id','Type ID','ro_int',NULL,'n','n','15','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
