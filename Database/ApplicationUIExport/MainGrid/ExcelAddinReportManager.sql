 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 262,'rm_excel_grid',NULL,NULL,NULL,NULL,'t','file_name,file_id,sheet_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 262,'publish','Publish','ch',NULL,'n','y','4','n',NULL,NULL,'n','50',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 262,'publish_mobile','Mobile','ch',NULL,'n','y','5','n',NULL,NULL,'n','50',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 262,'refreshed_on','Refreshed On','ro',NULL,'n','y','6','n',NULL,NULL,'n','100','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 262,'document_type','Excel Document Type','ro',NULL,'n','y','7','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 262,'file_id','File ID','ro_int',NULL,'n','n','2','y',NULL,NULL,'n','75','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 262,'sheet_id','Sheet ID','ro_int',NULL,'n','n','3','y',NULL,NULL,'n','75','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 262,'name','Files Name/Sheets Name','tree',NULL,'n','y','1','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n',NULL
