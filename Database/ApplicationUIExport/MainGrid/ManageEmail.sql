 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 459,'ManageEmail',NULL,NULL,NULL,'Emails','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 459,'attachment','Attachment','link',NULL,'n','y','6',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'mapped_object','Mapped Object','link',NULL,'n','y','9',NULL,NULL,NULL,NULL,'340','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'send_from','From','ro',NULL,'n','y','2',NULL,NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'send_to','To','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'subject','Subject','ro',NULL,'n','y','4',NULL,NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'date','Date','ro',NULL,'n','y','5',NULL,NULL,NULL,NULL,'180','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'user_category','User Category','ro',NULL,'n','y','7',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'email_type','Email Type','ro',NULL,'n','y','8','y',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'update_ts','Update Time','ro',NULL,'n','n','10',NULL,NULL,NULL,NULL,'300','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 459,'notes_id','Notes ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL
