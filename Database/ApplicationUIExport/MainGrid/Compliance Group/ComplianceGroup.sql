BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 5291,'ComplianceGroup',NULL,NULL,'SELECT value_id, code , DESCRIPTION FROM static_data_value AS sdv WHERE sdv.[type_id] = 28000','Compliance Group','g','ID',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 5291,'value_id','Value ID','ro',NULL,'n','y','1','y',NULL,NULL,'n',180,'int',NULL,'left' UNION ALL 
												SELECT 5291,'code','Code','ro',NULL,'n','y','2','n',NULL,NULL,'n',180,'str',NULL,'left' UNION ALL 
												SELECT 5291,'description','Description','ro',NULL,'n','y','3','n',NULL,NULL,'n',180,'int',NULL,'left'
