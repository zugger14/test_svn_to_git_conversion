BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 413,'regression_module_header',NULL,NULL,'EXEC(''select regression_module_header_id,module_name,description from regression_module_header'')','Unique Columns','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 413,'regression_module_header_id','ID','ro',NULL,'n','n','1','n',NULL,NULL,'n','80','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 413,'module_name','Module Name','ro',NULL,'n','y','2','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
												SELECT 413,'description','Description','ro',NULL,'n','y','3','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n'
