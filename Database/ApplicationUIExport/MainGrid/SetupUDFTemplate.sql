 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 313,'SetupUDFTemplate',NULL,NULL,'EXEC spa_populate_udf ''a''','UDF','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 313,'field_name','Field Name','ro',NULL,'n','y','2','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'field_label','Field Label','ro',NULL,'n','y','3','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'field_type','Field Type','ro',NULL,'n','y','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'data_type','Data Type','ro',NULL,'n','y','6','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'internal_field_type','Internal Field Type','ro',NULL,'n','y','7','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'udf_type','UDF Type','ro',NULL,'n','y','5','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'udf_category','UDF Category','ro',NULL,'n','y','13','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'deal_udf_type','Deal UDF Type','ro',NULL,'n','y','14','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'include_in_credit_exposure','Include in Credit Exposure','ro',NULL,'n','y','15','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'udf_template_id','UDF Template ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 313,'leg','Leg','ro_int',NULL,'n','y','8','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL
