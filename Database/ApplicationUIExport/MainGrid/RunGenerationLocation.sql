BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 230,'run_generation_location',NULL,NULL,'EXEC spa_setup_generator @flag = ''l''','Generation Location','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 230,'generation_name','Generation Name','ro',NULL,'y','n','2','n',NULL,NULL,NULL,'250','str','NotEmpty','left' UNION ALL 
												SELECT 230,'deal_ref_id','Deal Ref ID','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'250','str',NULL,'left' UNION ALL 
												SELECT 230,'group','Group','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'250','str',NULL,'left' 
