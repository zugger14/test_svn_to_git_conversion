BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 303,'pivot_dashboard_privilege',NULL,NULL,NULL,'Dashboard Privilege','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 303,'dashboard_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 303,'dashboard_name','Dashboard','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 303,'user_id','Users','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'300','str',NULL,'left' UNION ALL 
												SELECT 303,'role_name','Roles','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'300','str',NULL,'left'
