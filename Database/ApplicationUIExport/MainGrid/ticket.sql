 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 172,'ticket',NULL,NULL,'EXEC spa_split_deal_actuals ''t''','Ticket','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 172,'ticket_header_id','ID','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'ticket_detail_id','Ticket Detail ID','ro',NULL,'y','n',NULL,'y',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'ticket_number','Ticket Number','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'line_item','Line Item','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'ticket_issuer','Ticket issuer','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'movement_date_time','Movement Date/Time','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'date_issued','Issue Date','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'movement_location','Movement Location','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'product_commodity','Commodity','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'volume_uom','Volume UOM','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'ticket_type','Ticket Type','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'match_id','Match ID','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'330',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'origin','Origin','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'destination','Destination','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'term_start','Term Start','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'term_end','Term End','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'original_uom','Original UOM','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'gross_volume','Gross Volume','ro_v',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 172,'net_volume','Net Volume','ro_v',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'160',NULL,NULL,'left', NULL,'n',NULL
