 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 49,'source_price_curve_def','source_price_curve_def',NULL,'EXEC spa_contract_price ''c'' ,@contract_id=<ID> ',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 49,'source_currency_id','Currency','combo','EXEC spa_getcurrencyunit ''s''','y','y',NULL,NULL,NULL,NULL,NULL,NULL,'str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 49,'uom_id','UOM','combo','EXEC spa_getsourceuom ''s''','y','y',NULL,NULL,NULL,NULL,NULL,NULL,'str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 49,'granularity','Granularity','combo','SELECT value_id [Value ID], 
				CASE value_id 
		...
		WHERE s.type_id = 978 AND entity_id IS NULL order by c.category_name, code','y','y',NULL,NULL,NULL,NULL,NULL,NULL,'str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'commodity_id','Commodity','combo','EXEC spa_getsourceCommodity ''s''','y','y',NULL,NULL,NULL,NULL,NULL,NULL,'str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'curve_name','Contract Price Name','ed',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,'str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'market_value_id','market_value_id','ro',NULL,'y','y',NULL,'y',NULL,NULL,NULL,NULL,'str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'contract_id','contract_id','ro_int',NULL,'n','y','2','y',NULL,NULL,NULL,NULL,'int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'source_system_id','source_system_id','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,NULL,NULL,'int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'curve_id','curve_id','ro_int',NULL,'y','y',NULL,'y',NULL,NULL,NULL,NULL,'int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'source_curve_type_value_id','source_curve_type_value_id','ro_int',NULL,'y','y',NULL,'y',NULL,NULL,NULL,NULL,'int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 49,'source_curve_def_id','source_curve_def_id','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y',NULL,'int',NULL,'left', NULL,'n',NULL
