 BEGIN
			...
			SELECT 448,'ShipperCodeMapping',NULL,NULL,'EXEC spa_counterparty_shipper_info ''g''','Shipper Code Mapping','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 448,'source_counterparty_id','Counterparty ID','ro',NULL,'n','y','1','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 448,'counterparty_id','Counterparty','ro',NULL,'n','y','2',NULL,NULL,NULL,'n','330','str',NULL,'left', NULL,'n'-- UNION ALL 
												--SELECT 448,'location_id','Location','ro',NULL,'n','y','3',NULL,NULL,NULL,'n','80','str',NULL,'left', NULL,'n' 
