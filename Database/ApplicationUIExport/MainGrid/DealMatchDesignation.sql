 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 361,'DealMatchDesignation',NULL,NULL,NULL,'Summary','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 361,'matched','Matched Volume','ed_v',NULL,'n','y','12','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'source_deal_header_id','Deal ID','ro',NULL,'n','y','1','n',NULL,NULL,'y','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'ref_id','Reference ID','ro',NULL,'n','y','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'product','Product','ro',NULL,'n','y','3','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'commodity','Commodity','ro',NULL,'n','y','4','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'buy_sell','Buy/Sell','ro',NULL,'n','y','5','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'Counterparty','Counterparty','ro',NULL,'n','y','6','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'deal_date','Deal Date','ro',NULL,'n','y','7','n',NULL,NULL,'n','80','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'term_start','Term Start','ro',NULL,'n','y','8','n',NULL,NULL,'n','80','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'term_end','Term End','ro',NULL,'n','y','9','n',NULL,NULL,'n','80','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'expiration_date','Expiration Date','ro',NULL,'n','y','10','y',NULL,NULL,'n','80','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'remaining','Remaining','ro',NULL,'n','n','13','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'deal_volume_frequency','Volume Frequency','ro',NULL,'n','y','14','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'uom','UOM','ro',NULL,'n','y','15','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'currency','Currency','ro',NULL,'n','n','18','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 361,'vp_value','Value','ro_no',NULL,'n','n','17','y',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'price','Price','ro_p',NULL,'n','n','16','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 361,'actual_volume','Actual Volume','ro_v',NULL,'n','n','11','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL
