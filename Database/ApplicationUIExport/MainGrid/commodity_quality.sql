 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 101,'commodity_quality','source_commodity','source_commodity_id','EXEC spa_source_commodity_maintain ''y''','Quality','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 101,'quality','Quality','combo','EXEC spa_StaticDataValues ''h'', 29600','y','y','2',NULL,NULL,NULL,NULL,'130','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 101,'uom','UOM','combo','Exec spa_source_uom_maintain ''c''','y','y','6',NULL,NULL,NULL,NULL,'130','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 101,'from_value','From Value','ed_no',NULL,'y','y','4',NULL,NULL,NULL,NULL,'130','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 101,'to_value','To Value','ed_no',NULL,'y','y','5',NULL,NULL,NULL,NULL,'130','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 101,'commodity_quality_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','0','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 101,'source_commodity_id','Commodity ID','ro',NULL,'n','y','7','y','source_commodity','source_commodity_id',NULL,'130','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 101,'type','Type','ro',NULL,'n','n','3',NULL,NULL,NULL,NULL,'130','str',NULL,'left', NULL,'n',NULL
