 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 28,'contract_component_mapping',NULL,NULL,' EXEC spa_contract_component_mapping ''c''',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 28,'contract','Contract Component','ro',NULL,'y','y','2',NULL,NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 28,'charge','Charge Type ','ro',NULL,'y','y','3',NULL,NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 28,'contract_component_mapping_id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL
