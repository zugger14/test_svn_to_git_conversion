BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 5289,'grouped_deals',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 5289,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'80','str',NULL,'left' UNION ALL 
												SELECT 5289,'group_id','Group ID','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 5289,'is_primary','Primary','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'80','str',NULL,'left' UNION ALL 
												SELECT 5289,'deal_id','Deal ID','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 5289,'counterparty','Counterparty','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 5289,'contract','Contract','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 5289,'trader','Trader','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 5289,'buy_sell','Buy/Sell','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'80','str',NULL,'left' UNION ALL 
												SELECT 5289,'deal_type','Deal Type','ro',NULL,'n','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left'
