 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 68,'SetupStaticData',NULL,NULL,'EXEC spa_StaticDataValues @flag=''g'',@internal_external=''0''',NULL,'t','type_name,code','10101010','10101011',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 68,'template_name','Template','ro',NULL,'n','y','7','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'identity_col','Identity Column','ro',NULL,'n','y','8','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'description','Description','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'is_privilege_active','Activated','ro',NULL,'n','y','9','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'code','Code','ro',NULL,'n','y','10','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'update_ts','Update TS','ro',NULL,'n','y','11','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'update_user','Update By','ro',NULL,'n','y','12','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'create_ts','Create TS','ro',NULL,'n','y','13','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'create_user','Create By','ro',NULL,'n','y','14','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'value_id','System ID','ro_int',NULL,'n','y','3','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'type_id','Type ID','ro_int',NULL,'n','y','5','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'application_function_id','Application ID','ro_int',NULL,'n','y','6','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'rownumber','Unique ID','ro_int',NULL,'n','n','2','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 68,'type_name','Data Type/Static Data','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n',NULL
