 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 292,'import_data_interface',NULL,NULL,'EXEC spa_ixp_import_data_interface @flag = ''g''',NULL,'t','category,date_type',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							SELECT 292,'date_type','Category/Rule Name','tree',NULL,'n','n','1',NULL,NULL,NULL,'y','200','str',NULL,'left' UNION ALL 
							SELECT 292,'id','ID','ro',NULL,'n','n','2','y',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
							SELECT 292,'description','Rule Type','ro',NULL,'n','n','3',NULL,NULL,NULL,'y','100','str',NULL,'left' UNION ALL 
							SELECT 292,'import_rule_id','Import Rule ID','ro',NULL,'n','n','4','y',NULL,NULL,'y','200','str',NULL,'left' UNION ALL 
							SELECT 292,'column_list','Column List','ro',NULL,'n','n','5','y',NULL,NULL,'y','200','str',NULL,'left' UNION ALL 
							SELECT 292,'display_config','Display Config','ro',NULL,'n','n','6','y',NULL,NULL,'y','200','str',NULL,'left' UNION ALL 
							SELECT 292,'max_date','Start Date','ro',NULL,'n','n','7','y',NULL,NULL,'y','200','str',NULL,'left' UNION ALL 
							SELECT 292,'min_date','End Date','ro',NULL,'n','n','8','y',NULL,NULL,'y','200','str',NULL,'left'
							UPDATE tagc
