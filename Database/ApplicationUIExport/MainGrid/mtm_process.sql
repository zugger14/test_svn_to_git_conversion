 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 456,'mtm_process',NULL,NULL,NULL,'Deal','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 456,'id','Deal ID','ro',NULL,'n','y','1','n',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'deal_id','Reference ID','ro',NULL,'n','y','2','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'deal_date','Deal Date','ro',NULL,'n','n','3','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'term_start','Term Start','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'term_end','Term End','ro',NULL,'n','n','5','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'location_index','Index','ro',NULL,'n','n','6','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'Template','Template','ro',NULL,'n','n','7','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'currency','Currency','ro',NULL,'n','n','8','n',NULL,NULL,'n','150','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 456,'deal_type','Deal Type','ro',NULL,'n','n','9','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 456,'deal_volume_uom_id','UOM','ro',NULL,'n','n','11','n',NULL,NULL,'n','150','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 456,'deal_volume','Deal Volume','ro_v',NULL,'n','n','10','n',NULL,NULL,'n','150','str',NULL,'right', NULL,'n',NULL
