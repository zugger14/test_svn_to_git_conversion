BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 313,'deal_pricing_type',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 313,'deal_price_type_id','ID','ro',NULL,'y','y','1','y',NULL,NULL,NULL,'50','int',NULL,'left' UNION ALL 
												SELECT 313,'pricing_type','Pricing Type','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =103600','y','y','2','n',NULL,NULL,NULL,'180','str','NotEmpty','left' UNION ALL 
												SELECT 313,'description','Description','ed',NULL,'y','y','3','n',NULL,NULL,NULL,'150','str','','left'
