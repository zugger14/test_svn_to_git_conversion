 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 243,'requirement_constraint',NULL,NULL,'SELECT state_rec_requirement_detail_constraint_id, state_rec_requirement_applied_constraint_detail_id,sub_tier_value_id FROM state_rec_requirement_detail_constraint','Requirement Constraint','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 243,'state_rec_requirement_applied_constraint_detail_id','Tier','combo','EXEC spa_state_rec_requirement_detail ''y''','y','y','1','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 243,'sub_tier_value_id','Sub Tier','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 101800','n','y','2','n',NULL,NULL,NULL,'150','str','','left', NULL,'n',NULL UNION ALL 
												SELECT 243,'state_rec_requirement_detail_constraint_id','ID','ro_int',NULL,'n','y','0','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL
