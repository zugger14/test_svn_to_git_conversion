BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 232,'setup_generation_owner',NULL,NULL,NULL,'Owner','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 232,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'250','str',NULL,'left' UNION ALL 
												SELECT 232,'effective_date','Effective Date','dhxCalendarA',NULL,'n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 232,'owner','Owner','combo','SELECT source_counterparty_id, counterparty_id FROM source_counterparty','n','y','3','n',NULL,NULL,NULL,'150','str','NotEmpty','left' UNION ALL 
												SELECT 232,'owner_percent','Owner %','ed',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 232,'comments','Comments','txt',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left'
