BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 230,'setup_generation_data',NULL,NULL,NULL,'Data','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 230,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'250','str',NULL,'left' UNION ALL 
												SELECT 230,'effective_date','Effective Date','dhxCalendarA',NULL,'y','n','2','n',NULL,NULL,NULL,'150','str','NotEmpty','left' UNION ALL 
												SELECT 230,'end_date','End Date','dhxCalendarA',NULL,'n','n','3','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 230,'tou','ToU','combo','SELECT value_id, code FROM static_data_value WHERE type_id = 10018','n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 230,'hour_start','Hour Start','ed',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 230,'hour_end','Hour End','ed',NULL,'n','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 230,'type','Type','combo','SELECT value_id, code FROM static_data_value WHERE type_id = 44500','n','y','7','n',NULL,NULL,NULL,'150','str','NotEmpty','left' UNION ALL 
												SELECT 230,'period','Period','combo','SELECT ''LT'' [id], ''Long Term'' [value] UNION ALL SELECT ''ST'' [id], ''Short Term'' [value]','n','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 230,'value','Value','ed',NULL,'n','y','9','n',NULL,NULL,NULL,'150','str','NotEmpty','left' UNION ALL
												SELECT 230,'config','Config','combo','SELECT value_id, code FROM static_data_value WHERE type_id = 44800','n','n','10','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL
												SELECT 230,'comments','Comments','txt',NULL,'n','n','11','n',NULL,NULL,NULL,'150','str',NULL,'left'
