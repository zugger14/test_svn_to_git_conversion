BEGIN
	BEGIN TRY
		BEGIN TRAN		
			...
			SELECT 356,'EligibilityMappingTemplate',NULL,NULL,'EXEC spa_eligibility_mapping ''s''','Eligibility Mapping Template','g','template_id',NULL,NULL,NULL
			...
			SELECT 356,'template_id','Template ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','90','int',NULL,'left' UNION ALL 
			SELECT 356,'template_name','Template Name','ro',NULL,'n','n','2','n',NULL,NULL,'y','300','int',NULL,'left'
