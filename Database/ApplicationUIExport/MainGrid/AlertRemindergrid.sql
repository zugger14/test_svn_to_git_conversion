 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 417,'alert_reminder_grid',NULL,NULL,NULL,'Alert Remainder','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 417,'Description','Description','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 417,'Reminder_Days','Reminder Days','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 417,'Create_User','Created By','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 417,'Workflow_Event_Message','Message ID','ro',NULL,'n','y','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 417,'Date','Date','ro_dhxCalendarA',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 417,'Alert_Calendar_Id','System ID','ro_int',NULL,'n','y','1','Y',NULL,NULL,'y','150','int',NULL,'left', NULL,NULL,NULL
