 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 165,'ImpliedVolatilityCalculation',NULL,NULL,'','Implied Volatility Calculation','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 165,'options','Options','combo','SELECT ''c'', ''Call'' UNION ALL SELECT ''p'', ''Put''','n','n','1','n',NULL,NULL,NULL,'100','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 165,'exercise_type','Exercise Type','combo','SELECT ''a'', ''American'' UNION ALL SELECT ''e'', ''European''','n','n','2','n',NULL,NULL,NULL,'100','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 165,'commodity','Commodity','combo','EXEC spa_source_commodity_maintain ''a''','n','n','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 165,'index','Index','combo','EXEC spa_source_price_curve_def_maintain @flag = ''l'',  @source_system_id = 2','n','n','4','n',NULL,NULL,NULL,'150','str','ValidInteger','left', NULL,'n',NULL UNION ALL 
												SELECT 165,'term','Term','dhxCalendarA',NULL,'n','n','5','n',NULL,NULL,NULL,'150','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 165,'expiration','Expiration','dhxCalendarA',NULL,'n','n','6','n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 165,'strike','Strike','ed_no',NULL,'n','n','7','n',NULL,NULL,NULL,'150','str','ValidNumeric','left', NULL,'n',NULL UNION ALL 
												SELECT 165,'premium','Premium','ed_no',NULL,'n','n','8','n',NULL,NULL,NULL,'150','str','ValidNumeric','left', NULL,'n',NULL UNION ALL 
												SELECT 165,'seed','Seed','ed_no',NULL,'n','n','9','n',NULL,NULL,NULL,'140','int','ValidNumericWithEmpty','left', NULL,'n',NULL
