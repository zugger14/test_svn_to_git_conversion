BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 271,'variable_charge',NULL,NULL,'EXEC spa_transportation_rate_schedule @flag=''v'',@rate_schedule_id =<ID>','Variable Charge','g',NULL,'10162010','10162011',NULL
			...
			FROM #temp_all_grids
							...
							SELECT 271,'rate_type_id','Charge Type','combo','SELECT value_id,code FROM static_data_value WHERE type_id=5500','y','y','3','n',NULL,NULL,NULL,'175',NULL,NULL,'left' UNION ALL 
							SELECT 271,'zone_from','Zone From','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','y','4','y',NULL,NULL,NULL,'175',NULL,NULL,'left' UNION ALL 
							SELECT 271,'zone_to','Zone To','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','y','5','y',NULL,NULL,NULL,'175',NULL,NULL,'left' UNION ALL 
							SELECT 271,'rate','Rate','ed',NULL,'y','y','6','n',NULL,NULL,NULL,'175','str','ValidNumeric','left' UNION ALL 
							SELECT 271,'currency_id','Currency','combo','SELECT source_currency_id, currency_name  FROM source_currency','y','y','7','n',NULL,NULL,NULL,'205','str',NULL,'left' UNION ALL 
							SELECT 271,'formula_id','Formula','combo','SELECT formula_id, formula FROM formula_editor','y','y','8','n',NULL,NULL,NULL,'175',NULL,NULL,'left' UNION ALL 
							SELECT 271,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','9','n',NULL,NULL,NULL,'175',NULL,NULL,'left' UNION ALL 
							SELECT 271,'uom_id','UOM','combo','SELECT source_uom_id, uom_id uom_name  FROM source_uom','y','y','10','n',NULL,NULL,NULL,'175',NULL,NULL,'left' UNION ALL 
							SELECT 271,'rec_pay','Rec/Pay','combo','SELECT ''r'' [value], ''Receive'' [name] UNION ALL SELECT ''p'', ''Pay''','y','n','24','n',NULL,NULL,'n','150','str',NULL,'left' 
