 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 185,'maintain_criteria_grid',NULL,NULL,'EXEC spa_maintain_criteria_dhx @flag = ''g''',NULL,NULL,NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 185,'Id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'200','int',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'criteria_name','Criteria Name','ro',NULL,'y','y','2',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'criteria_description','Criteria Description','ro',NULL,'y','y','3',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'User','User','ro',NULL,'y','y','4','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'Role','Role','ro',NULL,'y','y','5','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'Active','Active','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'Public','Public','ro',NULL,'y','y','7','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'curve_source','Curve Source','ro',NULL,'y','y','8','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL
												SELECT 185,'volatility_source','Volatility Source','ro',NULL,'y','y','9','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL
