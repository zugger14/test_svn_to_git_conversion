BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 111,'grid_portfolio_group',NULL,NULL,NULL,NULL,'g',NULL,'10183210','10183211',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 111,'portfolio_group_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left' UNION ALL 
												SELECT 111,'portfolio_group_name','Portfolio Group Name','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 111,'portfolio_group_description','Group Description','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 111,'user','User','ro',NULL,'n','y','4','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 111,'role_name','Role','ro',NULL,'n','y','5','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 111,'public','Public','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 111,'active','Active','ro',NULL,'n','y','7','n',NULL,NULL,NULL,'150','str',NULL,'left'
