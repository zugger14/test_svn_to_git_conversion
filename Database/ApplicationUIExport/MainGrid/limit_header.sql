 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 122,'limit_header',NULL,NULL,'EXEC spa_limit_header @flag=''t''',NULL,'t','limit_for,limit_description',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 122,'limit_description','Limit For ID','ro',NULL,'y','n','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 122,'trader','Trader','ro',NULL,'y','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 122,'commodity','Commodity','ro',NULL,'y','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 122,'role','Role','ro',NULL,'y','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 122,'curve_source','Curve Source','ro',NULL,'y','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 122,'limit_id','Limit ID','ro_int',NULL,'y','n','2','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,NULL,NULL UNION ALL 
												SELECT 122,'limit_for','Limit For / Limit Name','tree',NULL,'y','n','1','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,NULL,NULL
