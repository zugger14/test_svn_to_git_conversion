 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 254,'LockAsOfDate',NULL,NULL,'EXEC spa_lock_as_of_date @flag=''g''','Lock As Of Date','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 254,'lock_as_of_date_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','100','int',NULL,'left' UNION ALL 
												SELECT 254,'sub_ids','Subsidiary','combo','EXEC spa_lock_as_of_date @flag=''x''','n','n','2','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 254,'close_date','Close Date ','dhxCalendarA',NULL,'n','y','3','n',NULL,NULL,'n','150','date','NotEmpty','left' UNION ALL 
												SELECT 254,'close_on','Close On','dhxCalendar',NULL,'n','n','4','n',NULL,NULL,'n','150','date',NULL,'left' UNION ALL 
												SELECT 254,'close_by','Close By','ro',NULL,'n','n','5','n',NULL,NULL,'n','150','str',NULL,'left'
