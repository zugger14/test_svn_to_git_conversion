 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 174,'MeterAllocation',NULL,NULL,'exec spa_recorder_generator_map @flag = ''s'', @generator_id = ''<ID>''','Meter Allocation','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 174,'meter_id','Meter','combo','EXEC spa_getAllMeter @flag=''s''','n','n','2','n',NULL,NULL,'y','150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 174,'allocation_per','Allocation','ed_no',NULL,'n','n','3','n',NULL,NULL,NULL,'150','int','BetweenZeroOne','left', NULL,'n',NULL UNION ALL 
												SELECT 174,'from_vol','From Volume','ed_v',NULL,'n','n','4','n',NULL,NULL,NULL,'150','int','','left', NULL,'n',NULL UNION ALL 
												SELECT 174,'to_vol','To Volume','ed_v',NULL,'n','n','5','n',NULL,NULL,NULL,'150','int','','left', NULL,'n',NULL UNION ALL 
												SELECT 174,'id','ID','ro_int',NULL,'n','n','1','y','alert_sql','alert_sql_id',NULL,'150','int',NULL,'left', NULL,'n',NULL
