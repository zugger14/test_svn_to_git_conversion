 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 175,'ContractAllocation',NULL,NULL,'exec spa_counterparty_contract @flag = ''s'', @ppa_counterparty_id = ''<ID>''','Contract Allocation','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 175,'ppa_contract_id','Contract Name','combo','exec spa_contract_group ''r''','n','n','2','n',NULL,NULL,'y','200','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 175,'location_id','Location','combo','EXEC spa_source_minor_location ''o'', @is_active = ''y''','n','n','3','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 175,'contract_allocation','Allocation','ed',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str','BetweenZeroOne','left', NULL,'n',NULL UNION ALL 
												SELECT 175,'generator_id','Generator ID','ro_int',NULL,'n','n','1','y','alert_sql','alert_sql_id',NULL,'150','int',NULL,'left', NULL,'n',NULL
