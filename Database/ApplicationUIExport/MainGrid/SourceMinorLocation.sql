 BEGIN
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 75,'source_minor_location_id','System ID','ron',NULL,'n','y','1','y',NULL,NULL,NULL,'70','int',NULL,'left' UNION ALL 
												...
												SELECT 75,'type_id','Type ID','ron',NULL,'n','n','10','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 75,'is_privilege_active','Privilege','ro',NULL,'n','n','11','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 75,'country','Location Group 1','ro',NULL,'n','y','12','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 75,'region','Location Group 2','ro',NULL,'n','y','13','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 75,'province','Location Group 3','ro',NULL,'n','y','14','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 75,'grid_value_id','Location Group 4','ron',NULL,'n','y','15','n',NULL,NULL,NULL,'150','int',NULL,'left'
