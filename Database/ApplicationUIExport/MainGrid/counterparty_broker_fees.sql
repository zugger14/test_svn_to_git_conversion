...
BEGIN
	...
	INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
							...
							SELECT 124,'counterparty_broker_fees',NULL,NULL,'EXEC spa_broker_fees ''g'', @counterparty_id=<ID>',NULL,NULL,NULL,NULL,NULL
					...
					CREATE TABLE #temp_all_grids_columns(
						...
						sorting_preference VARCHAR(200) COLLATE DATABASE_DEFAULT,
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 124,'Broker Fees ID','Broker Fees ID','ron',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 124,'Effective Date','Effective Date','dhxCalendar',NULL,'y','n',NULL,'n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 124,'Deal Type','Deal Type','combo','EXEC spa_getsourcedealtype @flag=''l''','y','n',NULL,'n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 124,'Commodity','Commodity','combo','EXEC spa_source_commodity_maintain @flag=''c''','y','n',NULL,'n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 124,'Product','Product','combo','exec spa_GetAllPriceCurveDefinitions ''Z''','y','n',NULL,'n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 124,'Unit Price','Unit Price','edn',NULL,'y','n',NULL,'n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 124,'Fixed Price','Fixed Price','edn',NULL,'y','n',NULL,'n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 124,'Currency','Currency','combo','EXEC spa_source_currency_maintain ''p''','y','n',NULL,'n',NULL,NULL,NULL,'150','str',NULL,'right'
