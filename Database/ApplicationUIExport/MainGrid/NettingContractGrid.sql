BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 337,'NettingContractGrid',NULL,NULL,NULL,'Netting Contract','g',NULL,'20013301','20013302',NULL 
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 337,'netting_contract_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 337,'internal_counterparty_id','Internal Counterparty','combo','EXEC spa_getsourcecounterparty @flag=''b'', @counterparty_type=''i''','n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 337,'netting_contract','Netting Contract','ed',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str','NotEmpty','left' UNION ALL
												SELECT 337,'description','Description','ed',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL
												SELECT 337,'effective_date','Effective Date','dhxCalendarA',NULL,'n','y','4','n',NULL,NULL,NULL,'150','int','NotEmpty','left' UNION ALL
												SELECT 337,'netting_type','Type','combo','EXEC spa_StaticDataValues ''h'', 109800','n','y','4','n',NULL,NULL,NULL,'150','str','ValidInteger','left' UNION ALL
												SELECT 337,'contract_id','Contract ID','ro',NULL,'n','n','5','y',NULL,NULL,NULL,'150','str',NULL,'left'  
