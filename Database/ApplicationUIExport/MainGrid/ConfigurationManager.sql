BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 8296,'ConfigurationManager',NULL,NULL,'EXEC spa_adiha_default_codes_values @flag = ''left_grid'' ','Default Codes','g','code_def',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 8296,'default_code_id','Code ID','ro',NULL,'n','y','1','y',NULL,NULL,'n','50','int',NULL,'left' UNION ALL 
												SELECT 8296,'code_def','Definition','ro',NULL,'n','y','2','n',NULL,NULL,'n','330','str',NULL,'left' UNION ALL
												SELECT 8296,'combo_or_text','Combo/Text','ro',NULL,'n','y','3','y',NULL,NULL,'n','100','str',NULL,'left' UNION ALL
												SELECT 8296,'sequence','Sequence','ro',NULL,'n','y','4','y',NULL,NULL,'n','100','int',NULL,'left'
