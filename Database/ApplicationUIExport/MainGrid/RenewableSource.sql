 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 470,'RenewableSource',NULL,NULL,'EXEC spa_rec_generator ''s''','Sources','g','generator_id',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 470,'source','Source','ro',NULL,'n','y','2','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'external_id','External Facility ID','ro',NULL,'n','y','3','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'unit','Unit ID','ro',NULL,'n','y','4','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'op_company','OP Company','ro',NULL,'n','y','5','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'business_unit','Business Unit','ro',NULL,'n','y','6','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'city','City','ro',NULL,'n','y','7','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'state','State','ro',NULL,'n','y','8','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'country','Country','ro',NULL,'n','y','9','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'fuel','Fuel Type','ro',NULL,'n','y','10','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'technology','Technology','ro',NULL,'n','y','11','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'classification_value_id','Technology Sub Type','ro',NULL,'n','y','12','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'start_date','Start Date','ro',NULL,'n','y','13','y',NULL,NULL,'n','200','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'state_value_id','Generation State','ro',NULL,'n','y','14','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'tier_type','Tier','ro',NULL,'n','y','15','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 470,'generator_id','Generator ID','ro_int',NULL,'n','y','1','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL
