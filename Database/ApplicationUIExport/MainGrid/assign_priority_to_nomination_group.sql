 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 84,'assign_priority_to_nomination_group',NULL,NULL,'EXEC spa_nomination_group ''g'' ',NULL,'g',NULL,'10165010','10165011',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 84,'nomination_group','Nomination Group','ro',NULL,'y','y','2',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 84,'effective_date','Effective Date','ro',NULL,'y','y','4',NULL,NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 84,'nomination_group_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 84,'priority','Priority','ro_int',NULL,'y','y','3',NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
