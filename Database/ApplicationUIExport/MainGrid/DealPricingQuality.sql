 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 360,'deal_pricing_quality',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 360,'attribute','Atrribute','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =29600','y','y','2','n',NULL,NULL,NULL,'180','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 360,'operator','Operator','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =37900, @license_not_to_static_value_id=37901','y','y','3','n',NULL,NULL,NULL,'180','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 360,'uom','UOM','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =106800','y','n','6','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 360,'basis','Basis','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =106900','y','n','7','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 360,'text_value','Text Value','ed',NULL,'y','n','5','n',NULL,NULL,NULL,'150','str','','left', NULL,'n',NULL UNION ALL 
												SELECT 360,'numeric_value','Numeric Value','ed_no',NULL,'y','y','4','n',NULL,NULL,NULL,'150','str','','left', NULL,'n',NULL UNION ALL 
												SELECT 360,'deal_price_quality_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'80','str',NULL,'left', NULL,'n',NULL
