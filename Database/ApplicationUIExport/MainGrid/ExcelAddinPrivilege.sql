BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 224,'rm_privilege_grid',NULL,NULL,NULL,'Assign Privilege','t','file_name,sheet_name','10101020','10101020'
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 224,'code','Files Name/Sheets Name','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 224,'role','Role','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 224,'user','User','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 224,'value_id','Sheet ID','ro',NULL,'n','y','4','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 224,'type_id','File ID','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL
												SELECT 224,'type','Type','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left'
