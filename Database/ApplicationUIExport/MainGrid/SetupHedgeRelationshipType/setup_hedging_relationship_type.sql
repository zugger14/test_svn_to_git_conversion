 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 147,'setup_hedging_relationship_type',NULL,NULL,'EXEC spa_effhedgereltype ''s''','Hedging Relationship Type','g',NULL,'10231910','10231912',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 147,'eff_test_name','Name','ro',NULL,'n','n','1','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'subsidiary','Subsidiary','ro',NULL,'n','n','2','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'strategy','Strategy','ro',NULL,'n','n','3','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'book','Book','ro',NULL,'n','n','4','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'eff_test_description','Description','ro',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'matching_type','Matching Type','ro',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'effective_start_date','Effective Start Date','ro',NULL,'n','n','7','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'effective_end_date','Effective End Date','ro',NULL,'n','n','8','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'profile_active','Active','ro',NULL,'n','n','9','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'profile_approved','Approved','ro',NULL,'n','n','10','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'profile_approved_by','Approved By','ro',NULL,'n','n','11','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'profile_approved_date','Approved Date','ro',NULL,'n','n','12','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'create_user','Created By','ro',NULL,'n','n','13','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'create_ts','Created Timestamp','ro',NULL,'n','n','14','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'update_user','Updated By','ro',NULL,'n','n','15','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'update_ts','Updated Timestamp','ro',NULL,'n','n','16','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'measurement_eff_test_approach','Effectiveness Test Approach','ro',NULL,'n','n','17','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'externalization','Externalization','ro',NULL,'n','n','18','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'eff_test_profile_id','Eff Test Profile ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'y','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 147,'fas_book_id','FAS Book ID','ro_int',NULL,'n','n','19','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL
