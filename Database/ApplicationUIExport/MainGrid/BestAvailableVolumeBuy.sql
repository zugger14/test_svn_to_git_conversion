 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 335,'best_available_volume_buy',NULL,NULL,'','Best Available Buy Volume','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 335,'deal_id','Deal ID','ro',NULL,'n','n','1','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 335,'flow_date','Flow Date','ro',NULL,'n','n','2','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 335,'location','Location','ro',NULL,'n','n','3','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 335,'volume','Volume','ro_v',NULL,'n','n','4','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 335,'rec_volume','Rec Volume','ro_v',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 335,'net_volume','Net Volume','ro_v',NULL,'n','n','7','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL
