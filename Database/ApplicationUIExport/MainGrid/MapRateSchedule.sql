 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 106,'map_rate_schedule','','','',NULL,'g','',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 106,'fuel_loss_group','Fuel Loss Group','combo',NULL,'y','y','5','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 106,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','3','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 106,'fuel_loss','Fuel Loss','ed',NULL,'y','y','4','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 106,'map_rate_schedule_id','System Id','ro_int',NULL,'n','y','1','n',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 106,'location_loss_factor_id','Location Loss Factor ID','ro_int',NULL,'n','y','2','y','location_loss_factor','location_loss_factor_id',NULL,'150','int',NULL,'left', NULL,'n',NULL
