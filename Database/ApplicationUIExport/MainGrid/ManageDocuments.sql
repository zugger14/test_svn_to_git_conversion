 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 461,'ManageDocuments',NULL,NULL,NULL,'Documents','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 461,'notes_attachment','Attachment','link',NULL,'n','y','2',NULL,NULL,NULL,NULL,'350','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'parent_object_id','Object ID','link',NULL,'n','y','3',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'url','URL','link',NULL,'n','y','5',NULL,NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'user_category','User Category','ro',NULL,'n','y','4',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'create_ts','Created Date','ro',NULL,'n','y','6',NULL,NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'create_user','Created By','ro',NULL,'n','y','7',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'attachment_file_name','File Name','ro',NULL,'n','y','8','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'notes_share_email_enable','Notes Share Email Enable','ro',NULL,'n','y','9','y',NULL,NULL,NULL,'160','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'search_criteria','Search Criteria','ro',NULL,'n','n','12','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'notes_attachment_real','Attachment Path','ro',NULL,'n','n','15','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'notes_id','Notes ID','ro_int',NULL,'n','n','10','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'sub_category_id','Sub Category ID','ro_int',NULL,'n','n','11','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'category_id','Category ID','ro_int',NULL,'n','n','13','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'notes_object_id','Notes Object ID','ro_int',NULL,'n','n','14','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 461,'notes_subject','Subject','tree',NULL,'n','y','1',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL
