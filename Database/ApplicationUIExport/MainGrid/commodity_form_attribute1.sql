 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 205,'commodity_form_attribute1','commodity_form','commodity_form_id','EXEC spa_source_commodity_origin ''f''','Attribute 1','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 205,'attribute_id','Attribute Type','combo','SELECT commodity_attribute_id, commodity_name FROM commodity_attribute','y','y','2',NULL,NULL,NULL,NULL,'130','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 205,'attribute_form_id','Attribute','combo','','y','y','3',NULL,NULL,NULL,NULL,'130','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 205,'commodity_form_attribute1_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 205,'commodity_form_id','Form ID','ro_int',NULL,'n','y','4','y','commodity_form','commodity_form_id',NULL,'130','int',NULL,'left', NULL,'n',NULL
