 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 55,'contract_group_transportation',NULL,NULL,NULL,'Contracts','a','contract_group_def_id',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 55,'contract_name','Contract Name','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'pipeline','Pipeline/Counterparty','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'capacity_release','Capacity Release','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'flow_start_date','Flow Start Date','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'flow_end_date','Flow End Date','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'contract_type','Capacity Type','ro',NULL,'n','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'maintain_rate_schedule','Rate Schedule','ro',NULL,'n','n','10','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'segmentation','Segmentation','ro',NULL,'n','n','11','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'is_active','Active','ro',NULL,'n','n','12','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'is_privilege_active','Privilege','ro',NULL,'n','n','14','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'contract_id_show','System ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'type_id','Type ID','ro_int',NULL,'n','n','13','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 55,'mdq','MDQ','ro_no',NULL,'n','n','5','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
