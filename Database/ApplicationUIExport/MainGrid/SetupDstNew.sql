 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 458,'Setup_dst_grid',NULL,NULL,'EXEC spa_dst_setup_hours ''n''','Setup DST','t','year,dst',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 458,'date','Date','dhxCalendar',NULL,'n','n','3','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 458,'hour','Hour','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 458,'id','ID','ro_int',NULL,'n','n','2','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 458,'year','year','tree',NULL,'n','n','1','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL
