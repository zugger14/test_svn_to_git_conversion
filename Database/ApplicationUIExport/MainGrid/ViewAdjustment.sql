 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 299,'ViewAdjustment',NULL,NULL,NULL,NULL,'g',NULL,'20007300','20007300',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 299,'counterparty','Counterparty','ro',NULL,'n','n','1','n',NULL,NULL,'n','300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'contract','Contract','ro',NULL,'n','n','2','n',NULL,NULL,'y','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'production_month','Production Month','ro',NULL,'n','n','3','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'charge_type','Charge Type','ro',NULL,'n','n','4','n',NULL,NULL,'y','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'delta_volume','Delta Volume','ro',NULL,'n','n','9','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'currency','Currency','ro',NULL,'n','n','12','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'accounting_status','Accounting Status','ro',NULL,'n','n','13','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'finalize_date','Finalize Date','ro',NULL,'n','n','14','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'invoice_no','Invoice Number','ro',NULL,'n','n','15','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'uom','UOM','ro',NULL,'n','n','10','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'create_user','Created By','ro',NULL,'n','n','16','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'create_ts','Created Time','ro',NULL,'n','n','17','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'true_up_id','True up ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'y','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'calc_id','Calc ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'y','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'current_value','Current Value','ro_p',NULL,'n','n','7','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'prior_value','Prior Value','ro_p',NULL,'n','n','8','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'delta_value','Delta Value','ro_p',NULL,'n','n','11','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'current_volume','Current Volume','ro_v',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 299,'prior_volume','Prior Volume','ro_v',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL
