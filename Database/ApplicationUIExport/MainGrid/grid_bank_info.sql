...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 53,'grid_bank_info',NULL,NULL,'EXEC spa_counterparty_bank_info ''t'', @counterparty_id = ''<ID>''',NULL,'g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 53,'bank_id','bank_id','ro',NULL,'n','y','0','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'Address2','Address 2','ed',NULL,'n','y','9','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'accountname','Account Name','ro',NULL,'n','y','1','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'Account_no','Account No.','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'currency','Currency','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'right' UNION ALL 
												SELECT 53,'wire_ABA','ABA No.','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'ACH_ABA','Swift No.','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'bank_name','Bank Name','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'Address1','Address 1','ro',NULL,'n','y','7','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'Address1','Address 2','ro',NULL,'n','y','8','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 53,'reference','Reference','ro',NULL,'n','y','9','n',NULL,NULL,NULL,'150','str',NULL,'left'
