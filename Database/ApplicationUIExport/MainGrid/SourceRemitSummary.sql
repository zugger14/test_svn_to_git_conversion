 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 229,'SourceRemitSummary',NULL,NULL,NULL,'Report Summary','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 229,'Create_date_from','Create Date From','ro',NULL,'n','n','1','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'create_date_to','Create Date To','ro',NULL,'n','n','2','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'report_type','Report Type','ro',NULL,'n','n','3','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'user','User','ro',NULL,'n','n','4','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'create_time','Create TS','ro',NULL,'n','n','5','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'status','Status','ro',NULL,'n','n','6','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'process_id','Process ID','ro_int',NULL,'n','n','7','n',NULL,NULL,'n','200','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 229,'report_type_id','Report ID','ro_int',NULL,'n','n','8','y',NULL,NULL,'n','200','int',NULL,'left', NULL,'n',NULL
