BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 223,'deal_exercise',NULL,NULL,NULL,'Exercise Deals','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 223,'deal_id','Exercise Deal','ro',NULL,'n','y','1','n',NULL,NULL,NULL,'120','int',NULL,'right' UNION ALL 
												SELECT 223,'term_start','Term Start','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 223,'term_end','Term End','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 223,'exercise_date','Exercise Date','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left'
