 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 108,'monte_carlo_model_parameter',NULL,NULL,'EXEC spa_monte_carlo_model ''s''','Risk Factor Model','g',NULL,'10183010','10183011',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 108,'Name','Name','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Volatility','Volatility','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Drift','Drift','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Seed','Seed','ro',NULL,'n','n','5','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Data Series','Data Series','ro',NULL,'n','n','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Curve Source','Curve Source','ro',NULL,'n','n','7','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Mean Reversion Time','Mean Reversion Time','ro',NULL,'n','n','8','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Mean Reversion Rate','Mean Reversion Rate','ro',NULL,'n','n','9','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Mean Reversion Level','Mean Reversion Level','ro',NULL,'n','n','10','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'Volatility Source','Volatility Source','ro',NULL,'n','n','11','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 108,'ID','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
