 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 182,'SetupRuleWorkflow',NULL,NULL,'EXEC spa_setup_rule_workflow @flag=''w''','Workflow','t','module_name,workflow_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 182,'event_name','Event','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 182,'owner','Owner','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 182,'module_events_id','ID','ro_int',NULL,'n','n','2','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 182,'workflow_name','Module/Workflow','tree',NULL,'n','n','1','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL
