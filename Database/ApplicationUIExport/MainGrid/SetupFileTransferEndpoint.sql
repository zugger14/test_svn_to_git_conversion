BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 350,'SetupFileTransferEndpoint',NULL,NULL,'EXEC spa_file_transfer_endpoint ''a''',NULL,'g',NULL,'20017301','20017302',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 350,'file_transfer_endpoint_id','ID','ro',NULL,'y','y','1','y',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 350,'name','Name','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'100',NULL,NULL,'left' UNION ALL
												SELECT 350,'certificate_key_name','Certificate Key Name','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 350,'description','Description','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'250',NULL,NULL,'left'  UNION ALL
												SELECT 350,'remote_directory','Remote Directory','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'250',NULL,NULL,'left' 
