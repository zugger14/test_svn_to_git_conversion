 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 124,'setup_profile',NULL,NULL,'EXEC spa_forecast_profile ''s''','Profile','t','profile_type,profile_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 124,'external_id','Profile Code','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 124,'uom_id','UOM','ro',NULL,'n','y','5','y',NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 124,'profile_id','ID','ro_int',NULL,'n','y','3','y',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 124,'profile_type','Profile Type/Profile Name','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL
