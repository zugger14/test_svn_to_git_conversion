BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 253,'eod_report_grid','','','','','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 253,'id','ID','ro',NULL,'n','y','1','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 253,'source','Source','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'300','int',NULL,'left' UNION ALL 
												SELECT 253,'status','Status','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 253,'description','Desription','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'500','str',NULL,'left'
