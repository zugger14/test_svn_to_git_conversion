 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 312,'TemplatePrivilege',NULL,NULL,NULL,'Template Mapping Privilege','t','template_name,template_description',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 312,'deal_type_id','Deal Type','combo','EXEC spa_source_deal_type_maintain @flag=''x''','y','n','4','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 312,'commodity_id','Commodity','combo','EXEC spa_source_commodity_maintain @flag=''a''','y','n','5','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 312,'user_id','Users','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 312,'role_name','Roles','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 312,'template_id','Template ID','ro_int',NULL,'n','y','2','y',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 312,'template_mapping_id','ID','ro_int',NULL,'n','n','3','y',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 312,'template_name','Template/Description','tree',NULL,'y','y','1','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL
