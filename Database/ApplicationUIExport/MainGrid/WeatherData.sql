 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 191,'weather_data','','','',NULL,'t','curve_type',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 191,'granulalrity','Granularity','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 191,'effective_date_applicable','Effective Date Applicable','ro',NULL,'n','y','4','y',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 191,'maturity_applicable','Maturity Applicable','ro',NULL,'n','n','5','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 191,'weather_data_id','System ID','ro_int',NULL,'y','y','2','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 191,'name','Series Type/ Name','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'350','str',NULL,'left', NULL,'n',NULL
