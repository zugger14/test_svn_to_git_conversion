BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 152,'deal_escalation',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 152,'quality','Quality','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 29600','y','y','2','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 152,'operator','Operator','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 37900','y','y','3','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 152,'reference','Reference','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 37800','y','y','4','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 152,'range_from','Lower Bound','ed',NULL,'y','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 152,'range_to','Upper Bound','ed',NULL,'y','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 152,'increment','Increment','ed',NULL,'y','y','7','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 152,'cost_increment','Cost/Increment','ed',NULL,'y','y','8','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 152,'currency','Currency','combo','EXEC spa_getcurrencyunit ''s''','y','y','9','n',NULL,NULL,NULL,'150','str',NULL,'right' UNION ALL 
												SELECT 152,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'100','int',NULL,'left'
