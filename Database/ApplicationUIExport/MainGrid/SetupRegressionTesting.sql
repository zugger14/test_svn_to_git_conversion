BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 313,'SetupRegressionTesting',NULL,NULL,'EXEC spa_regression_testing @flag = ''g''','Regression Testing','t','regression_group,rule_name','20009401','24009402',0
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 313,'regression_rule_id','ID','ro',NULL,'n','y','2','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'regression_group','Regression Group / Rule Name','tree',NULL,'n','y','1','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
												SELECT 313,'description','Description','ro',NULL,'n','y','3','n',NULL,NULL,'n','180','str',NULL,'left' UNION ALL 
												SELECT 313,'filter','Filter','ro',NULL,'n','y','5','y',NULL,NULL,'n','100','str',NULL,'left' UNION ALL
												SELECT 313,'is_system_defined','System Defined','ro',NULL,'n','y','6','y',NULL,NULL,'n','120','str',NULL,'left'
