 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 142,'GenHedgeGroupDetail',NULL,NULL,'','Hedge Group Detail','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 142,'deal_id','Source Deal ID','link',NULL,'n','n','2','n',NULL,NULL,'n','180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'percentage_included','Percentage Included','ro',NULL,'n','n','3','n',NULL,NULL,'n','180','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'effective_date','Effective Date','ro',NULL,'n','n','4','n',NULL,NULL,'n','90','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'deal_date','Deal Date','ro',NULL,'n','n','5','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'hedge_item','Hedge Item','ro',NULL,'n','n','6','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'term_start','Term Start','ro',NULL,'n','n','8','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'term_end','Term End','ro',NULL,'n','n','9','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'fixed_float','Fixed float','ro',NULL,'n','n','10','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'buy_sell','Buy Sell','ro',NULL,'n','n','11','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'uom','UOM','ro',NULL,'n','n','14','n',NULL,NULL,'n','80','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 142,'index','Index','ro',NULL,'n','n','15','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'currency','Currency','ro',NULL,'n','n','17','n',NULL,NULL,'n','100','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 142,'gen_hedge_group_id','Gen Group ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'n','10','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'source_deal_header_id','Deal ID','ro_int',NULL,'n','n','1','n',NULL,NULL,'n','80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'leg','Leg','ro_int',NULL,'n','n','7','n',NULL,NULL,'n','60','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'price','Price','ro_p',NULL,'n','n','16','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'volume','Volume','ro_v',NULL,'n','n','12','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'matched_volume','Matched Volume','ro_v',NULL,'n','n','13','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 142,'available_volume','Available Volume','ro_v',NULL,'n','n','13','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL
