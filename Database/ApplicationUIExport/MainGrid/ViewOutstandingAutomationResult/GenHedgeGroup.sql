...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 126,'GenHedgeGroup',NULL,NULL,'','Hedge Group','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
						...
						SELECT 126,'gen_hedge_group_id','','sub_row_grid',NULL,'n','n','1','n',NULL,NULL,'n','30','str',NULL,'left' UNION ALL 
						SELECT 126,'gen_hedge_group_name','Gen Group Name','ro',NULL,'n','n','2','n',NULL,NULL,'n','250','str',NULL,'left' UNION ALL 
						SELECT 126,'effective_date','Effective Date','ro',NULL,'n','n','3','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
						SELECT 126,'hedging_relationship_type','Relationship Type','ro',NULL,'n','n','4','n',NULL,NULL,'n','250','str',NULL,'left' UNION ALL 
						SELECT 126,'perfect_hedge','Perfect Hedge','ro',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
						SELECT 126,'relationship_type','Link Type','ro',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
						SELECT 126,'status','Status','link',NULL,'n','n','7','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
						SELECT 126,'portfolio','Portfolio','ro',NULL,'n','n','8','n',NULL,NULL,'n','480','str',NULL,'left'
