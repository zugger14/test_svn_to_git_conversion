BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 186,'setup_logical_trade_lock_grid',NULL,NULL,'EXEC spa_setup_logical_trade_lock ''g''','Setup Logical Trade Lock','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 186,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','250','int',NULL,'left' UNION ALL 
												SELECT 186,'role_id','Role Name','combo','EXEC spa_setup_logical_trade_lock @flag = ''r''','y','y','2','n',NULL,NULL,'n','250','str','NotEmpty','left' UNION ALL 
												SELECT 186,'deal_type_id','Deal Type','combo','EXEC spa_source_deal_type_maintain @flag=''x''','y','y','3','n',NULL,NULL,'n','250','str',NULL,'left' UNION ALL 
												SELECT 186,'hour','Hour','combo','EXEC spa_setup_logical_trade_lock @flag=''h''','y','y','4','n',NULL,NULL,'n','250','int','NotEmpty','left' UNION ALL 
												SELECT 186,'minute','Minute','combo','EXEC spa_setup_logical_trade_lock @flag=''m''','y','y','5','n',NULL,NULL,'n','250','int','NotEmpty','left'
