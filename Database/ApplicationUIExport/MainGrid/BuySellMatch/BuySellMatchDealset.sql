 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 440,'BuySellMatchDealset',NULL,NULL,NULL,'Summary','g',NULL,'20007901','20007902',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 440,'matched','Matched','ed_no',NULL,'n','y','15','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'ref_id','Reference ID','ro',NULL,'n','y','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'counterparty','Counterparty','ro',NULL,'n','y','3','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'vintage_year','Vintage Year','ro',NULL,'n','y','4','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'term_start','Vintage Start','ro',NULL,'n','y','6','n',NULL,NULL,'n','120','date',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'term_end','Vintage End','ro',NULL,'n','y','7','n',NULL,NULL,'n','120','date',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'delivery_date','Delivery Date','ro',NULL,'n','y','9','n',NULL,NULL,'n','120','date',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'deal_date','Deal Date','ro',NULL,'n','y','11','n',NULL,NULL,'n','80','date',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'detail_status','Detail Status','ro',NULL,'n','y','19','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'process_id','Process ID','ro',NULL,'n','y','22','y',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'product_class','Product Classification','ro',NULL,'n','y','23','y',NULL,NULL,'n','140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'sequence_from','Sequence From','ro',NULL,'n','y','12','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'sequence_to','Sequence To','ro',NULL,'n','y','13','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'transfer_status','Transfer Status','ro',NULL,'n','y','20','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'id','ID','ro',NULL,'n','y','21','y',NULL,NULL,'n','120','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'expiration_date','Expiration Date','ro_dhxCalendarA',NULL,'n','y','5','n',NULL,NULL,'n','120','date',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'source_deal_detail_id','Deal Detail ID','ro_int',NULL,'n','y','10','y',NULL,NULL,'y','100','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'leg','Leg','ro_int',NULL,'n','y','8','n',NULL,NULL,'n','50','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 440,'remaining','Remaining','ro_no',NULL,'n','n','16','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'vp_value','Value','ro_no',NULL,'n','n','18','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'price','Price','ro_p',NULL,'n','n','17','n',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'actual_volume','Best Available Volume','ro_v',NULL,'n','n','14','n',NULL,NULL,'n','140','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 440,'source_deal_header_id','Deal ID','tree',NULL,'n','y','1','n',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL
