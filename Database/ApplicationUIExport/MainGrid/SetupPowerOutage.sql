 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 123,'power_outage_grid',NULL,NULL,'exec spa_power_outage ''m''',NULL,'t','generator_name,Derate/Outage','10161810','10161811',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 123,'planned_start','Actual Start D/T','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'planned_end','Actual End D/T','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'actual_start','Planned Start D/T','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'actual_end','Planned End D/T','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'granularity','Granularity','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'status','Status','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'request_type','Request Type','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'derate_percent','Derate %','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'comments','Comments','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'power_outage_id','Power Outage ID','ro_int',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'granularity_id','Granularity ID','ro_int',NULL,'y','y',NULL,'y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'derate_mw','Derate MW','ro_no',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 123,'generator_name','Generator Unit [Derate/Outage]','tree',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL
