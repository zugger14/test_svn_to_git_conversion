 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 226,'alert_reports',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 226,'report_writer','Report Writer','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'report_name','Report Name','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'140','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'paramset_hash','Paramset Hash','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'report_param','Report Param','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'report_desc','Report Desc','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'table_prefix','Table Prefix','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'140','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'table_postfix','Table Postfix','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'140','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'report_where_clause','Report Where Clause','ro',NULL,'n','n','9','n',NULL,NULL,NULL,'190','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'report_type','Report Type','ro',NULL,'n','n','10','y',NULL,NULL,NULL,'140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'file_option_type','File Option Type','ro',NULL,'n','n','11','y',NULL,NULL,NULL,'140','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 226,'alert_reports_id','Alert Report ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'230','int',NULL,'left', NULL,'n',NULL
