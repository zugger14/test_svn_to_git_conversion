BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 337,'grid_contract_product',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 337,'counterparty_credit_block_id','ID','ro',NULL,'n','n','1','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'counterparty_id','Counterparty','combo',NULL,'n','n','2','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'internal_counterparty_id','Internal Counterparty','combo',NULL,'n','n','3','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'contract','Contract','combo',NULL,'n','n','4','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'comodity_id','Commodity','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'deal_type_id','Deal Type','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'buy_sell','Buy/Sell','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 337,'template_id','Template','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'60','int',NULL,'left' 
