 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 301,'FormTemplate',NULL,NULL,'EXEC spa_form_template_builder ''a''','Form','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 301,'template_name','Form Name','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 301,'template_description','Form Description','ro',NULL,'n','y','2',NULL,NULL,NULL,NULL,'330','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 301,'primary_id','Primary Column','ro',NULL,'n','y','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 301,'application_function_id','Function ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
