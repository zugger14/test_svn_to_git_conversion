...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 143,'DesignationOfHedge',NULL,NULL,'','Summary','g',NULL,'10233700',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 143,'link_id','Link ID','ro',NULL,'n','n','0','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'link_description','Description','ro',NULL,'y','n','1','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'subsidiary','Subsidiary','ro',NULL,'n','n','2','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'strategy','Strategy','ro',NULL,'n','n','3','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'book','Book','ro',NULL,'n','n','4','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'effective_date','Effective Date','ro',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'perfect_hedge','Perfect Hedge','ro',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'fully_dedesignated','Fully Dedesignated','ro',NULL,'n','n','7','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'link_active','Link Active','ro',NULL,'n','n','8','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'allow_change','Allow Change','ro',NULL,'n','n','8','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'assessment_result','Show Assessment Result','ro',NULL,'n','n','9','y',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'assessment_id','Assesment ID','ro',NULL,'n','n','10','y',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'hedge_doc_template','Hedge Documentation Template','ro',NULL,'n','n','11','y',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 143,'lnk_id','lnk_id','ro',NULL,'n','n','12','y',NULL,NULL,'n','120','str',NULL,'left'
