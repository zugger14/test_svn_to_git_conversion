 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 136,'deal_triggers',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 136,'term_start','Term Start','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 136,'term_end','Term End','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 136,'post_date','Trigger Date','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 136,'index','Index','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 136,'deal_id','Deal ID','ro_int',NULL,'n','y','1','n',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 136,'volume','Volume','ro_no',NULL,'n','y','6','n',NULL,NULL,NULL,'150','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 136,'fixed_price','Trigger Price','ro_p',NULL,'n','y','7','n',NULL,NULL,NULL,'150','int',NULL,'right', NULL,'n',NULL
