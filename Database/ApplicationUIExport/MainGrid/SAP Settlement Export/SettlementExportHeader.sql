 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 210,'settlement_export_header',NULL,NULL,'',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 210,'document_header','DOCUMENT HEADER','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'80',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'comp_code','COMP CODE','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'doc_type','DOC TYPE','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'doc_date','DOC DATE','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'fisc_year','FISC YEAR','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'pasng_date','PSTNG DATE','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'currency','CURRENCY','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 210,'header_txt','HEADER TXT','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'ref_doc_no','REF DOC NO','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'reason_rev','REASON REV','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'extension_field','EXTENSION1-FIELD1','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'text','TEXT','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'base_unit_of_measure','Base Unit of Measure','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 210,'process_id','Process id','ro',NULL,'n','y',NULL,'y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'create_user','Exported By','ro',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'create_ts','Exported TS','ro',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'settlement_period','Settlement Period','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 210,'quantity','Quantity','ro_no',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'right', NULL,'n',NULL
