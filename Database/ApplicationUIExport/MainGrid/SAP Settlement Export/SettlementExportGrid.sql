 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 209,'settlement_export_grid',NULL,NULL,'',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 209,'document_header','DOCUMENT_HEADER/KeyField','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'80',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'comp_code','COMP_CODE /AccountID','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'doc_type','DOC_TYPE/CustomerID','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'doc_date','DOC_DATE/VendorID','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'fisc_year','FISC_YEAR/BaseLineDate','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'pasng_date','PSTNG_DATE/CostCenter','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'currency','CURRENCY/Amount','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'header_txt','HEADER_TXT/TaxCode','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'ref_doc_no','REF_DOC_NO/Allocation','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'reason_rev','REASON_REV/BankID','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'extension_field','EXTENSION1-FIELD1/PartnerBankType','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'text','TEXT','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'quantity','Quantity','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'base_unit_of_measure','Base Unit of Measure','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'row_type','row_type','ro',NULL,'n','y',NULL,'y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'process_id','Process id','ro',NULL,'n','y',NULL,'y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'ProfitCenter','Profit Center','ro',NULL,'y','n',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'PartnerID','PartnerID','ro_int',NULL,'y','n',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 209,'settlement_period','Settlement Period','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
