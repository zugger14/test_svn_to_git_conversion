 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 211,'settlement_export_history',NULL,NULL,'',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 211,'key_field','KeyField','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'80',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'base_line_date','BaseLineDate','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'tax_code','TaxCode','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'allocation','Allocation','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'partner_bank_ty','ParetnerBankTy','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'text','TEXT','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'quantity','Quantity','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'base_unit_of_measure','Base Unit of Measure','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'amount','Amount','ro_a',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'account_id','Account ID','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'customer_id','Customer ID','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'vendor_id','Vendor ID','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'cost_center_id','CostCenter ID','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'bank_id','BankID','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 211,'settlement_period','Settlement Period','ro_int',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
