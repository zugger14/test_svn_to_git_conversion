 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 105,'location_loss_factor','','','EXEC spa_map_rate_schedules ''g''',NULL,'t','rate_schedule_type,logical_name','10163300','10163310',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 105,'from_location_zone','From Location/Zone','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 105,'to_location_zone','To Location/Zone','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 105,'rate_schedule','Rate Schedule','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 105,'id','System ID','ro_int',NULL,'y','y','2','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 105,'rate_schedule_type','Rate Schedule Type/Logical Name','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'210','str',NULL,'left', NULL,'n',NULL
