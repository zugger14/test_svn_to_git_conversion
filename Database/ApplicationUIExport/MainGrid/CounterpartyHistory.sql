 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 249,'CounterPartyHistory',NULL,NULL,'EXEC spa_counterparty_history ''s'', @source_counterparty_id=<ID>','Counterparty History','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 249,'counterparty_history_id','History Id','ron',NULL,'n','y','0','y',NULL,NULL,'y','158','int',NULL,'left' UNION ALL 
												SELECT 249,'effective_date','Effective Date','dhxCalendarA',NULL,'n','y','1','n',NULL,NULL,'n','158','date','NotEmpty','left' UNION ALL 
												SELECT 249,'source_counterparty_id','Source Counterparty Id','ron',NULL,'n','y','2','y',NULL,NULL,'n','158','int',NULL,'left' UNION ALL 
												SELECT 249,'counterparty_name','Counterparty Name','ed',NULL,'n','n','3','n',NULL,NULL,'n','158','str','NotEmpty','left' UNION ALL 
												SELECT 249,'counterparty_desc','Counterparty Description','ed',NULL,'n','n','5','n',NULL,NULL,'n','158','str',NULL,'left' UNION ALL 
												SELECT 249,'parent_counterparty','Parent Counterparty','combo','EXEC spa_getsourcecounterparty ''s''','n','n','6','n',NULL,NULL,'n','158','str',NULL,'left' UNION ALL 
												SELECT 249,'counterparty_id','Counterparty ID','ed',NULL,'n','y','4','n',NULL,NULL,'y','158','str',NULL,'left'
