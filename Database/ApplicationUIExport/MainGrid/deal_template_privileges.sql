BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 320,'deal_template_privilege',NULL,NULL,NULL,'Deal Template Privilege','g',NULL,'20011400','20011400',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 320,'template_id','Template ID','ro',NULL,'n','y','1','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 320,'template_name','Template Name','ro',NULL,'n','y','2',NULL,NULL,NULL,NULL,'250','str',NULL,'left' UNION ALL 
												SELECT 320,'user','User','ro',NULL,'n','y','3',NULL,NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 320,'role','Role','ro',NULL,'n','y','4',NULL,NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
												SELECT 320,'action','Action','ro',NULL,'n','y','5',NULL,NULL,NULL,NULL,'100','str',NULL,'left'
