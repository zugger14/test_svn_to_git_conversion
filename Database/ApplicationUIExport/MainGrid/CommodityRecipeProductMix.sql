 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 347,'commodity_recipe_product_mix','source_commodity','source_commodity_id',NULL,'Product Mix','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 347,'recipe_commodity_id','Commodity','combo','EXEC spa_source_commodity_maintain @flag=''a''','y','y','3',NULL,NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 347,'blend_contribution','Blend Contribution %','ed_no',NULL,'y','y','4',NULL,NULL,NULL,NULL,'150','int','ValidNumeric','left', NULL,'n',NULL UNION ALL 
												SELECT 347,'loss_shrinkage','Loss/Shrinkage %','ed_no',NULL,'y','y','5',NULL,NULL,NULL,NULL,'150','int','ValidNumericWithEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 347,'commodity_recipe_product_mix_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 347,'source_commodity_id','Parent Commodity ID','ro',NULL,'n','y','2','y','source_commodity','source_commodity_id',NULL,'150','str',NULL,'left', NULL,'n',NULL
