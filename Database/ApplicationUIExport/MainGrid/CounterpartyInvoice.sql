 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 63,'counterparty_invoice','','','',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 63,'invoice_date','Invoice Date','dhxCalendar',NULL,'y','y','3','y',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'invoice_ref_no','Invoice Ref No','ed',NULL,'n','y','2','y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'description','Description','ed',NULL,'y','y','8','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'amount','Amount','ed_a',NULL,'y','y','6','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'charge_type','Charge Type','ro',NULL,'n','y','1','n',NULL,NULL,NULL,'300',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'shadow_calc','Shadow Calc','ro_a',NULL,'y','y','5','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'variance','Variance','ro_a',NULL,'y','y','7','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'invoice_line_item_id','Invoice line Item ID','ro_int',NULL,'n','y','9','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'invoice_id','Invoice ID','ro_int',NULL,'n','y','10','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 63,'invoice_detail_id','Invoice Detail ID','ro_int',NULL,'n','y','11','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
