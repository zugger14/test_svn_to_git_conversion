 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 376,'SetupDealTemplateFieldsPool',NULL,NULL,'EXEC spa_setup_deal_template @flag = ''p''','Pools','t','field_template_type,default_label',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 376,'field_type','Type','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'header_detail','Header/Detail','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'system_required','System','ro',NULL,'n','n','5','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'sql_string','SQL','ro',NULL,'n','n','6','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'udf_or_system','UDF/System','ro',NULL,'n','n','7','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'is_disable','Disable','ro',NULL,'n','n','8','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'insert_required','Show in Insert','ro',NULL,'n','n','9','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'hide_control','Hide Column','ro',NULL,'n','n','10','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'default_value','Default Value','ro',NULL,'n','n','11','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'update_required','Show in Update','ro',NULL,'n','n','12','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'value_required','Value Required','ro',NULL,'n','n','13','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'id','Field ID','ro',NULL,'n','n','2','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 376,'label','Field Name','tree',NULL,'n','n','1','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL
