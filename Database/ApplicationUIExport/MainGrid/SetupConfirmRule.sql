 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 194,'setup_confirm_rule',NULL,NULL,'EXEC spa_deal_confirmation_rule ''s''',NULL,'t','entity_type,counterparty_id',NULL,NULL, NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 194,'source_counterparty_id','System ID','ro',NULL,'n','y','2','y',NULL,NULL,'y','150','str',NULL,'left' UNION ALL 
												SELECT 194,'counterparty_name','Name','ro',NULL,'n','y','3','y',NULL,NULL,'n','150','str',NULL,'left' UNION ALL 
												SELECT 194,'entity_name','Entity/Counterparty','tree',NULL,'n','y','1','n',NULL,NULL,'y','350','str',NULL,'left'
