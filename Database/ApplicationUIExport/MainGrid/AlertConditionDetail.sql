 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 184,'AlertConditionDetail',NULL,NULL,NULL,'Alert Conditions','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 184,'clause_type','','combo','SELECT 1, ''AND'' UNION ALL SELECT 2, ''OR''','n','n','2','n',NULL,NULL,NULL,'55','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'table_id','Table','combo','select '''' value, '''' as text','n','n','3','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'column_id','Column','combo','select '''' value, '''' as text','n','n','4','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'operator_id','Operator','combo','SELECT rpo.report_param_operator_id, rpo.[description] FROM report_param_operator rpo','n','n','6','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'column_function','Column Functions','ed',NULL,'n','n','5','n',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'column_value','Values','ed',NULL,'n','n','7','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'second_value','','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 184,'alert_table_where_clause_id','Clause ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL
