...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 115,'forecast_profile',NULL,NULL,'EXEC spa_forecast_profile ''s''','Profile','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 115,'profile_id','ID','ron',NULL,'n','y','1','y',NULL,NULL,NULL,'80','int',NULL,'left' UNION ALL 
												SELECT 115,'profile_name','Profile Name','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 115,'external_id','EAN','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 115,'profile_type','Profile Type','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 115,'uom_id','UOM','ro',NULL,'n','y','5','y',NULL,NULL,NULL,'150',NULL,NULL,'right'
