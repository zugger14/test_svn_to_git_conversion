 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 20,'report_ui','','','EXEC spa_view_report @flag=''s''',NULL,'t','report_category,report_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 20,'report_type','Report Type','ro',NULL,'y','y','4','y',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 20,'report_unique_identifier','Report Unique ID','ro',NULL,'y','y','6','y',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 20,'excel_doc_type','Excel Document Type','ro',NULL,'y','y','7','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 20,'report_id','Report ID','ro_int',NULL,'n','y','3','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 20,'paramset_id','Paramset ID','ro_int',NULL,'y','y','5','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 20,'report_name','Report Name','tree',NULL,'y','y','2','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL
