 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 221,'LocationStorage',NULL,NULL,NULL,'Location Storage','t',NULL,'10163700','10163700',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 221,'location_id','Location ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'location_name','Location Name','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'contract_id','Contract ID','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'contract_name','Contract Name','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'term','Term','ro',NULL,'n','n','7','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'wacog','Wacog','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'commodity','Commodity','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'exp_inventory_balance','Exp Inventory Balance','ro',NULL,'n','n','11','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'counterparty_id','Storage Operator','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'total_inventory_amt','Total Inventory Amount','ro_a',NULL,'n','n','10','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 221,'total_inventory_vol','Total Inventory Volume','ro_v',NULL,'n','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL
