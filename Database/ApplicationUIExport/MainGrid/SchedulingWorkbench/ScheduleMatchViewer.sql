...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 221,'ScheduleMatchViewer',NULL,NULL,NULL,'Schedule Match Viewer','t','group_name,transportation_grp,bookoutid,location','10163720','10163720'
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 221,'group_name','SM Group','tree',NULL,'n','n','1',NULL,NULL,NULL,NULL,'350','str',NULL,'left' UNION ALL 
												SELECT 221,'source_deal_detail_id','Detail ID','ron',NULL,'n','n','2','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 221,'source_minor_location_id','Location ID','ron',NULL,'n','n','3','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 221,'region','region','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'100','str',NULL,'left' UNION ALL 
												SELECT 221,'location_name','location','ro',NULL,'n','n','5','y',NULL,NULL,NULL,'100','str',NULL,'left' UNION ALL 
												SELECT 221,'source_commodity_id','Commodity','ron',NULL,'n','n','6','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 221,'match_group_shipment_id','Match Group Shipment ID','ron',NULL,'n','y','7','n',NULL,NULL,'y','150','int',NULL,'left'
