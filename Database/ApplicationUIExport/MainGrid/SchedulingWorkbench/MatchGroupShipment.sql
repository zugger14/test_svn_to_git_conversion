...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 229,'MatchGroupShipment',NULL,NULL,NULL,'Shipment','g',NULL,'10163700','10163700'
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 229,'match_group_shipment_id','','sub_row_grid',NULL,'n','n','1','n',NULL,NULL,'n','30','str',NULL,'left' UNION ALL 
												SELECT 229,'match_group_shipment','Shipment','ro',NULL,'n','n','2','n',NULL,NULL,'n','250','str',NULL,'left' UNION ALL 
												SELECT 229,'shipment_status','Shipment Status','ro',NULL,'n','n','4','n',NULL,NULL,'n','250','str',NULL,'left' UNION ALL 
												SELECT 229,'shipment_workflow_status','Workflow Status','ro',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 229,'match_group_id','Match Group ID','ron',NULL,'n','y','6','y',NULL,NULL,'n','30','int',NULL,'left' UNION ALL 
												SELECT 229,'is_parent','IsParent','ro',NULL,'n','y','7','n',NULL,NULL,'y','150','str',NULL,'left'
