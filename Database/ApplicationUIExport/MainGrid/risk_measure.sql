 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 118,'risk_measure',NULL,NULL,'EXEC spa_var_measurement_criteria_detail ''g''',NULL,'g',NULL,'10181210','10181212',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 118,'name','Name','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'measure','Measure','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'approach','Approach','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'category','Category','ro',NULL,'n','y','5','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'confidence_interval','Confidence Interval','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'data_series','Data Series','ro',NULL,'n','y','10','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'price_curve_source','Price curve source','ro',NULL,'n','y','9','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'risk_measure_id','Risk Measure ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'holding_period','Holding Period','ro_int',NULL,'n','y','7','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 118,'simulation_days','Simulation Days','ro_int',NULL,'n','y','8','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
