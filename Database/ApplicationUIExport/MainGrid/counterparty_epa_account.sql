 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 52,'counterparty_epa_account',NULL,NULL,'EXEC spa_counterparty_epa_account @flag=''s'', @counterparty_id=<ID>',NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 52,'counterparty_epa_account_id','ID','ron',NULL,'n','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 52,'counterparty_id','Counterparty','ro',NULL,'n','y','2','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 52,'external_type_id','External Type ID','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 2200','n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 52,'external_value','Value','ed',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left'
