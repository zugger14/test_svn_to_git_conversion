BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 426,'rec_trasfer_status_detail',NULL,NULL,NULL,'Transfer Status Detail','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												SELECT 426,'match_id','Match ID','ro',NULL,'n','n','1','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'sell_deal_id','Sell Deal ID','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'buy_deal','Buy Deal ID','ro',NULL,'n','n','3','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'facility_name','Facility Name','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'unit_id','Unit ID','ro',NULL,'n','n','5','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'matched_volume','Matched Volume','ro_no',NULL,'n','n','6','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'certificate_serial_number','Certificate Serial Number','ro',NULL,'n','n','7','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 426,'transferee_counterparty','Transferee Counterparty','ro',NULL,'n','n','8','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n' UNION ALL
												SELECT 426,'status','Status','ro',NULL,'n','n','9','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL
												SELECT 426,'message','Description/Message','ro',NULL,'n','n','10','n',NULL,NULL,'n','350','str',NULL,'left', NULL,'n'
