 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 434,'rec_transfer',NULL,NULL,NULL,'Summary','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 434,'hyper_link_id','Deal Match ID','ro',NULL,'n','y','1','n',NULL,NULL,'y','130','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 434,'link_description','Description','ro',NULL,'n','y','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'effective_date','Effective Date','ro',NULL,'n','y','3','n',NULL,NULL,'n','120','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 434,'group1','Group1','ro',NULL,'n','n','4','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'group2','Group2','ro',NULL,'n','n','5','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'group3','Group3','ro',NULL,'n','n','6','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'group4','Group4','ro',NULL,'n','n','7','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'currency_id','Currency','ro',NULL,'n','n','10','y',NULL,NULL,'n','80','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'match_status','Status','ro',NULL,'n','n','11','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 434,'link_id','Link Id','ro',NULL,'n','y','12','y',NULL,NULL,'y','120','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 434,'price','Price','ro_p',NULL,'n','n','9','y',NULL,NULL,'n','80','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 434,'total_matched_volume','Matched Volume','ro_v',NULL,'n','n','8','y',NULL,NULL,'n','120','int',NULL,'right', NULL,'n',NULL
