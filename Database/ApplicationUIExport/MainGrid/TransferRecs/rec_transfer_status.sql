BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 425,'rec_transfer_status',NULL,NULL,'EXEC spa_process_rec_api_info ''status_grid''','Transfer Status','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												SELECT 425,'match_id','Match ID','ro',NULL,'n','n','1','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 425,'process_id','Process ID','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 425,'sent_date','Sent Date','ro',NULL,'n','n','3','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 425,'external_id','Create User','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n'
