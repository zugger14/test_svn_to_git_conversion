 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 50,'data_export_import',NULL,NULL,'EXEC spa_ixp_rules @flag=''s''',NULL,'t','category,ixp_rules_name',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 50,'rule_type','Rule Type','ed',NULL,'n','y','3','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 50,'updatable','Updatable','ed',NULL,'n','y','4','y',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 50,'system_rule','System Rule','ed',NULL,'n','y','5','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 50,'owner','Owner','ed',NULL,'n','y','6','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 50,'data_source','Data Source','ed',NULL,'n','y','7','y',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 50,'ixp_rules_id','Rules ID','ed_int',NULL,'n','y','2','y',NULL,NULL,NULL,'300','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 50,'ixp_rules_name','Category/ Rule Name','tree',NULL,'n','y','1','n',NULL,NULL,NULL,'345','str',NULL,'left', NULL,'n',NULL
