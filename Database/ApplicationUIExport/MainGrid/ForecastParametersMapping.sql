 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 218,'forecast_parameters_mapping',NULL,NULL,NULL,NULL,'t','forecast_mapping_type,forecast_mapping_name','10167210','10167211',0
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 218,'forecast_mapping_name','Type/Mapping Name','tree',NULL,'n','n','1',NULL,NULL,NULL,NULL,'290','str',NULL,'left' UNION ALL 
												SELECT 218,'forecast_mapping_id','Forecast Mapping ID','ron',NULL,'n','n','2','y',NULL,NULL,'y','150','int',NULL,'left' UNION ALL 
												SELECT 218,'source','Source','ro',NULL,'n','n','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 218,'approval_required','Approval Required','ro',NULL,'n','n','4',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 218,'active','Active','ro',NULL,'n','n','5',NULL,NULL,NULL,NULL,'150','str',NULL,'left'
