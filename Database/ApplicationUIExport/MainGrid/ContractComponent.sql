BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 6,'contract_component',NULL,NULL,'EXEC spa_contract_group_detail @flag=''s'',@contract_id=<ID>,@prod_type=''p''',NULL,'a',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 6,'radio_automatic_manual','Type','ro',NULL,'n','y','1',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 6,'contract_components','Contract Component','combo','EXEC spa_contract_group_detail_UI ''c''','y','y','2',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 6,'volume_granularity','Calculation Granularity','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 978','n','y','4',NULL,NULL,NULL,NULL,'210','str',NULL,'left' UNION ALL 
												SELECT 6,'calc_aggregation','Aggregation Level','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 19000','n','y','5',NULL,NULL,NULL,NULL,'210','str',NULL,'left' UNION ALL 
												SELECT 6,'flat_fee','Flat Fee','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'150','str',NULL,'right' UNION ALL
												SELECT 6,'contract_charge_type_group','Contract Component Group','ro',NULL,'n','y','4',NULL,NULL,NULL,NULL,'150','str',NULL, 'left' UNION ALL
												SELECT 6,'true_up_applies_to','Applies To','ro',NULL,'n','n','5','y',NULL,NULL,NULL,110,'str',NULL,'left' UNION ALL
												SELECT 6,'is_true_up','True Up','ro',NULL,'n','n','6','y',NULL,NULL,NULL,110,'str',NULL,'left' UNION ALL
												SELECT 6,'charge_type','Charge Type','ro',NULL,'n','n','7','y',NULL,NULL,NULL,110,'str',NULL,'left'
