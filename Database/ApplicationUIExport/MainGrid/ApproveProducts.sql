 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 224,'approve_products',NULL,NULL,'EXEC spa_counterparty_products ''s'', @dependent_id = <ID>','Product','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 224,'product','Product','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'350','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'buy_sell','Buy/Sell','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'110','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'is_organic','Organic','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'90','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_form_attribute1','Attribute 1','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_form_attribute2','Attribute 2','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_form_attribute3','Attribute 3','ro',NULL,'n','n','10','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_form_attribute4','Attribute 4','ro',NULL,'n','n','11','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_form_attribute5','Attribute 5','ro',NULL,'n','n','12','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'counterparty_product_id','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_id','Commodity','ro_int',NULL,'n','n','3','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_origin_id','Origin','ro_int',NULL,'n','n','4','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'commodity_form_id','Form','ro_int',NULL,'n','n','6','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 224,'trader_id','Trader','ro_int',NULL,'n','n','13','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
