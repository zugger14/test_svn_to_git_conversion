 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 164,'grid_deleted_deals',NULL,NULL,NULL,NULL,'g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 164,'reference_id','Reference ID','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 164,'voided_date','Voided Date','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,'date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 164,'deleted_date','Deleted Date','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,'date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 164,'deleted_by','Deleted By','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 164,'deal_id','Deal ID','ro_int',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,NULL,'int',NULL,'left', NULL,'n',NULL
