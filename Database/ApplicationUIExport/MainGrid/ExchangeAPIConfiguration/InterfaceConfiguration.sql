BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 413,'InterfaceConfiguration',NULL,NULL,'EXEC spa_exchange_api_configuration @flag = ''p'',@interface_id = <ID>','Exchange','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 413,'id','ID','ro',NULL,'y','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 413,'interface_id','Interface ID','ro',NULL,'y','y','2','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 413,'configuration_type','Configuration Type','combo','EXEC spa_exchange_api_configuration ''m''','y','y','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 413,'variable_name','Variable Name','combo','EXEC spa_exchange_api_configuration ''l''','y','y','4',NULL,NULL,NULL,NULL,'260','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 413,'variable_value','Variable Value','ed',NULL,'y','n','5',NULL,NULL,NULL,NULL,'520','str',NULL,'left', NULL,'n'
