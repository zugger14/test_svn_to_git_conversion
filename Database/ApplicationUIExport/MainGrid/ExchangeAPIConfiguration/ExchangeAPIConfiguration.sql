BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 412,'ExchangeAPIConfiguration',NULL,NULL,'EXEC spa_exchange_api_configuration @flag = ''g''','Exchange','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 412,'interface_id','Interface ID','ro',NULL,'y','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 412,'interface_name','Interface Name','ro',NULL,'y','y','2',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 412,'description','Description','ro',NULL,'y','n','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n'
