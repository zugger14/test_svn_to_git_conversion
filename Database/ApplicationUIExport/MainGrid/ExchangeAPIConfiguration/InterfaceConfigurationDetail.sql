BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 414,'InterfaceConfigurationDetail',NULL,NULL,'EXEC spa_exchange_api_configuration @flag = ''q'',@interface_id = <ID>','Exchange','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 414,'id','ID','ro',NULL,'y','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'interface_id','Interface ID','ro',NULL,'y','y','2','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'interface_name','Interface Name','ed',NULL,'y','y','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'interface_type','Interface Type','combo','EXEC spa_exchange_api_configuration ''n''','y','y','4',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'is_active','Active','ch',NULL,'y','n','5',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'import_rule_hash','Import Rule','combo','EXEC spa_exchange_api_configuration ''o''','y','n','6',NULL,NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'user_login_id','User Login Id','ed',NULL,'y','n','7',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'password','Password','ed_password',NULL,'y','n','8',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'sender_comp_id','Sender Comp Id','ed',NULL,'y','n','9',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'sender_sub_id','Sender Sub Id','ed',NULL,'y','n','10',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'target_comp_id','Target Comp Id','ed',NULL,'y','n','11',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'target_sub_id','Target Sub Id','ed',NULL,'y','n','12',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'session_qualifier','Session Qualifier','ch',NULL,'y','n','13',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'reject_duplicate_trade','Reject Duplicate Trade','ch',NULL,'y','n','14',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'security_import_rule_hash','Security Import Rule','combo','EXEC spa_exchange_api_configuration ''o''','y','n','15',NULL,NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 414,'user_role_ids','Notification Role','combo','EXEC spa_exchange_api_configuration ''r''','y','y','16',NULL,NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n'
