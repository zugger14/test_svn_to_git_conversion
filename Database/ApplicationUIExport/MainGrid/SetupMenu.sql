BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 313,'SetupMenu',NULL,NULL,'EXEC spa_arrange_setup_menu @flag=''s''','Setup Menu','t','group_name,display_name_lvl_0,display_name_lvl_1,display_name_lvl_2,display_name_lvl_3',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 313,'group_name','Function Name','tree',NULL,'n','y','1','n',NULL,NULL,'n','300','str',NULL,'left' UNION ALL 
												SELECT 313,'setup_menu_id','ID','ro',NULL,'n','y','2','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'function_id','Function ID','ro',NULL,'n','y','3','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'parent_menu_id','Parent Menu ID','ro',NULL,'n','y','4','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'menu_type','Menu Type','ro',NULL,'n','y','5','y',NULL,NULL,'n','100','str',NULL,'left' UNION ALL 
												SELECT 313,'hide_show','Hidden','ro',NULL,'n','y','6','y',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'function_id_lvl_0','Function ID Level 0','ro',NULL,'n','y','7','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'function_id_lvl_1','Function ID Level 1','ro',NULL,'n','y','8','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'function_id_lvl_2','Function ID Level 2','ro',NULL,'n','y','9','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'function_id_lvl_3','Function ID Level 3','ro',NULL,'n','y','10','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL
												SELECT 313,'group_function_id','Group Function ID','ro',NULL,'n','y','11','n',NULL,NULL,'n','100','int',NULL,'left' UNION ALL 
												SELECT 313,'menu_order','Menu Order','ro',NULL,'n','y','12','n',NULL,NULL,'n','100','int',NULL,'left'
