 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 160,'ViewCumPNLSeries',NULL,NULL,'','Summary','g',NULL,'10233700',NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 160,'as_of_date','As of Date','dhxCalendarA',NULL,'n','n','1','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'u_h_mtm','Hedge MTM','ed',NULL,'n','n','3','n',NULL,NULL,'n','120',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'u_i_mtm','Item MTM','ed',NULL,'n','n','4','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'d_h_mtm','Discounted Hedge MTM','ed',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'d_i_mtm','Discounted Item MTM','ed',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'comments','Comments','ed',NULL,'n','n','7','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'link_id','Ref ID','ed_int',NULL,'n','n','2','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'create_user','Created User','ro',NULL,'n','n','8','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'create_ts','Created Date','ro',NULL,'n','n','9','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 160,'cum_pnl_series_id','ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL
