 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 199,'commodity_origin','source_commodity','source_commodity_id','EXEC spa_source_commodity_origin ''g''','Origin','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 199,'origin','Origin','combo','EXEC spa_StaticDataValues ''h'', 14000','y','y','2',NULL,NULL,NULL,NULL,'130','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 199,'commodity_origin_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','0','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 199,'source_commodity_id','Commodity ID','ro_int',NULL,'n','y','7','y','source_commodity','source_commodity_id',NULL,'130','int',NULL,'left', NULL,'n',NULL
