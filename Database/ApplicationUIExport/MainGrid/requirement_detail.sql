 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 242,'requirement_detail',NULL,NULL,NULL,'Requirement Detail','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 242,'Tier','Tier','ro',NULL,'n','y','1','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 242,'Sub Tier','Sub Tier','ro',NULL,'n','y','2','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 242,'Requirement Type','Requirement Type','ro',NULL,'n','y','3','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 242,'ID','ID','ro_int',NULL,'n','y','0','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 242,'Min Requirement (%)','Minimum Requirement (%)','ro_no',NULL,'n','y','4','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 242,'Min Requirement Value','Minimum Requirement Value','ro_no',NULL,'n','y','5','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 242,'Not to Exceed (%)','Not to Exceed (%)','ro_no',NULL,'n','y','6','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 242,'Not to Exceed value','Not to Exceed value','ro_no',NULL,'n','y','7','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL
