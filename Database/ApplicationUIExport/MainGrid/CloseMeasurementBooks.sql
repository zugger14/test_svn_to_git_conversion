BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 6295,'CloseMeasurementBooks',NULL,NULL,'EXEC spa_close_measurement_books_dhx ''g''','Close Accounting Period','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 6295,'close_measurement_books_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 6295,'sub_id','Subsidiary','combo','EXEC spa_close_measurement_books_dhx ''t''','n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 6295,'close_date','Closed Date','dhxCalendarA',NULL,'n','n','3','n',NULL,NULL,NULL,'150','str','NotEmpty','left' UNION ALL 
												SELECT 6295,'close_by','Closed By','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 6295,'close_on','Closed On','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left'
