...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 10,'application_functional_users',NULL,NULL,'exec spa_AccessRights @flag = n, @login_id = ''<ID>'', @product_id = ''<FARRMS_PRODUCT_ID>''','Privileges','t','function_name2,function_name3,function_name4,function_name5,function_name6','10111010','10111011',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 10,'parent_name','Function Name','tree',NULL,'y','y','1','n',NULL,NULL,NULL,'400',NULL,NULL,'left' UNION ALL 
												SELECT 10,'entity_subsidary','Subsidiary','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'200',NULL,NULL,'left' UNION ALL 
												SELECT 10,'functional_users_id','ID','ron',NULL,'y','y','2','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 10,'role_name','Role','ro',NULL,'n','y','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 10,'function_id','Function ID','ron',NULL,'n','y','3','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 10,'entity_book','Book','ro',NULL,'y','y','7','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 10,'entity_strategy','Strategy','ro',NULL,'y','y','6','n',NULL,NULL,NULL,'150',NULL,NULL,'left'
