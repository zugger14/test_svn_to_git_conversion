BEGIN
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 154,'event_type','Event Type','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 37800','y','y','2','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 154,'event_date','Event Date','dhxCalendarA',NULL,'y','y','3','n',NULL,NULL,NULL,'150','date',NULL,'left' UNION ALL 
												SELECT 154,'event_pricing_type','Pricing Type','edn',NULL,'y','y','4','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'pricing_index','Pricing Index','combo','EXEC spa_GetAllPriceCurveDefinitions @flag=''a'', @is_active=''y''','y','y','5','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 154,'adder','Adder','ed',NULL,'y','y','6','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'currency','Currency','combo','EXEC spa_getcurrencyunit ''s''','y','y','7','n',NULL,NULL,NULL,'150','str',NULL,'right' UNION ALL 
												SELECT 154,'multiplier','Multiplier','ed',NULL,'y','y','8','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'volume','Volume','ed',NULL,'y','y','9','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 154,'uom','UOM','combo','EXEC spa_getsourceuom @flag = ''s''','y','y','10','n',NULL,NULL,NULL,'150','int',NULL,'right' UNION ALL 
												SELECT 154,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'100','int',NULL,'left'
