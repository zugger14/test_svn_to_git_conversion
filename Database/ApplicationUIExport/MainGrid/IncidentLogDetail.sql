BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 401,'incident_log_detail',NULL,NULL,'','Incident Detail','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 401,'id','ID','ro',NULL,'n','y','1','y',NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 401,'incident_status','Incident Status','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n' UNION ALL 
												SELECT 401,'incident_update_date','Date','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150','date','NotEmpty','left', NULL,'n' UNION ALL 
												SELECT 401,'comments','Comments','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 401,'application_notes_id','Notes ID','ro',NULL,'n','n','6','y',NULL,NULL,NULL,'120','str',NULL,'left', NULL,'n'
