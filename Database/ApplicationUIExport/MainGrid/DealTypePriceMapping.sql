BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 289,'deal_type_pricing_maping',NULL,NULL,'EXEC [spa_deal_type_pricing_maping] @flag = ''g''','Deal Type Pricing Mapping','g','20002301','20002302',NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 289,'template_id','Template Name','ro',NULL,'n','y','2','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'source_deal_type_id','Deal Type','ro',NULL,'n','y','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'pricing_type','Pricing Type','ro',NULL,'n','y','5','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'curve_id','Curve ','ro',NULL,'n','n','7','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'formula_id','Formula','ro',NULL,'n','n','9','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'multiplier','Multiplier','ro',NULL,'n','n','10','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'pricing_start','Pricing Start','ro',NULL,'n','n','11','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'pricing_end','Pricing End','ro',NULL,'n','n','12','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'detail_pricing','Detail Pricing','ro',NULL,'n','n','13','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'pricing_tab','Pricing Tab','ro',NULL,'n','n','14','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'formula_curve_id','Formula Curve','ro',NULL,'n','n','15','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'enable_term_type','Enable Item','ro',NULL,'n','n','16','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'location_id','Location','ro',NULL,'n','n','17','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'price_multiplier','Pricing Multiplier','ro',NULL,'n','n','18','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 289,'enable_efp','Enable EFP','ro',NULL,'n','n','19','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
