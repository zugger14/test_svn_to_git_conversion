BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 251,'setup_forecast_model','forecast_model_input','forecast_model_id',NULL,NULL,'t','forecast_type,model_name','10167310','10167311'
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 256,'model_name','Forecast Type/Model Name','tree',NULL,'n','n','1',NULL,NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
												SELECT 256,'model_id','Model ID','ro',NULL,'n','n','2','y',NULL,NULL,'y','150','str',NULL,'left' UNION ALL 
												SELECT 256,'forecast_category','Forecast Category','ro',NULL,'n','n','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 256,'forecast_category','Forecast Granularity','ro',NULL,'n','n','4',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 256,'active','Active','ro',NULL,'n','n','5',NULL,NULL,NULL,NULL,'150','str',NULL,'left'
