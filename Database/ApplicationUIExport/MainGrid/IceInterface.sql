BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 251,'ice_interface',NULL,NULL,'EXEC spa_ICE_interface @flag = ''g''',NULL,'g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 256,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
												SELECT 256,'data_type','Data Type','ro',NULL,'n','n','2',NULL,NULL,NULL,'y','150','str',NULL,'left' UNION ALL 
												SELECT 256,'description','Description','ro',NULL,'n','n','3',NULL,NULL,NULL,'y','200','str',NULL,'left' UNION ALL 
												SELECT 256,'import_rule_id','Import Rule ID','ro',NULL,'n','n','4','y',NULL,NULL,'y','200','str',NULL,'left'
