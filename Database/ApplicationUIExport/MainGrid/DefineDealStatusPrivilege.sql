 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 247,'define_deal_status_privilege',NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 247,'from_status_value_id','From Status','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 5600','n','y','2','n',NULL,NULL,NULL,'610','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 247,'to_status_value_id','To Status','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 5600','y','y','3','n',NULL,NULL,NULL,'610','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 247,'deal_status_privilege_mapping_id','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,'y','610','int',NULL,'left', NULL,'n',NULL
