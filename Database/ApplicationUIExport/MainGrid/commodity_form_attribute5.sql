 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 201,'commodity_form_attribute5','commodity_form_attribute4','commodity_form_attribute4_id','EXEC spa_source_commodity_origin ''f''','Attribute 5','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 201,'attribute_id','Attribute Type','combo','SELECT commodity_attribute_id, commodity_name FROM commodity_attribute','y','y','2',NULL,NULL,NULL,NULL,'130','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 201,'attribute_form_id','Attribute','combo','','y','y','3',NULL,NULL,NULL,NULL,'130','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
												SELECT 201,'commodity_form_attribute5_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 201,'commodity_form_attribute4_id','Attribute 4 ID','ro_int',NULL,'n','y','4','y','commodity_form_attribute4','commodity_form_attribute4_id',NULL,'130','int',NULL,'left', NULL,'n',NULL
