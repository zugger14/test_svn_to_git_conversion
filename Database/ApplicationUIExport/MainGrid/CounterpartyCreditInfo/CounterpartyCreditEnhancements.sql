 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 103,'counterparty_credit_enhancements',NULL,NULL,'EXEC spa_counterparty_credit_enhancements @flag=''g'', @Counterparty_id=''<ID>''','Enhancements','t','internal_counterparty,contract,enhancement_id',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 103,'Deal ID','Deal ID','link',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'enhance_type','Enhance Type','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'guarantee_counterparty','Guarantee Counterparty','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'effective_date',' Effective Date','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'expiration_date','Expiration Date','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'currency','Currency','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 103,'approved_by','Approved By','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'comment','Comment','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'receive','Receive','ro',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 103,'amount','Amount','ro_a',NULL,'n','n',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 103,'enhancement_id','Internal Counterparty/Contract/Enhancement ID','tree',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL
