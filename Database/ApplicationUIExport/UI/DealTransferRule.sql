...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20005600' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20005600'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20005600' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20005600')
		BEGIN				
			...
			WHERE autd.application_function_id = '20005600'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20005600
		...
		SELECT 366,'deal_transfer_mapping_detail','deal_transfer_mapping','deal_transfer_mapping_id','EXEC spa_deal_transfer_mapping @flag=''g'', @mapping_id=<ID>','Transfer Criteria','g',NULL,'20005600','20005600',NULL
		...
		SELECT 366,'deal_transfer_mapping_detail_id','Transfer Mapping Detail ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','170','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'deal_transfer_mapping_id','Transfer Mapping ID','ro',NULL,'n','n','2','y','deal_transfer_mapping','deal_transfer_mapping_id',NULL,'170','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'sub_book','Offset Sub Book','combo','EXEC spa_get_source_book_map @flag = ''z'', @function_id=10131024','n','y','3','n',NULL,NULL,NULL,'180','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 366,'trader_id','Offset Trader','combo','EXEC spa_source_traders_maintain ''y''','n','n','4','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'counterparty_id','Offset Counterparty','combo','EXEC spa_source_counterparty_maintain @flag = ''c'', @is_active = ''y'', @not_int_ext_flag = ''b''','y','n','5','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'contract_id','Offset Contract','combo','EXEC spa_contract_group ''r''','y','n','6','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'template_id','Offset Template','combo','EXEC spa_getDealTemplate ''S''','y','n','7','y',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_sub_book','Transfer Sub Book','combo','EXEC spa_get_source_book_map @flag = ''z'', @function_id=10131024','n','y','8','n',NULL,NULL,NULL,'180','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_trader_id','Transfer Trader','combo','EXEC spa_source_traders_maintain ''y''','n','n','9','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_counterparty_id','Transfer Counterparty','combo','EXEC spa_source_counterparty_maintain @flag = ''c'', @is_active = ''y'', @not_int_ext_flag = ''b''','y','n','10','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_contract_id','Transfer Contract','combo','EXEC spa_contract_group ''r''','y','n','11','n',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_template_id','Transfer Template','combo','EXEC spa_getDealTemplate ''S''','y','n','12','y',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'location_id','Location','combo','EXEC spa_source_minor_location ''o''','y','n','14','y',NULL,NULL,NULL,'180','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_volume','Transfer Volume','ed_no',NULL,'y','y','15','n',NULL,NULL,NULL,'180','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'volume_per','Volume%','ed_no',NULL,'y','y','16','n',NULL,NULL,NULL,'180','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'pricing_options','Pricing Options','combo','SELECT ''d'' [value], ''Original Deal Price'' [name] UNION ALL SELECT ''m'', ''Market Price'' UNION ALL SELECT ''x'', ''Fixed Price''','y','y','17','n',NULL,NULL,NULL,'180','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 366,'fixed_price','Fixed Price','ed_no',NULL,'y','y','18','n',NULL,NULL,NULL,'180','float',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'transfer_date','Transfer Date','dhxCalendarA',NULL,'n','n','19','n',NULL,NULL,'n','180','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'index_adder','Index Adder','combo','EXEC spa_source_price_curve_def_maintain ''l''','n','n','20','n',NULL,NULL,NULL,'180','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 366,'fixed_adder','Fixed Adder','ed_no',NULL,'y','y','21','n',NULL,NULL,NULL,'180','float',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20005600') 
		BEGIN 
			...
			VALUES('20005600','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','deal_transfer_mapping_id','deal_transfer_mapping_id','ID','input','varchar','h','n',NULL,NULL,'n','y',NULL,'n','n','n','n','y','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','logical_name','logical_name','Logical Name','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','transfer','transfer','Transfer Type','combo','char','h','n','SELECT ''o'' as ''id'', ''Offset Only'' as ''value'' UNION SELECT ''b'' as ''id'',''Xfer with Offset'' as ''value'' UNION SELECT ''x'' as ''id'',''Xfer Only'' as ''value''',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','counterparty_id_from','counterparty_id_from','Counterparty','combo','int','h','n','EXEC spa_source_counterparty_maintain ''c''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','source_book_mapping_id_from','source_book_mapping_id_from','From Sub-Book','combo','int','h','n','exec spa_source_book_maintain @flag = ''c''',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','counterparty_id_to','counterparty_id_to','Internal Counterparty','combo','int','h','n','EXEC spa_source_counterparty_maintain @flag = ''c'', @is_active = ''y'', @int_ext_flag = ''i''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','contract_id_from','contract_id_from','Contract','combo','int','h','n','EXEC spa_contract_group ''r''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','trader_id_from','trader_id_from','From Trader','combo','int','h','n','EXEC spa_source_traders_maintain ''y''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','source_deal_type_id','source_deal_type_id','Deal Type','combo','int','h','n','EXEC spa_source_deal_type_maintain @flag=''x'', @sub_type=''n''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','template_id','template_id','Template','combo','int','h','n',' EXEC spa_getDealTemplate ''S''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','pricing_type','pricing_type','Pricing Type','combo','int','h','n',' EXEC [spa_deal_type_pricing_maping] @flag =''r''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','commodity_id','commodity_id','Commodity','combo','int','h','n',' EXEC spa_source_commodity_maintain ''a''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','internal_portfolio_id','internal_portfolio_id','Product Group','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 39800',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','header_buy_sell_flag','header_buy_sell_flag','Buy/Sell','combo','char','h','n','SELECT ''b'' [value], ''Buy'' [code] UNION SELECT ''s'' [value], ''Sell'' [code]',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20005600','physical_financial_flag','physical_financial_flag','Physical/Financial','combo','char','h','n','SELECT ''p'' [value], ''Physical'' [code] UNION SELECT ''f'' [value], ''Financial'' [code]',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'2E',NULL
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 9450,19294,'General','from_criteria','','n','n','500','500','From Criteria',NULL,NULL,NULL,'800','1',NULL
		...
		SELECT 109349,19294,108187,NULL,'General','',NULL,NULL,NULL,'y',NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109350,19294,108188,NULL,'General','deal_transfer_mapping_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109351,19294,108189,NULL,'General','logical_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109352,19294,108190,NULL,'General','transfer',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109353,19294,108191,'9450','General','counterparty_id_from',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109354,19294,108192,'9450','General','source_book_mapping_id_from',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109355,19294,108193,'9450','General','counterparty_id_to',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109356,19294,108195,'9450','General','trader_id_from',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109357,19294,108196,'9450','General','source_deal_type_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109358,19294,108197,'9450','General','template_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109359,19294,108194,'9450','General','contract_id_from',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109360,19294,108198,'9450','General','pricing_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109361,19294,108199,'9450','General','commodity_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109362,19294,108200,'9450','General','internal_portfolio_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109363,19294,108201,'9450','General','header_buy_sell_flag',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 109364,19294,108202,'9450','General','physical_financial_flag',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21332,19294,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 21333,19294,'General','b','366','deal_transfer_mapping_detail',2,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20005600'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20005600'  
							ELSE @db + '_UI_' + '20005600'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20005600
