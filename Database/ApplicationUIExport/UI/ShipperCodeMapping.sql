...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20016500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20016500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20016500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20016500')
		BEGIN				
			...
			WHERE autd.application_function_id = '20016500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20016500
		...
		SELECT 457,'shipper_code_mapping_detail',NULL,NULL,'EXEC spa_counterparty_shipper_info @flag = ''k'', @source_counterparty_id = <ID>','Shipper Code Mapping Detail','g',NULL,'20016501','20016502',NULL
		...
		SELECT 457,'shipper_code_mapping_detail_id','System ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','200','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 457,'shipper_code_id','Shipper Code ID','ro',NULL,'n','n','2','y','conversion_factor','conversion_factor_id',NULL,'200','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 457,'location_id','Location','combo','EXEC spa_source_minor_location ''o''','n','y','3','n',NULL,NULL,NULL,'200','int','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 457,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','4','n',NULL,NULL,NULL,'200','date','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 457,'shipper_code1','Shipper Code 1','ed',NULL,'y','y','5','n',NULL,NULL,NULL,'200','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 457,'shipper_code','Shipper Code 2','ed',NULL,'y','y','6','n',NULL,NULL,NULL,'200','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 457,'shipper_code1_is_default','Shipper Code 1 - Is Default','combo','SELECT ''y'' [value], ''Yes'' [code] UNION SELECT ''n'', ''No''','y','y','7','n',NULL,NULL,'n','200','char',NULL,'left', NULL,'n' UNION ALL 
		SELECT 457,'is_default','Shipper Code 2 - Is Default','combo','SELECT ''y'' [value], ''Yes'' [code] UNION SELECT ''n'', ''No''','y','y','8','n',NULL,NULL,'n','200','char',NULL,'left', NULL,'n' UNION ALL 
		SELECT 457,'is_active','Is Active','combo','SELECT ''y'' [value], ''Yes'' [code] UNION SELECT ''n'', ''No''','y','y','9','n',NULL,NULL,'n','200','char',NULL,'left', NULL,'n' UNION ALL 
		SELECT 457,'external_id','External ID','ed',NULL,'y','n','10','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 457,'internal_counterparty','Internal Counterparty','combo','SELECT source_counterparty_id, Counterparty_id FROM source_counterparty where int_ext_flag=''i''','y','n','11','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n'
		...
		VALUES('20016500',
		'setup_shipper_code_mapping',
		'Setup Shipper Code Mapping',
		'y',
		'y',
		NULL,
		'n',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20016500') 
		BEGIN 
			...
			VALUES('20016500','','','','settings','',' ',' ','','0','n','n','','n','n','n','n','y','y','n','n',NULL,NULL,NULL)
		...
		SELECT 105319,17635,104078,NULL,'General','',NULL,'','',' ',' ','0','settings',NULL,'0','0',NULL,NULL,'',NULL,NULL,NULL,NULL,NULL
		...
		SELECT 19672,17635,'General','a','457','shipper_code_mapping_detail',2,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20016500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20016500'  
							ELSE @db + '_UI_' + '20016500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20016500
