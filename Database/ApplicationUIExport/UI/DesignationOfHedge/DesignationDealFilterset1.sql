...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10233722' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10233722'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10233722' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10233722')
		BEGIN				
			...
			WHERE autd.application_function_id = '10233722'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10233722
		...
		VALUES('10233722',
		'DealMatchFilter1DesignationOfHedge',
		'Deal Match Filter1 Designation Of Hedge',
		'y',
		'y',
		NULL,
		'n',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10233722') 
		BEGIN 
			...
			VALUES('10233722','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','counterparty_id','counterparty_id','Counterparty','browser','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','deal_date_from','deal_date_from','Deal Date From','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'y','n','y','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','deal_date_to','deal_date_to','Deal Date To','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'y','n','y','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','term_start','term_start','Term Start','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','term_end','term_end','Term End','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','create_ts_from','create_ts_from','Create Date From','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','create_ts_to','create_ts_to','Create Date To','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','buy_sell_id','buy_sell_id','Buy/Sell','combo','varchar','h','n','SELECT ''b'' [value], ''Buy'' [label] UNION SELECT ''s'' [value], ''Sell'' [label]',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','curve_id','curve_id','Product','combo','int','h','n','EXEC spa_source_price_curve_def_maintain ''l''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','deal_volume_uom_id','deal_volume_uom_id','Convert UOM','combo','int','h','n','EXEC spa_getsourceuom @flag = ''s''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','book_structure','book_structure','Book Structure','browser','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','y','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','source_system_book_id1','source_system_book_id1','Tag 1','combo_tag1','varchar','h','n','EXEC spa_source_book_maintain ''x'', @source_system_book_type_value_id = 50',NULL,'n','n','','n','n','n',NULL,'y',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','source_system_book_id2','source_system_book_id2','Tag 2','combo_tag2','varchar','h','n','EXEC spa_source_book_maintain ''x'', @source_system_book_type_value_id = 51',NULL,'n','n','','n','n','n',NULL,'y',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','source_system_book_id3','source_system_book_id3','Tag 3','combo_tag3','varchar','h','n','EXEC spa_source_book_maintain ''x'', @source_system_book_type_value_id = 52',NULL,'n','n','','n','n','n',NULL,'y',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','source_system_book_id4','source_system_book_id4','Tag 4','combo_tag4','varchar','h','n','EXEC spa_source_book_maintain ''x'', @source_system_book_type_value_id = 53',NULL,'n','n','','n','n','n',NULL,'y',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','trader_id','trader_id','Trader','combo','int','h','n','EXEC spa_source_traders_maintain ''y''',NULL,'n','n','','n','n','n',NULL,'y',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233722','deal_type_id','deal_type_id','Deal Type','combo','int','h','n','EXEC spa_source_deal_type_maintain ''x'', @sub_type=''n''',NULL,'n','n','','n','n','n',NULL,'y',' ',' ',' ',NULL,NULL,NULL)
		...
		SELECT 'Dealset1FilterDesignationOfHedge',NULL,'y','y','2',NULL,'1C',NULL
		...
		SELECT 77288,13936,76850,NULL,'Dealset1FilterDesignationOfHedge','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77289,13936,76851,NULL,'Dealset1FilterDesignationOfHedge','counterparty_id',NULL,NULL,'m',NULL,NULL,NULL,'browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,'browse_counterparty',NULL UNION ALL 
		SELECT 77290,13936,76852,NULL,'Dealset1FilterDesignationOfHedge','commodity_id',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77291,13936,76853,NULL,'Dealset1FilterDesignationOfHedge','deal_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77292,13936,76854,NULL,'Dealset1FilterDesignationOfHedge','deal_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77293,13936,76855,NULL,'Dealset1FilterDesignationOfHedge','term_start',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77294,13936,76856,NULL,'Dealset1FilterDesignationOfHedge','term_end',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77295,13936,76857,NULL,'Dealset1FilterDesignationOfHedge','create_ts_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77296,13936,76858,NULL,'Dealset1FilterDesignationOfHedge','create_ts_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77297,13936,76859,NULL,'Dealset1FilterDesignationOfHedge','buy_sell_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77298,13936,76860,NULL,'Dealset1FilterDesignationOfHedge','curve_id',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77299,13936,76861,NULL,'Dealset1FilterDesignationOfHedge','deal_volume_uom_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77300,13936,76862,NULL,'Dealset1FilterDesignationOfHedge','book_structure',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,'book',NULL UNION ALL 
		SELECT 77301,13936,76863,NULL,'Dealset1FilterDesignationOfHedge','source_system_book_id1',NULL,NULL,NULL,NULL,NULL,NULL,'combo_tag1',NULL,'13',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77302,13936,76864,NULL,'Dealset1FilterDesignationOfHedge','source_system_book_id2',NULL,NULL,NULL,NULL,NULL,NULL,'combo_tag2',NULL,'14',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77303,13936,76865,NULL,'Dealset1FilterDesignationOfHedge','source_system_book_id3',NULL,NULL,NULL,NULL,NULL,NULL,'combo_tag3',NULL,'15',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77304,13936,76866,NULL,'Dealset1FilterDesignationOfHedge','source_system_book_id4',NULL,NULL,NULL,NULL,NULL,NULL,'combo_tag4',NULL,'16',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77305,13936,76867,NULL,'Dealset1FilterDesignationOfHedge','trader_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'17',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77306,13936,76868,NULL,'Dealset1FilterDesignationOfHedge','deal_type_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'18',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL
		...
		SELECT 11798,13936,'Dealset1FilterDesignationOfHedge','b','FORM',NULL,1,'0',NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10233722'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10233722'  
							ELSE @db + '_UI_' + '10233722'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10233722
