...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10233710' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10233710'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10233710' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10233710')
		BEGIN				
			...
			WHERE autd.application_function_id = '10233710'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10233710
		...
		SELECT 156,'DedesignationHedge',NULL,NULL,'EXEC spa_get_percentage_dedesignation ''s'',<ID>','Dedesignation Hedge','g',NULL,NULL,NULL,NULL UNION ALL SELECT 157,'DesignationHedges',NULL,NULL,'EXEC spa_faslinkdetail @flag=''s'', @flag2=''h'', @summary_option=''s'', @link_id=<ID>','Hedges','g',NULL,'10231913',NULL,NULL UNION ALL SELECT 158,'DesignationItems',NULL,NULL,'EXEC spa_faslinkdetail @flag=''s'', @flag2=''i'', @summary_option=''s'', @link_id=<ID>','Items','g',NULL,'10231913',NULL,NULL UNION ALL SELECT 159,'AssessmentResult',NULL,NULL,'','View Assessment Result','g',NULL,'10231913',NULL,NULL
		...
		SELECT 156,'link_description','Description','ro',NULL,'y','n','1','n',NULL,NULL,'n','220','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 156,'link_end_date','Dedesignation Date','ro',NULL,'n','n','2','n',NULL,NULL,'n','150','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 156,'dedesignated_percentage','Dedesignated Percentage','ro',NULL,'n','n','3','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 156,'dedesignation_type','Dedesignation Type','ro',NULL,'n','n','4','n',NULL,NULL,'n','170','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 156,'link_id','Link ID','ro_int',NULL,'n','n','0','n',NULL,NULL,'n','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'as_of_date','As of Date','ro',NULL,'n','n','0','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'assessment_type','Assessment Type','ro',NULL,'n','n','1','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'assessment_value','Assessment Value','ro',NULL,'n','n','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'add_assessment_value','Add Assessment Value','ro',NULL,'n','n','3','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'relation_name','Relation Name','ro',NULL,'n','n','4','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'strategy','Strategy','ro',NULL,'n','n','7','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'book','Book','ro',NULL,'n','n','8','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'overriden_by_user','Overriden By User ','ro',NULL,'n','n','9','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'rsq','RSQ','ro',NULL,'n','n','10','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'correlation','Correlation','ro',NULL,'n','n','11','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'slope','Slope','ro',NULL,'n','n','12','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'intercept','Intercept','ro',NULL,'n','n','13','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'t_value','T Value','ro',NULL,'n','n','14','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'f_value','F Value','ro',NULL,'n','n','15','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'df','DF','ro',NULL,'n','n','16','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'create_timestamp','Create Timestamp','ro',NULL,'n','n','19','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'created_user','Created User','ro',NULL,'n','n','20','y',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'updated_user','Updated User','ro',NULL,'n','n','21','y',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'type','Type','ro',NULL,'n','n','22','y',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'result_id','Result ID','ro_int',NULL,'n','n','5','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'subsidiary','Subsidiary','ro_int',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'relation_id','Relation ID','ro_int',NULL,'n','n','17','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 159,'link_id','Link ID','ro_int',NULL,'n','n','18','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 157,'effective_date','Effective Date','dhxCalendarA',NULL,'y','n','3','n',NULL,NULL,'n','120','date',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'deal_id','Ref ID','ed',NULL,'y','n','1','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'perc_included','Percentage Included','ed',NULL,'y','n','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'deal_date','Deal Date','ro',NULL,'y','n','4','n',NULL,NULL,'n','120','date',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'term_start','Term Start','ro',NULL,'y','n','5','n',NULL,NULL,'n','120','date',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'term_end','Term End','ro',NULL,'y','n','6','n',NULL,NULL,'n','120','date',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'buy_sell','Buy Sell','ro',NULL,'y','n','7','n',NULL,NULL,'n','120','str',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'frequency','Volume Frequency','ro',NULL,'y','n','10','n',NULL,NULL,'n','120','str',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'uom','Volume UOM','ro',NULL,'y','n','11','n',NULL,NULL,'n','120','str',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'index','Index','ro',NULL,'y','n','12','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'currency','Currency','ro',NULL,'y','n','14','n',NULL,NULL,'n','120','str',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'fas_link_detail_id','Link Detail ID','ro',NULL,'y','n','16','y',NULL,NULL,'n','120','str',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'source_deal_header_id','Deal ID','ro',NULL,'y','n','0','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'link_id','Link ID','ro_int',NULL,'y','n','15','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'price','Price','ro_p',NULL,'y','n','13','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'volume','Total Volume','ro_v',NULL,'y','n','8','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 157,'matched_volume','Matched Volume','ro_v',NULL,'y','n','9','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		...
		SELECT 158,'volume','Total Volume','ro_v',NULL,'y','n','8','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 158,'matched_volume','Matched Volume','ro_v',NULL,'y','n','9','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL UNION ALL 
		SELECT 158,'frequency','Volume Frequency','ro_int',NULL,'y','n','10','n',NULL,NULL,'n','120','int',NULL,'left', NULL,NULL,NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10233710') 
		BEGIN 
			...
			VALUES('10233710','','','','settings','',' ',' ','','250','n','n','','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','book_id','fas_book_id','Book Structure','browser','varchar','h','n',NULL,'230','n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','link_id','link_id','Link ID','input','int','h','n',NULL,'250','y','n',NULL,'n','n','n','n','y','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','link_description','link_description','Description','input','varchar','h','n',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','eff_test_profile_id','eff_test_profile_id','Hedging Relationship Type','combo','int','h','n','EXEC spa_effhedgereltype ''g''','250','n','n',NULL,'y','n','y','n','y','n','n','n',NULL,'10231900',NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','link_type_value_id','link_type_value_id','Link Type','combo','int','h','n','EXEC spa_StaticDataValues @flag=h, @type_id=450','250','n','n','450','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','link_effective_date','link_effective_date','Effective Date','calendar','datetime','h','n',NULL,'250','n','n',NULL,'y','n','y','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','link_end_date','link_end_date','End Date','calendar','datetime','h','n',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','perfect_hedge','perfect_hedge','Perfect Hedge','checkbox','char','h','n',NULL,'150','n','n','n','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','fully_dedesignated','fully_dedesignated','Fully Dedesignated','checkbox','char','h','n',NULL,'150','n','n','n','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','link_active','link_active','Active','checkbox','char','h','n',NULL,'150','n','n','y','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','original_link_id','original_link_id','Dedesignated Link ID','input','varchar','h','n',NULL,'250','n','y',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','dedesignated_percentage','dedesignated_percentage','Dedesignated Percentage','input','float','h','n',NULL,'250','n','y',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10233710','lock','lock','Lock','checkbox','varchar','h','n',NULL,'150','y','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'Link Info',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'Dedesignation',NULL,'y','n','3',NULL,'1C',NULL UNION ALL SELECT 'Original Link',NULL,'y','n','4',NULL,'1C',NULL UNION ALL SELECT 'Assessment Result',NULL,'y','n','5',NULL,'1C',NULL UNION ALL SELECT 'Hedges/Items',NULL,'y','n','2',NULL,'2U',NULL
		...
		SELECT 116178,20197,114967,NULL,'Link Info','',NULL,NULL,NULL,NULL,'n',NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116179,20197,114968,NULL,'Link Info','book_id',NULL,NULL,NULL,NULL,'n','250','browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,'book',NULL,NULL UNION ALL 
		SELECT 116180,20197,114969,NULL,'Link Info','link_id',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116181,20197,114970,NULL,'Link Info','link_description',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116182,20197,114971,NULL,'Link Info','eff_test_profile_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116183,20197,114972,NULL,'Link Info','link_type_value_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116184,20197,114973,NULL,'Link Info','link_effective_date',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116185,20197,114974,NULL,'Link Info','link_end_date',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116186,20197,114975,NULL,'Link Info','perfect_hedge',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116187,20197,114976,NULL,'Link Info','fully_dedesignated',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116188,20197,114977,NULL,'Link Info','link_active',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116189,20197,114978,NULL,'Link Info','original_link_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116190,20197,114979,NULL,'Link Info','dedesignated_percentage',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116191,20197,114980,NULL,'Link Info','lock',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22280,20197,'Link Info','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22281,20198,'Dedesignation','a','156','DedesignationHedge',3,NULL,NULL,NULL,NULL UNION ALL SELECT 22282,20200,'Assessment Result','a','159','AssessmentResult',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22283,20201,'Hedges/Items','a','157','DesignationHedges',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22284,20201,'Hedges/Items','b','158','DesignationItems',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10233710'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10233710'  
							ELSE @db + '_UI_' + '10233710'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10233710
