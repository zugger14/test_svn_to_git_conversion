...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20008900' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20008900'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20008900' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20008900')
		BEGIN				
			...
			WHERE autd.application_function_id = '20008900'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20008900
		...
		SELECT 76,'transportation_rate_schedule',NULL,NULL,'EXEC spa_transportation_rate_schedule @flag=''s'', @for=''s'', @rate_schedule_id =<ID>','Demand/Fixed Charge','g',NULL,'20008904','20008905',NULL UNION ALL
		SELECT 271,'variable_charge',NULL,NULL,'EXEC spa_transportation_rate_schedule @flag=''v'', @for=''s'',@rate_schedule_id =<ID>','Variable Charge','g',NULL,'20008904','20008905',NULL
		...
		SELECT 76,'zone_from','Zone From','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','n','4','y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'zone_to','Zone To','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','n','5','y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n' UNION ALL 
		...
		SELECT 271,'rate_schedule_type','Rate Schedule Type','ro',NULL,'n','n','20','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20008900') 
		BEGIN 
			...
			VALUES('20008900','','','','settings','',' ',' ','','250','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20008900','value_id','value_id','ID','input','int','h','n',NULL,'250','n','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20008900','code','code','Name','input','varchar','h','y',NULL,'250','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20008900','description','description','Description','input','varchar','h','n',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20008900','type_id','type_id','type_id','input','int','h','n',NULL,'250','n','y','1800','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20008900','contract_type','contract_type','Contract Type','input','char','h','n',NULL,'250','n','y','s','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 3687,9587,'Rate Schedule','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,'100',NULL,'1'
		...
		SELECT 65733,9587,65135,NULL,'Rate Schedule','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 65734,9587,65136,NULL,'Rate Schedule','value_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 65735,9587,65137,NULL,'Rate Schedule','code',NULL,NULL,NULL,'y',NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 65736,9587,65138,NULL,'Rate Schedule','description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 65737,9587,65139,NULL,'Rate Schedule','type_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 65738,9587,65140,NULL,'Rate Schedule','contract_type',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 7928,9587,'Rate Schedule','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 7929,9587,'Rate Schedule','b','76','transportation_rate_schedule',1,NULL,NULL,NULL,NULL UNION ALL SELECT 7930,9587,'Rate Schedule','c','271','variable_charge',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20008900'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20008900'  
							ELSE @db + '_UI_' + '20008900'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20008900
