...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10102500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10102500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10102500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10102500')
		BEGIN				
			...
			WHERE autd.application_function_id = '10102500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10102500
		...
		SELECT 13,'source_minor_location_meter',NULL,NULL,'EXEC spa_source_minor_location_meter @flag=''s'', @source_minor_location_id=<ID>','Location Meter','g',NULL,'10102510','10102510',NULL UNION ALL SELECT 73,'location_ranking',NULL,NULL,'EXEC(''SELECT location_ranking_id, location_id, dbo.FNAGetSQLStandardDate(effective_date), rank_id FROM location_ranking WHERE location_id = <ID>'')','Optimizer Rank','g',NULL,'10102510','10102510',NULL UNION ALL SELECT 74,'source_minor_location_nomination_group',NULL,NULL,'EXEC(''SELECT source_minor_location_nomination_group_id, source_minor_location_id, dbo.FNAGetSQLStandardDate(effective_date), group_id, info_type FROM source_minor_location_nomination_group WHERE info_type = ''''n'''' AND source_minor_location_id = <ID>'')','Nomination Group','g',NULL,'10102510','10102510',NULL UNION ALL SELECT 99,'vwSourceMinorLocationNominationGroup',NULL,NULL,'EXEC(''SELECT source_minor_location_nomination_group_id, source_minor_location_id,  dbo.FNAGetSQLStandardDate(effective_date), group_id, info_type FROM vwSourceMinorLocationNominationGroup WHERE source_minor_location_id = <ID>'')','Route','g',NULL,'10102510','10102510',NULL UNION ALL SELECT 115,'forecast_profile',NULL,NULL,'SELECT profile_id, profile_name FROM  forecast_profile','Profile','g',NULL,NULL,NULL,NULL UNION ALL SELECT 129,'location_rank',NULL,NULL,'EXEC(''SELECT location_rank_id, location_id, dbo.FNAGetSQLStandardDate(effective_date), rank_value_id FROM location_rank WHERE location_id = <ID>'')','Del Rank','g',NULL,'10102510','10102510',NULL UNION ALL SELECT 380,'location_price_index',NULL,NULL,'EXEC spa_location_price_index @flag=''l'', @location_id=<ID>','Valuation Index','g',NULL,'10102510','10102510',NULL
		...
		SELECT 13,'meter_id','Meter','combo','EXEC spa_getAllMeter @flag=''s''','y','y','3','n',NULL,NULL,'n','200',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 13,'meter_type','Meter Type','combo','EXEC spa_StaticDataValues ''h'', 38600','y','y','4','n',NULL,NULL,NULL,'200',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
		...
		SELECT 74,'source_minor_location_nomination_group_id','ID','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 74,'source_minor_location_id','Location ID','ro_int',NULL,'n','y',NULL,'y',NULL,'source_minor_location_id',NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 99,'group_id','Route','combo','SELECT maintain_location_routes_id [value], route_name [text] FROM maintain_location_routes WHERE maintain_location_routes_detail_id IS NULL','y','y',NULL,NULL,NULL,NULL,NULL,'200',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 99,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'200','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 99,'info_type','Info Type','ro',NULL,'n','y',NULL,'y',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 99,'source_minor_location_nomination_group_id','ID','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 99,'source_minor_location_id','Location ID','ro_int',NULL,'n','y',NULL,'y',NULL,'source_minor_location_id',NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 115,'profile_name','Profile Name','ro',NULL,'n','y','2',NULL,NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 115,'profile_id','ID','ro_int',NULL,'n','y','1',NULL,NULL,NULL,NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 129,'rank_value_id','Rank','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =32000','n','y',NULL,NULL,NULL,NULL,NULL,'200','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 129,'effective_date','Effective Date','dhxCalendarA',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'200','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 129,'location_rank_id','ID','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 129,'location_id','Location ID','ro_int',NULL,'n','y',NULL,'y',NULL,'source_minor_location_id',NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 380,'commodity_id','Commodity','combo','EXEC spa_source_commodity_maintain ''a''','y','y','3','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 380,'curve_id','Index','combo','EXEC spa_source_price_curve_def_maintain @flag = ''l'',  @source_system_id = 2','y','y','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 380,'adder_index_id','Adder Index','combo','EXEC spa_source_price_curve_def_maintain @flag = ''l'',  @source_system_id = 2','y','n','7','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 380,'multiplier','Multiplier','ed_no',NULL,'y','n','5','n',NULL,NULL,'n','150','int','ValidNumericWithEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 380,'adder','Adder','ed_no',NULL,'y','n','6','n',NULL,NULL,'n','150','int','ValidNumericWithEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 380,'location_price_index_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 380,'location_id','Location ID','ro',NULL,'n','y','2','y','source_minor_location','source_minor_location_id','n','80','int',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10102500') 
		BEGIN 
			...
			VALUES('10102500','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','source_system_id','source_system_id','Source System','combo','int','h','n','EXEC spa_source_system_description ''s''',NULL,'n','n','2','y','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','source_minor_location_id','source_minor_location_id','System ID','input','int','h','n',NULL,NULL,'y','n','','n','n','n','n','y','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','location_name','location_name','Location Name','input','varchar','h','n',NULL,NULL,'n','n','','y','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','location_description','location_description','Location Description','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','source_major_location_id','source_major_location_id','Location Group','combo','int','h','n','EXEC spa_source_major_location ''x''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','location_id','location_id','Location ID','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','term_pricing_index','term_pricing_index','Valuation Curve','combo','int','h','n','EXEC spa_source_price_curve_def_maintain ''l''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n','50','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','pipeline','pipeline','Pipeline','combo','CHAR','h','n','EXEC spa_source_counterparty_maintain @flag = ''c'', @type_of_entity= ''-10021''',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','proxy_location_id','proxy_location_id','Proxy Location','combo','CHAR','h','n','EXEC spa_source_minor_location ''o''',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','is_active','is_active','Active','checkbox','char','h','n','',NULL,'n','n','y','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','calculation_method','calculation_method','Calculation Method','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','profile_id','profile_id','Profile','browser','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','proxy_profile_id','proxy_profile_id','Proxy Profile','browser','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','is_pool','is_pool','Pool','checkbox','char','h','n',NULL,NULL,'n','n','y','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','forecast_needed','forecast_needed','Forecast Needed','checkbox','char','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','country','country','Location Group 1','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 14000',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','region','region','Location Group 2','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 11150',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','province','province','Location Group 3','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 29500',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','grid_value_id','grid_value_id','Location Group 4','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 18000',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','owner','owner','Owner','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,'100',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','address','address','Address','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,'1000',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','postal_code','postal_code','Postal Code','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','profile_code','profile_code','Profile Code','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','forecasting_group','forecasting_group','Forecasting Group','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','time_zone','time_zone','Timezone','combo','int','h','n','EXEC spa_time_zone ''s''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','physical_shipper','physical_shipper','Physical Shipper','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','proxy_position_type','proxy_position_type','Proxy Position Type','combo','INT','h','n','EXEC spa_StaticDataValues ''h'', 110200',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','accounting_code','accounting_code','Accounting Code','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','rpg','rpg','RPG','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','duns_ref','duns_ref','DUNS REF','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','tsp_location_name','tsp_location_name','TSP Location Name','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','tesoro_facility_id','tesoro_facility_id','Tesoro Facility ID','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','tesoro_gsi_group','tesoro_gsi_group','Tesoro GSI Group','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','facility','facility','Facility','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10102500','conversion_value_id','conversion_value_id','Conversion Name','combo','int','h','n','EXEC spa_staticDataValues @flag=''h'', @type_id =112400',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 9823,20398,'Attributes','hierarchy','','n','n','500','500','Hierarchy',NULL,NULL,NULL,'800','1','4' UNION ALL 
								SELECT 9824,20394,'Meter/Wellhead','fieldset',NULL,'n','n','10',NULL,'Forecast',NULL,NULL,NULL,'760',NULL,'3'
		...
		SELECT 117548,20392,116314,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117549,20392,116315,NULL,'General','source_system_id',NULL,'2',NULL,NULL,'y',NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117550,20392,116316,NULL,'General','source_minor_location_id',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117551,20392,116317,NULL,'General','location_name',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117552,20392,116318,NULL,'General','location_description',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117553,20392,116319,NULL,'General','source_major_location_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117554,20392,116320,NULL,'General','location_id',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117555,20392,116322,NULL,'General','commodity_id',NULL,'50',NULL,NULL,'n',NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117556,20392,116323,NULL,'General','pipeline',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117557,20392,116324,NULL,'General','proxy_location_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117558,20392,116350,NULL,'General','conversion_value_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117559,20392,116343,NULL,'General','accounting_code',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117560,20392,116325,NULL,'General','is_active',NULL,'y',NULL,NULL,'n',NULL,'checkbox',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117561,20392,116321,NULL,'General','term_pricing_index',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117562,20392,116342,NULL,'General','proxy_position_type',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117563,20393,116314,NULL,'Additional','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117564,20393,116344,NULL,'Additional','rpg',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'1',NULL,'1420','-5680',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117565,20393,116345,NULL,'Additional','duns_ref',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'2',NULL,'1421','-5681',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117566,20393,116346,NULL,'Additional','tsp_location_name',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'3',NULL,'1422','-5682',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117567,20393,116347,NULL,'Additional','tesoro_facility_id',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'4',NULL,'1423','-5683',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117568,20393,116348,NULL,'Additional','tesoro_gsi_group',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'5',NULL,'1424','-5684',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117569,20393,116349,NULL,'Additional','facility',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'6',NULL,'1425','-5689',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117570,20394,116314,NULL,'Meter/Wellhead','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117571,20394,116326,NULL,'Meter/Wellhead','calculation_method',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117572,20394,116327,NULL,'Meter/Wellhead','profile_id',NULL,'',NULL,NULL,'n',NULL,'browser',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,'115',NULL,NULL UNION ALL 
		SELECT 117573,20394,116328,NULL,'Meter/Wellhead','proxy_profile_id',NULL,'',NULL,NULL,'n',NULL,'browser',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,'115',NULL,NULL UNION ALL 
		SELECT 117574,20394,116329,NULL,'Meter/Wellhead','is_pool',NULL,'y',NULL,NULL,'n',NULL,'checkbox',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117575,20394,116330,NULL,'Meter/Wellhead','forecast_needed',NULL,'',NULL,NULL,'y',NULL,'checkbox',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117576,20398,116331,NULL,'Attributes','country',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117577,20398,116332,NULL,'Attributes','region',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117578,20398,116333,NULL,'Attributes','province',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117579,20398,116334,NULL,'Attributes','grid_value_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117580,20398,116335,NULL,'Attributes','owner',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117581,20398,116336,NULL,'Attributes','address',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117582,20398,116337,NULL,'Attributes','postal_code',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117583,20398,116338,NULL,'Attributes','profile_code',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117584,20398,116339,NULL,'Attributes','forecasting_group',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117585,20398,116340,NULL,'Attributes','time_zone',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117586,20398,116341,NULL,'Attributes','physical_shipper',NULL,'',NULL,NULL,'y',NULL,'input',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117587,20398,116314,NULL,'Attributes','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117588,20399,116314,NULL,'Valuation Index','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22501,20392,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22502,20393,'Additional','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22503,20396,'Optimizer Rank','a','73','location_ranking',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22504,20395,'Nom Group/Route','a','74','source_minor_location_nomination_group',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22505,20395,'Nom Group/Route','b','99','vwSourceMinorLocationNominationGroup',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22506,20397,'Del Rank','a','129','location_rank',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22507,20394,'Meter/Wellhead','a','FORM',NULL,1,NULL,'150',NULL,NULL UNION ALL SELECT 22508,20394,'Meter/Wellhead','b','13','source_minor_location_meter',2,NULL,NULL,NULL,NULL UNION ALL SELECT 22509,20398,'Attributes','a','FORM',NULL,7,NULL,NULL,NULL,NULL UNION ALL SELECT 22510,20399,'Valuation Index','a','380','location_price_index',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10102500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10102500'  
							ELSE @db + '_UI_' + '10102500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10102500
