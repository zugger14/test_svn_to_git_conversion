...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10105003' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10105003'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10105003' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10105003')
		BEGIN				
			...
			WHERE autd.application_function_id = '10105003'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10105003
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10105003') 
		BEGIN 
			...
			VALUES('10105003','','','','settings','',' ',' ','','200','n','n',NULL,'n','n','n','n','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10105003','product_category','product_category','Product','combo','int','h','y','SELECT function_id, display_name FROM setup_Menu WHERE product_category = function_id','200','n','n','10000000','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		SELECT 62960,9298,62388,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 62961,9298,62389,NULL,'General','product_category',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 7688,9298,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10105003'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
