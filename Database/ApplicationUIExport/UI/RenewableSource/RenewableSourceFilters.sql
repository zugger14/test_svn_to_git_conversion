...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '12101728' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '12101728'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '12101728' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '12101728')
		BEGIN				
			...
			WHERE autd.application_function_id = '12101728'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 12101728
		...
		VALUES('12101728',
		'RenewableSourceFilters',
		'Renewable Source Filters',
		'y',
		'y',
		NULL,
		'n',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '12101728') 
		BEGIN 
			...
			VALUES('12101728','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','book_structure','book_structure','Book Structure','browser','varchar','h','n','EXEC spa_source_book_maintain ''z''',NULL,'n','n',NULL,'n','n','n','y','n','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','source_group','source_group','Source Group','browser','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','y','n','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','technology','technology','Technology','combo','int','h','n','EXEC spa_staticDataValues @flag=''h'', @type_id=''10009''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','classification_value_id','classification_value_id','Technology Sub Type','combo','int','h','n','EXEC spa_staticDataValues @flag=''h'', @type_id=''13000''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','source_curve_def_id','source_curve_def_id','Valuation Index','combo','int','h','n','EXEC spa_source_price_curve_def_maintain @flag=''l'', @obligation = ''y''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','fuel_type','fuel_type','Fuel Type','combo','int','h','n','EXEC spa_staticDataValues @flag=''h'', @type_id=''10023''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','eligibility_mapping_template','eligibility_mapping_template','Eligibility Mapping Template','combo','int','h','n','EXEC spa_eligibility_mapping @flag=''s''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','counterparty_id','counterparty_id','Counterparty','combo','int','h','n','EXEC spa_source_counterparty_maintain ''c''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('12101728','contract_id','contract_id','Contract','combo','int','h','n','EXEC spa_contract_group ''r''',NULL,'n','n',NULL,'n','n','n','y','y','y','n','n',NULL,NULL,NULL)
		...
		SELECT 97921,16486,96769,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97922,16486,96770,NULL,'General','book_structure',NULL,NULL,NULL,NULL,'n',NULL,'browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,'book',NULL,NULL UNION ALL 
		SELECT 97923,16486,96771,NULL,'General','source_group',NULL,NULL,NULL,NULL,'n',NULL,'browser',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,'source_group',NULL,NULL UNION ALL 
		SELECT 97924,16486,96772,NULL,'General','technology',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97925,16486,96773,NULL,'General','classification_value_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97926,16486,96774,NULL,'General','source_curve_def_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97927,16486,96776,NULL,'General','eligibility_mapping_template',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97928,16486,96775,NULL,'General','fuel_type',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97929,16486,96777,NULL,'General','counterparty_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 97930,16486,96778,NULL,'General','contract_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='12101728'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '12101728'  
							ELSE @db + '_UI_' + '12101728'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 12101728
