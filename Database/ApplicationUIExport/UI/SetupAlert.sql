...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10122500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10122500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10122500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10122500')
		BEGIN				
			...
			WHERE autd.application_function_id = '10122500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10122500
		...
		SELECT 179,'alert_rule_table',NULL,NULL,'EXEC spa_alert_rule_table @flag=''s'',@alert_id=<ID>','Rule Tables','g',NULL,'10122510','10122511',NULL UNION ALL SELECT 180,'AlertActions',NULL,NULL,NULL,'Actions','g',NULL,NULL,NULL,NULL UNION ALL SELECT 181,'AlertCondition',NULL,NULL,'EXEC spa_alert_conditions @flag=''s'',@rules_id=<ID>','Conditions','g',NULL,NULL,NULL,NULL
		...
		SELECT 179,'table_id','Table','combo','EXEC spa_alert_rule_table ''x''','n','n','3','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 179,'table_alias','Alias','ed',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 179,'alert_rule_table_id','Table ID','ro_int',NULL,'n','n','2','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 179,'alert_id','ID','ro_int',NULL,'n','n','1','y','alert_sql','alert_sql_id',NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 180,'table_id','Table','combo','select '''' value, '''' as text','n','n','3','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 180,'column_id','Column','combo','select '''' value, '''' as text','n','n','4','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 180,'column_value','Values','ed',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 181,'alert_conditions_name','Name','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 181,'alert_conditions_description','Description','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 181,'is_sql','Is SQL','ro',NULL,'n','n','2','y',NULL,NULL,'n','50','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 181,'alert_conditions_id','ID','ro_int',NULL,'n','n','1','y','alert_sql','alert_sql_id',NULL,'50','int',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10122500') 
		BEGIN 
			...
			VALUES('10122500','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','alert_sql_id','alert_sql_id','System ID','input','int','h','n',NULL,NULL,'y','y',NULL,'y','n','y',NULL,'n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','alert_sql_name','alert_sql_name','Name','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','message','message','Message','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n',NULL,'n','n','n','n','5',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','notification_type','notification_type','Notification Type','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 750',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','rule_category','rule_category','Rule Category','combo','int','h','n','EXEC spa_setup_rule_workflow @flag=''5''',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','workflow_only','workflow_only','Workflow Only','checkbox','char','h','n',NULL,NULL,'n','y',NULL,'n','n','n',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','system_rule','system_rule','System Event','checkbox','char','h','n',NULL,NULL,'n','n',NULL,'n','n','n',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','is_active','is_active','Active','checkbox','char','h','n',NULL,NULL,'n','n','y','n','n','n',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10122500','sql_statement','sql_statement','SQL','input','varchar','h','n',NULL,NULL,'y','y',NULL,'n','n','n',NULL,'n','n','n','n','8',NULL,NULL,NULL)
		...
		SELECT 'Rule','Rule','y','y','1',NULL,'2E',NULL UNION ALL SELECT 'Rule Detail','Rule Detail','y','n','2',NULL,'2U',NULL
		...
		SELECT 112914,19723,111695,NULL,'Rule','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112915,19723,111696,NULL,'Rule','alert_sql_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112916,19723,111697,NULL,'Rule','alert_sql_name',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112917,19723,111698,NULL,'Rule','message',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112918,19723,111699,NULL,'Rule','notification_type',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112919,19723,111700,NULL,'Rule','rule_category',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112920,19723,111701,NULL,'Rule','workflow_only',NULL,NULL,NULL,NULL,'y',NULL,'checkbox',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112921,19723,111702,NULL,'Rule','system_rule',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112922,19723,111703,NULL,'Rule','is_active',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112923,19724,111695,NULL,'Rule Detail','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112924,19723,111704,NULL,'Rule','sql_statement',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21814,19723,'Rule','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 21815,19723,'Rule','b','179','alert_rule_table',2,NULL,NULL,NULL,NULL UNION ALL SELECT 21816,19724,'Rule Detail','b','180','AlertActions',2,NULL,NULL,NULL,NULL UNION ALL SELECT 21817,19724,'Rule Detail','a','181','AlertCondition',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10122500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10122500'  
							ELSE @db + '_UI_' + '10122500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10122500
