...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10106600' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10106600'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10106600' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10106600')
		BEGIN				
			...
			WHERE autd.application_function_id = '10106600'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10106600
		...
		SELECT 178,'SetupRuleEvents',NULL,NULL,'EXEC spa_setup_rule_workflow @flag=''e'', @workflow_id = <ID>','Rules','t','rule_name,name,action_name',NULL,NULL,NULL
		...
		SELECT 178,'rule_name','Rule Message/Action','tree',NULL,'n','n','1','n',NULL,NULL,NULL,'350','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 178,'next_rule_name','Next Rule','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'350','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 178,'alert_id','Alert ID','ro_int',NULL,'n','n','3','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 178,'event_message_id','Message ID','ro_int',NULL,'n','n','6','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 178,'event_action_id','Action ID','ro_int',NULL,'n','n','5','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 178,'event_trigger_id','ID','ro_int',NULL,'n','n','4','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10106600') 
		BEGIN 
			...
			VALUES('10106600','','','','settings','','h','y',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10106600','module_events_id','module_events_id','System ID','input','int','h','y',NULL,NULL,'y','y',NULL,'y','n','y',NULL,'n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10106600','workflow_name','workflow_name','Name','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10106600','modules_id','modules_id','Module','combo','int','h','y','EXEC spa_StaticDataValues ''h'', 20600',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10106600','event_id','event_id','Event','combo','int','h','y','EXEC spa_StaticDataValues ''h'', 20500',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General','General','y','y','1',NULL,'2E',NULL
		...
		SELECT 113278,19782,112046,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113279,19782,112047,NULL,'General','module_events_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113280,19782,112048,NULL,'General','workflow_name',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113281,19782,112049,NULL,'General','modules_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113282,19782,112050,NULL,'General','event_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21880,19782,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 21881,19782,'General','b','178','SetupRuleEvents',2,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10106600'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10106600'  
							ELSE @db + '_UI_' + '10106600'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10106600
