...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10141900' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10141900'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10141900' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10141900')
		BEGIN				
			...
			WHERE autd.application_function_id = '10141900'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '10141900'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '10141900'	

			DELETE FROM application_ui_filter WHERE application_function_id = '10141900'
			...
			WHERE application_function_id = '10141900'
		...
		SELECT 94,'meter_location',NULL,NULL,'EXEC spa_source_minor_location @flag = ''r''','Location','g',NULL,NULL,NULL,NULL UNION ALL SELECT 115,'forecast_profile',NULL,NULL,'SELECT profile_id, profile_name FROM  forecast_profile','Profile','g',NULL,NULL,NULL,NULL
		...
		SELECT 115,'profile_id','ID','ron',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'80','int',NULL,'left' UNION ALL 
		SELECT 115,'profile_name','Profile Name','ro',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		...
		SELECT 94,'status','Status','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'100',NULL,NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10141900') 
		BEGIN 
			...
			VALUES('10141900','','','','settings','','h','y',NULL,NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','profile_id','profile_id','Profile','browser','varchar','h','n','',NULL,'n','n','','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','location_id','location_id','Location','browser','int','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','prod_month_from','prod_month_from','Date From','dyn_calendar','date','h','y','',NULL,'n','n','','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','prod_month_to','prod_month_to','Date To','dyn_calendar','date','h','y','',NULL,'n','n','','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','hour_from','hour_from','Hour From','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] 
UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label]
UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] 
UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label]
UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] 
UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label] 
UNION ALL SELECT ''7'' AS [Value], ''7'' AS [Label] 
UNION ALL SELECT ''8'' AS [Value], ''8'' AS [Label]
UNION ALL SELECT ''9'' AS [Value], ''9'' AS [Label] 
UNION ALL SELECT ''10'' AS [Value], ''10'' AS [Label] 
UNION ALL SELECT ''11'' AS [Value], ''11'' AS [Label] 
UNION ALL SELECT ''12'' AS [Value], ''12'' AS [Label] 
UNION ALL SELECT ''13'' AS [Value], ''13'' AS [Label] 
UNION ALL SELECT ''14'' AS [Value], ''14'' AS [Label] 
UNION ALL SELECT ''15'' AS [Value], ''15'' AS [Label] 
UNION ALL SELECT ''16'' AS [Value], ''16'' AS [Label]
UNION ALL SELECT ''17'' AS [Value], ''17'' AS [Label] 
UNION ALL SELECT ''18'' AS [Value], ''18'' AS [Label] 
UNION ALL SELECT ''19'' AS [Value], ''19'' AS [Label] 
UNION ALL SELECT ''20'' AS [Value], ''20'' AS [Label]
UNION ALL SELECT ''21'' AS [Value], ''21'' AS [Label] 
UNION ALL SELECT ''22'' AS [Value], ''22'' AS [Label] 
UNION ALL SELECT ''23'' AS [Value], ''23'' AS [Label] 
UNION ALL SELECT ''24'' AS [Value], ''24'' AS [Label]) a',NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','hour_to','hour_to','Hour To','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] 
UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label]
UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] 
UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label]
UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] 
...
UNION ALL SELECT ''24'' AS [Value], ''24'' AS [Label]) a',NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
			...
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','round_value','round_value','Round value','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label] UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label] UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label] UNION ALL SELECT ''7'' AS [Value], ''7'' AS [Label] UNION ALL SELECT ''8'' AS [Value], ''8'' AS [Label]) a',NULL,'n','n','2','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','grouping_option','grouping_option','Report Option','radio','char','h','y','SELECT * FROM (SELECT ''s'' AS [value], ''Summary'' AS [label] UNION ALL SELECT ''d'' AS [value], ''Detail'' AS [label] ) p',NULL,'n','n','s','n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','format','format','Report Format','radio','char','h','y','SELECT * FROM (SELECT ''c'' AS [value], ''Cross Tab'' AS [label] UNION ALL SELECT ''r'' AS [value], ''Regular'' AS [label] ) p',NULL,'n','n','r','n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','enable_paging','enable_paging','Apply Paging','checkbox','boolean','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','report_id','report_id','Report','input','int','h','n',NULL,NULL,'r','y',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10141900','spa_name','spa_name','Spa Name','input','int','h','n',NULL,NULL,'r','y',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 69219,18003,66731,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69220,18003,66732,NULL,'General','profile_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,'115',NULL UNION ALL 
		SELECT 69221,18003,66733,NULL,'General','location_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,'94',NULL UNION ALL 
		SELECT 69222,18003,66734,NULL,'General','prod_month_from',NULL,NULL,NULL,'y',NULL,NULL,'dyn_calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69223,18003,66735,NULL,'General','prod_month_to',NULL,NULL,NULL,'y',NULL,NULL,'dyn_calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69224,18003,66736,NULL,'General','hour_from',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69225,18003,66737,NULL,'General','hour_to',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69226,18003,66738,NULL,'General','round_value',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69227,18003,66739,NULL,'General','grouping_option',NULL,NULL,NULL,NULL,NULL,NULL,'radio',NULL,'8',NULL,NULL,NULL,'label-right',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69228,18003,66740,NULL,'General','format',NULL,NULL,NULL,NULL,NULL,NULL,'radio',NULL,'9',NULL,NULL,NULL,'label-right',NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69229,18003,66741,NULL,'General','enable_paging',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69230,18003,66742,NULL,'General','report_id','','','',' ','y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69231,18003,66743,NULL,'General','spa_name','','spa_load_forecast_report','',' ','y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 15461,18003,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10141900'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
