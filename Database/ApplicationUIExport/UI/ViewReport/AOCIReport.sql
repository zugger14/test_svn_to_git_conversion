...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10235200' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10235200'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10235200' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10235200')
		BEGIN				
			...
			WHERE autd.application_function_id = '10235200'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '10235200'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '10235200'	

			DELETE FROM application_ui_filter WHERE application_function_id = '10235200'
			...
			WHERE application_function_id = '10235200'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10235200') 
		BEGIN 
			...
			VALUES('10235200','book_structure','book_structure','Book Structure','browser','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','discount_option','discount_option','Discount Option','combo','varchar','h','n','SELECT * FROM (SELECT ''d'' AS [Value], ''Present Value'' AS [Label] UNION ALL SELECT ''u'' AS [Value], ''Future Value'' AS [Label]) a',NULL,'n','n','d','n','n','n',NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','as_of_date','as_of_date','As of Date','dyn_calendar','date','h','n',NULL,NULL,'n','n','GETDATE()','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','term_start','term_start','Term Start','dyn_calendar','date','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','term_end','term_end','Term End','dyn_calendar','date','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','report_type','report_type','Report Type','combo','varchar','h','n','SELECT * FROM (SELECT ''s'' AS [Value], ''Summary by Sub/Strategy/Book'' AS [Label] UNION ALL SELECT ''p'' AS [Value], ''Summary by Sub/Tenor'' AS [Label] UNION ALL SELECT ''r'' AS [Value], ''Summary by Sub/Strategy/Rollout'' AS [Label] UNION ALL SELECT ''t'' AS [Value], ''Summary by Sub/Rollout/Tenor'' AS [Label] UNION ALL SELECT ''u'' AS [Value], ''Summary by Sub/Rollout'' AS [Label] UNION ALL SELECT ''d'' AS [Value], ''Detail'' AS [Label]) a',NULL,'n','n','s','n','n','n',NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','apply_paging','apply_paging','Apply Paging','checkbox','boolean','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','round_value','round_value','Round Value','combo','varchar','h','n','SELECT * FROM (SELECT ''0'' AS [Value], ''0'' AS [Label] UNION ALL SELECT ''1'' AS [Value], ''1'' AS [Label] UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label] UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label] UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label]) a',NULL,'n','n','2','n','n','n',NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10235200','','','','settings','',' ',' ','',NULL,' ',' ','',' ',' ',' ',' ',' ',' ',' ',' ',NULL,NULL,NULL)
		...
		SELECT 57038,8589,56695,NULL,'General','book_structure',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57039,8589,56696,NULL,'General','discount_option',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57040,8589,56697,NULL,'General','as_of_date',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57041,8589,56698,NULL,'General','term_start',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57042,8589,56699,NULL,'General','term_end',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57043,8589,56700,NULL,'General','report_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57044,8589,56701,NULL,'General','apply_paging',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57045,8589,56702,NULL,'General','round_value',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 57046,8589,56703,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10235200'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
