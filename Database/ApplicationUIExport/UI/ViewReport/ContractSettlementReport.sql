...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10221200' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10221200'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10221200' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10221200')
		BEGIN				
			...
			WHERE autd.application_function_id = '10221200'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '10221200'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '10221200'	

			DELETE FROM application_ui_filter WHERE application_function_id = '10221200'
			...
			WHERE application_function_id = '10221200'
		...
		SELECT 86,'status','Status','ro',NULL,'y','y','4','y',NULL,NULL,NULL,'225',NULL,NULL,'left' UNION ALL 
		SELECT 87,'contract_id','Contract ID','ron',NULL,'n','y','1','y',NULL,NULL,NULL,'225','int',NULL,'left' UNION ALL 
		SELECT 87,'contract','Contract','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'225',NULL,NULL,'left' UNION ALL 
		SELECT 87,'counterparty','Counterparty','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'225',NULL,NULL,'left' UNION ALL 
		SELECT 87,'status','Status','ro',NULL,'y','y','4','y',NULL,NULL,NULL,'225',NULL,NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10221200') 
		BEGIN 
			...
			VALUES('10221200','','','','settings','','h','y',NULL,NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','summary_option','summary_option','Report Option','combo','char','h','y','SELECT * FROM (SELECT ''a'' AS [Value], ''Monthly by counterparty'' AS [Label] UNION ALL SELECT ''b'' AS [Value], ''Monthly charges by counterparty'' AS [Label] UNION ALL SELECT ''c'' AS [Value], ''Detailed by delivery month'' AS [Label] UNION ALL SELECT ''d'' AS [Value], ''Detailed by counterparty'' AS [Label] UNION ALL SELECT ''e'' AS [Value], ''Detailed by charge type'' AS [Label] UNION ALL SELECT ''z'' AS [Value], ''Detailed by deal'' AS [Label]) a',NULL,'n','n','a','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','as_of_date_from','as_of_date_from','As of Date From','dyn_calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','as_of_date_to','as_of_date_to','As of Date To','dyn_calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','counterparty_id','counterparty_id','Counterparty','browser','varchar','h','n','NULL',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','contract_id','contract_id','Contract','browser','varchar','h','n','NULL',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','settlement_date_from','settlement_date_from','Settlement Date From','dyn_calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','settlement_date_to','settlement_date_to','Settlement Date To','dyn_calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','drill_line_item','drill_line_item','Charge Type','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10019',NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','prod_date_from','prod_date_from','Delivery Date From','dyn_calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','prod_date_to','prod_date_to','Delivery Date To','dyn_calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','deal_id','deal_id','Deal ID','input','int','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','ref_id','ref_id','Reference ID','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','deal_filter','deal_filter','Deal Filter','browser','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','show_recent_calculation','show_recent_calculation','Recent Calculation','checkbox','boolean','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','enable_paging','enable_paging','Apply Paging','checkbox','boolean','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','round_value','round_value','Round Value','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label] UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label] UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label] ) a',NULL,'n','n','2','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','report_id','report_id','Report','input','int','h','n',NULL,NULL,'r','y',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','spa_name','spa_name','Spa Name','input','varchar','h','n',NULL,NULL,'r','y',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','invoice_remittance','invoice_remittance','Invoice/Remittance','combo','char','h','n','SELECT ''i'' [id], ''Invoice'' [name] UNION ALL SELECT ''r'', ''Remittance''',NULL,'n','n','n','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10221200','workflow_status','workflow_status','Workflow Status','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 20700',NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 69198,18002,66710,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69199,18002,66711,NULL,'General','summary_option',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69200,18002,66712,NULL,'General','as_of_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69201,18002,66713,NULL,'General','as_of_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69202,18002,66714,NULL,'General','counterparty_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'6',NULL,NULL,NULL,NULL,'NULL','NULL','86',NULL UNION ALL 
		SELECT 69203,18002,66715,NULL,'General','contract_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'11',NULL,NULL,NULL,NULL,'NULL','NULL','87',NULL UNION ALL 
		SELECT 69204,18002,66716,NULL,'General','settlement_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69205,18002,66717,NULL,'General','settlement_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69206,18002,66718,NULL,'General','drill_line_item',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69207,18002,66719,NULL,'General','prod_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69208,18002,66720,NULL,'General','prod_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'dyn_calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69209,18002,66721,NULL,'General','deal_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Invalid Number' UNION ALL 
		SELECT 69210,18002,66722,NULL,'General','ref_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Invalid Number' UNION ALL 
		SELECT 69211,18002,66723,NULL,'General','deal_filter',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,'deal_filter',NULL UNION ALL 
		SELECT 69212,18002,66724,NULL,'General','show_recent_calculation',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'18',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69213,18002,66725,NULL,'General','enable_paging',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69214,18002,66726,NULL,'General','round_value',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69215,18002,66727,NULL,'General','report_id','','','',' ','y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69216,18002,66728,NULL,'General','spa_name','','spa_run_settlement_invoice_report','',' ','y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69217,18002,66729,NULL,'General','invoice_remittance',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69218,18002,66730,NULL,'General','workflow_status',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'16',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 15460,18002,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10221200'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
