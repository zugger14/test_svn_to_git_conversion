...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10222400' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10222400'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10222400' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10222400')
		BEGIN				
			...
			WHERE autd.application_function_id = '10222400'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10222400
		...
		SELECT 58,'meter_filter','','','EXEC spa_getAllMeter @flag=''s''','Meter','a',NULL,NULL,NULL,NULL UNION ALL SELECT 94,'meter_location',NULL,NULL,'EXEC spa_source_minor_location @flag = ''r''','Location','g',NULL,NULL,NULL,NULL
		...
		SELECT 58,'meter_id','ID','ro_int',NULL,'n','y','1','n',NULL,NULL,NULL,'230','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 58,'recorderid','Meter ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'240','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 58,'status','Status','ro',NULL,'y','y','3','y',NULL,NULL,NULL,'240','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 94,'source_minor_location_id','Location ID','ro',NULL,'n','n','1','n',NULL,NULL,NULL,'200',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 94,'location_name','Location Name','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'277',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 94,'status','Status','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10222400') 
		BEGIN 
			...
			VALUES('10222400','','','','settings','','h','y',NULL,NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','meter_id','meter_id','Meter ID','browser','varchar','h','n','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','channel','channel','Channel','input','int','h','n','SELECT id, channel FROM meter_id_channel',NULL,'n','n',NULL,'n','n','n','y','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','location_id','location_id','Location','browser','int','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','counterparty_id','counterparty_id','Meter Counterparty','combo','int','h','y','EXEC spa_getsourcecounterparty ''s''',NULL,'n','y','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','prod_month_from','prod_month_from','Date From','dyn_calendar','date','h','y','',NULL,'n','n','','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','prod_month_to','prod_month_to','Date To','dyn_calendar','date','h','y','',NULL,'n','n','','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','hour_from','hour_from','Hour From','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label] UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label]
	UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label] UNION ALL SELECT ''7'' AS [Value], ''7'' AS [Label] UNION ALL SELECT ''8'' AS [Value], ''8'' AS [Label]
	UNION ALL SELECT ''9'' AS [Value], ''9'' AS [Label] UNION ALL SELECT ''10'' AS [Value], ''10'' AS [Label] UNION ALL SELECT ''11'' AS [Value], ''11'' AS [Label] UNION ALL SELECT ''12'' AS [Value], ''12'' AS [Label]
	UNION ALL SELECT ''13'' AS [Value], ''13'' AS [Label] UNION ALL SELECT ''14'' AS [Value], ''14'' AS [Label] UNION ALL SELECT ''15'' AS [Value], ''15'' AS [Label] UNION ALL SELECT ''16'' AS [Value], ''16'' AS [Label]
	UNION ALL SELECT ''17'' AS [Value], ''17'' AS [Label] UNION ALL SELECT ''18'' AS [Value], ''18'' AS [Label] UNION ALL SELECT ''19'' AS [Value], ''19'' AS [Label] UNION ALL SELECT ''20'' AS [Value], ''20'' AS [Label]
	UNION ALL SELECT ''21'' AS [Value], ''21'' AS [Label] UNION ALL SELECT ''22'' AS [Value], ''22'' AS [Label] UNION ALL SELECT ''23'' AS [Value], ''23'' AS [Label] UNION ALL SELECT ''24'' AS [Value], ''24'' AS [Label]
	) a',NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','hour_to','hour_to','Hour To','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label] UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label]
	UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label] UNION ALL SELECT ''7'' AS [Value], ''7'' AS [Label] UNION ALL SELECT ''8'' AS [Value], ''8'' AS [Label]
	UNION ALL SELECT ''9'' AS [Value], ''9'' AS [Label] UNION ALL SELECT ''10'' AS [Value], ''10'' AS [Label] UNION ALL SELECT ''11'' AS [Value], ''11'' AS [Label] UNION ALL SELECT ''12'' AS [Value], ''12'' AS [Label]
	UNION ALL SELECT ''13'' AS [Value], ''13'' AS [Label] UNION ALL SELECT ''14'' AS [Value], ''14'' AS [Label] UNION ALL SELECT ''15'' AS [Value], ''15'' AS [Label] UNION ALL SELECT ''16'' AS [Value], ''16'' AS [Label]
	UNION ALL SELECT ''17'' AS [Value], ''17'' AS [Label] UNION ALL SELECT ''18'' AS [Value], ''18'' AS [Label] UNION ALL SELECT ''19'' AS [Value], ''19'' AS [Label] UNION ALL SELECT ''20'' AS [Value], ''20'' AS [Label]
	UNION ALL SELECT ''21'' AS [Value], ''21'' AS [Label] UNION ALL SELECT ''22'' AS [Value], ''22'' AS [Label] UNION ALL SELECT ''23'' AS [Value], ''23'' AS [Label] UNION ALL SELECT ''24'' AS [Value], ''24'' AS [Label]
			...
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n',NULL,'n','n','n','y','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','contract_id','contract_id','Contract','combo','int','h','y','EXEC spa_contract_group ''r''',NULL,'n','y','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','granularity','granularity','Report Granularity','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 978, @code=''10Min, 15Min, 30Min, 5Min, Hourly, Monthly''',NULL,'n','n','982','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','round_value','round_value','Round value','combo','int','h','y','SELECT * FROM (SELECT ''1'' AS [Value], ''1'' AS [Label] UNION ALL SELECT ''2'' AS [Value], ''2'' AS [Label] UNION ALL SELECT ''3'' AS [Value], ''3'' AS [Label] UNION ALL SELECT ''4'' AS [Value], ''4'' AS [Label] UNION ALL SELECT ''5'' AS [Value], ''5'' AS [Label] UNION ALL SELECT ''6'' AS [Value], ''6'' AS [Label] UNION ALL SELECT ''7'' AS [Value], ''7'' AS [Label] UNION ALL SELECT ''8'' AS [Value], ''8'' AS [Label] UNION ALL SELECT ''9'' AS [Value], ''9'' AS [Label] UNION ALL SELECT ''10'' AS [Value], ''10'' AS [Label]) a',NULL,'n','n','4','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','grouping_option','grouping_option','Report Option','radio','char','h','y','SELECT * FROM (SELECT ''s'' AS [value], ''Summary'' AS [label] UNION ALL SELECT ''d'' AS [value], ''Detail'' AS [label] ) p',NULL,'n','n','s','n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','format','format','Report Format','radio','char','h','y','SELECT * FROM (SELECT ''c'' AS [value], ''Cross Tab'' AS [label] UNION ALL SELECT ''r'' AS [value], ''Regular'' AS [label] ) p',NULL,'n','n','c','n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','enable_paging','enable_paging','Apply Paging','checkbox','boolean','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','show_enhance_volume','show_enhance_volume','Show Enhanced Volume','checkbox','boolean','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','report_id','report_id','Report','input','int','h','n',NULL,NULL,'r','y',NULL,'n','n',NULL,NULL,'y','y','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10222400','spa_name','spa_name','Spa Name','input','int','h','n',NULL,NULL,'r','y',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y',NULL,NULL,'1C',NULL
		...
		SELECT 113345,19800,112115,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113346,19800,112116,NULL,'General','meter_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,'58',NULL,NULL UNION ALL 
		SELECT 113347,19800,112117,NULL,'General','channel',NULL,'1',NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113348,19800,112118,NULL,'General','location_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,'94',NULL,NULL UNION ALL 
		SELECT 113349,19800,112119,NULL,'General','counterparty_id',NULL,NULL,NULL,NULL,'y',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113350,19800,112120,NULL,'General','prod_month_from',NULL,NULL,NULL,'y',NULL,NULL,'dyn_calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113351,19800,112121,NULL,'General','prod_month_to',NULL,NULL,NULL,'y',NULL,NULL,'dyn_calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113352,19800,112122,NULL,'General','hour_from',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113353,19800,112123,NULL,'General','hour_to',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113354,19800,112124,NULL,'General','commodity_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,'offset',NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113355,19800,112125,NULL,'General','contract_id',NULL,NULL,NULL,NULL,'y',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113356,19800,112126,NULL,'General','granularity',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113357,19800,112127,NULL,'General','round_value',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113358,19800,112128,NULL,'General','grouping_option',NULL,NULL,NULL,NULL,NULL,NULL,'radio',NULL,'9',NULL,NULL,NULL,'label-right',NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113359,19800,112129,NULL,'General','format',NULL,NULL,NULL,NULL,NULL,NULL,'radio',NULL,'10',NULL,NULL,NULL,'label-right',NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113360,19800,112130,NULL,'General','enable_paging',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113361,19800,112131,NULL,'General','show_enhance_volume',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113362,19800,112132,NULL,'General','report_id','','','',' ','y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113363,19800,112133,NULL,'General','spa_name','','spa_meter_data_report','',' ','y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21907,19800,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10222400'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10222400'  
							ELSE @db + '_UI_' + '10222400'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10222400
