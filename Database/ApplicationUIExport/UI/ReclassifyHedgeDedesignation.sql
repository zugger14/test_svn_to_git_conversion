...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10234000' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10234000'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10234000' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10234000')
		BEGIN				
			...
			WHERE autd.application_function_id = '10234000'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10234000
		...
		SELECT 154,'ReclassifyHedgeDedesignation',NULL,NULL,NULL,'ReclassifyHedgeDedesignation','g',NULL,'10234610','10234612',NULL
		...
		SELECT 154,'dedesignation_date','De-designation Date','ro',NULL,'n','n','0','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 154,'reclassify_date','Reclassify Date','ro',NULL,'n','n','1','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 154,'link_description','Link Description','ro',NULL,'n','n','4','n',NULL,NULL,'n','400','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 154,'book_deal_type_map_id','Book Map ID','ro_int',NULL,'n','n','2','y',NULL,NULL,'n','250','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 154,'link_id','Link ID','ro_int',NULL,'n','n','3','n',NULL,NULL,'n','250','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 154,'fas_book_id','Book ID','ro_int',NULL,'n','n','5','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL
		...
		VALUES('10234000',
		'ReclassifyHedgeDedesignation',
		'Reclassify Hedge Dedesignation',
		'y',
		'y',
		NULL,
		'n',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10234000') 
		BEGIN 
			...
			VALUES('10234000','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10234000','dedesignation_date_from','dedesignation_date_from','Dedesignation Date From','calendar','date','h','n',NULL,NULL,'n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10234000','dedesignation_date_to','dedesignation_date_to','Dedesignation Date To','calendar','date','h','n',NULL,NULL,'n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'Detail',NULL,'y','y','2',NULL,'1C',NULL
		...
		SELECT 112893,19719,111674,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112894,19719,111675,NULL,'General','dedesignation_date_from',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112895,19719,111676,NULL,'General','dedesignation_date_to',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21809,19719,'General','a','FORM',NULL,1,NULL,NULL,'ns_reclassify_dedesignation','book' UNION ALL SELECT 21810,19720,'Detail','b','154','ReclassifyHedgeDedesignation',2,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10234000'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10234000'  
							ELSE @db + '_UI_' + '10234000'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10234000
