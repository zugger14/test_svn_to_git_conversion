...
BEGIN
			...
			*/		
			...
			BEGIN
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '10162000'
				...
				WHERE application_function_id = '10162000'
			...
			SELECT 76,'transportation_rate_schedule',NULL,NULL,'EXEC spa_transportation_rate_schedule @flag=''s'',@rate_schedule_id =<ID>','Rate/Fees','g',NULL,'10162010','10162011',NULL
			...
			END
				...
				ON agd.grid_name = tag.grid_name
							...
							SELECT 76,'id','Rate ID','ron',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left' UNION ALL 
							SELECT 76,'rate_schedule_id','Rate Schedule ID','ron',NULL,'n','y','2','y','static_data_value','value_id',NULL,'100','int',NULL,'left' UNION ALL 
							SELECT 76,'rate_type_id','Charge Type','combo','Exec spa_StaticDataValues @flag = ''b'' ,@type_id = 5500, @code = ''Rate Schedule Code''','y','y','3','n',NULL,NULL,NULL,'200','str','NotEmpty','left' UNION ALL 
							SELECT 76,'rate','Rate','edn',NULL,'y','y','4','n',NULL,NULL,NULL,'150','int','ValidNumeric','left' UNION ALL 
							SELECT 76,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','5','n',NULL,NULL,NULL,'200','date',NULL,'left' UNION ALL 
							SELECT 76,'uom_id','UOM','combo','Exec spa_source_uom_maintain ''c''','y','y','6','n',NULL,NULL,NULL,'205','str','NotEmpty','right'
...
DECLARE @application_ui_template_id_new INT
	...
	IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10162000') BEGIN 
	...
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				...
				VALUES('10162000','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10162000','value_id','value_id','ID','input','int','h','n',NULL,NULL,'n','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10162000','code','code','Name','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,'500')
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10162000','description','description','Description','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,'500')
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10162000','type_id','type_id','type_id','input','int','h','n',NULL,NULL,'n','y','1800','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
 END 
				...
				INSERT INTO #temp_old_template_group(group_name, group_description, active_flag, default_flag, sequence, inputWidth, field_layout, old_application_grid_id)
								...
								SELECT 'Rate Schedule',NULL,'y','y',NULL,NULL,'2E',NULL
			...
			IF OBJECT_ID('tempdb..#temp_old_template_fieldsets') IS NOT NULL
				...
				CREATE TABLE #temp_new_template_fieldsets (new_id INT, group_id INT, fieldset_name VARCHAR(200) COLLATE DATABASE_DEFAULT)							
					...
					INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 4808,12032,'Rate Schedule','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,'100',NULL,NULL
				...
				IF OBJECT_ID('tempdb..#temp_old_template_fields') IS NOT NULL
					...
					INSERT INTO #temp_old_template_fields(old_field_id, old_group_id, old_application_ui_field_id, old_fieldset_id, group_name, ui_field_id, field_alias, Default_value, default_format, validation_flag, hidden, field_size, field_type, field_id, sequence, inputHeight, udf_template_id, udf_field_name, position, dependent_field, dependent_query, old_grid_id, validation_message)
								...
								SELECT 68425,12032,68223,NULL,'Rate Schedule','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68426,12032,68224,NULL,'Rate Schedule','value_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68427,12032,68225,NULL,'Rate Schedule','code',NULL,NULL,NULL,'y',NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68428,12032,68226,NULL,'Rate Schedule','description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68429,12032,68227,NULL,'Rate Schedule','type_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
					...
					INSERT INTO #temp_old_ui_layout(old_layout_grid_id, old_group_id, group_name, layout_cell, old_grid_id, grid_name, sequence, num_column, cell_height,grid_object_name,grid_object_unique_column)
								...
								SELECT 10566,12032,'Rate Schedule','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10567,12032,'Rate Schedule','b','76','transportation_rate_schedule',1,NULL,NULL,NULL,NULL
