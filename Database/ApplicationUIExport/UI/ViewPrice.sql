...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10151000' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10151000'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10151000' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10151000')
		BEGIN				
			...
			WHERE autd.application_function_id = '10151000'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10151000
		...
		SELECT 474,'view_price_curve',NULL,NULL,NULL,'Price Curve','t','s_curve_type,curve_name','10102610','10102611','0'
		...
		SELECT 474,'commodity_name','Commodity','ro',NULL,'n','n','9',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'market_value_id','Market','ro',NULL,'n','n','10',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'curve_des','Description','ro',NULL,'n','n','4',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'curve_id','Curve ID','ro',NULL,'n','n','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'s_granularity','Granularity','ro',NULL,'n','n','5',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'source_currency_id','Currency','ro',NULL,'n','n','7',NULL,NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 474,'uom_name','UOM','ro',NULL,'n','n','8',NULL,NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 474,'is_active','Active','ro',NULL,'n','n','14',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'Forward_settle','Forward/Settlement','ro',NULL,'n','n','11',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'index_group','Index Group','ro',NULL,'n','n','13',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'formula_id','Formula','ro',NULL,'n','n','12',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'is_privilege_active','Privilege','ro',NULL,'n','n','16','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'effective_date','Effective Date','ro',NULL,'n','n','17',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'s_granularity_id','Granularity ID','ro',NULL,'n','n','18','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'source_curve_def_id','System ID','ro_int',NULL,'n','n','2','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'type_id','Type ID','ro_int',NULL,'n','n','15','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 474,'s_curve_type','Curve Type/Curve Name','tree',NULL,'n','n','1',NULL,NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10151000') 
		BEGIN 
			...
			VALUES('10151000','','','','settings','','h','y',NULL,NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','as_of_date_from','as_of_date_from','As of Date From','calendar','date','h','y','',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','as_of_date_to','as_of_date_to','As of Date To','calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','tenor_from','tenor_from','Tenor From','calendar','date','h','y','',NULL,'n','n','GETDATE()+1','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','tenor_to','tenor_to','Tenor To','calendar','date','h','y','',NULL,'n','n','EOMONTH(GETDATE())','y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','curve_source','curve_source','Curve Source','combo','int','h','y','EXEC spa_StaticDataValues ''h'', 10007',NULL,'n','n','y','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','average','average','Average','combo','char','h','y','SELECT * FROM (SELECT ''d'' AS [value], ''Daily'' AS [label] UNION ALL SELECT ''m'' AS [value], ''Monthly'' AS [label] UNION ALL SELECT  ''q'' AS [value], ''Quaterly'' AS [label] UNION ALL SELECT ''y'' AS [value], ''Yearly'' AS [label] UNION ALL SELECT ''l'' AS [value], ''All'' AS [label]) p',NULL,'n','n','y','n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','bid_ask','bid_ask','Bid & Ask','checkbox','varchar','h','n','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10151000','round_value','round_value','Round','combo','int','h','y','EXEC spa_round_value ''s''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 116645,20282,115426,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116646,20282,115427,NULL,'General','as_of_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116647,20282,115428,NULL,'General','as_of_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116648,20282,115429,NULL,'General','tenor_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116649,20282,115430,NULL,'General','tenor_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116650,20282,115431,NULL,'General','curve_source',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116651,20282,115432,NULL,'General','average',NULL,NULL,NULL,NULL,'y',NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116652,20282,115433,NULL,'General','bid_ask',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116653,20282,115434,NULL,'General','round_value',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22383,20282,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22384,20282,'General','b','474','view_price_curve',2,'2',NULL,'view_price.price_curve_grid','source_curve_def_id'
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10151000'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10151000'  
							ELSE @db + '_UI_' + '10151000'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10151000
