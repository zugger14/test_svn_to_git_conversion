...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20013600' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20013600'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20013600' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20013600')
		BEGIN				
			...
			WHERE autd.application_function_id = '20013600'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20013600
		...
		SELECT 393,'regression_module_dependencies',NULL,NULL,'EXEC(''SELECT regression_module_dependencies_id[ID],regression_module_header_id[Regression Module Header ID],object_name[Object Name] FROM regression_module_dependencies WHERE regression_module_header_id = <ID>'')','Regression Module Dependencies','g',NULL,'20013600','20013600',NULL UNION ALL SELECT 395,'regression_module_detail',NULL,NULL,'EXEC spa_test_regression_rule @flag = ''r'', @regression_module_header_id = <ID>','Regression Module Detail','g',NULL,'20013600','20013600',NULL
		...
		SELECT 393,'regression_module_dependencies_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','80','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 393,'regression_module_header_id','Regression Module Header ID','ro',NULL,'n','y','2','y','regression_module_header','regression_module_header_id','n','80','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 393,'object_name','Object Name','ed',NULL,'n','y','3','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'regression_module_detail_id','Detail ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','250','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'regression_module_header_id','Regression Module Header ID','ro',NULL,'n','y','2','y','regression_module_header','regression_module_header_id','n','250','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'table_name','Table Name','browser','EXEC spa_test_regression_rule @flag=''t''','n','y','4','n',NULL,NULL,'n','250','varchar',NULL,'left', 'table_column_browser','n' UNION ALL 
		SELECT 395,'regg_rpt_paramset_hash','Report Name','browser','EXEC spa_test_regression_rule @flag=''q''','n','y','5','n',NULL,NULL,'n','250','varchar',NULL,'left', 'report_column_browser','n' UNION ALL 
		SELECT 395,'unique_columns','Unique Columns','ro',NULL,'n','y','6','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'compare_columns','Compare Columns','ro',NULL,'n','y','7','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'display_columns','Display Columns','ro',NULL,'n','y','8','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'data_order','Data Order','ed',NULL,'n','y','9','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'process_exec_order','Process Execution','ed',NULL,'n','y','102','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n' UNION ALL 
		SELECT 395,'regg_type','Regression Type','combo','EXEC spa_StaticDataValues @flag =''h'', @type_id=109700','n','y','3','n',NULL,NULL,'n','250','varchar',NULL,'left', NULL,'n'
		...
		VALUES('20013600',
		'SetupRegressionConfiguration',
		'SetupRegressionConfiguration',
		'y',
		'y',
		'regression_module_header',
		'n',
		'20013600',
		'20013600',
		NULL)
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20013600') 
		BEGIN 
			...
			VALUES('20013600','','','','settings','',' ',' ','','200','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013600','regression_module_header_id','regression_module_header_id','System ID','input','int','h','n',NULL,NULL,'y','n',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013600','module_name','module_name','Name','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013600','description','description','Description','input','varchar','h','y',NULL,'460','n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013600','process_exec_order','process_exec_order','Sequence','input','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y',1,NULL,'2E',NULL UNION ALL 
		SELECT 'Dependencies',NULL,'y',NULL,2,NULL,'1C',NULL
		...
		SELECT 86399,17831,85850,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 86400,17831,85851,NULL,'General','regression_module_header_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 86401,17831,85852,NULL,'General','module_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 86402,17831,85853,NULL,'General','description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 86403,17831,85854,NULL,'General','process_exec_order',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 15808,17831,'General','a','FORM',NULL,1,NULL,100,NULL,NULL UNION ALL SELECT 15809,17831,'General','b','395','regression_module_detail',1,NULL,NULL,NULL,NULL UNION ALL SELECT 15810,17832,'Dependencies','a','393','regression_module_dependencies',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20013600'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20013600'  
							ELSE @db + '_UI_' + '20013600'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20013600
