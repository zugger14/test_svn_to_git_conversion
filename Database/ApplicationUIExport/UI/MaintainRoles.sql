...
BEGIN
			...
			INSERT INTO  #temp_old_application_ui_filter (application_ui_filter_id,application_group_id,group_name,user_login_id,application_ui_filter_name,application_function_id)
				...
				WHERE aut.application_function_id = '10111100' AND auf.application_function_id IS NULL
				UNION ALL
				SELECT 
				...
				WHERE auf.application_function_id = '10111100'  AND auf.application_function_id IS NOT NULL
				...
				FROM 
					...
					WHERE aut.application_function_id = '10111100' AND auf.application_function_id IS NOT NULL
			...
			*/		
			...
			IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10111100')
			BEGIN
				...
				WHERE autd.application_function_id = '10111100'
				...
				INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
				WHERE aut.application_function_id = '10111100'
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '10111100'
				...
				WHERE application_function_id = '10111100'
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 18,'role_users',NULL,NULL,'exec spa_application_security_role  @flag = f, @role_id = <ID>','Users',NULL,NULL,'10111016','10111018',NULL UNION ALL 
									SELECT 19,'application_privilege',NULL,NULL,'exec spa_AccessRights @flag = m, @role_id = <ID>','Privileges','t','function_name2,function_name3,function_name4,function_name5,function_name6','10111113','10111114',NULL
			...
			END
				...
				ON agd.grid_name = tag.grid_name
							...
							INSERT INTO #temp_all_grids_columns(old_grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 18,'user_login_id','Login','ro',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'400','str',NULL,'left' UNION ALL 
												SELECT 18,'name','User Name','ro',NULL,'y','y',NULL,NULL,NULL,NULL,NULL,'350','str',NULL,'left' UNION ALL 
												SELECT 19,'parent_name','Function Name','tree',NULL,'y','y','1','n',NULL,NULL,NULL,'400',NULL,NULL,'left' UNION ALL 
												SELECT 19,'entity_subsidary','Subsidiary','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'200',NULL,NULL,'left' UNION ALL 
												SELECT 19,'functional_users_id','ID','ro',NULL,'y','y','2','y',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 19,'function_id','Function ID','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 19,'entity_book','Book','ro',NULL,'y','y','6','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 19,'entity_strategy','Strategy','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL
												SELECT 19,'tag1','Tag 1','ro',NULL,'y','y','7','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL
												SELECT 19,'tag2','Tag 2','ro',NULL,'y','y','8','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL
												SELECT 19,'tag3','Tag 3','ro',NULL,'y','y','9','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL
												SELECT 19,'tag4','Tag 4','ro',NULL,'y','y','10','n',NULL,NULL,NULL,'150',NULL,NULL,'left' UNION ALL 
												SELECT 18,'system_id','System ID','ro',NULL,'n','y',NULL,'n',NULL,NULL,NULL,'100',NULL,NULL,'left'
...
VALUES('10111100',
						...
						'y',
						'y',
						'application_security_role',
						NULL,
						'10111110',
						'10111111')
DECLARE @application_ui_template_id_new INT
			SET @application_ui_template_id_new = SCOPE_IDENTITY() 
	IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10111100') BEGIN 
	...
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				...
				VALUES('10111100','role_name','role_name','Role Name','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,'50')
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10111100','role_id','role_id','Role ID','input','int','h','n',NULL,NULL,'y','y',NULL,'n','n','n','n','y','y','n','y',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10111100','role_description','role_description','Role Description','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,'250')
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10111100','role_type_value_id','role_type_value_id','Role Type','combo','int','h','n','EXEC spa_role_user @flag=''t''',NULL,'n','n','4','y','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10111100','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
 END 
				...
				INSERT INTO #temp_old_template_group(group_name, group_description, active_flag, default_flag, sequence, inputWidth, field_layout, old_application_grid_id)
								...
								SELECT 'Privilege',NULL,'y','n','2',NULL,'1C',NULL
			...
			IF OBJECT_ID('tempdb..#temp_old_template_fieldsets') IS NOT NULL
				...
				IF OBJECT_ID('tempdb..#temp_old_template_fields') IS NOT NULL
					...
					INSERT INTO #temp_old_template_fields(old_field_id, old_group_id, old_application_ui_field_id, old_fieldset_id, group_name, ui_field_id, field_alias, Default_value, default_format, validation_flag, hidden, field_size, field_type, field_id, sequence, inputHeight, udf_template_id, udf_field_name, position, dependent_field, dependent_query, old_grid_id, validation_message)
								...
								SELECT 68796,12085,68591,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68797,12085,68587,NULL,'General','role_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68798,12085,68589,NULL,'General','role_description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68799,12085,68588,NULL,'General','role_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68800,12085,68590,NULL,'General','role_type_value_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68801,12086,68591,NULL,'Privilege','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
					...
					INSERT INTO #temp_old_ui_layout(old_layout_grid_id, old_group_id, group_name, layout_cell, old_grid_id, grid_name, sequence, num_column, cell_height,grid_object_name,grid_object_unique_column)
								...
								SELECT 10620,12085,'General','b','18','role_users',1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10621,12085,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10622,12086,'Privilege','a','19','application_privilege',2,NULL,NULL,NULL,NULL
