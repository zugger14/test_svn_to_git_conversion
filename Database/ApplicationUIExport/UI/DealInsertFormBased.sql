...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10131010' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10131010'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10131010' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10131010')
		BEGIN				
			...
			WHERE autd.application_function_id = '10131010'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '10131010'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '10131010'	

			DELETE FROM application_ui_filter WHERE application_function_id = '10131010'
			...
			WHERE application_function_id = '10131010'
		...
		SELECT 305,'select_template',NULL,NULL,'EXEC spa_deal_type_pricing_maping ''y''','Template','g',NULL,NULL,NULL,NULL
		...
		SELECT 305,'id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'template_id','Template ID','ro',NULL,'n','n','2','y',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'deal_type_id','Deal Type ID','ro',NULL,'n','n','3','y',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'commodity_id','Commodity ID','ro',NULL,'n','n','4','y',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'pricing_type_id','Pricing Type ID','ro',NULL,'n','n','5','y',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'term_type_id','Term Type ID','ro',NULL,'n','n','6','y',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'template_name','Template','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'200','str',NULL,'left' UNION ALL 
		SELECT 305,'deal_type_name','Deal Type','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'commodity','Commodity','ro',NULL,'n','n','9','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'pricing_type','Pricing Type','ro',NULL,'n','n','10','n',NULL,NULL,NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 305,'term_type','Term','ro',NULL,'n','n','11','n',NULL,NULL,NULL,'100','str',NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10131010') 
		BEGIN 
			...
			VALUES('10131010','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10131010','apply_filters','apply_filters','Apply Filters','combo','varchar','h','n','EXEC spa_application_ui_filter ''s'',''<ApplicationFilter application_group_id="<ID>"></ApplicationFilter>''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'Filters','Filters','y','y','0','0','1C',NULL
		...
		SELECT 58856,8771,58468,NULL,'Filters','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 7213,8771,'Filters','a','305','select_template',0,'0','0','selectTemplate.select_template','id'
