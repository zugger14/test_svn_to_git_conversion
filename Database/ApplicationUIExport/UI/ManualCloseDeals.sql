...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20013500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20013500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20013500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20013500')
		BEGIN				
			...
			WHERE autd.application_function_id = '20013500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20013500
		...
		SELECT 396,'grid_manual_close_deals_from',NULL,NULL,'EXEC spa_stmt_invoice @flag = ''a'', @invoice_id = ''<ID>''','Details','g',NULL,NULL,NULL,'0' UNION ALL SELECT 397,'grid_manual_close_deals_to',NULL,NULL,'EXEC spa_stmt_invoice @flag = ''a'', @invoice_id = ''<ID>''','Details','g',NULL,NULL,NULL,'0'
		...
		SELECT 396,'source_deal_detail_id','Deal Detail ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'deal_ref_id','Deal Ref ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'deal_date','Deal Date','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'100','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'term_start','Term Start','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'100','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'term_end','Term End','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'100','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'counterparty','Counterparty','ro',NULL,'y','y','6','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'location','Location','ro',NULL,'y','y','7','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'index','Index','ro',NULL,'y','y','8','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'uom','UOM','ro',NULL,'y','y','12','n',NULL,NULL,NULL,'100','str',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 396,'deal_id','Deal ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 396,'price','Price','ro_p',NULL,'y','y','13','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 396,'volume','Volume','ro_v',NULL,'y','y','9','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 396,'match_volume','Match Volume','ro_v',NULL,'y','y','10','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 396,'volume_left','Volume Left','ro_v',NULL,'y','y','11','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 397,'source_deal_detail_id','Deal Detail ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'deal_ref_id','Deal Ref ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'deal_date','Deal Date','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'100','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'term_start','Term Start','ro',NULL,'y','y','4','n',NULL,NULL,NULL,'100','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'term_end','Term End','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'100','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'counterparty','Counterparty','ro',NULL,'y','y','6','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'location','Location','ro',NULL,'y','y','7','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'index','Index','ro',NULL,'y','y','8','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'uom','UOM','ro',NULL,'y','y','12','n',NULL,NULL,NULL,'100','str',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 397,'deal_id','Deal ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 397,'price','Price','ro_p',NULL,'y','y','13','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 397,'volume','Volume','ro_v',NULL,'y','y','9','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 397,'match_volume','Match Volume','ro_v',NULL,'y','y','10','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 397,'volume_left','Volume Left','ro_v',NULL,'y','y','11','n',NULL,NULL,NULL,'100','int',NULL,'right', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20013500') 
		BEGIN 
			...
			VALUES('20013500','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','book_structure','book_structure','Book Structure','browser','varchar','h','y',NULL,'250','n','n',NULL,'y','n','n','n','n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','deal_type','deal_type','Deal Type','combo','int','h','y','exec spa_source_deal_type_maintain ''x''','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','tenor_from','tenor_from','Tenor From','calendar','date','h','y',NULL,'250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','tenor_to','tenor_to','Tenor To','calendar','date','h','y',NULL,'250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','margin_product','margin_product','Margin Product','combo','int','h','n','EXEC spa_StaticDataValues ''h'', ''108100''','250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','approach','approach','Approach','combo','int','h','y','EXEC spa_StaticDataValues ''h'', ''21100''','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','buy_sell','buy_sell','Buy/Sell','combo','char','h','y','SELECT ''b'' [id],''Buy'' [name] UNION SELECT ''s'',''Sell''','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','best_match_only','best_match_only','Best Match Only','checkbox','char','h','y',NULL,'250','n','n','y','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013500','perfect_volume_match','perfect_volume_match','Perfect Volume Match','checkbox','char','h','y',NULL,'250','n','n','y','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'3E',NULL
		...
		SELECT 114783,20002,113558,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114784,20002,113559,NULL,'General','book_structure',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,'book',NULL,NULL UNION ALL 
		SELECT 114785,20002,113560,NULL,'General','deal_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114786,20002,113561,NULL,'General','tenor_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114787,20002,113562,NULL,'General','tenor_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114788,20002,113563,NULL,'General','margin_product',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114789,20002,113564,NULL,'General','approach',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114790,20002,113565,NULL,'General','buy_sell',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114791,20002,113566,NULL,'General','best_match_only',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 114792,20002,113567,NULL,'General','perfect_volume_match',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22127,20002,'General','b','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22128,20002,'General','c','396','grid_manual_close_deals_from',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22129,20002,'General','c','397','grid_manual_close_deals_to',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20013500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20013500'  
							ELSE @db + '_UI_' + '20013500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20013500
