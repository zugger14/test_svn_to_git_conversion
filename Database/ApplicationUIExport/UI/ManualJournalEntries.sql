...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10237000' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10237000'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10237000' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10237000')
		BEGIN				
			...
			WHERE autd.application_function_id = '10237000'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10237000
		...
		SELECT 155,'ManualJournalEntriesDetail',NULL,NULL,'EXEC spa_manual_journal_entries @flag = ''t'', @manual_je_id=<ID>','Journal Entries Detail','g',NULL,'10237010','10237010',NULL
		...
		SELECT 155,'uom','UOM','combo','EXEC spa_getsourceuom @flag = ''s''','n','n','8','n',NULL,NULL,'n','150','str',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 155,'debit_amount','Dr. Amount','ed_no',NULL,'n','n','5','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 155,'credit_amount','Cr. Amount','ed_no',NULL,'n','n','6','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 155,'volume','Volume','ed_v',NULL,'n','n','7','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 155,'account_type_name','Account Name','ro',NULL,'n','n','3','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 155,'gl_account_number','GL Number','ro',NULL,'n','n','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 155,'manual_je_detail_id','Detail ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 155,'manual_je_id','ID','ro_int',NULL,'n','n','1','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 155,'gl_number_id','Account ID','ro_int',NULL,'n','n','2','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 155,'comment','Comment','txttxt',NULL,'n','n','9','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10237000') 
		BEGIN 
			...
			VALUES('10237000','','','','settings','',' ',' ','',NULL,'n','n','','y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','manual_je_id','manual_je_id','ID','input','int','h','y',NULL,NULL,'n','y',NULL,'n','n','n','n','n','y','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','as_of_date','as_of_date','As of Date','calendar','datetime','h','n',NULL,NULL,'n','n','getdate()','y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','book_id','book_id','Book','browser','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','dr_cr_match','dr_cr_match','Debit & Credit must match','checkbox','char','h','n',NULL,NULL,'n','n','y','n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','frequency','frequency','Frequency','combo','varchar','h','n','SELECT ''o'',''One Time'' UNION SELECT ''r'',''Reoccuring''',NULL,'n','n','o','y','n','y','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','until_date','until_date','End Date','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10237000','comment','comment','Comment','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n','3',NULL,NULL,NULL)
		...
		SELECT 116245,20208,115035,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116246,20208,115036,NULL,'General','manual_je_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116247,20208,115037,NULL,'General','as_of_date',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116248,20208,115038,NULL,'General','book_id',NULL,NULL,NULL,NULL,'n',NULL,'browser',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116249,20208,115039,NULL,'General','dr_cr_match',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116250,20208,115040,NULL,'General','frequency',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116251,20208,115041,NULL,'General','until_date',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116252,20208,115042,NULL,'General','comment',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22293,20208,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22294,20208,'General','b','155','ManualJournalEntriesDetail',3,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10237000'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10237000'  
							ELSE @db + '_UI_' + '10237000'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10237000
