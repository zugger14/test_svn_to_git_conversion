...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10101161' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10101161'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10101161' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10101161')
		BEGIN				
			...
			WHERE autd.application_function_id = '10101161'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10101161
		...
		SELECT 285,'DealConfirmationRule',NULL,NULL,'EXEC spa_deal_confirmation_rule @flag = ''a'', @counterparty_id = <ID>','Deal Confirmation Rule','g',NULL,NULL,NULL,NULL
		...
		SELECT 285,'rule_id','Rule','ro',NULL,'n','n','1','n',NULL,NULL,NULL,'90','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'legal_entity','Legal Entity','combo','EXEC spa_deal_confirmation_rule @flag=''z''','y','n','2','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'book','Book','combo','EXEC spa_GetAllSourceBookMapping NULL, NULL, ''s'', NULL','y','n','3','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'contract_id','Contract','combo','SELECT contract_id as value, contract_name as text from contract_group','y','n','4','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'counterparty2','Counterparty2','combo','EXEC [spa_getsourcecounterparty] ''s''','y','n','5','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'deal_type_id','Deal Type','combo','EXEC spa_getsourcedealtype @flag=''l''','y','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'deal_sub_type','Deal Sub Type','combo','EXEC spa_getsourcedealtype @flag=''g'',@sub_type=''y''','y','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'deal_template_id','Deal Template','combo',' EXEC spa_getDealTemplate ''S''','y','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'deal_group','Deal Group','ro',NULL,'y','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'commodity_id','Commodity','combo','EXEC spa_getsourceCommodity ''s''','y','y','10','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 285,'location_group','Location Group','combo','SELECT source_major_location_ID [value], location_name [text] FROM source_major_location','y','n','11','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'buy_sell_flag','BuySell','combo','SELECT ''B'' as [value],''Buy'' as [label] UNION SELECT ''S'' as [value],''Sell'' as [label] UNION SELECT ''A'' as [value],''All'' as [label]','y','y','16','n',NULL,NULL,NULL,'150','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 285,'confirm_template_id','Confirm template','combo','select template_id,template_name from contract_report_template where template_type=33','y','n','21','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'location','Location','combo','EXEC spa_source_minor_location ''o''','y','n','13','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'index_group','Index Group','combo','SELECT value_id, code FROM static_data_value where type_id = 15100','y','n','14','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'index_id','Index','combo','EXEC spa_GetAllPriceCurveDefinitions @flag=''a''','y','n','15','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'deal_status','Deal Status','combo','EXEC spa_StaticDataValues @flag=''h'', @type_id=5600','y','n','18','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'confirm_status','Confirm Status','combo','EXEC spa_get_confirm_status','y','n','17','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 285,'revision_confirm_template_id','Revision Confirm Template','combo','SELECT template_id, template_name FROM contract_report_template WHERE template_type = 4305','y','n','22','y',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10101161') 
		BEGIN 
			...
			VALUES('10101161','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 7893,15816,'General','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 92718,15816,91597,NULL,'General','',NULL,NULL,NULL,'y',NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 13723,15816,'General','a','285','DealConfirmationRule',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10101161'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10101161'  
							ELSE @db + '_UI_' + '10101161'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10101161
