...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20006200' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20006200'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20006200' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20006200')
		BEGIN				
			...
			WHERE autd.application_function_id = '20006200'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20006200
		...
		SELECT 370,'adiha_default_codes_values_grid',NULL,NULL,NULL,'Default Code Values','g','seq_no','20006201','20006202',NULL
		...
		SELECT 370,'description','Description','combo',NULL,'y','y','4','n',NULL,NULL,'n','550','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 370,'sequence_desc','Sequence Description','ed',NULL,'n','n','6','y',NULL,NULL,'n','146','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 370,'adiha_default_codes_values_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'n','50','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 370,'var_value','Value','ro',NULL,'n','n','5','n',NULL,NULL,'n','80','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 370,'default_code_id','Configuration ID','ro_int',NULL,'n','y','2','y','adiha_default_codes','default_code_id','n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 370,'seq_no','Sequence','ro_int',NULL,'n','n','3','n',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL
		...
		'Configuration Manager : Maintain Configuration',
		'y',
		'y',
		'adiha_default_codes',
		'n',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20006200') 
		BEGIN 
			...
			VALUES('20006200','','','','settings','',' ','n','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20006200','default_code_id','default_code_id','ID','input','int','h','n',NULL,NULL,'n','n',NULL,'y','n','n','n','y','y','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 116176,20196,114965,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116177,20196,114966,NULL,'General','default_code_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22279,20196,'General','a','370','adiha_default_codes_values_grid',1,'3',NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20006200'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20006200'  
							ELSE @db + '_UI_' + '20006200'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20006200
