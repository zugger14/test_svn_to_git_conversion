...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10162301' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10162301'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10162301' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10162301')
		BEGIN				
			...
			WHERE autd.application_function_id = '10162301'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '10162301'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '10162301'	

			DELETE FROM application_ui_filter WHERE application_function_id = '10162301'
			...
			WHERE application_function_id = '10162301'
		...
		SELECT 12,'source_minor_location',NULL,NULL,'EXEC spa_source_minor_location ''l''','Location','t','source_major_location_id',NULL,NULL,NULL
		...
		SELECT 12,'source_major_location_id','Location Group','tree',NULL,'y','y','1',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 12,'source_minor_location_id','ID','ro',NULL,'n','y','2','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
		SELECT 12,'location_name','Location Name','ro',NULL,'n','y','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 12,'term_pricing_index','Valuation Curve','ro',NULL,'n','y','5',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 12,'commodity_id','Commodity','ro',NULL,'n','y','4',NULL,NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 12,'is_active','Active','ro',NULL,'n','y','6','n',NULL,NULL,NULL,'150','str',NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10162301') 
		BEGIN 
			...
			VALUES('10162301','','','','settings','',' ',' ','','200','n','n','','n','n','n','n','y','n','n','n','0','','0')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','storage_asset_id','storage_asset_id','Storage Asset ID','input','int','h','n',NULL,'250','y','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','asset_name','asset_name','Asset Name','input','varchar','h','y',NULL,'250','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','asset_description','asset_description','Asset Description','input','varchar','h','y',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','commodity_id','commodity_id','Commodity','combo','int','h','n','SELECT source_commodity_id AS id, commodity_name AS VALUE  FROM source_commodity','250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','location_id','location_id','Location','combo','int','h','n','SELECT smlo.source_minor_location_id, CASE WHEN smlo.Location_Name <> smlo.location_id THEN smlo.location_id + '' - '' + smlo.Location_Name ELSE smlo.Location_Name END + CASE WHEN sml.location_name IS NULL THEN '''' ELSE  '' ['' + sml.location_name + '']'' END  [name]	FROM source_minor_location smlo  LEFT JOIN source_major_location sml ON  smlo.source_major_location_ID = sml.source_major_location_ID WHERE sml.location_name = ''Storage''','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','effective_date','effective_date','Effective Date','calendar','datetime','h','n',NULL,NULL,'n','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)

			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162301','capacity','capacity','Total Capacity','input','float','h','y',NULL,'250','y','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'Asset',NULL,'y','y','1',NULL,'2E',NULL UNION ALL SELECT 'Capacity',NULL,'y','n','2',NULL,'2E',NULL
		...
		SELECT 61718,9996,61419,NULL,'Asset','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61719,9996,61420,NULL,'Asset','storage_asset_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61720,9996,61421,NULL,'Asset','asset_name',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61721,9996,61422,NULL,'Asset','asset_description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61722,9996,61423,NULL,'Asset','commodity_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61723,9996,61424,NULL,'Asset','location_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61724,9997,61419,NULL,'Capacity','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 61725,9997,61425,NULL,'Capacity','effective_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL
		SELECT 61725,9997,61425,NULL,'Capacity','capacity',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 8347,9996,'Asset','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 8348,9996,'Asset','b','12','source_minor_location',1,NULL,NULL,NULL,NULL UNION ALL SELECT 8349,9997,'Capacity','a','12','source_minor_location',3,NULL,NULL,NULL,NULL
