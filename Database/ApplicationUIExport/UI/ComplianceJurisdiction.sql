...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '14100100' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '14100100'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '14100100' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '14100100')
		BEGIN				
			...
			WHERE autd.application_function_id = '14100100'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 14100100
		...
		SELECT 236,'state_rec_requirement_data',NULL,NULL,'EXEC spa_state_rec_requirement_data ''s'', ''<ID>''','Requirement','g',NULL,'14100101','14100102','0' UNION ALL SELECT 463,'tier_mapping',NULL,NULL,'EXEC spa_save_custom_form_data @flag = ''l'', @state_value_id = ''<ID>''','Tier Mapping ','g',NULL,'14100101','14100102','0'
		...
		SELECT 236,'from_year','From Year','combo','SELECT n + 1999 , n + 1999 FROM seq WHERE n < 102','n','y','4','n',NULL,NULL,NULL,'150','',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 236,'to_year','To Year','combo','SELECT n + 1999 , n + 1999 FROM seq WHERE n < 102','n','y','5','n',NULL,NULL,NULL,'150','',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 236,'assignment_priority','Assignment Priority','ro',NULL,'n','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 236,'state_value_id','State Value ID','ro',NULL,'n','y','1','y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 236,'state_rec_requirement_data_id','ID','ro_int',NULL,'n','y','0','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 236,'total_absolute_target','Total Absolute Target (MWh)','ro_no',NULL,'n','y','6','n',NULL,NULL,NULL,'150','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 236,'total_compliance_target','Total Compliance Target (%)','ro_no',NULL,'n','y','7','n',NULL,NULL,NULL,'150','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 463,'tier_id','Tier','combo','SELECT value_id, code FROM static_data_value AS sdv WHERE sdv.[type_id] = 15000','y','y','3','n',NULL,NULL,NULL,'150','','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 463,'technology_id','Technology','combo','SELECT value_id, code FROM static_data_value AS sdv WHERE sdv.[type_id] = 10009','y','y','4','n',NULL,NULL,NULL,'150','','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 463,'technology_subtype_id','Technology Sub Type','combo','SELECT value_id, code FROM static_data_value AS sdv WHERE sdv.[type_id] = 13000','y','n','5','n',NULL,NULL,NULL,'150','',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 463,'price_index','Price Index','combo','EXEC spa_GetAllPriceCurveDefinitions ''e''','y','n','6','n',NULL,NULL,NULL,'150','',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 463,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','7','n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 463,'banking_years','Banking Years','ed','SELECT value_id, code FROM static_data_value AS sdv WHERE sdv.[type_id] = 15000','y','n','8','n',NULL,NULL,NULL,'150','int','ValidNumericWithEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 463,'state_properties_details_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 463,'value_id','State Value Id','ro',NULL,'n','y','2','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '14100100') 
		BEGIN 
			...
			VALUES('14100100','','','','settings','',' ',' ','','150','n','n','','n','n','n','n','y','n','n','n','0','','0',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','state_value_id','state_value_id','Jurisdiction','input','varchar','h','y',NULL,NULL,'y','y',NULL,'n','n',NULL,NULL,'y','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','code','code','Code','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','description','description','Description','input','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','region_id','region_id','Region','browser','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','begin_date','begin_date','Program Beginning Date','calendar','date','h','y',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','program_scope','program_scope','Program Scope','combo','char','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 3100',NULL,'n','n','a','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','calendar_from_month','calendar_from_month','From Month','combo','int','h','y','EXEC spa_get_date_combo_values @flag =  ''f''',NULL,'n','n','1','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','calendar_to_month','calendar_to_month','To Month','combo','int','h','y','EXEC spa_get_date_combo_values @flag =  ''t''',NULL,'n','n','12','y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','current_next_year','current_next_year','Current/Next Year','combo','varchar','h','y','EXEC spa_get_date_combo_values @flag =  ''n''',NULL,'n','n',NULL,'y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('14100100','detail','detail','Detail','checkbox','char','h','y',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'2E',NULL UNION ALL SELECT 'Requirement',NULL,'y','n','2',NULL,'1C',NULL
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 9762,20194,'General','compliance_calendar_year',NULL,'n','n','500','500','Compliance Calendar Year',NULL,NULL,NULL,'800','1','3'
		...
		SELECT 116165,20194,114954,NULL,'General','',NULL,NULL,NULL,NULL,'y',NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116166,20194,114955,NULL,'General','state_value_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116167,20194,114956,NULL,'General','code',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116168,20194,114957,NULL,'General','description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116169,20194,114958,NULL,'General','region_id',NULL,NULL,NULL,NULL,'n',NULL,'browser',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,'browse_region_id',NULL,NULL UNION ALL 
		SELECT 116170,20194,114959,NULL,'General','begin_date',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116171,20194,114960,NULL,'General','program_scope',NULL,'3104',NULL,NULL,'n',NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116172,20194,114961,'9762','General','calendar_from_month',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116173,20194,114962,'9762','General','calendar_to_month',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116174,20194,114963,'9762','General','current_next_year',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116175,20194,114964,NULL,'General','detail',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22276,20194,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22277,20194,'General','b','463','tier_mapping',2,NULL,NULL,NULL,NULL UNION ALL SELECT 22278,20195,'Requirement','a','236','state_rec_requirement_data',3,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='14100100'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '14100100'  
							ELSE @db + '_UI_' + '14100100'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 14100100
