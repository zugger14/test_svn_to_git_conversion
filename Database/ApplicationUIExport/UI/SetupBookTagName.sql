...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20010500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20010500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20010500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20010500')
		BEGIN				
			...
			WHERE autd.application_function_id = '20010500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20010500
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20010500') 
		BEGIN 
			...
			VALUES('20010500','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','tag1','tag1','Tag 1','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','tag2','tag2','Tag 2','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','tag3','tag3','Tag 3','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','tag4','tag4','Tag 4','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','reporting_group1','reporting_group1','Reporting Group 1','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','reporting_group2','reporting_group2','Reporting Group 2','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','reporting_group3','reporting_group3','Reporting Group 3','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','reporting_group4','reporting_group4','Reporting Group 4','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010500','reporting_group5','reporting_group5','Reporting Group 5','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n',' ',' ',' ',NULL,NULL,NULL)
		...
		SELECT 8326,17698,'General','tag',NULL,'n','n',NULL,NULL,'Book Identifier',NULL,NULL,NULL,NULL,'1',NULL UNION ALL 
		SELECT 8327,17698,'General','reporting_group',NULL,'n','n',NULL,NULL,'Reporting Group',NULL,NULL,NULL,NULL,'2',NULL
		...
		SELECT 105506,17698,104297,NULL,'General','',NULL,NULL,NULL,NULL,'n','200','settings',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105507,17698,104298,'8326','General','tag1',NULL,NULL,NULL,NULL,'n','200','input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105508,17698,104299,'8326','General','tag2',NULL,NULL,NULL,NULL,'n','200','input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105509,17698,104300,'8326','General','tag3',NULL,NULL,NULL,NULL,'n','200','input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105510,17698,104301,'8326','General','tag4',NULL,NULL,NULL,NULL,'n','200','input',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105511,17698,104302,'8327','General','reporting_group1',NULL,NULL,NULL,NULL,'n','200','input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105512,17698,104303,'8327','General','reporting_group2',NULL,NULL,NULL,NULL,'n','200','input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105513,17698,104304,'8327','General','reporting_group3',NULL,NULL,NULL,NULL,'n','200','input',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105514,17698,104305,'8327','General','reporting_group4',NULL,NULL,NULL,NULL,'n','200','input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 105515,17698,104306,'8327','General','reporting_group5',NULL,NULL,NULL,NULL,'n','200','input',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20010500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20010500'  
							ELSE @db + '_UI_' + '20010500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20010500
