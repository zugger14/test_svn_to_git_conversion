...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20008100' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20008100'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20008100' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20008100')
		BEGIN				
			...
			WHERE autd.application_function_id = '20008100'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '20008100'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '20008100'	

			DELETE FROM application_ui_filter WHERE application_function_id = '20008100'
			...
			WHERE application_function_id = '20008100'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20008100') 
		BEGIN 
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20008100'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
