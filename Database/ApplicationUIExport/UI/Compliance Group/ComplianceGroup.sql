...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20004800' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20004800'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20004800' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20004800')
		BEGIN				
			...
			WHERE autd.application_function_id = '20004800'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '20004800'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '20004800'	

			DELETE FROM application_ui_filter WHERE application_function_id = '20004800'
			...
			WHERE application_function_id = '20004800'
		...
		SELECT 5292,'compliance_group','static_data_value','value_id','SELECT compliance_group_id,logical_name,cg.assignment_type,cg.assigned_state,cg.compliance_year,cg.commit_type FROM compliance_group AS cg WHERE cg.logical_name = <ID>','Compliance Group','g',NULL,20004801,20004802,NULL		
		...
		SELECT 5292,'compliance_group_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','200',NULL,NULL,'left' UNION ALL  		
		SELECT 5292,'logical_name','System ID','ro',NULL,'n','y','2','y','static_data_value','value_id',NULL,'200',NULL,NULL,'left' UNION ALL  
		SELECT 5292,'assignment_type','Assignment Type','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10013','y','y','3',NULL,NULL,NULL,NULL,'200',NULL,'NotEmpty','left' UNION ALL  
		SELECT 5292,'assigned_state','Assignment State','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10002','y','y','4',NULL,NULL,NULL,NULL,'200',NULL,'NotEmpty','left' UNION ALL 
		SELECT 5292,'compliance_year','Compliance Year','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10092','y','y','5',NULL,NULL,NULL,NULL,'200',NULL,'NotEmpty','left' UNION ALL 
		SELECT 5292,'commit_type','Commit Type','combo','SELECT ''a'' AS [value], ''Aggregate'' AS [option] UNION ALL SELECT ''d'' AS [value], ''Detail'' AS [option] ORDER BY [option]','y','y','6',NULL,NULL,NULL,NULL,'200',NULL,'NotEmpty','left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20004800') 
		BEGIN 
			...
			VALUES('20004800','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20004800','value_id','value_id','System ID','input','int','h','n',NULL,NULL,'y','n',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20004800','code','code','Code','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20004800','description','description','Description','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n','5',NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20004800','type_id','type_id','Data Type','combo','int','h','n','select type_id,type_name from static_data_type where type_id = 28000',NULL,'y','n',NULL,'n','n','n','n','n','h','n','n',NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'Group',NULL,'y','n','2',NULL,'1C',NULL
		...
		SELECT 99029,27483,98872,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99030,27483,98873,NULL,'General','value_id',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99031,27483,98874,NULL,'General','code',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99032,27483,98875,NULL,'General','description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99033,27483,98876,NULL,'General','type_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 25541,27483,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 25542,27484,'Group','a','5292','compliance_group',2,NULL,NULL,NULL,NULL
