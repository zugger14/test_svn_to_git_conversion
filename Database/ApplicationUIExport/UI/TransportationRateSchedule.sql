...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10162000' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10162000'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10162000' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10162000')
		BEGIN				
			...
			EXEC spa_application_ui_template 'd', 10162000
		...
		UNION ALL SELECT 271,'variable_charge',NULL,NULL,'EXEC spa_transportation_rate_schedule @flag=''v'', @for=''s'',@rate_schedule_id =<ID>','Variable Charge','g',NULL,'20008900','20008900',NULL
		...
		INSERT INTO #temp_all_grids_columns(old_grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
		
		SELECT 76,'id','Rate ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','100','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'rate_schedule_id','Rate Schedule ID','ro',NULL,'n','y','2','y','transportation_rate_category','value_id',NULL,'100','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'rate_type_id','Charge Type','combo','SELECT sdv.value_id, sdv.code FROM   static_data_value sdv INNER JOIN user_defined_fields_template udft ON  sdv.value_id = udft.field_name INNER JOIN static_data_value AS sdv2 ON udft.udf_category = sdv2.value_id WHERE  sdv.TYPE_ID = 5500 AND sdv2.value_id=101900','y','y','3','n',NULL,NULL,NULL,'175','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 76,'zone_from','Zone From','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','n','4','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'zone_to','Zone To','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','n','5','n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'begin_date','Begin Date','dhxCalendarA',NULL,'y','y','6','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'end_date','End Date','dhxCalendarA',NULL,'y','y','7','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'effective_date','Effective Date','dhxCalendarA',NULL,'y','n','8','y',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'rate','Rate','ed',NULL,'y','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'rate_granularity','Rate Granularity','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 106200','y','n','10','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'formula_id','Formula ID','ro',NULL,'y','y','11','y',NULL,NULL,NULL,'200',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'formula_name','Formula','ro',NULL,'y','y','12','n',NULL,NULL,NULL,'200',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'currency_id','Currency','combo','SELECT source_currency_id, currency_name  FROM source_currency','y','y','13','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'uom_id','UOM','combo','SELECT source_uom_id, uom_id uom_name  FROM source_uom','y','n','14','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'billing_frequency','Billing Frequency','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 106300','y','n','15','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'payment_date','Payment Date','dhxCalendarA',NULL,'y','y','16','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'payment_calendar','Payment Calendar','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 10017','y','n','17','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'settlement_date','Settlement Date','dhxCalendarA',NULL,'y','y','18','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'settlement_calendar','Settlement Calendar','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 10017','y','n','19','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'rate_schedule_type','Rate Schedule Type','ro',NULL,'n','n','20','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		
		SELECT 76,'counterparty_id','Counterparty','combo','EXEC spa_source_counterparty_maintain ''c''','y','n','21','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL
		SELECT 76,'contract_id','Contract','combo','EXEC spa_contract_group ''r''','y','n','22','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 76,'rec_pay','Rec/Pay','combo','SELECT ''r'' [value], ''Receive'' [name] UNION ALL SELECT ''p'', ''Pay''','y','n','24','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n'   UNION ALL 

		SELECT 271,'id','Rate ID','ro',NULL,'y','y','1','y',NULL,NULL,'y','175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'rate_schedule_id','Rate Schedule ID','ro',NULL,'y','y','2','y','transportation_rate_category','value_id',NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'rate_type_id','Charge Type','combo','SELECT sdv.value_id, sdv.code FROM   static_data_value sdv INNER JOIN user_defined_fields_template udft ON  sdv.value_id = udft.field_name INNER JOIN static_data_value AS sdv2 ON udft.udf_category = sdv2.value_id WHERE  sdv.TYPE_ID = 5500 AND sdv2.value_id=101901','y','y','3','n',NULL,NULL,NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'zone_from','Zone From','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','n','4','y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'zone_to','Zone To','combo','SELECT value_id, code FROM static_data_value WHERE type_id=18000','y','n','5','y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'begin_date','Begin Date','dhxCalendarA',NULL,'y','y','6','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'end_date','End Date','dhxCalendarA',NULL,'y','y','7','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'effective_date','Effective Date','dhxCalendarA',NULL,'y','n','8','y',NULL,NULL,NULL,'125',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'rate','Rate','ed',NULL,'y','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'rate_granularity','Rate Granularity','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 106200','y','n','10','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'formula_id','ID','ro',NULL,'y','y','11','y',NULL,NULL,NULL,'200',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'formula_name','Formula','ro',NULL,'y','y','12','n',NULL,NULL,NULL,'200',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'currency_id','Currency','combo','SELECT source_currency_id, currency_name  FROM source_currency','y','y','13','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'uom_id','UOM','combo','SELECT source_uom_id, uom_id uom_name  FROM source_uom','y','n','14','n',NULL,NULL,NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'billing_frequency','Billing Frequency','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 106300','y','n','15','n',NULL,NULL,NULL,'175','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'payment_date','Payment Date','dhxCalendarA',NULL,'y','y','16','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'payment_calendar','Payment Calendar','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 10017','y','n','17','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'settlement_date','Settlement Date','dhxCalendarA',NULL,'y','y','18','n',NULL,NULL,NULL,'125','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'settlement_calendar','Settlement Calendar','combo','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 10017','y','n','19','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 271,'rate_schedule_type','Rate Schedule Type','ro',NULL,'n','n','20','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
		
		SELECT 271,'counterparty_id','Counterparty','combo','EXEC spa_source_counterparty_maintain ''c''','y','n','21','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL
		SELECT 271,'contract_id','Contract','combo','EXEC spa_contract_group ''r''','y','n','22','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL
		SELECT 271,'rec_pay','Rec/Pay','combo','SELECT ''r'' [value], ''Receive'' [name] UNION ALL SELECT ''p'', ''Pay''','y','n','24','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n'  
		...
		VALUES('10162000',
		'maintain_transportation_rate_schedule',
		'Transportaion Rate Schedule',
		'y',
		'y',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10162000') 
		BEGIN 
			...
			VALUES('10162000','','','','settings','',' ',' ','','250','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','value_id','value_id','ID','input','int','h','n',NULL,'250','n','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','code','code','Name','input','varchar','h','y',NULL,'250','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','description','description','Description','input','varchar','h','n',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','type_id','type_id','type_id','input','int','h','n',NULL,'250','n','y','1800','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','rate_category','rate_category','Rate Category','combo','int','h','n','EXEC spa_StaticDataValues ''e'', 45200','250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','pipeline','pipeline','Provider','combo','int','h','n','EXEC spa_source_counterparty_maintain @flag = ''y'', @type_of_entity= ''301994''','250','n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10162000','contract_type','contract_type','Contract Type','input','char','h','n',NULL,'250','n','y','t','n','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 3754,9837,'Rate Schedule','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,'100',NULL,'1'
		...
		SELECT 67955,9837,67247,NULL,'Rate Schedule','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67956,9837,67248,NULL,'Rate Schedule','value_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67957,9837,67249,NULL,'Rate Schedule','code',NULL,NULL,NULL,'y',NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67958,9837,67250,NULL,'Rate Schedule','description',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67959,9837,67251,NULL,'Rate Schedule','type_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67960,9837,67252,NULL,'Rate Schedule','rate_category',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67961,9837,67253,NULL,'Rate Schedule','pipeline',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67962,9837,67254,NULL,'Rate Schedule','contract_type',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 8162,9837,'Rate Schedule','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 8163,9837,'Rate Schedule','b','76','transportation_rate_schedule',1,NULL,NULL,NULL,NULL UNION ALL SELECT 8164,9837,'Rate Schedule','c','271','variable_charge',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10162000'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10162000'  
							ELSE @db + '_UI_' + '10162000'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10162000
