...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20001200' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20001200'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20001200' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20001200')
		BEGIN				
			...
			WHERE autd.application_function_id = '20001200'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20001200
		...
		SELECT 322,'product','Product','combo','EXEC spa_staticDataValues @flag=''h'', @type_id=39800','y','n','12','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 322,'jurisdiction','Jurisdiction','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10002','y','n','13','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 322,'tier','Tier','combo','EXEC spa_staticDataValues @flag=''h'', @type_id=15000','y','n','14','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 322,'type','Type','combo','EXEC spa_setup_fees_grid_data @flag=''t''','y','n','15','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		...
		SELECT 322,'from_volume','From Volume','ed_v',NULL,'y','n','16','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 322,'to_volume','To Volume','ed_v',NULL,'y','n','17','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 322,'volume_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 322,'source_fee_id','Source ID','ro',NULL,'y','n','2','y',NULL,NULL,'n','150','int',NULL,'left', NULL,'n',NULL UNION ALL
       SELECT 322,'aggressor_initiator','Aggressor/Initiator','combo','SELECT ''a'' [value], ''Aggressor'' [name] UNION ALL SELECT ''i'', ''Initiator''','y','n','22','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL 
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20001200') 
		BEGIN 
			...
			VALUES('20001200','','','','settings','',' ',' ','','0','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20001200','source_fee_id','source_fee_id','Source Fee ID','input','int','h','n',NULL,'230','y','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20001200','counterparty','counterparty','Counterparty/Broker','combo','int','h','y','EXEC spa_source_counterparty_maintain @flag=''c''','230','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20001200','contract','contract','Contract','combo','int','h','y','EXEC spa_setup_fees_grid_data @flag=''a''','230','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20001200','fees','fees','Fees','combo','int','h','n','EXEC spa_setup_fees_grid_data @flag=''z''','230','n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20001200','fee_name','fee_name','Fee Name','input','varchar','h','n',NULL,'230','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y',NULL,NULL,'2E',NULL UNION ALL SELECT 'Product',NULL,'n','n',NULL,NULL,'1C',NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20001200'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20001200'  
							ELSE @db + '_UI_' + '20001200'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20001200
