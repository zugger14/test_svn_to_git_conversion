...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20010800' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20010800'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20010800' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20010800')
		BEGIN				
			...
			WHERE autd.application_function_id = '20010800'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '20010800'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '20010800'	

			DELETE FROM application_ui_filter WHERE application_function_id = '20010800'
			...
			WHERE application_function_id = '20010800'
		...
		SELECT 178,'process_margin_detail',NULL,NULL,'EXEC spa_margin_analysis @flag=''m'', @process_margin_header_id = <ID>','Process Margin Detail',NULL,NULL,'20010801','20010802','0'
		...
		SELECT 178,'process_margin_detail_id','Process Margin Detail ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','180','str',NULL,'left' UNION ALL 
		SELECT 178,'process_margin_header_id','Process Margin Header ID','ro',NULL,'n','n','2','y','process_margin_header','process_margin_header_id',NULL,'180','str',NULL,'left' UNION ALL 
		SELECT 178,'effective_date','Effective Date','dhxCalendarA',NULL,'n','n','3','n',NULL,NULL,NULL,'150','date',NULL,'left' UNION ALL 
		SELECT 178,'initial_margin','Initial Margin','ed_no',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'initial_margin_per','Initial Margin %','ed_no',NULL,'n','n','5','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'maintenance_margin','Maintenance Margin','ed_no',NULL,'n','n','6','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'maintenance_margin_per','Maintenance Margin %','ed_no',NULL,'n','n','7','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'currency_id','Currency','combo','SELECT source_currency_id, currency_id from source_currency','n','n','8','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'lot_size','Lot Size','ed_no',NULL,'n','n','9','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'uom_id','Uom','combo','select source_uom_id, uom_id from source_uom','n','n','10','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 178,'post_rec_threshold','Threshold','ed_no',NULL,'n','n','11','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL
		SELECT 178,'rounding','Rounding','ed_no',NULL,'n','n','12','n',NULL,NULL,NULL,'150','str',NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20010800') 
		BEGIN 
			...
			VALUES('20010800','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,'','0')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010800','process_margin_header_id','process_margin_header_id','System ID','input','int','h','n',NULL,NULL,'y','n',NULL,'n','n','n','n','y','y','n','y',NULL,'','0')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010800','counterparty_id','counterparty_id','Counterparty','combo','int','h','n','EXEC spa_source_counterparty_maintain ''c''',NULL,'n','n','','n','n','n','n','n','n','n','n',NULL,'','0')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010800','contract_id','contract_id','Contract','combo','int','h','n','EXEC spa_contract_group ''r''',NULL,'n','n','','n','n','n','n','n','n','n','n',NULL,'','0')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010800','product_id','product_id','Product','combo','int','h','n','EXEC spa_StaticDataValues @flag=''h'', @type_id=''108100''',NULL,'n','n','','n','n','n','n','n','n','n','n',NULL,'','0')
		...
		SELECT 67129,10708,66805,NULL,'General','',NULL,'','',' ',' ',NULL,'settings',NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,'','' UNION ALL 
		SELECT 67130,10708,66806,NULL,'General','process_margin_header_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67131,10708,66807,NULL,'General','counterparty_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67132,10708,66808,NULL,'General','contract_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 67133,10708,66809,NULL,'General','product_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 8951,10708,'General','a','FORM',NULL,1,NULL,'120',NULL,NULL UNION ALL SELECT 8952,10708,'General','b','178','SetupRuleEvents',2,NULL,NULL,NULL,NULL
