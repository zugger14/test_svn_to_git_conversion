...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20006800' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20006800'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20006800' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20006800')
		BEGIN				
			...
			WHERE autd.application_function_id = '20006800'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '20006800'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '20006800'	

			DELETE FROM application_ui_filter WHERE application_function_id = '20006800'
			...
			WHERE application_function_id = '20006800'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20006800') 
		BEGIN 
			...
			VALUES('20006800','data_type','data_type','Data Type','combo','int','h','y','EXEC spa_StaticDataValues ''h'', 2150','230','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20006800','as_of_date_from','as_of_date_from','As of Date From','calendar','date','h','y',NULL,'230','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20006800','as_of_date_to','as_of_date_to','As of Date To','calendar','date','h','y',NULL,'230','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			--INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			--OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			--INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			--VALUES('20006800','data_location_left','data_location_left','Data Location Left','combo','int','h','y',NULL,'230','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			--INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			--OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			--INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			--VALUES('20006800','data_location_right','data_location_right','Data Location Right','combo','int','h','y',NULL,'230','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 58364,8710,57981,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 58365,8710,57982,NULL,'General','data_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 58366,8710,57983,NULL,'General','as_of_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 58367,8710,57984,NULL,'General','as_of_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL --UNION ALL 
		--SELECT 58368,8710,57985,NULL,'General','data_location_left',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		--SELECT 58369,8710,57986,NULL,'General','data_location_right',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 7165,8710,'General','a','FORM',NULL,1,'3',NULL,NULL,NULL
