...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20013700' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20013700'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20013700' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20013700')
		BEGIN				
			...
			WHERE autd.application_function_id = '20013700'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20013700
		...
		SELECT 409,'WorkflowMessageTag','workflow_message_tag','workflow_message_tag_id','EXEC spa_workflow_module_event_mapping ''''s'''',@module_id = <ID>','Workflow Message Tag','g',NULL,'20013701','20013702',NULL UNION ALL SELECT 410,'RuleTableMapping','workflow_module_rule_table_mapping','mapping_id','EXEC spa_workflow_module_event_mapping ''''b'''',@module_id = <ID>','Rule Table Mapping','g',NULL,'20013701','20013702',NULL UNION ALL SELECT 411,'ModuleMapping','workflow_module_event_mapping','mapping_id','EXEC spa_workflow_module_event_mapping ''''a'''',@module_id = <ID>','Module Mapping','g',NULL,'20013701','20013702',NULL UNION ALL SELECT 418,'WorkflowContacts','workflow_contacts','workflow_contacts_id','EXEC spa_workflow_module_event_mapping ''''e'''',@module_id = <ID>','Workflow Contacts','g',NULL,'20013701','20013702',NULL
		...
		SELECT 409,'workflow_message_tag_id','Workflow Message Tag ID','ro',NULL,'n','n','1','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 409,'workflow_message_tag_name','Tag Name','ed',NULL,'n','y','2','n',NULL,NULL,'n','200','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 409,'workflow_message_tag','Tag','txttxt',NULL,'n','y','3','n',NULL,NULL,'n','250','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 409,'workflow_tag_query','Tag Query','txttxt',NULL,'n','y','4','n',NULL,NULL,'n','300','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 409,'is_hyperlink','Is Hyperlink','ch',NULL,'n','y','5','n',NULL,NULL,'n','150','str','NotEmpty','center', NULL,'n' UNION ALL 
		SELECT 409,'system_defined','System Defined','ch',NULL,'n','y','7','n',NULL,NULL,'n','150','str','NotEmpty','center', NULL,'n' UNION ALL 
		SELECT 409,'application_function_id','Function ID','txttxt',NULL,'n','n','6','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 410,'mapping_id','Mapping ID','ro',NULL,'n','n','1','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 410,'rule_table_id','Data Source Table','combo','EXEC spa_workflow_module_event_mapping @flag = ''r''','n','y','2','n',NULL,NULL,'n','150','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 410,'data_source_id','Data Source','combo','EXEC spa_workflow_module_event_mapping @flag = ''u''','n','n','4','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 410,'is_action_view','Action View','ch',NULL,'n','n','5','n',NULL,NULL,'n','150','int',NULL,'center', NULL,'n' UNION ALL 
		SELECT 410,'primary_column','Data Source Primary column','ed',NULL,'n','n','6','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 410,'is_active','Active/Inactive','ch',NULL,'n','n','3','n',NULL,NULL,'n','150','int',NULL,'center', NULL,'n' UNION ALL 
		SELECT 411,'mapping_id','Mapping ID','ro',NULL,'n','n','1','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 411,'event_id','Event','combo','EXEC spa_staticDataValues @flag = ''h'', @type_id = ''20500''','n','y','2','n',NULL,NULL,'n','220','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 411,'is_active','Active/Inactive','ch',NULL,'n','y','3','n',NULL,NULL,'n','150','int',NULL,'center', NULL,'n' UNION ALL 
		SELECT 418,'workflow_contacts_id','Workflow Contacts ID','ro',NULL,'n','n','1','y',NULL,NULL,'n','150','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 418,'email_group','Email Group','ed',NULL,'n','n','2','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 418,'email_group_query','Email Group Query','txttxt',NULL,'n','n','3','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 418,'group_type','Email/CC/BCC','combo','EXEC spa_workflow_module_event_mapping @flag = ''c''','n','y','4','n',NULL,NULL,'n','200','str','NotEmpty','left', NULL,'n' UNION ALL 
		SELECT 418,'email_address_query','Email Query','txttxt',NULL,'n','y','5','n',NULL,NULL,'n','300','str','NotEmpty','left', NULL,'n'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20013700') 
		BEGIN 
			...
			VALUES('20013700','','','','settings','',' ',' ',NULL,'180','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20013700','module_name','module_name','Module','input','int','h','y',NULL,NULL,'y','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'3U',NULL UNION ALL 
		SELECT 'Workflow Contact',NULL,'y',NULL,2,NULL,'1C',NULL
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 7717,15111,'General','Module Mapping',NULL,'n','n','500','500','Module Mapping',NULL,NULL,NULL,'470','1','2'
		...
		SELECT 88279,15111,87162,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 88280,15111,87163,'7717','General','module_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 13015,15111,'General','a','411','ModuleMapping',1,NULL,NULL,'ModuleMapping','mapping_id' 
		UNION ALL SELECT 13016,15111,'General','b','410','RuleTableMapping',2,NULL,NULL,'RuleTableMapping','mapping_id' 
		UNION ALL SELECT 13017,15111,'General','c','409','WorkflowMessageTag',3,NULL,NULL,'WorkflowMessageTag','workflow_message_tag_id' 
		UNION ALL SELECT 13018,15112,'Workflow Contact','a','418','WorkflowContacts',1,NULL,NULL,'WorkflowContacts','workflow_contacts_id'
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20013700'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20013700'  
							ELSE @db + '_UI_' + '20013700'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20013700
