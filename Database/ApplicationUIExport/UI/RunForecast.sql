...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10167400' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10167400'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10167400' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10167400')
		BEGIN				
			...
			WHERE autd.application_function_id = '10167400'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10167400
		...
		SELECT 213,'forecast_parameters_mapping',NULL,NULL,NULL,NULL,'t','forecast_mapping_type,forecast_mapping_name','10167210','10167211',NULL
		...
		SELECT 213,'source','Source','ro',NULL,'n','n','3',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 213,'approval_required','Approval Required','ro',NULL,'n','n','4',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 213,'active','Active','ro',NULL,'n','n','5',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 213,'forecast_mapping_id','forecast_mapping_id','ro_int',NULL,'n','n','2','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 213,'forecast_mapping_name','Type/Mapping Name','tree',NULL,'n','n','1',NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10167400') 
		BEGIN 
			...
			VALUES('10167400','','','','settings','',' ',' ','','189','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10167400','date_from','date_from','Date From','calendar','date','h','n',NULL,'189','n','n',NULL,'n','n','n','y','n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10167400','date_to','date_to','Date To','calendar','date','h','n','','189','n','n',NULL,'n','n','n','y','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10167400','status','status','Status','combo','int','h','n','SELECT '''' [id], '''' [code] UNION ALL SELECT ''a'' [id], ''Approved'' [code] UNION ALL SELECT ''u'' [id], ''Unapproved''','189','n','n','u','n','n','n','y','n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 112910,19722,111691,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112911,19722,111692,NULL,'General','date_from',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112912,19722,111693,NULL,'General','date_to',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 112913,19722,111694,NULL,'General','status',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21812,19722,'General','a','FORM',NULL,1,'4',NULL,NULL,NULL UNION ALL SELECT 21813,19722,'General','b','213','forecast_parameters_mapping',2,'4',NULL,'run_forecasting.run_forecasting_grid','forecast_mapping_id'
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10167400'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10167400'  
							ELSE @db + '_UI_' + '10167400'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10167400
