...
BEGIN
			...
			IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10104900')
			BEGIN
				...
				WHERE aut.application_function_id = '10104900'
				...
				WHERE application_function_id = '10104900'
...
DECLARE @application_ui_template_id_new INT
	...
	IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10104900') BEGIN 
