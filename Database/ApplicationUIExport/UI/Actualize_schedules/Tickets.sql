...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10166600' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10166600'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10166600' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10166600')
		BEGIN				
			...
			WHERE autd.application_function_id = '10166600'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10166600
		...
		SELECT 171,'ticket_event',NULL,NULL,'EXEC [spa_ticket] @flag=''e'', @ticket_header_id=<ID>','Ticket Event','g',NULL,NULL,NULL,NULL UNION ALL SELECT 250,'TicketDetail',NULL,NULL,'EXEC spa_ticket @flag = ''s'', @ticket_header_id=<ID>','Ticket Detail','g',NULL,NULL,NULL,NULL UNION ALL SELECT 357,'ticket_cost',NULL,NULL,'EXEC [spa_ticket] @flag=''c'', @ticket_header_id=<ID>','Ticket Cost','g',NULL,NULL,NULL,NULL
		...
		SELECT 171,'event_type','Event Type','combo','select value_id, code  from static_data_value where type_id = 37800','y','y',NULL,'n',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 171,'event_date','Event Date','dhxCalendarDT',NULL,'y','n',NULL,'n',NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 171,'ticket_event_id','ID','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 171,'ticket_header_id','Ticket Header ID','ro',NULL,'n','n',NULL,'y',NULL,NULL,NULL,'150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'ticket_detail_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','80','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'line_item','Line Item','ro',NULL,'n','y','2','n',NULL,NULL,'n','80','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'location_id','Title Transfer Location','ro',NULL,'n','y','3','n',NULL,NULL,'n','140','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'movement_date_time','Movement Date/Time','ro',NULL,'n','y','4','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'automatch_status','Automatch Status','ro',NULL,'n','y','5','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'gross_quantity','Gross Quantity','ro',NULL,'n','y','6','n',NULL,NULL,'n','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'net_quantity','Net Quantity','ro',NULL,'n','y','7','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'quantity_uom','Quantity UOM','ro',NULL,'n','y','8','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'gross_weight','Gross Weight','ro',NULL,'n','y','9','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'net_weight','Net Weight','ro',NULL,'n','y','10','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'weight_uom','Weight UOM','ro',NULL,'n','y','11','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'commodity','Commodity','ro',NULL,'n','y','12','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 250,'destination','Destination','ro',NULL,'n','y','13','n',NULL,NULL,'n','100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'cost_name','Cost','combo','SELECT udf_template_id AS [id],field_label AS [value] FROM user_defined_fields_template ORDER BY Field_label','y','y',NULL,NULL,'4','n',NULL,'150','str','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 357,'currency_id','Currency','combo','EXEC spa_getcurrencyunit ''s''','n','n',NULL,NULL,'6','n',NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'uom_id','UOM','combo','EXEC spa_getsourceuom ''s''','n','n',NULL,NULL,'7','n',NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'counterparty_id','Counterparty','combo','EXEC spa_getsourcecounterparty ''s''','n','n',NULL,NULL,'8','n',NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'contract_id','Contract','combo','EXEC spa_contract_group ''r''','n','n',NULL,NULL,'9','n',NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'receive_pay','Rec/Pay','combo','SELECT ''r'' [id], ''Receive'' [value] UNION ALL SELECT ''p'', ''Pay''','n','n',NULL,NULL,'10','n',NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'udf_value','Value','ed_no',NULL,'y','n',NULL,NULL,'5','n',NULL,'150','int','ValidNumeric','left', NULL,'n',NULL UNION ALL 
		SELECT 357,'cost_id','Cost ID','ro',NULL,'n','y',NULL,'y','1','y',NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'ticket_header_id','Ticket Header ID','ro',NULL,'n','y',NULL,'y','1','y',NULL,'80','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 357,'internal_field_type','Charge Type','ro',NULL,'n','y',NULL,NULL,'3','n',NULL,'150','str',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10166600') 
		BEGIN 
			...
			VALUES('10166600','','','','settings','',' ',' ','','200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_header_id','ticket_header_id','ID','input','varchar','h','n',NULL,'250','y','n',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_number','ticket_number','Ticket Number','input','varchar','h','y',NULL,'250','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_issuer','ticket_issuer','Ticket Issuer','combo','int','h','y','EXEC spa_getsourcecounterparty ''s''','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','issued_date','issued_date','Issued Date','calendar','datetime','h','y',NULL,'250','n','n','GETDATE()','y','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_id','ticket_id','Ticket ID','input','varchar','h','y',NULL,'250','n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_type','ticket_type','Ticket Type','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 39200','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_template','ticket_template','Ticket Template','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 100100','250','n','n','100101','y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','update_user','update_user','Last Changed By','input','varchar','h','y',NULL,'250','y','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','update_ts','update_ts','Changed On','input','varchar','h','y',NULL,'250','y','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10166600','ticket_template','ticket_template','Ticket Template','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 100100','250','n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'Detail',NULL,'y','n','2',NULL,'1C',NULL UNION ALL SELECT 'Event',NULL,'y','n','3',NULL,'1C',NULL UNION ALL SELECT 'Cost',NULL,'y','n','4',NULL,'1C',NULL
		...
		SELECT 117431,20375,116195,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117432,20375,116196,NULL,'General','ticket_header_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117433,20375,116197,NULL,'General','ticket_number',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117434,20375,116198,NULL,'General','ticket_issuer',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117435,20375,116199,NULL,'General','issued_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117436,20375,116200,NULL,'General','ticket_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117437,20375,116201,NULL,'General','ticket_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117438,20375,116202,NULL,'General','ticket_template',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117439,20375,116203,NULL,'General','update_user',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117440,20375,116204,NULL,'General','update_ts',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117441,20376,116195,NULL,'Detail','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22483,20375,'General','a','FORM',NULL,1,'2',NULL,NULL,NULL UNION ALL SELECT 22484,20376,'Detail','a','250','TicketDetail',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22485,20377,'Event','a','171','ticket_event',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22486,20378,'Cost','a','357','ticket_cost',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10166600'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10166600'  
							ELSE @db + '_UI_' + '10166600'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10166600
