...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20010600' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20010600'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20010600' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20010600')
		BEGIN				
			...
			WHERE autd.application_function_id = '20010600'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20010600
		...
		SELECT 369,'eligibility_mapping_template_detail1',NULL,NULL,NULL,'Eligibility Mapping','g','template_id','20010601','20010602',NULL
		...
		SELECT 369,'template_detail_id','Template Detail ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','100','int',NULL,'left' UNION ALL 
		SELECT 369,'template_id','Template ID','ro',NULL,'n','n','2','y',NULL,NULL,'n','80','int',NULL,'left' UNION ALL 
		SELECT 369,'state_value_id','Jurisdiction','combo','EXEC spa_eligibility_mapping @flag = ''j''','y','y','3','n',NULL,NULL,'n','180','str',NULL,'left' UNION ALL 
		SELECT 369,'tier_id','Tier','combo','EXEC spa_eligibility_mapping @flag = ''t''','y','y','4','n',NULL,NULL,'n','150','str',NULL,'left'
		...
		VALUES('20010600',
		'SetupEligibilityMappingTemplate',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20010600') 
		BEGIN 
			...
			VALUES('20010600','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)

			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010600','template_id','template_id','Template ID','input','int','h','n',NULL,NULL,'y','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20010600','template_name','template_name','Template Name','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'Eligibility Mapping',NULL,'y','y',NULL,NULL,'2E',NULL
		...
		SELECT 77053,13902,76637,NULL,'Eligibility Mapping','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77054,13902,76638,NULL,'Eligibility Mapping','template_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77055,13902,76639,NULL,'Eligibility Mapping','template_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 11803,13902,'Eligibility Mapping','a','FORM',NULL,1,'2','80',NULL,NULL UNION ALL 
		SELECT 11804,13902,'Eligibility Mapping','b','369','eligibility_mapping_template_detail',2,'4',NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20010600'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20010600'  
							ELSE @db + '_UI_' + '20010600'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20010600
