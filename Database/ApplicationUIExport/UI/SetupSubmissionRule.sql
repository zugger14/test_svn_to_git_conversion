...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20015200' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20015200'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20015200' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20015200')
		BEGIN				
			...
			WHERE autd.application_function_id = '20015200'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20015200
		...
		SELECT 419,'SubmissionRuleMain',NULL,NULL,'EXEC [dbo].[spa_submission_rule] @flag=main_grid_refresh','Submission Type','g',NULL,NULL,NULL,NULL
		...
		SELECT 419,'submission_type_id','Submission Type ID','ro',NULL,'y','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 419,'submission_type','Submission Type','ro',NULL,'y','y','2','n',NULL,NULL,'y','250','int',NULL,'left', NULL,'n'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20015200') 
		BEGIN 
			...
			VALUES('20015200','','','','settings','',' ',' ',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
		...
		SELECT 88592,15124,87476,NULL,'General','',NULL,NULL,NULL,'y',NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 13020,15124,'General','a','419','SubmissionRuleMain',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20015200'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20015200'  
							ELSE @db + '_UI_' + '20015200'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20015200
