...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10211400' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10211400'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10211400' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10211400')
		BEGIN				
			...
			WHERE autd.application_function_id = '10211400'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10211400
		...
		SELECT 166,'transportation_contract_rank',NULL,NULL,'SELECT transportation_contract_rank_id[ID],contract_id[Contract],rank_id[Rank], dbo.FNAGetSQLStandardDate(effective_date)[Effective Date] FROM transportation_contract_rank WHERE contract_id = <ID>','Rank','g',NULL,NULL,NULL,NULL UNION ALL SELECT 167,'transportation_contract_parties',NULL,NULL,'SELECT transportation_contract_parties_id[ID],contract_id[Contract],party[Party],type[Type], dbo.FNAGetSQLStandardDate(effective_date)[Effective Date] FROM transportation_contract_parties WHERE contract_id = <ID>','Parties','g',NULL,NULL,NULL,NULL UNION ALL SELECT 168,'transportation_contract_location',NULL,NULL,'SELECT transportation_contract_location_id[ID],contract_id[Contract],type[Type],location_id[Location],rec_del[Rec/Del], dbo.FNAGetSQLStandardDate(effective_date)[Effective Date],dbo.FNARRound(mdq,0)[MDQ],rank[Rank],dbo.FNARRound(surcharge,3)[Surcharge],dbo.FNARRound(fuel,3)[Fuel],fuel_group[Fuel Group],dbo.FNARRound(rate,3)[Rate] FROM transportation_contract_location WHERE contract_id = <ID>','Location','g',NULL,NULL,NULL,NULL UNION ALL SELECT 169,'transportation_contract_mdq',NULL,NULL,'SELECT transportation_contract_mdq_id[ID],contract_id[Contract],convert(varchar(10), cast(effective_date as date))[Effective Date],dbo.FNARemoveTrailingZero(mdq)[MDQ] FROM transportation_contract_mdq WHERE contract_id = <ID> ORDER BY effective_date DESC','MDQ','g',NULL,NULL,NULL,NULL
		...
		SELECT 166,'rank_id','Rank','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 32100','y','y','3','n',NULL,NULL,NULL,'150',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 166,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','4','n',NULL,NULL,NULL,'150','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 166,'transportation_contract_rank_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 166,'contract_id','Contract','ro_int',NULL,'n','y','2','y','contract_group','contract_id',NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 167,'party','Party','combo','EXEC spa_source_counterparty_maintain ''c''','y','y','3','n',NULL,NULL,NULL,'150',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 167,'type','Type','combo','EXEC spa_StaticDataValues ''h'', 10020','y','y','4','n',NULL,NULL,NULL,'150',NULL,'NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 167,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','5','n',NULL,NULL,NULL,'150','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 167,'transportation_contract_parties_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 167,'contract_id','Contract','ro_int',NULL,'n','y','2','y','contract_group','contract_id',NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		...
		SELECT 168,'fuel','Fuel','ed',NULL,'y','y','10','n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 168,'rate','Rate','ed',NULL,'y','y','12','n',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 168,'transportation_contract_location_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 168,'contract_id','Contract','ro_int',NULL,'n','y','2','y','contract_group','contract_id',NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 169,'effective_date','Effective Date','dhxCalendarA',NULL,'y','y','3','n',NULL,NULL,NULL,'150','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 169,'mdq','MDQ','ed',NULL,'y','y','4','n',NULL,NULL,NULL,'150',NULL,'ValidInteger','left', NULL,'n',NULL UNION ALL 
		SELECT 169,'transportation_contract_mdq_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 169,'contract_id','Contract','ro_int',NULL,'n','y','2','y','contract_group','contract_id',NULL,'150','int',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10211400') 
		BEGIN 
			...
			VALUES('10211400','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_id','contract_id','System ID','input','int','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','source_contract_id','source_contract_id','Contract ID','input','VARCHAR','h','n',NULL,NULL,'n','n',NULL,'n','n','n',NULL,'n','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','source_system_id','source_system_id','Source System','combo','int','h','n','EXEC spa_source_system_description ''s''',NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','pipeline','pipeline','Pipeline Company','combo','int','h','n','EXEC spa_source_counterparty_maintain @flag = ''h''',NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_name','contract_name','Contract Name','input','VARCHAR','h','n',NULL,NULL,'n','n',NULL,'y','n','n',NULL,'n','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','flow_start_date','flow_start_date','Flow Start Date','calendar','date','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','flow_end_date','flow_end_date','Flow End Date','calendar','date','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','maintain_rate_schedule','maintain_rate_schedule','Rate Schedule','combo','int','h','n','EXEC spa_transportation_rate_schedule ''c''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,'10162000',NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','mdq','mdq','MDQ','input','int','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_type','contract_type','Type','combo','varchar','h','y','SELECT ''f'' as Value,''Firm Transport'' as text UNION SELECT ''i'' as Value,''Interruptible Transport'' as text UNION SELECT ''m'' as Value,''Imbalance'' as text UNION SELECT ''p'' as Value,''Pooling'' as text UNION SELECT ''t'' as Value,''TGT NNS'' as text',NULL,'n','n','y','n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','capacity_release','capacity_release','Capacity Release','checkbox','char','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','grouping_contract','grouping_contract','Primary Contract','combo','varchar','h','y','Select contract_id, contract_name from contract_group  WHERE ISNULL(contract_type_def_id, ''1'') = ''1'' 
			OR contract_type_def_id = 38402',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_type_def_id','contract_type_def_id','Contract Type','input','int','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','settlement_date','settlement_date','Settlement Rule','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 20000',NULL,'n','n',NULL,'y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','settlement_days','settlement_days','Settlement Days','input','int','h','n',NULL,NULL,'n','n',NULL,'y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','invoice_due_date','invoice_due_date','Payment Rule','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 20000',NULL,'n','n',NULL,'y','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','payment_days','payment_days','Payment Days','input','int','h','n',NULL,NULL,'n','n',NULL,'y','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','volume_granularity','volume_granularity','Invoice Frequency','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 978',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','invoice_report_template','invoice_report_template','Invoice','combo','int','h','n','SELECT template_id, template_name FROM contract_report_template WHERE template_type = 38',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_report_template','contract_report_template','Remmitance','combo','int','h','n','SELECT template_id, template_name FROM contract_report_template WHERE template_type = 38',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','netting_template','netting_template','Netting','combo','int','h','n','SELECT template_id, template_name FROM contract_report_template WHERE template_type = 38',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_email_template','contract_email_template','Email','combo','int','h','n','	SELECT aec.admin_email_configuration_id, aec.template_name FROM admin_email_configuration aec
...
WHERE sdv.type_id= 17800 AND sdv.code = ''Invoice Mail''',NULL,'n','n',NULL,'y','n','y',NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
			...
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','create_ts','create_ts','Created Date','input','VARCHAR','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','create_user','create_user','Created By','input','VARCHAR','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','update_ts','update_ts','Updated Date','input','VARCHAR','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','update_user','update_user','Updated By','input','VARCHAR','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,'50',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','segmentation','segmentation','Segmentation','checkbox','char','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','delievery_link','',' ','template','varchar','h','n','',NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,'open_delivery_hyperlink',NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','is_active','is_active','Active','checkbox','char','h','n',NULL,NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','netting_statement','netting_statement','Netting Statement','checkbox','char','h','n','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_status','contract_status','Contract Status','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 1900',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','volume_uom','volume_uom','UOM','combo','int','h','n','EXEC spa_source_uom_maintain ''s''',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','commodity','commodity','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','currency','currency','Currency','combo','int','h','n','EXEC spa_source_currency_maintain ''p''',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','sub_id','sub_id','Subsidiary','combo','int','h','n','EXEC get_subsidiaries_for_rights @function_id=''10211400''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','contract_charge_type_id','contract_charge_type_id','Contract Component Template','combo','int','h','n','EXEC spa_contract_charge_type ''s''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10211400','shipper_id','shipper_id','Shipper','combo','int','h','n','EXEC spa_load_pda_priority_data @flag=''c''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'MDQ',NULL,'y','n','2',NULL,'1C',NULL UNION ALL SELECT 'Invoice',NULL,'y','n','3',NULL,'1C',NULL UNION ALL SELECT 'Audit',NULL,'y','n','4',NULL,'1C',NULL UNION ALL SELECT 'Rank',NULL,'y','n','7',NULL,'1C',NULL UNION ALL SELECT 'Parties',NULL,'y','n','5',NULL,'1C',NULL UNION ALL SELECT 'Location',NULL,'y','n','6',NULL,'1C',NULL
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 9603,19735,'Invoice','Invoice Rule','','n','n','500','500','Invoice Rule',NULL,NULL,NULL,'700','1','2' UNION ALL 
								SELECT 9604,19735,'Invoice','Invoice Templates','','n','n','500','500','Invoice Templates',NULL,NULL,NULL,'700','2','2' UNION ALL 
								SELECT 9605,19735,'Invoice','Netting Settlement',NULL,'n','n','500','500','Netting',NULL,NULL,NULL,'700','3','1'
		...
		SELECT 113009,19733,111786,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113010,19733,111787,NULL,'General','contract_id',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113011,19733,111799,NULL,'General','contract_type_def_id',NULL,'38402',NULL,NULL,'y',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113012,19733,111788,NULL,'General','source_contract_id',NULL,NULL,NULL,'n',NULL,NULL,'input',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113013,19733,111790,NULL,'General','pipeline',NULL,NULL,NULL,'y',NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113014,19733,111791,NULL,'General','contract_name',NULL,NULL,NULL,'y',NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113015,19733,111792,NULL,'General','flow_start_date',NULL,NULL,NULL,'n',NULL,NULL,'calendar',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113016,19733,111793,NULL,'General','flow_end_date',NULL,NULL,NULL,'n',NULL,NULL,'calendar',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113017,19733,111794,NULL,'General','maintain_rate_schedule',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113018,19733,111795,NULL,'General','mdq',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113019,19733,111796,NULL,'General','contract_type',NULL,'f',NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113020,19733,111817,NULL,'General','contract_status',NULL,'1903',NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113021,19733,111797,NULL,'General','capacity_release',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113022,19733,111813,NULL,'General','segmentation',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113023,19733,111814,NULL,'General','delievery_link',NULL,NULL,NULL,NULL,NULL,NULL,'template',NULL,'17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113024,19733,111815,NULL,'General','is_active',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'16',NULL,NULL,NULL,'label-right',NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113025,19733,111789,NULL,'General','source_system_id',NULL,'2',NULL,NULL,'y',NULL,'combo',NULL,'18',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113026,19735,111786,NULL,'Invoice','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113027,19735,111800,'9603','Invoice','settlement_date',NULL,'20003',NULL,NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113028,19735,111801,'9603','Invoice','settlement_days',NULL,'2',NULL,NULL,NULL,NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113029,19735,111802,'9603','Invoice','invoice_due_date',NULL,'20003',NULL,NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113030,19735,111803,'9603','Invoice','payment_days',NULL,'20',NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113031,19735,111804,'9603','Invoice','volume_granularity',NULL,'980',NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113032,19735,111805,'9604','Invoice','invoice_report_template',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113033,19735,111806,'9604','Invoice','contract_report_template',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113034,19735,111807,'9604','Invoice','netting_template',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113035,19735,111808,'9604','Invoice','contract_email_template',NULL,'20003',NULL,NULL,NULL,NULL,'combo',NULL,'20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113036,19736,111786,NULL,'Audit','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113037,19736,111810,NULL,'Audit','create_user',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113038,19736,111809,NULL,'Audit','create_ts',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113039,19736,111812,NULL,'Audit','update_user',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113040,19736,111811,NULL,'Audit','update_ts',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113041,19735,111816,'9605','Invoice','netting_statement',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113042,19733,111818,NULL,'General','volume_uom',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113043,19733,111819,NULL,'General','commodity',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113044,19733,111820,NULL,'General','currency',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113045,19733,111821,NULL,'General','sub_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113046,19733,111822,NULL,'General','contract_charge_type_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113047,19733,111798,NULL,'General','grouping_contract',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 113048,19733,111823,NULL,'General','shipper_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 21825,19733,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 21826,19735,'Invoice','a','FORM',NULL,2,NULL,NULL,NULL,NULL UNION ALL SELECT 21827,19736,'Audit','a','FORM',NULL,10,NULL,NULL,NULL,NULL UNION ALL SELECT 21828,19737,'Rank','a','166','transportation_contract_rank',3,NULL,NULL,NULL,NULL UNION ALL SELECT 21829,19734,'MDQ','a','169','transportation_contract_mdq',4,NULL,NULL,NULL,NULL UNION ALL SELECT 21830,19738,'Parties','a','167','transportation_contract_parties',5,NULL,NULL,NULL,NULL UNION ALL SELECT 21831,19739,'Location','a','168','transportation_contract_location',6,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10211400'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10211400'  
							ELSE @db + '_UI_' + '10211400'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10211400
