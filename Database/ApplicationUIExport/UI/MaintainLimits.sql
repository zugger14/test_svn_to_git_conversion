BEGIN
	...
	IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10181300')
	BEGIN
		...
		WHERE autd.application_function_id = '10181300'
		...
		WHERE aut.application_function_id = '10181300'
		...
		DELETE FROM application_ui_filter WHERE application_function_id = '10181300'
		...
		WHERE application_function_id = '10181300'
...
IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10181300') BEGIN 
...
END 
		...
		INSERT INTO #temp_old_template_group(group_name, group_description, active_flag, default_flag, sequence, inputWidth, field_layout, old_application_grid_id)
						...
						SELECT 'Limit',NULL,'y','n','3',NULL,'1C',NULL
