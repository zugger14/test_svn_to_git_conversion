...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20009800' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20009800'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20009800' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20009800')
		BEGIN				
			...
			WHERE autd.application_function_id = '20009800'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '20009800'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '20009800'	

			DELETE FROM application_ui_filter WHERE application_function_id = '20009800'
			...
			WHERE application_function_id = '20009800'
		...
		SELECT 87,'browse_contract_counterparty','','','EXEC spa_contract_group ''r''','Contract','g',NULL,NULL,NULL,NULL UNION ALL SELECT 133,'browse_location','','','EXEC spa_source_minor_location @flag = ''o''','Location','g','',NULL,NULL,NULL
		...
		SELECT 133,'source_minor_location_id','System Id','ron',NULL,'n','y','1','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
		SELECT 133,'name','Location','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'300',NULL,NULL,'left' UNION ALL 
		SELECT 133,'status','Status','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'100',NULL,NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20009800') 
		BEGIN 
			...
			VALUES('20009800','','','','settings','',' ',' ','','200','n','n','','n','n','n','n','y','n','n','n','0','','0')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20009800','counterparty_id','counterparty_id','Counterparty','combo','varchar','h','y','EXEC spa_source_counterparty_maintain ''h''','250','n','n',NULL,'n','n','n','n','n','n','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20009800','location_id','location_id','Location','browser','int','h','y',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20009800','contract','contract','Contract','browser','varchar','h','y',NULL,'250','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20009800','term_start','term_start','Term Start','calendar','datetime','h','y',NULL,'250','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20009800','term_end','term_end','Term End','calendar','datetime','h','y',NULL,'250','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 66722,9707,66110,NULL,'General','',NULL,'','',' ',' ','0','settings',NULL,'0','0',NULL,NULL,'',NULL,NULL,'','' UNION ALL 
		SELECT 66723,9707,66111,NULL,'General','counterparty_id',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 66724,9707,66112,NULL,'General','location_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,'133',NULL UNION ALL 
		SELECT 66725,9707,66113,NULL,'General','contract',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,'87',NULL UNION ALL 
		SELECT 66726,9707,66114,NULL,'General','term_start',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 66727,9707,66115,NULL,'General','term_end',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 8035,9707,'General','a','FORM',NULL,1,'3',NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20009800'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
