...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10103300' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10103300'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10103300' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10103300')
		BEGIN				
			...
			WHERE autd.application_function_id = '10103300'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10103300
		...
		SELECT 91,'adjustment_default_gl_codes_detail',NULL,NULL,'EXEC spa_get_adjustment_defaultGLCode_detail @flag=''g'', @default_gl_id=<ID>','Contract Component Details','g',NULL,'10103310','10103311',NULL
		...
		SELECT 91,'debit_gl_number','Debit GL Number (+ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'credit_gl_number','Credit GL Number (+ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'netting_debit_gl_number','Netting Debit GL Number (+ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'netting_credit_gl_number','Netting Credit GL Number (+ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'debit_gl_number_minus','Debit GL Number (-ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'credit_gl_number_minus','Credit GL Number (-ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'netting_debit_gl_number_minus','Netting Debit GL Number (-ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'netting_credit_gl_number_minus','Netting Credit GL Number (-ve)','combo','EXEC [spa_gl_system_mapping] ''g''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'uom_id','UOM','combo','EXEC spa_getsourceuom @flag = ''s''','n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 91,'term_start','Term Start','dhxCalendar',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'term_end','Term End','dhxCalendar',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','date',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'debit_remark','Debit Remarks','ro',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'credit_remark','Credit Remarks','ro',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'detail_id','ID','ro_int',NULL,'n','y',NULL,'y',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'default_gl_id','System ID','ro_int',NULL,'n','y',NULL,'y',NULL,'default_gl_id',NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'debit_volume_multiplier','Debit Volume Multiplier','ro_no',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 91,'credit_volume_multiplier','Credit Volume Multiplier','ro_no',NULL,'n','y',NULL,NULL,NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
		...
		VALUES('10103300',
		'invoice_glcode',
		'Maintain Contract Component GL Code',
		'y',
		'y',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10103300') 
		BEGIN 
			...
			VALUES('10103300','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','default_gl_id','default_gl_id','default_gl_id','input','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','fas_subsidiary_id','fas_subsidiary_id','Subsidiary','combo','int','h','n','EXEC get_subsidiaries_for_rights 10103300',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','adjustment_type_id','adjustment_type_id','GL Group','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10015',NULL,'n','n',NULL,'y','y','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','estimated_actual','estimated_actual','GL Type','combo','varchar','h','n','SELECT ''a'', ''Actual'' UNION ALL SELECT ''e'', ''Estimate'' UNION ALL SELECT ''c'', ''Cash Applied''',NULL,'n','n','e','y','y','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','debit_gl_number','debit_gl_number','Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','credit_gl_number','credit_gl_number','Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','netting_debit_gl_number','netting_debit_gl_number','Netting Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','netting_credit_gl_number','netting_credit_gl_number','Netting Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','debit_gl_number_minus','debit_gl_number_minus','Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','credit_gl_number_minus','credit_gl_number_minus','Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','netting_debit_gl_number_minus','netting_debit_gl_number_minus','Netting Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','netting_credit_gl_number_minus','netting_credit_gl_number_minus','Netting Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','debit_volume_multiplier','debit_volume_multiplier','Debit Volume Multiplier','input','numeric','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n','1','y','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','credit_volume_multiplier','credit_volume_multiplier','Credit Volume Multiplier','input','numeric','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n','1','y','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','uom_id','uom_id','UOM','combo','int','h','n','EXEC spa_source_uom_maintain ''s''',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','debit_remark','debit_remark','Debit Remarks','input','varchar','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,'100',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103300','credit_remark','credit_remark','Credit Remarks','input','varchar','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,'100',NULL)
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 9767,20215,'General','Positive',NULL,'n','n','700','500','Positive',NULL,NULL,NULL,NULL,'1','2' UNION ALL 
								SELECT 9768,20215,'General','Negative',NULL,'n','n','700','500','Negative',NULL,NULL,NULL,NULL,'2','2'
		...
		SELECT 116285,20215,115074,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116286,20215,115075,NULL,'General','default_gl_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116287,20215,115076,NULL,'General','fas_subsidiary_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116288,20215,115077,NULL,'General','adjustment_type_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116289,20215,115078,NULL,'General','estimated_actual',NULL,'e',NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116290,20215,115079,'9767','General','debit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116291,20215,115081,'9767','General','netting_debit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116292,20215,115080,'9767','General','credit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116293,20215,115082,'9767','General','netting_credit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116294,20215,115083,'9768','General','debit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116295,20215,115085,'9768','General','netting_debit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116296,20215,115084,'9768','General','credit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116297,20215,115086,'9768','General','netting_credit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116298,20215,115087,NULL,'General','debit_volume_multiplier',NULL,'1',NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Numeric value required.',NULL UNION ALL 
		SELECT 116299,20215,115088,NULL,'General','credit_volume_multiplier',NULL,'1',NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Numeric value required.',NULL UNION ALL 
		SELECT 116300,20215,115089,NULL,'General','uom_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116301,20215,115090,NULL,'General','debit_remark',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116302,20215,115091,NULL,'General','credit_remark',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22304,20215,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22305,20216,'Details','a','91','adjustment_default_gl_codes_detail',2,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10103300'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10103300'  
							ELSE @db + '_UI_' + '10103300'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10103300
