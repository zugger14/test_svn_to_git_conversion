...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10103312' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10103312'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10103312' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10103312')
		BEGIN				
			...
			WHERE autd.application_function_id = '10103312'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10103312
		...
		VALUES('10103312',
		'cc_glcode_detail',
		'Define Contract Components GL Code Detail',
		'y',
		'y',
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10103312') 
		BEGIN 
			...
			VALUES('10103312','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','detail_id','detail_id','detail_id','input','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','y','y','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','default_gl_id','default_gl_id','default_gl_id','input','int','h','n',NULL,NULL,'n','y',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','term_start','term_start','Term Start','calendar','calendar','h','n','',NULL,'n','n',NULL,'y','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','term_end','term_end','Term End','calendar','calendar','h','n','',NULL,'n','n',NULL,'y','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','debit_gl_number','debit_gl_number','Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','credit_gl_number','credit_gl_number','Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','netting_debit_gl_number','netting_debit_gl_number','Netting Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','netting_credit_gl_number','netting_credit_gl_number','Netting Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','debit_gl_number_minus','debit_gl_number_minus','Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','credit_gl_number_minus','credit_gl_number_minus','Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','netting_debit_gl_number_minus','netting_debit_gl_number_minus','Netting Debit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','netting_credit_gl_number_minus','netting_credit_gl_number_minus','Netting Credit GL Number','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','debit_volume_multiplier','debit_volume_multiplier','Debit Volume Multiplier','input','numeric','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n','1','y','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','credit_volume_multiplier','credit_volume_multiplier','Credit Volume Multiplier','input','numeric','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n','1','y','y','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','debit_remark','debit_remark','Debit Remarks','input','varchar','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,'100',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','credit_remark','credit_remark','Credit Remarks','input','varchar','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,'100',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103312','uom_id','uom_id','UOM','combo','int','h','y','EXEC spa_source_uom_maintain ''s''',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General','Define Contract Components GL Code Detail','y','y','1',NULL,'1C',NULL
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 8171,16778,'General','Positive',NULL,'n','n','500','500','Positive',NULL,NULL,NULL,NULL,'1','2' UNION ALL 
								SELECT 8172,16778,'General','Negative',NULL,'n','n','500','500','Negative',NULL,NULL,NULL,NULL,'2','2'
		...
		SELECT 99970,16778,98740,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99971,16778,98741,NULL,'General','detail_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99972,16778,98742,NULL,'General','default_gl_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99973,16778,98743,NULL,'General','term_start',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99974,16778,98744,NULL,'General','term_end',NULL,NULL,NULL,NULL,'n',NULL,'calendar',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99975,16778,98745,'8171','General','debit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99976,16778,98747,'8171','General','netting_debit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99977,16778,98746,'8171','General','credit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99978,16778,98748,'8171','General','netting_credit_gl_number',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99979,16778,98749,'8172','General','debit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99980,16778,98751,'8172','General','netting_debit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99981,16778,98750,'8172','General','credit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99982,16778,98752,'8172','General','netting_credit_gl_number_minus',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99983,16778,98753,NULL,'General','debit_volume_multiplier',NULL,'1',NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Numeric value required',NULL UNION ALL 
		SELECT 99984,16778,98754,NULL,'General','credit_volume_multiplier',NULL,'1',NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Numeric value required',NULL UNION ALL 
		SELECT 99985,16778,98757,NULL,'General','uom_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99986,16778,98755,NULL,'General','debit_remark',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 99987,16778,98756,NULL,'General','credit_remark',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 18751,16778,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10103312'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10103312'  
							ELSE @db + '_UI_' + '10103312'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10103312
