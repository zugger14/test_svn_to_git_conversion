...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10163400' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10163400'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10163400' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10163400')
		BEGIN				
			...
			WHERE autd.application_function_id = '10163400'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10163400
		...
		SELECT 81,'SetupDeliveryPath',NULL,NULL,'EXEC spa_setup_delivery_path @flag=''g''','Setup delivery Path','t','group_path','10161110','10161111',NULL
		...
		SELECT 81,'group_path','Group Path','tree',NULL,'n','y','1','n',NULL,NULL,'y','170',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'path_id','path_id','ro_int',NULL,'n','y','2','y',NULL,NULL,'y','50','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'path_name','Path Name','ro',NULL,'n','y','3','n',NULL,NULL,'y','150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'path_code','Path Code','ro',NULL,'n','y','4','n',NULL,NULL,'y','150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'receipt_location','Receipt Location','ro',NULL,'n','y','5','n',NULL,NULL,'y','150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'delivery_location','Delivery Location','ro',NULL,'n','y','6','n',NULL,NULL,'y','150','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'counterparty_name','Counterparty','ro',NULL,'n','y','7','n',NULL,NULL,'y','150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'contract_name','Contract','ro',NULL,'n','y','8','n',NULL,NULL,'y','150',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'mdq','MDQ','ro_no',NULL,'n','y','9','n',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'priority','Priority','ro',NULL,'n','y','10','n',NULL,NULL,'y','100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 81,'rate_schedule','Rates','ro',NULL,'n','y','11','n',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10163400') 
		BEGIN 
			...
			VALUES('10163400','','','','settings','','h','y','',NULL,'n','n','y','n','n',' ',' ','y','n','n','n','0','','0',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','date_from','date_from','Flow Date From','calendar','datetime','h','n','',NULL,'n','n','','n','n','n',NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','date_to','date_to','Flow Date To','calendar','datetime','h','y','',NULL,'n','n','','n','n','n',NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','location_group','location_group','Location Group','combo','int','h','n','EXEC spa_location_ranking @flag = ''g''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','location_name','location_name','Location','combo','int','h','n','EXEC spa_source_minor_location @flag=''o''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','priority','priority','Path Priority','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''b'', @type_id = 31400',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','pipeline','pipeline','Pipeline','combo','int','h','n','EXEC spa_source_counterparty_maintain @flag = ''c'', @type_of_entity=301994',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','contract','contract','Contract','combo','int','h','n','EXEC spa_contract_group ''r''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','rec_priority','rec_priority','Receipt Priority','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 32000',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','del_priority','del_priority','Delivery Priority','combo','int','h','n','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 32000',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','grouping_type','grouping_type','Grouping Type','combo','int','h','n','SELECT ''l'' [value], ''Location'' [text] UNION ALL SELECT ''p'', ''Path''',NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10163400','transaction_type','transaction_type','Transaction Type','combo','int','h','n','SELECT ''b'' [value], ''Buy/Sell Only'' [text] UNION ALL SELECT ''t'', ''Transportation Only'' UNION ALL SELECT ''a'', ''All''',NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'Filters',NULL,'y','y','1',NULL,'2E',NULL
		...
		SELECT 116633,20281,115414,NULL,'Filters','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116634,20281,115415,NULL,'Filters','date_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116635,20281,115416,NULL,'Filters','date_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116636,20281,115417,NULL,'Filters','location_group',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116637,20281,115418,NULL,'Filters','location_name',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,'location_group','EXEC spa_source_minor_location @flag=''o'', @source_major_location_ID=''<location_group>''',NULL,NULL,NULL UNION ALL 
		SELECT 116638,20281,115419,NULL,'Filters','priority',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116639,20281,115420,NULL,'Filters','pipeline',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116640,20281,115421,NULL,'Filters','contract',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116641,20281,115422,NULL,'Filters','rec_priority',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116642,20281,115423,NULL,'Filters','del_priority',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116643,20281,115424,NULL,'Filters','grouping_type',NULL,'p',NULL,NULL,'y',NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 116644,20281,115425,NULL,'Filters','transaction_type',NULL,'t',NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22381,20281,'Filters','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22382,20281,'Filters','b','81','SetupDeliveryPath',2,NULL,NULL,'view_nom_schedules.delivery_path_grid','path_id'
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10163400'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10163400'  
							ELSE @db + '_UI_' + '10163400'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10163400
