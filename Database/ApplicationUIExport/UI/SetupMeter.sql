...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10103000' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10103000'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10103000' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10103000')
		BEGIN				
			...
			WHERE autd.application_function_id = '10103000'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10103000
		...
		SELECT 4,'recorder_properties',NULL,NULL,'EXEC spa_recorder_properties @flag=''s'', @meter_id=<ID>','Meter Channel','g',NULL,'10103010','10103010',NULL UNION ALL SELECT 47,'meter_id_allocation',NULL,NULL,'EXEC(''SELECT allocation_id [Allocation ID], meter_id [Meter ID], convert(varchar(10),production_month,120) [Production Month],gre_per [gre per],gre_volume [gre volume] FROM meter_id_allocation where meter_id = <ID>'')','Meter Allocation','g',NULL,'10103010','10103010',NULL
		...
		SELECT 4,'uom_id','UOM','combo','EXEC spa_source_uom_maintain ''s''','y','y','6','n',NULL,NULL,NULL,'100','str','NotEmpty','right', NULL,'n',NULL UNION ALL 
		SELECT 4,'channel_description','Channel Description','ed',NULL,'y','n','4','n',NULL,NULL,NULL,'300','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 4,'channel','Channel','ed_int',NULL,'y','y','3','n',NULL,NULL,NULL,'100','int','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 4,'mult_factor','Multiplier','ed_no',NULL,'y','y','5','n',NULL,NULL,NULL,'100','int','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 4,'meter_id','Meter ID','ro_int',NULL,'n','y','2','y','meter_id','meter_id',NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 4,'recorder_property_id','ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 47,'production_month','Production Month','dhxCalendarA',NULL,'n','y','3','n',NULL,NULL,NULL,'200','date','NotEmpty','left', NULL,'n',NULL UNION ALL 
		SELECT 47,'gre_per','Third Party %','ed_no',NULL,'n','y','4','n',NULL,NULL,NULL,'200','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 47,'gre_volume','Third Party Volume','ed_v',NULL,'n','y','5','n',NULL,NULL,NULL,'200','int',NULL,'right', NULL,'n',NULL UNION ALL 
		SELECT 47,'meter_id','Meter ID','ro_int',NULL,'n','y','2','y','meter_id','meter_id',NULL,'200','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 47,'allocation_id','Allocation ID','ro_int',NULL,'n','y','1','y',NULL,NULL,'y','200','int',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10103000') 
		BEGIN 
			...
			VALUES('10103000','meter_id','meter_id','System ID','input','int','h','n',NULL,NULL,'y','n','','n','n','y','n','y','y','n','y',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','recorderid','recorderid','Meter ID','input','varchar','h','n',NULL,NULL,'n','n','','y','n','y','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','description','description','Description','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n','5',NULL,'100',NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','meter_manufacturer','meter_manufacturer','Manufacturer','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','meter_type','meter_type','Type','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','meter_serial_number','meter_serial_number','Serial Number','input','varchar','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','meter_certification','meter_certification','Inspection Date','calendar','datetime','h','n',NULL,NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','counterparty_id','counterparty_id','Counterparty','combo','int','h','n','EXEC spa_source_counterparty_maintain ''c''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','sub_meter_id','sub_meter_id','Sub Meter','combo','int','h','n','EXEC spa_getAllMeter @flag=''s''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','country_id','country_id','Country','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 14000',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','multiple_location','multiple_location','Multiple Location','checkbox','char','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','granularity','granularity','Granularity','combo','varchar','h','n','EXEC spa_StaticDataValues ''h'', 978',NULL,'n','n','981','y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','allocation_type','allocation_type','Allocation Type','combo','int','h','n','EXEC spa_StaticDataValues ''h'', 20400',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','','','','settings','',' ',' ','',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','source_uom_id','source_uom_id','UOM','combo','int','h','n','Exec spa_source_uom_maintain ''c''',NULL,'n','n','6','y','n','n','n','n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','Operator','Operator','Operator','combo','int','h','n','EXEC spa_source_counterparty_maintain @flag = ''c'', @is_active = ''y'', @not_int_ext_flag = ''b''',NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','Pigridcode','Pigridcode','Pigridcode','input','varchar','h','n','',NULL,'n','n','','n','n','n','n','y','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','reporting_code','reporting_code','Reporting Code','input','varchar','h','n','',NULL,'n','n','','n','n','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','wexpro_agreement','wexpro_agreement','Wexpro Agreement','input','varchar','h','n','',NULL,'n','n','','n','n','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','field','field','Field','input','varchar','h','n','',NULL,'n','n','','n','n','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10103000','status','status','Status','input','varchar','h','n','',NULL,'n','n','','n','n','n','n','n','n','y','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,NULL,NULL UNION ALL SELECT 'Metering Info',NULL,'y','n','2',NULL,NULL,NULL UNION ALL SELECT 'Additional',NULL,'y','n','3',NULL,'2E',NULL
		...
		INSERT INTO #temp_old_template_fieldsets(old_fieldset_id, old_group_id, group_name, fieldset_name, className, is_disable, is_hidden, inputLeft, inputTop, label, offsetLeft, offsetTop, position, width, sequence, num_column)
								...
								SELECT 9831,20407,'General','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,NULL,NULL,'2' UNION ALL 
								SELECT 9832,20408,'Metering Info','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,NULL,NULL,'2' UNION ALL 
								SELECT 9833,20409,'Additional','fieldset','','n','n','500','500','fieldset',NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 117645,20407,116417,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117646,20407,116404,NULL,'General','recorderid',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117647,20407,116405,NULL,'General','description',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117648,20407,116415,NULL,'General','granularity',NULL,'981',NULL,NULL,'n',NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117649,20408,116406,NULL,'Metering Info','meter_manufacturer',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117650,20408,116407,NULL,'Metering Info','meter_type',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117651,20408,116408,NULL,'Metering Info','meter_serial_number',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117652,20408,116412,NULL,'Metering Info','sub_meter_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117653,20408,116411,NULL,'Metering Info','commodity_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117654,20408,116413,NULL,'Metering Info','country_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117655,20408,116410,NULL,'Metering Info','counterparty_id',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117656,20408,116416,NULL,'Metering Info','allocation_type',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117657,20408,116414,NULL,'Metering Info','multiple_location',NULL,'',NULL,NULL,'n',NULL,'checkbox',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117658,20408,116417,NULL,'Metering Info','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117659,20409,116417,NULL,'Additional','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117660,20407,116403,NULL,'General','meter_id',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117661,20407,116418,NULL,'General','source_uom_id',NULL,'6',NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117662,20408,116409,NULL,'Metering Info','meter_certification',NULL,'',NULL,NULL,'n',NULL,'calendar',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117663,20407,116419,NULL,'General','Operator',NULL,'',NULL,NULL,'n',NULL,'combo',NULL,'5',NULL,'1327','303416',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117664,20407,116420,NULL,'General','Pigridcode',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'6',NULL,'1328','303415',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117665,20408,116421,NULL,'Metering Info','reporting_code',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'10',NULL,'1416','-5685',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117666,20408,116422,NULL,'Metering Info','wexpro_agreement',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'11',NULL,'1417','-5686',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117667,20408,116423,NULL,'Metering Info','field',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'12',NULL,'1418','-5687',NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117668,20408,116424,NULL,'Metering Info','status',NULL,'',NULL,NULL,'n',NULL,'input',NULL,'13',NULL,'2977','-5688',NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22520,20407,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22521,20408,'Metering Info','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22522,20409,'Additional','a','4','recorder_properties',1,NULL,NULL,NULL,NULL UNION ALL SELECT 22523,20409,'Additional','b','47','meter_id_allocation',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10103000'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10103000'  
							ELSE @db + '_UI_' + '10103000'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10103000
