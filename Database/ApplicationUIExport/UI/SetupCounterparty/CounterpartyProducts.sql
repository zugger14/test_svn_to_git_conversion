...
BEGIN
			...
			INSERT INTO  #temp_old_application_ui_filter (application_ui_filter_id,application_group_id,group_name,user_login_id,application_ui_filter_name,application_function_id)
				...
				WHERE aut.application_function_id = '10105890' AND auf.application_function_id IS NULL
				UNION ALL
				SELECT 
				...
				WHERE auf.application_function_id = '10105890'  AND auf.application_function_id IS NOT NULL
				...
				FROM 
					...
					WHERE aut.application_function_id = '10105890' AND auf.application_function_id IS NOT NULL
			...
			*/		
			...
			IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10105890')
			BEGIN
				...
				WHERE autd.application_function_id = '10105890'
				...
				INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
				WHERE aut.application_function_id = '10105890'
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '10105890'
...
DECLARE @application_ui_template_id_new INT
	...
	IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10105890') BEGIN 
	...
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				...
				VALUES('10105890','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','counterparty_product_id','counterparty_product_id','Product ID','input','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','y','n','y',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','counterparty_id','counterparty_id','Counterparty ID','input','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','buy_sell','buy_sell','Buy/Sell','combo','char','h','n','SELECT ''b'', ''Buys'' UNION ALL SELECT ''s'', ''Sells'' UNION ALL SELECT ''a'', ''Buys + Sells''',NULL,'n','n','b','y','y','y','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n',NULL,'y','y','y','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_origin_id','commodity_origin_id','Origin','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','is_organic','is_organic','Organic','checkbox','varchar','h','n',NULL,NULL,'n','n','n','n','y','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_form_id','commodity_form_id','Form','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_form_attribute1','commodity_form_attribute1','Attribute 1','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_form_attribute2','commodity_form_attribute2','Attribute 2','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_form_attribute3','commodity_form_attribute3','Attribute 3','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_form_attribute4','commodity_form_attribute4','Attribute 4','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','commodity_form_attribute5','commodity_form_attribute5','Attribute 5','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10105890','trader_id','trader_id','Contact','multiselect','varchar','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','n','n','n','n',NULL,NULL,NULL)
 END 
			...
			IF OBJECT_ID('tempdb..#temp_old_template_fieldsets') IS NOT NULL
				...
				IF OBJECT_ID('tempdb..#temp_old_template_fields') IS NOT NULL
					...
					INSERT INTO #temp_old_template_fields(old_field_id, old_group_id, old_application_ui_field_id, old_fieldset_id, group_name, ui_field_id, field_alias, Default_value, default_format, validation_flag, hidden, field_size, field_type, field_id, sequence, inputHeight, udf_template_id, udf_field_name, position, dependent_field, dependent_query, old_grid_id, validation_message)
								...
								SELECT 69720,12194,69493,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 69721,12194,69494,NULL,'General','counterparty_product_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 69722,12194,69495,NULL,'General','counterparty_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 69723,12194,69496,NULL,'General','buy_sell',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 69724,12194,69497,NULL,'General','commodity_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 69725,12194,69498,NULL,'General','commodity_origin_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,'commodity_id','EXEC spa_counterparty_products @flag=''o'',@dependent_id=''<commodity_id>''',NULL,NULL UNION ALL 
								SELECT 69726,12194,69500,NULL,'General','commodity_form_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,'commodity_origin_id','EXEC spa_counterparty_products @flag=''f'',@dependent_id=''<commodity_origin_id>''',NULL,NULL UNION ALL 
								SELECT 69727,12194,69501,NULL,'General','commodity_form_attribute1',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,'commodity_form_id','EXEC spa_counterparty_products @flag=''a'',@dependent_id=''<commodity_form_id>''',NULL,NULL UNION ALL 
								SELECT 69728,12194,69502,NULL,'General','commodity_form_attribute2',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,'commodity_form_attribute1','EXEC spa_counterparty_products @flag=''b'',@dependent_id=''<commodity_form_attribute1>''',NULL,NULL UNION ALL 
								SELECT 69729,12194,69503,NULL,'General','commodity_form_attribute3',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,'commodity_form_attribute2','EXEC spa_counterparty_products @flag=''c'',@dependent_id=''<commodity_form_attribute2>''',NULL,NULL UNION ALL 
								SELECT 69730,12194,69504,NULL,'General','commodity_form_attribute4',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,'commodity_form_attribute3','EXEC spa_counterparty_products @flag=''e'',@dependent_id=''<commodity_form_attribute3>''',NULL,NULL UNION ALL 
								SELECT 69731,12194,69505,NULL,'General','commodity_form_attribute5',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,'commodity_form_attribute4','EXEC spa_counterparty_products @flag=''g'',@dependent_id=''<commodity_form_attribute4>''',NULL,NULL UNION ALL 
								SELECT 69732,12194,69506,NULL,'General','trader_id',NULL,NULL,NULL,NULL,'n',NULL,'multiselect',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 69733,12194,69499,NULL,'General','is_organic',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
					...
					INSERT INTO #temp_old_ui_layout(old_layout_grid_id, old_group_id, group_name, layout_cell, old_grid_id, grid_name, sequence, num_column, cell_height,grid_object_name,grid_object_unique_column)
								...
								SELECT 10701,12194,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
