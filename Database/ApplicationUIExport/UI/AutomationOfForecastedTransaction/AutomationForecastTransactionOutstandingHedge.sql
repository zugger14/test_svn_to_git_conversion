 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 144,'AutomationForecastTransactionOutstandingHedge',NULL,NULL,'','Outstanding Hedges','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 144,'hedging_relationship_type','Hedging Relationship Type','combo','EXEC spa_effhedgereltype ''g''','n','n','0','n',NULL,NULL,'n','250','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'perfect_hedge','Perfect Hedge','combo','SELECT ''y'', ''Yes'' UNION SELECT ''n'', ''No''','n','n','2','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'effective_date','Effective Date','dhxCalendarA',NULL,'y','n','1','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'percentage_available','Percentage Available','ro',NULL,'n','n','3','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'deal_id','Ref ID','ro',NULL,'n','n','5','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'deal_date','Deal Date','ro',NULL,'n','n','6','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'term_start','Term Start','ro',NULL,'n','n','7','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'term_end','Term End','ro',NULL,'n','n','8','n',NULL,NULL,'n','120','date',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'buy_sell','Buy Sell','ro',NULL,'n','n','9','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'UOM','UOM','ro',NULL,'n','n','11','n',NULL,NULL,'n','120','str',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 144,'source_deal_header_id','Deal ID','ro_int',NULL,'n','n','4','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 144,'average_volume','Average Volume','ro_v',NULL,'n','n','10','n',NULL,NULL,'n','120','int',NULL,'right', NULL,'n',NULL
