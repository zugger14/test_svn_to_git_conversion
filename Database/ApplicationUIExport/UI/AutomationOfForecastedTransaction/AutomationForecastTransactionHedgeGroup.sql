...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 129,'AutomationForecastTransactionHedgeGroup',NULL,NULL,'','Hedge Group','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 129,'gen_hedge_group_id','','sub_row_grid',NULL,'n','n','1','n',NULL,NULL,'n','30','str',NULL,'left' UNION ALL 
												SELECT 129,'gen_hedge_group_name','Gen Group Name','ro',NULL,'n','n','2','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
												SELECT 129,'hedging_relationship_type','Hedging Relationship Type','ro',NULL,'n','n','3','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
												SELECT 129,'effective_date','Effective Date','ro',NULL,'n','n','4','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 129,'link_type_value','Relationship Type','ro',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left' UNION ALL 
												SELECT 129,'perfect_hedge','Perfect Hedge','ro',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left'
