 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 145,'AutomationForecastTransactionHedgeGroupDetail',NULL,NULL,'','Hedge Group Detail','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 145,'percentage_use','Percentage Use','ed',NULL,'n','n','0','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'deal_date','Deal Date','ro',NULL,'n','n','3','n',NULL,NULL,'n','200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'effective_date','Effective Date','ro',NULL,'n','n','4','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'term_start','Term Start','ro',NULL,'n','n','5','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'term_end','Term End','ro',NULL,'n','n','6','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'buy_sell','Buy/Sell','ro',NULL,'n','n','7','n',NULL,NULL,'n','120','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'gen_hedge_group_detail_id','Detail ID','ro_int',NULL,'n','n','0','y',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'source_deal_header_id','Deal ID','ro_int',NULL,'n','n','1','n',NULL,NULL,'n','120','int',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 145,'deal_id','Ref ID','ro_int',NULL,'n','n','2','n',NULL,NULL,'n','200','int',NULL,'left', NULL,'n',NULL
