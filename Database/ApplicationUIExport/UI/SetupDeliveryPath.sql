...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10161110' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10161110'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10161110' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10161110')
		BEGIN				
			...
			WHERE autd.application_function_id = '10161110'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10161110
		...
		SELECT 133,'browse_location','','','EXEC spa_source_minor_location @flag = ''o''','Location','g','',NULL,NULL,NULL
		...
		SELECT 133,'source_minor_location_id','System Id','ron',NULL,'n','y','1','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,NULL UNION ALL 
		SELECT 133,'name','Location','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'300',NULL,NULL,'left', NULL,NULL UNION ALL 
		SELECT 133,'status','Status','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10161110') 
		BEGIN 
			...
			VALUES('10161110','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','path_id','path_id','Path ID','input','int','h','y',NULL,NULL,'n','n',NULL,'n','y','n','n','y','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','path_code','path_code','Path Code','input','varchar','h','y','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,'100')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','path_name','path_name','Path Name','input','varchar','h','y','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,'100')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','groupPath','groupPath','Group Path','checkbox','char','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','commodity','commodity','Commodity','input','int','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','isactive','isactive','Active','checkbox','char','h','n','',NULL,'n','n','y','n','y','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','logical_name','logical_name','Rates','combo','varchar','h','n','SELECT logical_name, logical_name FROM location_loss_factor',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,'500')
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','location_id','location_id','location_id','input','int','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','from_location','from_location','Receipt Location','browser','varchar','h','y',' SELECT smlo.source_minor_location_id,
	...
	LEFT JOIN source_major_location sml ON  smlo.source_major_location_ID = sml.source_major_location_ID WHERE sml.source_major_location_id <> 9',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','to_location','to_location','Delivery location','browser','varchar','h','y',' SELECT smlo.source_minor_location_id,
	       CASE WHEN smlo.Location_Name <> smlo.location_id THEN smlo.location_id + '' - '' + smlo.Location_Name ELSE smlo.Location_Name END + CASE WHEN sml.location_name IS NULL THEN '''' ELSE  '' ['' + sml.location_name + ''] '' END  [name]
	FROM source_minor_location smlo  
	LEFT JOIN source_major_location sml ON  smlo.source_major_location_ID = sml.source_major_location_ID WHERE sml.source_major_location_id <> 9',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL)
			...
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','shipping_counterparty','shipping_counterparty','shipping_counterparty','input','int','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','receiving_counterparty','receiving_counterparty','receiving_counterparty','input','int','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','rateSchedule','rateSchedule','Rate Schedule','input','int','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','mdq','mdq','MDQ','input','numeric','h','y','',NULL,'n','n','0','n','y','n','y','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','priority','priority','Priority','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 31400',NULL,'n','n',NULL,'y','y','n','n','n','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','deal_link','','','template','varchar','h','n','',NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,'open_deal_link',NULL)

			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10161110','is_backhaul','is_backhaul','Backhaul','checkbox','char','h','n','',NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'Path Detail',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'Fuel/Loss Factor',NULL,'y','n','3',NULL,'1C',NULL UNION ALL SELECT 'MDQ',NULL,'y','n','4',NULL,'1C',NULL
		...
		SELECT 77674,13959,77257,NULL,'Path Detail','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77675,13959,77258,NULL,'Path Detail','path_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77676,13959,77259,NULL,'Path Detail','path_code',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77677,13959,77260,NULL,'Path Detail','path_name',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77678,13959,77266,NULL,'Path Detail','from_location',NULL,NULL,NULL,NULL,'n',NULL,'browser',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,'133',NULL UNION ALL 
		SELECT 77679,13959,77267,NULL,'Path Detail','to_location',NULL,NULL,NULL,NULL,'n',NULL,'browser',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,'133',NULL UNION ALL 
		SELECT 77680,13959,77272,NULL,'Path Detail','priority',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77681,13959,77264,NULL,'Path Detail','logical_name',NULL,NULL,NULL,NULL,'y',NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77682,13959,77271,NULL,'Path Detail','mdq',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77683,13959,77263,NULL,'Path Detail','isactive',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77684,13959,77261,NULL,'Path Detail','groupPath',NULL,NULL,NULL,NULL,'y',NULL,'checkbox',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77685,13959,77270,NULL,'Path Detail','rateSchedule',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77686,13959,77273,NULL,'Path Detail','deal_link',NULL,NULL,NULL,NULL,'n',NULL,'template',NULL,'17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 77687,13959,77274,NULL,'Path Detail','is_backhaul',NULL,NULL,NULL,NULL,'n',NULL,'checkbox',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 11824,13959,'Path Detail','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		BEGIN
			...
			SELECT tnf.application_ui_filter_id,tntf.new_field_id,toduf.field_value,tlg.new_layout_grid_id,toduf.book_level
			FROM #temp_old_application_ui_filter_details toduf
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10161110'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10161110'  
							ELSE @db + '_UI_' + '10161110'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10161110
