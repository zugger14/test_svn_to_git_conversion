...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20012200' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20012200'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20012200' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20012200')
		BEGIN				
			...
			WHERE autd.application_function_id = '20012200'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20012200
		...
		SELECT 391,'grid_settlement_invoice_details',NULL,NULL,'EXEC spa_stmt_invoice @flag = ''a'', @invoice_id = ''<ID>''','Details','g',NULL,NULL,NULL,'0'
		...
		SELECT 391,'charge_type_id','Charge Type ID','ro',NULL,'y','y','2','y',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'charge_type','Charge Type','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'currency','Currency','ro',NULL,'y','y','5','n',NULL,NULL,NULL,'75','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'uom','UOM','ro',NULL,'y','y','7','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'delivery_month','Delivery Month','ro',NULL,'y','y','8','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'accounting_status','Accounting Status','ro',NULL,'y','y','9','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'finalized_date','Finalized Date','ro',NULL,'y','y','10','y',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'amount','Amount','ro_a',NULL,'y','y','4','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'stmt_invoice_detail_id','Settlement Invoice Detail ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL UNION ALL 
		SELECT 391,'volume','Volume','ro_v',NULL,'y','y','6','n',NULL,NULL,NULL,'100','str',NULL,'left', NULL,'n',NULL
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20012200') 
		BEGIN 
			...
			VALUES('20012200','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','counterparty_id','counterparty_id','Counterparty','combo','int','h','n','EXEC spa_source_counterparty_maintain ''c''',NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','contract_id','contract_id','Contract','combo','int','h','n','EXEC spa_contract_group ''r''',NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','invoice_number','invoice_number','Invoice No','input','int','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','invoice_type','invoice_type','Invoice Type','combo','CHAR','h','n','SELECT ''i'' [id], ''Invoice'' [name] UNION ALL SELECT ''r'', ''Remittance'' UNION ALL SELECT ''n'', ''Netting''',NULL,'y','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','invoice_status','invoice_status','Workflow Status','combo','int','h','n','EXEC spa_StaticDataValues ''h'',20700',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','is_finalized','is_finalized','Accounting Status','combo','CHAR','h','n','SELECT ''f'' [id], ''Finalized'' [name] UNION ALL SELECT ''n'', ''Not Finalized''',NULL,'y','n','n','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','is_voided','is_voided','Void Status','combo','CHAR','h','n','SELECT ''v'' [id], ''Voided'' [name] UNION ALL SELECT ''n'', ''Not Voided''',NULL,'y','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','as_of_date','as_of_date','As of Date','calendar','datetime','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','prod_date_from','prod_date_from','Date From','calendar','datetime','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','prod_date_to','prod_date_to','Date To','calendar','datetime','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','payment_date','payment_date','Payment Date','calendar','datetime','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','invoice_date','invoice_date','Invoice Date','calendar','datetime','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','finalized_date','finalized_date','Finalized Date','calendar','datetime','h','n',NULL,NULL,'y','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','invoice_note','invoice_note','Invoice Note','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n','5',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length, open_ui_function_id) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','stmt_invoice_id','stmt_invoice_id','Settlement Invoice ID','input','int','h','n',NULL,NULL,'n','y',NULL,'n','n',NULL,NULL,'n','y','n','n',NULL,NULL,NULL,NULL)
			...
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20012200','invoice_type','invoice_type','Invoice Type','combo','CHAR','h','n','SELECT ''i'' [id], ''Invoice'' [name] UNION ALL SELECT ''r'', ''Remittance'' UNION ALL SELECT ''n'', ''Netting''',NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL,NULL)
		...
		SELECT 'Invoice','Settlement Invoice','y','y','1',NULL,'2E',NULL
		...
		SELECT 117094,20339,115859,NULL,'Invoice','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117095,20339,115860,NULL,'Invoice','counterparty_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117096,20339,115861,NULL,'Invoice','contract_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117097,20339,115862,NULL,'Invoice','invoice_number',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117098,20339,115863,NULL,'Invoice','invoice_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117099,20339,115864,NULL,'Invoice','invoice_status',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117100,20339,115865,NULL,'Invoice','is_finalized',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117101,20339,115866,NULL,'Invoice','is_voided',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117102,20339,115867,NULL,'Invoice','as_of_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117103,20339,115868,NULL,'Invoice','prod_date_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117104,20339,115869,NULL,'Invoice','prod_date_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117105,20339,115870,NULL,'Invoice','payment_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117106,20339,115871,NULL,'Invoice','invoice_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117107,20339,115872,NULL,'Invoice','finalized_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117108,20339,115874,NULL,'Invoice','stmt_invoice_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 117109,20339,115873,NULL,'Invoice','invoice_note',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 22447,20339,'Invoice','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 22448,20339,'Invoice','b','391','grid_settlement_invoice_details',1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20012200'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20012200'  
							ELSE @db + '_UI_' + '20012200'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20012200
