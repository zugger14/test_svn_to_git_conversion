...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20012203' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20012203'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20012203' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20012203')
		BEGIN				
			...
			WHERE autd.application_function_id = '20012203'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20012203
		...
		INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
			SELECT 387,'SettlementCounterpartyInvoice',NULL,NULL,NULL,'Details','g',NULL,NULL,NULL,0
		...
		SELECT 387,'charge_type','Charge Type','ro',NULL,'n','y','1','n',NULL,NULL,NULL,'225','int',NULL,'left' UNION ALL
		SELECT 387,'shadow_calc','Shadow Calc','ro_a',NULL,'n','y','2','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL
		SELECT 387,'amount','Amount','ed_a',NULL,'y','y','3','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
		SELECT 387,'variance','Variance','ro_a',NULL,'n','y','4','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
		SELECT 387,'prod_date_from','Date From','dhxCalendarA',NULL,'y','y','5','n',NULL,NULL,NULL,'100','date',NULL,'left' UNION ALL 
		SELECT 387,'prod_date_to','Date To','dhxCalendarA',NULL,'y','y','6','n',NULL,NULL,NULL,'100','date',NULL,'left' UNION ALL 
		SELECT 387,'currency_id','Currency','combo','EXEC spa_getcurrencyunit ''s''','y','y','7','n',NULL,NULL,NULL,'100','str',NULL,'left' UNION ALL 
		SELECT 387,'invoice_volume','Volume','ed_no',NULL,'y','y','8','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
		SELECT 387,'invoice_volume_uom_id','UOM','combo','EXEC spa_getsourceuom ''s''','y','y','9','n',NULL,NULL,NULL,'150','str',NULL,'left' UNION ALL 
		SELECT 387,'description1','Description','ed',NULL,'y','y','10','n',NULL,NULL,NULL,'150','str',NULL,'left'  UNION ALL 
		SELECT 387,'invoice_line_item_id','Invoice Line Item ID','ro',NULL,'n','y','11','y',NULL,NULL,NULL,'150','int',NULL,'left'
		...
		VALUES('20012203',
		'settlement counterparty invoice',
		'settlement counterparty invoice',
		'y',
		'y',
		'stmt_counterparty_invoice',
		NULL,
		NULL,
		NULL,
		NULL)
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20012203') 
		BEGIN 
			...
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				...
				VALUES('20012203','','','','settings','','h','y',NULL,NULL,'n','n','y','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','description3','description3','Amount','input','float','h','n',NULL,NULL,'n','y',NULL,'n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)

		
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','invoice_date','invoice_date','Invoice Date','calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','invoice_due_date','invoice_due_date','Invoice Due Date','calendar','date','h','y','',NULL,'n','n','','n','n',NULL,NULL,'y','n','n','n',NULL,NULL,NULL)
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','description1','description1','Description 1','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n','3',NULL,NULL)
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','description2','description2','Description 2','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'y','n','n','n','3',NULL,NULL)
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','invoice_ref_no','invoice_ref_no','Invoice Ref No','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
						OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
						INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
						VALUES('20012203','stmt_invoice_id','stmt_invoice_id','Invoice ID','input','int','h','y',NULL,NULL,'y','y','n','n','n','n','n','y','y','n','y',NULL,NULL,NULL)
		...
		SELECT 69155,12143,68945,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69158,12143,68948,NULL,'General','description3',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69163,12143,68953,NULL,'General','invoice_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69164,12143,68954,NULL,'General','invoice_due_date',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69165,12143,68955,NULL,'General','description1',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69166,12143,68956,NULL,'General','description2',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69168,12143,68958,NULL,'General','invoice_ref_no',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 69169,12143,68959,NULL,'General','stmt_invoice_id',NULL,NULL,NULL,NULL,'Y',NULL,'input',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 12187,14301,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20012203'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20012203'  
							ELSE @db + '_UI_' + '20012203'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20012203
