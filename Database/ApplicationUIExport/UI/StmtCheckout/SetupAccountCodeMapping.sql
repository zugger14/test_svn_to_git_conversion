...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20011500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20011500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20011500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20011500')
		BEGIN				
			...
			WHERE autd.application_function_id = '20011500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20011500
		...
		SELECT 424,'stmt_account_code_chargetype',NULL,NULL,'EXEC spa_stmt_account_code_mapping @flag=''chargetype_grid'', @code_mapping_id=<ID>','Account Code Charge Type','g','charge_type_id','20011501','20011502',NULL UNION ALL 
		SELECT 427,'stmt_account_code_gl',NULL,NULL,'EXEC spa_stmt_account_code_mapping @flag=''gl_grid'', @acc_code_chargetype_id=<ID>','Account Code GL','g','effective_date','20011501','20011502',NULL
		...
		SELECT 424,'stmt_account_code_chargetype_id','Account Code ChargeType ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','200','int',NULL,'left' UNION ALL 
		SELECT 424,'stmt_account_code_mapping_id','Account Code Mapping ID','ro',NULL,'n','n','2','y','stmt_account_code_mapping_id','stmt_account_code_mapping_id','n','200','str',NULL,'left' UNION ALL 
		SELECT 424,'deal_charge_type_id','Deal Charge Type','combo','EXEC spa_staticdatavalues @flag=''h'', @type_id=5500','n','n','3','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 424,'contract_charge_type_id','Contract Charge Type','combo','EXEC spa_staticdatavalues @flag=''h'', @type_id=10019','n','n','4','y',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 424,'charge_type_alias','Charge Type Alias','combo','EXEC spa_staticdatavalues @flag=''h'', @type_id=108900','n','n','6','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 424,'pnl_line_item_id','PNL Line Item','combo','EXEC spa_staticdatavalues @flag=''h'', @type_id=109000','n','n','7','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL
		SELECT 424,'invoicing_charge_type_id','Invoice Line Item','combo','EXEC spa_staticdatavalues @flag=''h'', @type_id=10019','n','n','5','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL
		SELECT 424,'is_hide','Hide','combo','EXEC spa_get_combo_value @flag=''h''','n','n','8','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL

		SELECT 427,'stmt_account_code_gl_id','Account Code GL Group ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','200','int',NULL,'left' UNION ALL 
		SELECT 427,'stmt_account_code_chargetype_id','Account Code ChargeType ID','ro',NULL,'n','n','2','y',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 427,'effective_date','Effective Date','dhxCalendarA',NULL,'n','n','3','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 427,'estimate_gl','Estimate GL Group','combo','EXEC spa_stmt_account_code_mapping @flag=''glcode_combo_e'' ','n','n','4','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 427,'final_gl','Final GL Group','combo','EXEC spa_stmt_account_code_mapping @flag=''glcode_combo_a'' ','n','n','5','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL
		SELECT 427,'payment_gl_group','Payment GL Group','combo','EXEC spa_stmt_account_code_mapping @flag=''glcode_combo_c'' ','n','n','6','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 427,'prior_period_gl','Prior Period GL Group','combo','EXEC spa_stmt_account_code_mapping @flag=''glcode_combo'' ','n','n','7','n',NULL,NULL,'n','200','str',NULL,'left' UNION ALL 
		SELECT 427,'applies_to','Prior Period GL Group Applies To','combo','SELECT ''y'', ''Year'' UNION ALL SELECT ''m'', ''Month'' ','n','n','8','n',NULL,NULL,'n','250','str',NULL,'left'
		...
		VALUES('20011500',
		'SetupAccountCodeMapping',
		'Setup Account Code Mapping',
		'y',
		'y',
		'stmt_account_code_mapping',
		'n',
		'20011501',
		'20011502')
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20011500') 
		BEGIN 
			...
			VALUES('20011500','','','','settings','','h','y',NULL,NULL,'n','n',NULL,'n','n',NULL,NULL,'n','n','n','n',NULL,NULL,NULL)

			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','stmt_account_code_mapping_id','stmt_account_code_mapping_id','ID','input','int','h','y',NULL,NULL,'y','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','account_code_group_name','account_code_group_name','Group Name','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','buy_sell_flag','buy_sell_flag','Buy/Sell','combo','char','h','n','SELECT ''b'' as code, ''Buy'' as value UNION ALL SELECT ''s'' as code, ''Sell'' as value',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','source_deal_type_id','source_deal_type_id','Deal Type','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag = ''sdt_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','source_deal_sub_type_id','source_deal_sub_type_id','Deal Sub Type','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag = ''sdt_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag = ''commodity_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','location_id','location_id','Location','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag = ''location_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','location_group_id','location_group_id','Location Group','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag =''location_group_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','template_id','template_id','Template','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag =''template_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','currency_id','currency_id','Currency','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag =''currency_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','contract_id','contract_id','Contract','combo','int','h','n','EXEC spa_stmt_account_code_mapping @flag =''contract_combo'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','counterparty_type','counterparty_type','Counterparty Type','combo','char','h','n','SELECT ''i'' id, ''Internal'' value UNION SELECT ''e'', ''External'' UNION SELECT ''b'', ''Broker'' UNION SELECT ''c'', ''Clearing'' ',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','counterparty_group','counterparty_group','Counterparty Entity Type','combo','int','h','n','EXEC spa_staticdatavalues @flag=''h'', @type_id=10020',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','region','region','Region','combo','int','h','n','EXEC spa_staticdatavalues @flag = ''h'', @type_id = 11150',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)

			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','reversal_required','reversal_required','Reversal Required','checkbox','boolean','h','n',NULL,NULL,'n','n','y','n','n','n','n','y','n','n','n',NULL,NULL,NULL)


			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20011500','is_hide','is_hide','Hide','checkbox','boolean','h','n',NULL,NULL,'n','n','n','n','n','n','n','y','n','n','n',NULL,NULL,NULL)

			--INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			--OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			--INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			--VALUES('20011500','priority','priority','Priority','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y',NULL,NULL,'3T',NULL
		...
		SELECT 83488,14478,83004,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83489,14478,83005,NULL,'General','stmt_account_code_mapping_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83490,14478,83006,NULL,'General','account_code_group_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83491,14478,83007,NULL,'General','buy_sell_flag',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83492,14478,83008,NULL,'General','source_deal_type_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83493,14478,83009,NULL,'General','source_deal_sub_type_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83494,14478,83010,NULL,'General','commodity_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83495,14478,83011,NULL,'General','location_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83496,14478,83012,NULL,'General','location_group_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83497,14478,83013,NULL,'General','template_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83498,14478,83014,NULL,'General','currency_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83499,14478,83015,NULL,'General','contract_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83500,14478,83016,NULL,'General','counterparty_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83501,14478,83017,NULL,'General','counterparty_group',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83502,14478,83018,NULL,'General','region',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL
		SELECT 83503,14478,83019,NULL,'General','reversal_required',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL
		SELECT 83503,14478,83019,NULL,'General','is_hide',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		--SELECT 83502,14478,83018,NULL,'General','priority',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL  
		...
		SELECT 12339,14478,'General','a','FORM',NULL,1,NULL,'150',NULL,NULL UNION ALL SELECT 12340,14478,'General','b','424','account_code_chargetype',1,'3',NULL,NULL,NULL UNION ALL SELECT 12341,14478,'General','c','427','account_code_gl',1,'3',NULL,NULL,NULL
		...
		--EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20011500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20011500'  
							ELSE @db + '_UI_' + '20011500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20011500
