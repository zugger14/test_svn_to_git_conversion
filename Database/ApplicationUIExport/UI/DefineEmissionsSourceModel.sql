...
BEGIN
			...
			INSERT INTO  #temp_old_application_ui_filter (application_ui_filter_id,application_group_id,group_name,user_login_id,application_ui_filter_name,application_function_id)
				...
				WHERE aut.application_function_id = '14111100' AND auf.application_function_id IS NULL
				UNION ALL
				SELECT 
				...
				WHERE auf.application_function_id = '14111100'  AND auf.application_function_id IS NOT NULL
				...
				FROM 
					...
					WHERE aut.application_function_id = '14111100' AND auf.application_function_id IS NOT NULL
			...
			*/		
			...
			IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '14111100')
			BEGIN
				...
				WHERE autd.application_function_id = '14111100'
				...
				INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
				WHERE aut.application_function_id = '14111100'
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '14111100'
				...
				WHERE application_function_id = '14111100'
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 252,'ems_source_formula',NULL,NULL,'EXEC spa_ems_source_formula @flag=''s'', @ems_source_model_detail_id=<ID>','Formula','g',NULL,'14111110','14111111',NULL UNION ALL 
									SELECT 253,'ems_input_map',NULL,NULL,'EXEC spa_ems_input_map @flag=''s'', @source_model_id=<ID>','Define Input(s)/Output Used To Calculate Emissions.','g',NULL,'14111110','14111111',NULL UNION ALL 
			...
			END
				...
				ON agd.grid_name = tag.grid_name
							...
							INSERT INTO #temp_all_grids_columns(old_grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 252,'ems_source_formula_id','ID','ro',NULL,'n','y','1','n',NULL,NULL,'y','150',NULL,NULL,'left' UNION ALL 
												SELECT 252,'forecast_type','Series Type','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id =14300 ','y','y','2','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'input_type','Input Type','ro',NULL,'n','y','2','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'char_applies','Char Applies','ro',NULL,'n','y','3','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'uom','UOM','ro',NULL,'n','y','4','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'input_output','Input/Output','ro',NULL,'n','y','5','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'constant','Constant','ro',NULL,'n','y','6','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
												SELECT 253,'rating','Rating','ro',NULL,'n','y','7','n',NULL,NULL,'n','150',NULL,NULL,'left' UNION ALL 
...
VALUES('14111100',
						'define_ems_source_model',
						'Define Emissions Source Model',
						'y',
						'y',
						'ems_source_model',
						'n',
...
DECLARE @application_ui_template_id_new INT
	...
	IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '14111100') BEGIN 
	...
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				...
				VALUES('14111100','','','','settings','','h','y',NULL,NULL,'n','y',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','ems_source_model_id','ems_source_model_id','ID','input','int','h','y',NULL,NULL,'y','n',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','ems_source_model_name','ems_source_model_name','Source Model Name','input','varchar','h','y',NULL,NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','input_frequency','input_frequency','Reporting Period Frequency','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 978',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','source_model_type','source_model_type','Source Model Type','combo','int','h','y','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 3600',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','keyword1','keyword1','Keyword 1','input','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','keyword2','keyword2','Keyword 2','input','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','keyword3','keyword3','Keyword 3','input','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('14111100','keyword4','keyword4','Keyword 4','input','varchar','h','y',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
 END 
				...
				INSERT INTO #temp_old_template_group(group_name, group_description, active_flag, default_flag, sequence, inputWidth, field_layout, old_application_grid_id)
								...
								SELECT 'Define Input(s)/Output',NULL,'y','n','2',NULL,'1C',NULL UNION ALL 
								SELECT 'Emissions Types',NULL,'y','n','3',NULL,'3T',NULL
			...
			IF OBJECT_ID('tempdb..#temp_old_template_fieldsets') IS NOT NULL
				...
				IF OBJECT_ID('tempdb..#temp_old_template_fields') IS NOT NULL
					...
					INSERT INTO #temp_old_template_fields(old_field_id, old_group_id, old_application_ui_field_id, old_fieldset_id, group_name, ui_field_id, field_alias, Default_value, default_format, validation_flag, hidden, field_size, field_type, field_id, sequence, inputHeight, udf_template_id, udf_field_name, position, dependent_field, dependent_query, old_grid_id, validation_message)
								...
								SELECT 68228,11997,68028,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68229,11997,68029,NULL,'General','ems_source_model_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68230,11997,68030,NULL,'General','ems_source_model_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68231,11997,68031,NULL,'General','input_frequency',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68232,11997,68032,NULL,'General','source_model_type',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68233,11997,68033,NULL,'General','keyword1',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68234,11997,68034,NULL,'General','keyword2',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68235,11997,68035,NULL,'General','keyword3',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 68236,11997,68036,NULL,'General','keyword4',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
					...
					INSERT INTO #temp_old_ui_layout(old_layout_grid_id, old_group_id, group_name, layout_cell, old_grid_id, grid_name, sequence, num_column, cell_height,grid_object_name,grid_object_unique_column)
								...
								SELECT 10537,11997,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10538,11998,'Define Input(s)/Output','a','253','ems_input_map',1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10539,11999,'Emissions Types','a','255','ems_source_model_detail',1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10540,11999,'Emissions Types','b','252','ems_source_formula',2,NULL,NULL,NULL,NULL
