...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20003300' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20003300'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20003300' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20003300')
		BEGIN				
			...
			WHERE autd.application_function_id = '20003300'
			...
			INNER JOIN application_ui_template AS aut ON aut.application_ui_template_id = autg.application_ui_template_id
			WHERE aut.application_function_id = '20003300'
				
			DELETE aufd FROM application_ui_filter_details aufd
			INNER JOIN application_ui_filter auf ON auf.application_ui_filter_id = aufd.application_ui_filter_id
			WHERE auf.application_function_id = '20003300'	

			DELETE FROM application_ui_filter WHERE application_function_id = '20003300'
			...
			WHERE application_function_id = '20003300'
		...
		SELECT 8304,'user_defined_tables_metadata','user_defined_tables','udt_id','EXEC spa_user_defined_tables @flag=''h'', @udt_id=<ID>','Metadata','g',NULL,'20003301','20003302',NULL
		...
		SELECT 8304,'udtm_id','Metadata ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','170','int',NULL,'left' UNION ALL 
		SELECT 8304,'udt_id','User Defined Table ID','ro',NULL,'n','n','2','y','user_defined_tables','udt_id',NULL,'170','int',NULL,'left' UNION ALL 
		SELECT 8304,'column_name','Column Name','ed',NULL,'n','y','3','n',NULL,NULL,NULL,'170','str','NotEmpty','left' UNION ALL 
		SELECT 8304,'column_descriptions','Description','ed',NULL,'n','y','4','n',NULL,NULL,NULL,'170','str','NotEmpty','left' UNION ALL 
		SELECT 8304,'column_type','Column Type','combo','EXEC spa_StaticDataValues ''h'', 104300','n','y','5','n',NULL,NULL,NULL,'100','str','NotEmpty','left' UNION ALL 
		SELECT 8304,'column_length','Length','ed',NULL,'n','y','6','n',NULL,NULL,NULL,'100','int','ValidInteger','left' UNION ALL 
		SELECT 8304,'column_prec','Precision','ed',NULL,'n','n','7','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'column_scale','Scale','ed',NULL,'n','n','8','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'column_nullable','Nullable','ch',NULL,'n','n','9','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'is_primary','Is Primary','ch',NULL,'n','n','10','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'is_identity','Is Identity','ch',NULL,'n','n','11','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'use_as_filter','Use as Filter','ch',NULL,'n','n','12','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL
		SELECT 8304,'effective_date_filter','Effective Date Filter','ch',NULL,'n','n','13','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'required_filter','Required Filter','ch',NULL,'n','n','14','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL  
		SELECT 8304,'static_data_type_id','Static Data Type','combo','SELECT type_id, type_name FROM static_data_type UNION SELECT -1, ''Counterparty'' UNION SELECT -2, ''Location'' UNION SELECT -3, ''Currency'' UNION SELECT -4, ''UOM''  UNION SELECT -5, ''Sub Book'' UNION SELECT -7, ''Contract'' UNION SELECT -8, ''Calc Status'' ORDER BY 2 ','n','n','15','n',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL

		SELECT 8304,'custom_sql','Custom Sql','txt',NULL,'n','y','16','n',NULL,NULL,NULL,'170','int',NULL,'left' UNION ALL 

		SELECT 8304,'sequence_no','Sequence','combo','; WITH CTE AS  
(  
 SELECT 1 ID, 1 code, ''enable'' state
 UNION ALL  
 SELECT ID +1, code +1, ''enable'' state FROM CTE WHERE ID <100  
)  
SELECT * FROM CTE','n','n','17','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL 
		SELECT 8304,'rounding','Rounding','combo','; WITH CTE AS  
(  
 SELECT 1 ID, 1 code, ''enable'' state
 UNION ALL  
 SELECT ID +1, code +1, ''enable'' state FROM CTE WHERE ID <10  
)  
SELECT * FROM CTE','n','n','18','n',NULL,NULL,NULL,'100','int',NULL,'left'  UNION ALL 
		SELECT 8304,'unique_combination','Unique Combination','ch',NULL,'n','n','19','n',NULL,NULL,NULL,'100','int',NULL,'left'  UNION ALL 
		SELECT 8304,'custom_validation','Custom Validation','combo','SELECT -1, ''Year'' UNION SELECT -2, ''Month''','n','n','20','n',NULL,NULL,NULL,'100','int',NULL,'left' UNION ALL
		SELECT 8304,'reference_column','Reference Column','ra',NULL,'n','n','21','n',NULL,NULL,NULL,'100','int',NULL,'left'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20003300') 
		BEGIN 
			...
			VALUES('20003300','','','','settings','',' ','n','',NULL,'n','n','','y','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20003300','udt_id','udt_id','User Defined Table ID','input','int','h','n',NULL,NULL,'n','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20003300','udt_name','udt_name','User Defined Table Name','input','varchar','h','n',NULL,NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20003300','udt_descriptions','udt_descriptions','User Defined Table Description','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)
			
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20003300','is_system','is_system','System Defined','checkbox','bit','h','n',NULL,NULL,'n','y',NULL,'n','n','n','n','n','n','n','n',NULL,NULL,NULL)				
		END 
		...
		SELECT 'General',NULL,'y','y',NULL,NULL,'2E',NULL
		...
		SELECT 106996,31115,106764,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 106997,31115,106765,NULL,'General','udt_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 106998,31115,106766,NULL,'General','udt_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 106999,31115,106767,NULL,'General','udt_descriptions',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 106999,31115,106767,NULL,'General','is_system',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 29021,31115,'General','a','FORM',NULL,1,NULL,'100',NULL,NULL UNION ALL SELECT 29022,31115,'General','b','8304','user_defined_tables_metadata',2,NULL,NULL,NULL,NULL
