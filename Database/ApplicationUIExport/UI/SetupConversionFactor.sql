...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20016600' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20016600'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20016600' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20016600')
		BEGIN				
			...
			WHERE autd.application_function_id = '20016600'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20016600
		...
		SELECT 451,'conversion_factor_detail',NULL,NULL,'EXEC spa_conversion_factor @flag = ''g'', @conversion_factor_id = <ID>','Conversion Factor Detail','g',NULL,'20016601','20016602',NULL
		...
		SELECT 451,'conversion_factor_detail_id','System ID','ro',NULL,'n','n','1','y',NULL,NULL,'y','200','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 451,'conversion_factor_id','Conversion Factor ID','ro',NULL,'n','n','2','y','conversion_factor','conversion_factor_id',NULL,'200','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 451,'effective_date','Effective Date','dhxCalendarA',NULL,'y','n','3','n',NULL,NULL,NULL,'200','date',NULL,'left', NULL,'n' UNION ALL 
		SELECT 451,'factor','Factor','ed_no',NULL,'y','n','4','n',NULL,NULL,NULL,'200','int',NULL,'left', NULL,'n' UNION ALL
        SELECT 451,'actual_forecast','Actual/Forecast','combo','SELECT ''a'' [value], ''Actual'' [code] UNION SELECT ''f'', ''Forecast''','y','y','5','n',NULL,NULL,'n','200','char',NULL,'left', NULL,'n'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20016600') 
		BEGIN 
			...
			VALUES('20016600','','','','settings','',' ',' ','','0','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20016600','conversion_factor_id','conversion_factor_id',' ID','input','int','h','n',NULL,NULL,'y','y',NULL,'n','n','n','n','n','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20016600','conversion_value_id','conversion_value_id','Conversion Name ','combo','int','h','n','EXEC spa_staticDataValues @flag=''h'', @type_id =112400',NULL,'n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20016600','from_uom','from_uom','From UOM','combo','int','h','y','EXEC spa_source_uom_maintain ''s''',NULL,'n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20016600','to_uom','to_uom','To UOM','combo','int','h','y','EXEC spa_source_uom_maintain ''s''',NULL,'n','n',NULL,'y','n','y','n','n','n','n','n',NULL,NULL,NULL)
		...
		SELECT 103736,17301,102429,NULL,'General','',NULL,'','',' ',' ','0','settings',NULL,'0','0',NULL,NULL,'',NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 103737,17301,102430,NULL,'General','conversion_factor_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 103738,17301,102431,NULL,'General','conversion_value_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 103739,17301,102432,NULL,'General','from_uom',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 103740,17301,102433,NULL,'General','to_uom',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 19332,17301,'General','a','FORM',NULL,1,NULL,'150',NULL,NULL UNION ALL SELECT 19333,17301,'General','b','451','conversion_factor_detail',2,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20016600'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20016600'  
							ELSE @db + '_UI_' + '20016600'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20016600
