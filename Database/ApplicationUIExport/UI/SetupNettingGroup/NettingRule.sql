...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10101514' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10101514'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10101514' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10101514')
		BEGIN				
			...
			WHERE autd.application_function_id = '10101514'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10101514
		...
		VALUES('10101514',
		'netting_asset_liab_group_detail',
		'Maintain Netting Asset/Liab Groups3',
		'y',
		'y',
		'netting_group_detail',
		NULL,
		NULL,
		NULL,
		NULL)
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10101514') 
		BEGIN 
			...
			VALUES('10101514','','','','settings','',' ',' ','',NULL,'n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10101514','netting_group_detail_id','netting_group_detail_id','Netting Group Detail ID','input','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','y','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10101514','source_counterparty_id','source_counterparty_id','Counterparty','combo','int','h','n','EXEC spa_getsourcecounterparty ''s''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10101514','gl_number_id_st_asset','gl_number_id_st_asset','GL ST Asset','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10101514','gl_number_id_st_liab','gl_number_id_st_liab','GL ST Liability','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10101514','gl_number_id_lt_asset','gl_number_id_lt_asset','GL LT Asset','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('10101514','gl_number_id_lt_liab','gl_number_id_lt_liab','GL LT Liability','combo','int','h','n','EXEC [spa_gl_system_mapping] ''g''',NULL,'n','n',NULL,'n','y','n','n','y','n','y','n',NULL,NULL,NULL)
		...
		SELECT 'Netting Rules',NULL,'y','y','1',NULL,'1C',NULL
		...
		SELECT 83937,14670,83040,NULL,'Netting Rules','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83938,14670,83041,NULL,'Netting Rules','netting_group_detail_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83939,14670,83042,NULL,'Netting Rules','source_counterparty_id',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83940,14670,83043,NULL,'Netting Rules','gl_number_id_st_asset',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83941,14670,83044,NULL,'Netting Rules','gl_number_id_st_liab',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83942,14670,83045,NULL,'Netting Rules','gl_number_id_lt_asset',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 83943,14670,83046,NULL,'Netting Rules','gl_number_id_lt_liab',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10101514'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10101514'  
							ELSE @db + '_UI_' + '10101514'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10101514
