...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '10164500' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '10164500'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '10164500' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '10164500')
		BEGIN				
			...
			WHERE autd.application_function_id = '10164500'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 10164500
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '10164500') 
		BEGIN 
		...
		SELECT 'General',NULL,'y','y',NULL,NULL,NULL,NULL UNION ALL SELECT 'View',NULL,'y','n',NULL,NULL,'1C',NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='10164500'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '10164500'  
							ELSE @db + '_UI_' + '10164500'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 10164500
