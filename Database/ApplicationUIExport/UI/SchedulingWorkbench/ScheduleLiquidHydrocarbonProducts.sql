...
BEGIN
			...
			INSERT INTO  #temp_old_application_ui_filter (application_ui_filter_id,application_group_id,group_name,user_login_id,application_ui_filter_name,application_function_id)
				...
				WHERE aut.application_function_id = '10163700' AND auf.application_function_id IS NULL
				UNION ALL
				SELECT 
				...
				WHERE auf.application_function_id = '10163700'  AND auf.application_function_id IS NOT NULL
				...
				FROM 
					...
					WHERE aut.application_function_id = '10163700' AND auf.application_function_id IS NOT NULL
...
DECLARE @application_ui_template_id_new INT
	...
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				...
				VALUES('10163700','commodity_id','commodity_id','Commodity','combo','int','h','n','EXEC spa_source_commodity_maintain ''a''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','location_group','location_group','Location Group','combo','int','h','n','EXEC spa_StaticDataValues @flag=''h'', @type_id=11150',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','quantity_uom','quantity_uom','Convert Quantity UOM','combo','int','h','n','exec spa_source_uom_maintain @flag=''c'', @uom_type = 44303',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','price_uom','price_uom','Convert Price UOM','combo','int','h','n','exec spa_source_uom_maintain @flag=''c'', @uom_type = 44301',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','period_from','period_from','Period From','calendar','datetime','h','n','',NULL,'n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','','','','settings','',' ',' ','',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','location','location','Location','combo','varchar','h','n','EXEC spa_source_minor_location ''o''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','apply_filters','apply_filters','Apply Filters','combo','varchar','h','n','EXEC spa_application_ui_filter ''s'',''<ApplicationFilter application_group_id="<ID>"></ApplicationFilter>''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','period_to','period_to','Period To','calendar','datetime','h','n','',NULL,'n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','deal_type','deal_type','Deal Type','combo','int','h','n','EXEC spa_source_deal_type_maintain @flag=''x'', @sub_type=''n''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','process_id','process_id','Prcocess ID','input','varchar','h','n',NULL,NULL,'n','y',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_group','commodity_group','Commodity Group','combo','int','h','n','EXEC spa_StaticDataValues @flag=''h'', @type_id=29100',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','frequency','frequency','Frequency','combo','varchar','h','n','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 700, @code=''Daily, Monthly''',NULL,'n','n',NULL,'y','n','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','split_status','split_status','Split Status','combo','varchar','h','n','SELECT ''n'', ''No'' UNION ALL SELECT ''y'', ''Yes''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','schedule_match_status','schedule_match_status','Schedule Match Status','combo','varchar','h','n','SELECT ''n'', ''No'' UNION ALL SELECT ''y'', ''Yes''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_origin_id','commodity_origin_id','Origin','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_form_id','commodity_form_id','Form','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_form_attribute1','commodity_form_attribute1','Attribute 1','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_form_attribute2','commodity_form_attribute2','Attribute 2','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_form_attribute3','commodity_form_attribute3','Attribute 3','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_form_attribute4','commodity_form_attribute4','Attribute 4','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','commodity_form_attribute5','commodity_form_attribute5','Attribute 5','combo','int','h','n',NULL,NULL,'n','n',NULL,'n','y','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','','','','settings','',' ',' ','',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	...
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','organic','organic','Organic','combo','char','h','n','SELECT ''b'' as ID, ''Both'' AS value UNION ALL SELECT ''y'', ''Organic'' UNION ALL  SELECT ''n'', ''Non-Organic''',NULL,'n','n',NULL,'n','y','n','n','n','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','inco_terms','inco_terms','INCOTerm','combo','varchar','h','n','EXEC spa_StaticDataValues @flag=''h'', @type_id=40200',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','crop_year','crop_year','Crop Year','combo','varchar','h','n','EXEC spa_StaticDataValues @flag=''h'', @type_id=10092',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','sub_deal_type','sub_deal_type','Sub Deal Type','combo','int','h','n','EXEC spa_source_deal_type_maintain @flag=''x'', @sub_type=''y''',NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
	INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
				OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
				INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
				VALUES('10163700','lot','lot','Lot','input','varchar','h','n',NULL,NULL,'n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
 END 
				...
				INSERT INTO #temp_old_template_group(group_name, group_description, active_flag, default_flag, sequence, inputWidth, field_layout, old_application_grid_id)
								...
								SELECT 'Filters',NULL,'y','y','1',NULL,'1C',NULL UNION ALL 
								SELECT 'Commodity','Commodity','y','y','2',NULL,'1C',NULL UNION ALL 
								SELECT 'Apply Filter','Apply Filter','y','y','3',NULL,'1C',NULL
			...
			IF OBJECT_ID('tempdb..#temp_old_template_fieldsets') IS NOT NULL
				...
				IF OBJECT_ID('tempdb..#temp_old_template_fields') IS NOT NULL
					...
					INSERT INTO #temp_old_template_fields(old_field_id, old_group_id, old_application_ui_field_id, old_fieldset_id, group_name, ui_field_id, field_alias, Default_value, default_format, validation_flag, hidden, field_size, field_type, field_id, sequence, inputHeight, udf_template_id, udf_field_name, position, dependent_field, dependent_query, old_grid_id, validation_message)
								...
								SELECT 70887,12311,70651,NULL,'Commodity','commodity_id',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'14',NULL,NULL,NULL,NULL,'commodity_group','EXEC spa_source_commodity_maintain @flag = ''z'',@commodity_group = ''<commodity_group>''',NULL,NULL UNION ALL 
								SELECT 70888,12310,70652,NULL,'Filters','location_group',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70889,12310,70653,NULL,'Filters','quantity_uom',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70890,12310,70654,NULL,'Filters','price_uom',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70891,12310,70655,NULL,'Filters','period_from',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70892,12310,70656,NULL,'Filters','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70893,12310,70657,NULL,'Filters','location',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,'location_group','EXEC spa_minor_location_detail @flag=''c'',@region=''<location_group>''',NULL,NULL UNION ALL 
								SELECT 70894,12312,70658,NULL,'Apply Filter','apply_filters',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70895,12310,70659,NULL,'Filters','period_to',NULL,NULL,NULL,NULL,NULL,NULL,'calendar',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70896,12310,70660,NULL,'Filters','deal_type',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70897,12310,70661,NULL,'Filters','process_id',NULL,NULL,NULL,NULL,'y',NULL,'input',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70898,12311,70662,NULL,'Commodity','commodity_group',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70899,12310,70663,NULL,'Filters','frequency',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70900,12310,70664,NULL,'Filters','split_status',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70901,12310,70665,NULL,'Filters','schedule_match_status',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70902,12311,70666,NULL,'Commodity','commodity_origin_id',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'15',NULL,NULL,NULL,NULL,'commodity_id','EXEC spa_counterparty_products @flag=''o'',@dependent_id=''<commodity_id>''',NULL,NULL UNION ALL 
								SELECT 70903,12311,70667,NULL,'Commodity','commodity_form_id',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'16',NULL,NULL,NULL,NULL,'commodity_origin_id','EXEC spa_counterparty_products @flag=''f'',@dependent_id=''<commodity_origin_id>''',NULL,NULL UNION ALL 
								SELECT 70904,12311,70668,NULL,'Commodity','commodity_form_attribute1',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'17',NULL,NULL,NULL,NULL,'commodity_form_id','EXEC spa_counterparty_products @flag=''a'',@dependent_id=''<commodity_form_id>''',NULL,NULL UNION ALL 
								SELECT 70905,12311,70669,NULL,'Commodity','commodity_form_attribute2',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'18',NULL,NULL,NULL,NULL,'commodity_form_attribute1','EXEC spa_counterparty_products @flag=''b'',@dependent_id=''<commodity_form_attribute1>''',NULL,NULL UNION ALL 
								SELECT 70906,12311,70670,NULL,'Commodity','commodity_form_attribute3',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'19',NULL,NULL,NULL,NULL,'commodity_form_attribute2','EXEC spa_counterparty_products @flag=''c'',@dependent_id=''<commodity_form_attribute2>''',NULL,NULL UNION ALL 
								SELECT 70907,12311,70671,NULL,'Commodity','commodity_form_attribute4',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'20',NULL,NULL,NULL,NULL,'commodity_form_attribute3','EXEC spa_counterparty_products @flag=''e'',@dependent_id=''<commodity_form_attribute3>''',NULL,NULL UNION ALL 
								SELECT 70908,12311,70672,NULL,'Commodity','commodity_form_attribute5',NULL,NULL,'m',NULL,'n',NULL,'combo',NULL,'21',NULL,NULL,NULL,NULL,'commodity_form_attribute4','EXEC spa_counterparty_products @flag=''g'',@dependent_id=''<commodity_form_attribute4>''',NULL,NULL UNION ALL 
								SELECT 70909,12311,70656,NULL,'Commodity','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70910,12312,70656,NULL,'Apply Filter','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70911,12311,70675,NULL,'Commodity','organic',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'22',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70912,12310,70676,NULL,'Filters','inco_terms',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'23',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70913,12311,70677,NULL,'Commodity','crop_year',NULL,NULL,NULL,NULL,'n',NULL,'combo',NULL,'24',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70914,12310,70678,NULL,'Filters','sub_deal_type',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 70915,12311,70679,NULL,'Commodity','lot',NULL,NULL,NULL,NULL,'n',NULL,'input',NULL,'25',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
					...
					INSERT INTO #temp_old_ui_layout(old_layout_grid_id, old_group_id, group_name, layout_cell, old_grid_id, grid_name, sequence, num_column, cell_height,grid_object_name,grid_object_unique_column)
								...
								SELECT 10785,12310,'Filters','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10786,12311,'Commodity','a','FORM',NULL,2,NULL,NULL,NULL,NULL UNION ALL 
								SELECT 10787,12312,'Apply Filter','a','FORM',NULL,1,NULL,NULL,NULL,NULL
