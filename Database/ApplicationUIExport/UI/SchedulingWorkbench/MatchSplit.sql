 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 352,'MatchSplit',NULL,NULL,NULL,'Match Split','g',NULL,'10163750','10163750',NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 352,'seq','Match Split Sequence','tree',NULL,'n','y','1','n',NULL,NULL,'y','500','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 352,'volume','Volume','ed_v',NULL,'n','y','3','n',NULL,NULL,'n','150','int',NULL,'right', NULL,'n',NULL UNION ALL 
												SELECT 352,'match_group_shipment_id','Match Group Shipment ID','ro',NULL,'n','y','5','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 352,'est_movement_date_from','Estimated Movement Date From','dhxCalendarDT',NULL,'n','y','6','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 352,'est_movement_date_to','Estimated Movement Date To','dhxCalendarDT',NULL,'n','y','7','n',NULL,NULL,'n','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 352,'is_parent','Parent','ro',NULL,'n','y','9','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 352,'source_commodity_id','Commodity ID','ro',NULL,'n','n','10','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 352,'available_quantity','Available Qty','ro',NULL,'n','n','11','y',NULL,NULL,'y','150','str',NULL,'left', NULL,'n',NULL
