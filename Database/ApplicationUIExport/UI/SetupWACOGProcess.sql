...
BEGIN
	BEGIN TRY
		...
		WHERE aut.application_function_id = '20007400' AND auf.application_function_id IS NULL
		UNION ALL
		SELECT 
		...
		WHERE auf.application_function_id = '20007400'  AND auf.application_function_id IS NOT NULL
		...
		FROM 
			...
			WHERE aut.application_function_id = '20007400' AND auf.application_function_id IS NOT NULL
		...
		*/		
		...
		IF EXISTS(SELECT 1 FROM application_ui_template aut WHERE aut.application_function_id = '20007400')
		BEGIN				
			...
			WHERE autd.application_function_id = '20007400'
				
			-- DELETE SCRIPT STARTS HERE
				
			EXEC spa_application_ui_template 'd', 20007400
		...
		SELECT 133,'browse_location','','','EXEC spa_source_minor_location @flag = ''o'', @filter_value = ''<FILTER_VALUE>''','Location','g','',NULL,NULL,NULL UNION ALL SELECT 152,'BrowseIndex',NULL,NULL,'EXEC spa_source_price_curve_def_maintain ''m'' ','Index','g',NULL,NULL,NULL,NULL UNION ALL SELECT 428,'wacog_group_detail',NULL,NULL,'EXEC [dbo].[spa_wacog_group] @flag=''x'', @wacog_group_id =<ID>','WACOG Detail','g',NULL,'20007401','20007402',NULL UNION ALL SELECT 431,'wacog_group_environmental',NULL,NULL,'EXEC [spa_wacog_group] @flag=''e'', @wacog_group_id = <ID>','Environmental','g',NULL,'20007401','20007402',NULL
		...
		SELECT 133,'source_minor_location_id','System Id','ron',NULL,'n','y','1','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 133,'name','Location','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'300',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 133,'status','Status','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 152,'curve_id','Curve ID','ron',NULL,'n','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 152,'curve','Curve','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 152,'status','Status','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'250','str',NULL,'left', NULL,'n' UNION ALL 
		SELECT 428,'wacog_group_detail_id','ID','ro',NULL,'y','y','1','y',NULL,NULL,'y','175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 428,'wacog_group_id','WACOG Group','ro',NULL,'n','n','2','y','wacog_group','wacog_group_id',NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 428,'template_id','Template','combo','EXEC spa_getDealTemplate @flag=s','y','y','3','n',NULL,NULL,NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 428,'source_deal_type_id','Deal Type','combo','EXEC spa_source_deal_type_maintain @flag=x','y','n','4','n',NULL,NULL,NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 428,'charge_type_id','Exclude Charge Type','combo','SELECT value_id val, code lab FROM STATIC_DATA_VALUE where value_id = -10019
				UNION
				SELECT udf_template_id val, field_label lab FROM user_defined_fields_template WHERE NULLIF(internal_field_type, '''') IS NOT NULL','y','n','5','n',NULL,NULL,NULL,'175',NULL,NULL,'left', NULL,'y' UNION ALL 
		SELECT 428,'leg','Leg','ed',NULL,'y','y','7','n',NULL,NULL,NULL,'175',NULL,NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'wacog_group_environmental_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','80','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'wacog_group_id','WACOG Group','ro',NULL,'n','y','2','y','wacog_group','wacog_group_id','n','80','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'jurisdiction','Jurisdiction','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10002','y','n','3','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'tier','Tier','combo','EXEC spa_staticDataValues @flag=''h'', @type_id = 15000','y','n','4','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'default_jurisdiction','Default Jurisdiction','combo','EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10002','y','n','5','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'default_tier','Default Tier','combo','EXEC spa_staticDataValues @flag=''h'', @type_id = 15000','y','n','6','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n' UNION ALL 
		SELECT 431,'vintage_year','Vintage Year','combo','EXEC spa_staticDataValues @flag=''h'', @type_id = 10092','y','n','7','n',NULL,NULL,'n','150','int',NULL,'left', NULL,'n'
		...
		IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition autd WHERE autd.application_function_id = '20007400') 
		BEGIN 
			...
			VALUES('20007400','','','','settings','',' ',' ','','250','n','n','','n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','wacog_group_id','wacog_group_id','Wacog Group ID','input','int','h','y',NULL,'200','y','y',NULL,'n','n','n','n','y','y','n','y',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','wacog_group_name','wacog_group_name','Wacog Group','input','str','h','y',NULL,'200','n','n',NULL,'y','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','subbook_id','subbook_id','Book Structure','browser','str','h','y',NULL,'200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','source_counterparty_id','source_counterparty_id','Counterparty','combo','varchar','h','y','EXEC spa_getsourcecounterparty ''s''','200','n','n',NULL,'n','n','n','y','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','contract_id','contract_id','Contract','combo','varchar','h','y','EXEC spa_contract_group ''r''','200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','trader_id','trader_id','Trader','combo','int','h','y','EXEC spa_getsourcetrader @flag = ''b''','200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','source_commodity_id','source_commodity_id','Commodity','combo','int','h','y','EXEC spa_source_commodity_maintain ''a''','200','n','n',NULL,'n','n','n','y','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','location_id','location_id','Location','browser','str','h','y',NULL,'200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','curve_id','curve_id','Index','browser','int','h','y',NULL,'200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','physical_financial_flag','physical_financial_flag','Physical/Financial','combo','char','h','y','SELECT ''p'' AS [value], ''Physical'' AS [label] UNION ALL SELECT ''f'' AS [value], ''Financial'' AS [label]','200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','buy_sell_flag','buy_sell_flag','Buy/Sell','combo','char','h','y','SELECT ''b'' AS [value], ''Buy'' AS [label] UNION ALL SELECT ''s'' AS [value], ''Sell'' AS [label]','200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','frequency','frequency','Frequency','combo','char','h','y','SELECT  ''m'' id,''Monthly'' val UNION SELECT ''q'', ''Quarterly'' UNION SELECT ''h'',''Hourly'' UNION SELECT ''s'',''Semi-Annually'' UNION SELECT ''a'', ''Annually'' UNION SELECT ''d'', ''Daily'' UNION SELECT ''t'', ''term''','200','n','n',NULL,'n','n','n','n','y','n','n','n',NULL,NULL,NULL)
						
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','enable_environmental','enable_environmental','Enable Environmental','checkbox','char','h','y',NULL,'200','n','n',NULL,'n','n','n','n',NULL,'n','n','n',NULL,NULL,NULL)
			
			INSERT INTO application_ui_template_definition (application_function_id, field_id, farrms_field_id, default_label, field_type, data_type, header_detail, system_required, sql_string, field_size, is_disable, is_hidden, default_value, insert_required, data_flag, update_required, has_round_option, blank_option, is_primary, is_udf, is_identity, text_row_num, hyperlink_function, char_length) 
			OUTPUT INSERTED.application_ui_field_id, INSERTED.field_id, INSERTED.field_type
			INTO #temp_new_template_definition (new_definition_id, field_id, field_type)
			VALUES('20007400','include_financial','include_financial','Include Financial','checkbox','char','h','n','',NULL,'n','n','y','n','y','n','n','y','n','n','n',NULL,NULL,NULL)
		...
		SELECT 'General',NULL,'y','y','1',NULL,'1C',NULL UNION ALL SELECT 'Types','Types','y','n','2',NULL,'1C',NULL UNION ALL SELECT 'Environmental','Environmental','y','n','3',NULL,'1C',NULL
		...
		SELECT 94652,16137,93541,NULL,'General','',NULL,NULL,NULL,NULL,NULL,NULL,'settings',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94653,16137,93542,NULL,'General','wacog_group_id',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94654,16137,93543,NULL,'General','wacog_group_name',NULL,NULL,NULL,NULL,NULL,NULL,'input',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94655,16137,93544,NULL,'General','subbook_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94656,16137,93545,NULL,'General','source_counterparty_id',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94657,16137,93546,NULL,'General','contract_id',NULL,NULL,'m',NULL,NULL,NULL,'combo',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94658,16137,93547,NULL,'General','trader_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94659,16137,93548,NULL,'General','source_commodity_id',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94660,16137,93549,NULL,'General','location_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,'133',NULL,NULL UNION ALL 
		SELECT 94661,16137,93550,NULL,'General','curve_id',NULL,NULL,NULL,NULL,NULL,NULL,'browser',NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,'152',NULL,NULL UNION ALL 
		SELECT 94662,16137,93551,NULL,'General','physical_financial_flag',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94663,16137,93552,NULL,'General','buy_sell_flag',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94664,16137,93553,NULL,'General','frequency',NULL,NULL,NULL,NULL,NULL,NULL,'combo',NULL,'12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL 
		SELECT 94664,16137,93553,NULL,'General','enable_environmental',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL UNION ALL
		SELECT 94664,16137,93553,NULL,'General','include_financial',NULL,NULL,NULL,NULL,NULL,NULL,'checkbox',NULL,'14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
		...
		SELECT 14077,16137,'General','a','FORM',NULL,1,NULL,NULL,NULL,NULL UNION ALL SELECT 14078,16138,'Types','a','428','wacog_group_detail',2,NULL,NULL,NULL,NULL UNION ALL SELECT 14079,16139,'Environmental','a','431','wacog_group_environmental',3,NULL,NULL,NULL,NULL
		...
		EXEC spa_application_ui_template_audit @flag='d', @application_function_id='20007400'
	COMMIT 
	END TRY
	BEGIN CATCH
		IF @@TRANCOUNT > 0
	...
	SELECT @memcache_key = CASE WHEN aut.is_report = 'y' 
							THEN @db + '_RptList' + ',' + @db + '_RptStd_' + '20007400'  
							ELSE @db + '_UI_' + '20007400'
						END 
	FROM application_ui_template AS aut
	WHERE aut.application_function_id = 20007400
