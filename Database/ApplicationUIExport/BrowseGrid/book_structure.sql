 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 424,'book_structure',NULL,NULL,'EXEC spa_source_book_maintain ''z''','Book Structure','g','book_deal_type_map_id, subsidiary,strategy,book,subbook',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 424,'book_deal_type_map_id','ID','ro',NULL,'n','y','1','y',NULL,NULL,'y','100','int',NULL,'left', NULL,'n' UNION ALL 
												SELECT 424,'subsidiary','Subsidiary','ro',NULL,'n','y','3','n',NULL,NULL,'y','80','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 424,'strategy','Strategy','ro',NULL,'n','y','2','n',NULL,NULL,'y','80','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 424,'book','Book','ro',NULL,'n','y','4','n',NULL,NULL,'y','80','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 424,'subbook','Subbook','ro',NULL,'n','y','5','n',NULL,NULL,'y','80','str',NULL,'left', NULL,'n'
