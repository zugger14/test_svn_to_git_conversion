BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 438,'browse_generator','','','EXEC spa_rec_generator @flag = ''k''','Generator','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select)
												...
												SELECT 438,'generator_id','Generator ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 438,'name','Name','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 438,'facility_id','Facility ID','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n' UNION ALL 
												SELECT 438,'unit_id','Unit ID','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'150','str',NULL,'left', NULL,'n'
