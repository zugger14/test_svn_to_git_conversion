BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 5281,'browse_CounterpartyContactsPayables',NULL,NULL,'EXEC spa_counterparty_contacts @flag=''p'', @counterparty_id=<ID>,@application_field_id =<application_field_id>,@filter_value = ''<FILTER_VALUE>''','Contacts','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 5281,'counterparty_contact_id','ID','ro',NULL,'n','n','1','y',NULL,NULL,NULL,'60','int',NULL,'left' UNION ALL 
												SELECT 5281,'contact_type','Contact Type','ro',NULL,'n','n','4','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'title','Title','ro',NULL,'n','n','5','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'name','Name','ro',NULL,'n','n','3','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'id','Contact ID','ro',NULL,'n','n','2','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'address1','Address 1','ro',NULL,'n','n','6','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'address2','Address 2','ro',NULL,'n','n','7','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'city','City','ro',NULL,'n','n','8','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'state','State','ro',NULL,'n','n','9','n',NULL,NULL,NULL,'100','str',NULL,'left' UNION ALL 
												SELECT 5281,'zip','ZIP','ro',NULL,'n','n','10','n',NULL,NULL,NULL,'100','str',NULL,'left' UNION ALL 
												SELECT 5281,'phone_no','Phone Number','ro_phone',NULL,'n','n','11','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'cell_no','Cell Number','ro_phone',NULL,'n','n','12','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'fax','Fax','ro_phone',NULL,'n','n','13','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'email','E-mail','ro',NULL,'n','n','14','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'email_cc','E-mail CC','ro',NULL,'n','n','15','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'email_bcc','E-mail BCC','ro',NULL,'n','n','16','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'country','Country','ro',NULL,'n','n','17','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'region','Region','ro',NULL,'n','n','18','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'comment','Comment','ro',NULL,'n','n','19','n',NULL,NULL,NULL,'120','str',NULL,'left' UNION ALL 
												SELECT 5281,'is_active','Active','ro',NULL,'n','n','20','n',NULL,NULL,NULL,'80','str',NULL,'left' UNION ALL 
												SELECT 5281,'is_primary','Primary','ro',NULL,'n','n','21','n',NULL,NULL,NULL,'80','str',NULL,'left'
