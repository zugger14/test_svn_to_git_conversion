BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 1235,'browse_region_id',NULL,NULL,'EXEC spa_StaticDataValues @flag = ''p'', @type_id = ''11150'', @filter_value = ''<FILTER_VALUE>''','Browse Region','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 1235,'value_id','Region','ro',NULL,'n','y','1','n',NULL,NULL,'n','150','int',NULL,'left' UNION ALL 
												SELECT 1235,'code','Code','ro',NULL,'n','y','2','n',NULL,NULL,'n','80','str',NULL,'left' UNION ALL
												SELECT 1235,'description','Description','ro',NULL,'n','y','3','y',NULL,NULL,'n','80','str',NULL,'left' UNION ALL
												SELECT 1235,'state','State','ro',NULL,'n','y','4','y',NULL,NULL,'n','80','str',NULL,'left'
