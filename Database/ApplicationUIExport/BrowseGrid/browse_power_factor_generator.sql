BEGIN 
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 260,'browse_power_factor_generator',NULL,NULL,'EXEC spa_rec_generator @flag = ''m'', @form_xml = ''<Root><FormXML generator_group_name = ''''PowerFactor''''></FormXML></Root>''', 'Plant ID','g',NULL,NULL,NULL,NULL
