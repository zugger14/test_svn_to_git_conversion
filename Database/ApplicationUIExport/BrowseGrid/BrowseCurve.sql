 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 149,'browse_curve','','','EXEC spa_source_price_curve_def_maintain ''b'' ','Curve','g',NULL,NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 149,'curve_name','Curve Name','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 149,'curve_des','Description','ro',NULL,'y','y','3','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 149,'status','Status','ro',NULL,'y','y','3','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 149,'source_curve_def_id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL
