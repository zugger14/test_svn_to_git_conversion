 BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission, split_at)
									...
									SELECT 133,'browse_location','','','EXEC spa_source_minor_location @flag = ''o'', @filter_value = ''<FILTER_VALUE>''','Location','g','',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 133,'name','Location','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'300',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 133,'status','Status','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'100',NULL,NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 133,'source_minor_location_id','System Id','ro_int',NULL,'n','y','1','n',NULL,NULL,NULL,'150','int',NULL,'left', NULL,'n',NULL
