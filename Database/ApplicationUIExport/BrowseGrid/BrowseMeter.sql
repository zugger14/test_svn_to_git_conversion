 BEGIN
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment, browser_grid_id, allow_multi_select, rounding)
												...
												SELECT 97,'recorderid','Meter ID','ro',NULL,'y','y','2','n',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 97,'status','Status','ro',NULL,'y','y','3','y',NULL,NULL,NULL,'200','str',NULL,'left', NULL,'n',NULL UNION ALL 
												SELECT 97,'meter_id','System ID','ro_int',NULL,'n','y','1','y',NULL,NULL,NULL,'100','int',NULL,'left', NULL,'n',NULL
