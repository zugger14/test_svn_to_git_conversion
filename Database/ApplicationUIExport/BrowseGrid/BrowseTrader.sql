...
BEGIN
			...
			INSERT INTO #temp_all_grids(old_grid_id, grid_name, fk_table, fk_column, load_sql, grid_label, grid_type, grouping_column, edit_permission, delete_permission)
									...
									SELECT 159,'BrowseTrader',NULL,NULL,'EXEC spa_source_traders_maintain @flag=''x'',@filter_value = ''<FILTER_VALUE>''','Trader','g',NULL,NULL,NULL
			...
			FROM #temp_all_grids
							...
							INSERT INTO #temp_all_grids_columns(grid_id, column_name, column_label, field_type, sql_string, is_editable, is_required, column_order, is_hidden, fk_table, fk_column, is_unique, column_width, sorting_preference, validation_rule, column_alignment)
												...
												SELECT 159,'source_trader_id','ID','ron',NULL,'n','y','1','y',NULL,NULL,NULL,'150','int',NULL,'left' UNION ALL 
												SELECT 159,'trader_name','Trader','ro',NULL,'n','y','2','n',NULL,NULL,NULL,'450','str',NULL,'left' UNION ALL 
												SELECT 159,'status','Status','ro',NULL,'n','y','3','y',NULL,NULL,NULL,'450','str',NULL,'left' 
