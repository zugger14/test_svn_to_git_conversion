--drop table [dbo].[source_deal_pnl_tou]
go
if object_id('source_deal_pnl_tou') is null
begin
	CREATE TABLE [dbo].[source_deal_pnl_tou](
	...
	create unique clustered index indx_unq_source_deal_pnl_tou on dbo.source_deal_pnl_tou (
	[source_deal_header_id],[term_start],[Leg] ,[pnl_as_of_date],tou_id)
end
