...
BEGIN
	...
	VALUES ('ContractualQualityValue', 'Quality', 'd', '',  'Quality', '', 'SELECT value_id, code FROM static_data_value WHERE type_id = 29600', '0', '0', '', '1', dbo.FNADBUser(), GETDATE())
END
...
BEGIN
	INSERT INTO formula_function_mapping (
		...
		'ContractualQualityValue',
		'dbo.FNARContractualQualityValue(cast(arg1 as numeric),CAST(arg2 AS INT))', 
		'arg1',
