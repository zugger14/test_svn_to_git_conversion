...
IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_match_group_detail_id')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_match_group_detail_id', 'n', 'Match Group Detail ID - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_quantity')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_quantity', 'n', 'Quantity - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_source_commodity_id')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_source_commodity_id', 'n', 'Commodity - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_scheduling_period')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_scheduling_period', 'n', 'Scheduling Period - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_notes')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_notes', 'n', 'Notes - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_source_deal_detail_id')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_source_deal_detail_id', 'n', 'Deal Detail ID - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_is_complete')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_is_complete', 'n', 'Is Complete - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_create_user')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_create_user', 'n', 'Match Detail Create User - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_create_ts')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_create_ts', 'n', 'Match Detail Create Time - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_update_user')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_update_user', 'n', 'Match Detail Update User - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_update_ts')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_update_ts', 'n', 'Match Detail Update Time - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_bookout_split_volume')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_bookout_split_volume', 'n', 'Bookout Split Volume - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_split_deal_detail_volume_id')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_split_deal_detail_volume_id', 'n', 'Volume - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_frequency')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_frequency', 'n', 'Frequency - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_lot')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_lot', 'n', 'Lot - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_batch_id')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_batch_id', 'n', 'Batch ID - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_inco_terms')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_inco_terms', 'n', 'Inco Terms - Sell'
END

IF NOT EXISTS (SELECT 1 FROM alert_columns_definition WHERE alert_table_id = @new_alert_table_definition_id AND column_name = 'mgd_s_crop_year')
BEGIN
	INSERT INTO alert_columns_definition(alert_table_id, column_name, is_primary, column_alias)
	SELECT @new_alert_table_definition_id, 'mgd_s_crop_year', 'n', 'Crop Year - Sell'
END
