/****** Object:  Table [dbo].[stage_report_hourly_position_profile]    Script Date: 02/28/2012 10:18:07 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stage_report_hourly_position_profile]') AND type in (N'U'))
DROP TABLE [dbo].[stage_report_hourly_position_profile]
GO
...
CREATE CLUSTERED INDEX [indx_stage_report_hourly_position_profile] ON [dbo].[stage_report_hourly_position_profile] 
(
	[term_start] ASC
