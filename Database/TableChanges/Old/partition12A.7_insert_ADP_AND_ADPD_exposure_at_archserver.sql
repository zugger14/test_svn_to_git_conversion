...
BEGIN
	...
	SELECT @ident_archive_data_policy archive_data_policy_id, 'fx_exposure' table_name, 0 is_arch_table, 1 sequence, 'FARRMSMAIN.TRMTracker_essent'  archive_db, '*' field_list, 1 retention_period
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'fx_exposure_arch1', 1, 2,NULL, '*', 9
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'fx_exposure_arch2', 1, 3, NULL, '*', -1
