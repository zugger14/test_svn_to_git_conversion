/** inserting static data values for confidence interval(tyoe_id=1500)
* sligal
* 9/21/2021
* (after risk merge)
**/
SET IDENTITY_INSERT static_data_value ON
IF NOT EXISTS(SELECT 1 FROM static_data_value WHERE value_id = 1500)
BEGIN
	INSERT INTO static_data_value (value_id, [type_id], code, [description], create_user, create_ts)
	VALUES (1500, 1500, '95% - 1.65', '95% - 1.65', 'farrms_admin', GETDATE())
	PRINT 'Inserted static data value 1500 - 95% - 1.65.'
END
ELSE
BEGIN
	PRINT 'Static data value 1500 - 95% - 1.65 already EXISTS.'
END
SET IDENTITY_INSERT static_data_value OFF
SET IDENTITY_INSERT static_data_value ON
IF NOT EXISTS(SELECT 1 FROM static_data_value WHERE value_id = 1501)
BEGIN
	INSERT INTO static_data_value (value_id, [type_id], code, [description], create_user, create_ts)
	VALUES (1501, 1500, '99% - 2.33', '99% - 2.33', 'farrms_admin', GETDATE())
	PRINT 'Inserted static data value 1501 - 99% - 2.33.'
END
ELSE
BEGIN
	PRINT 'Static data value 1501 - 99% - 2.33 already EXISTS.'
END
SET IDENTITY_INSERT static_data_value OFF
SET IDENTITY_INSERT static_data_value ON
