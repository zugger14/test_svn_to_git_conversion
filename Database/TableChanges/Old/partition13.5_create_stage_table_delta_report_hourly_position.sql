/****** Object:  Table [dbo].[stage_delta_report_hourly_position]    Script Date: 02/28/2012 15:38:28 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stage_delta_report_hourly_position]') AND type in (N'U'))
DROP TABLE [dbo].[stage_delta_report_hourly_position]
GO
...
/****** Object:  Index [indx_stage_delta_report_hourly_position_as_of_date]    Script Date: 02/28/2012 15:38:28 ******/
CREATE NONCLUSTERED INDEX [indx_stage_delta_report_hourly_position_as_of_date] ON [dbo].[stage_delta_report_hourly_position] 
(
	[as_of_date] ASC
...
/****** Object:  Index [indx_stage_delta_report_hourly_position_delta_type]    Script Date: 02/28/2012 15:38:28 ******/
CREATE NONCLUSTERED INDEX [indx_stage_delta_report_hourly_position_delta_type] ON [dbo].[stage_delta_report_hourly_position] 
(
	[delta_type] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 90) ON PS_position(term_start)
GO
...
/****** Object:  Index [indx_stage_delta_report_hourly_position_id]    Script Date: 02/28/2012 15:38:28 ******/
CREATE NONCLUSTERED INDEX [indx_stage_delta_report_hourly_position_id] ON [dbo].[stage_delta_report_hourly_position] 
(
