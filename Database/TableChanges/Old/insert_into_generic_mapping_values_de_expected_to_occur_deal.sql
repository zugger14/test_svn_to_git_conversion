...
DECLARE @mapping_table_id_de_expected_occur_deal INT
SELECT @mapping_table_id_de_expected_occur_deal = mapping_table_id FROM generic_mapping_header WHERE mapping_name = 'DE Expected to Occur Deal';
...
INSERT INTO #temp_generic_mapping ([internal_portfolio], [counterparty_group], [instrument_type], [proj_index_group], [transaction_type]) VALUES ('Expected to occur', 'None_FT', 'None_FT','None_FT','Out of Scope')
...
SELECT	@mapping_table_id_de_expected_occur_deal [mapping_table_id], 
		sb.[source_book_id],
		sb2.[source_book_id],
		sb1.[source_book_id],
		sb3.[source_book_id],
...
LEFT JOIN generic_mapping_values gmv ON gmv.mapping_table_id = @mapping_table_id_de_expected_occur_deal
