...
IF NOT EXISTS ( SELECT 1  FROM   netting_group_parent WHERE netting_parent_group_id = -2)
BEGIN
	INSERT INTO netting_group_parent
      (
        netting_parent_group_id,
...
BEGIN
    UPDATE netting_group_parent
    SET    netting_parent_group_name = 'Credit Netting Group',
			active = 'y'
    WHERE  netting_parent_group_id = -2
END
