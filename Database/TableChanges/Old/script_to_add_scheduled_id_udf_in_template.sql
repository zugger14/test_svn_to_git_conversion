...
--Internal UDF field Scheduled ID -5607
IF NOT EXISTS (SELECT 1 FROM user_defined_fields_template udft WHERE field_name = -5607)
BEGIN
	...
	SELECT  -5607, N'Scheduled ID', N't', N'int', N'n', N'', NULL, NULL, NULL, NULL, N'h', NULL, 30, -5607, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
END


SELECT @udf_template_id = udf_template_id FROM user_defined_fields_template udft WHERE udft.field_name = -5607
...
BEGIN
	PRINT 'UDF ''Scheduled ID'' already exist.'
	RETURN
END
