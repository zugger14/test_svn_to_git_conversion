-- DELETE SCRIPT STARTS HERE
				...
				WHERE aut.application_function_id = '10106000'
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '10106000'
				...
				WHERE application_function_id = '10106000'