IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ems_calc_detail_value_arch2]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[ems_calc_detail_value_arch2](
