...
IF NOT exists( select 1 FROM sys.partition_schemes WHERE [NAME]=N'ps_allocation_hour')
BEGIN 

CREATE PARTITION SCHEME [ps_allocation_hour]
AS 
PARTITION pf_allocation_hour TO 
