...
IF NOT exists( select 1 FROM sys.partition_schemes WHERE [NAME]=N'ps_allocation_data')
BEGIN 

CREATE PARTITION SCHEME [ps_allocation_data]
AS 
PARTITION pf_allocation_data TO 
