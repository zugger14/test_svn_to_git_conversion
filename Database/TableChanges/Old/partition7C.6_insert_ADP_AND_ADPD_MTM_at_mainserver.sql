...
BEGIN
	...
	SELECT @ident_archive_data_policy archive_data_policy_id, 'source_deal_pnl' table_name, 0 is_arch_table, 1 sequence, NULL  archive_db, '*' field_list, 1 retention_period
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'source_deal_pnl_arch1', 1, 2,'FARRMSARCH.TRMTracker_essent', '*', 4
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'source_deal_pnl_arch2', 1, 3, 'FARRMSARCH.TRMTracker_essent', '*', -1
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy archive_data_policy_id, 'source_deal_pnl_detail' table_name, 0 is_arch_table, 1 sequence, NULL  archive_db, '*' field_list, 1 retention_period
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'source_deal_pnl_detail_arch1', 1, 2,'FARRMSARCH.TRMTracker_essent', '*', 4
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'source_deal_pnl_detail_arch2', 1, 3, 'FARRMSARCH.TRMTracker_essent', '*', -1
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy archive_data_policy_id, 'Index_fees_breakdown' table_name, 0 is_arch_table, 1 sequence, NULL  archive_db, '*' field_list, 1 retention_period
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'Index_fees_breakdown_arch1', 1, 2,'FARRMSARCH.TRMTracker_essent', '*', 4
...
BEGIN
	--SET IDENTITY_INSERT archive_data_policy_detail ON
	INSERT INTO archive_data_policy_detail (archive_data_policy_id, table_name, is_arch_table, sequence, archive_db, field_list, retention_period)
	SELECT @ident_archive_data_policy, 'Index_fees_breakdown_arch2', 1, 3, 'FARRMSARCH.TRMTracker_essent', '*', -1
