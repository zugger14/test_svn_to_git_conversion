...
--Internal UDF field Path Detail ID -5614
IF NOT EXISTS (SELECT 1 FROM user_defined_fields_template udft WHERE field_name = -5614)
BEGIN
	...
	SELECT  -5614, N'Loss', N't', N'float', N'n', N'', NULL, NULL, NULL, NULL, N'h', NULL, 30, -5614, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
END


SELECT @udf_template_id = udf_template_id FROM user_defined_fields_template udft WHERE udft.field_name = -5614
