...
IF EXISTS (SELECT 1 FROM generic_mapping_header WHERE mapping_name = 'DE Participating Subsidiaries')
BEGIN
...
BEGIN 
	...
	values
	('DE Participating Subsidiaries',1)
...
BEGIN
	...
	cross join #tmp_udf udf
	WHERE mapping_name = 'DE Participating Subsidiaries'
END
