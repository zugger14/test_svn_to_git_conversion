...
/****** Object:  Table [dbo].[delta_report_hourly_position]    Script Date: 09/19/2012 08:32:16 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[delta_report_hourly_position_financial]') AND type in (N'U'))
DROP TABLE [dbo].[delta_report_hourly_position_financial]
GO
...
CREATE TABLE [dbo].[delta_report_hourly_position_financial](
