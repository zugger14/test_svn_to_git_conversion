...
DECLARE @mapping_table_id_uk_probable_limit_power INT
SELECT @mapping_table_id_uk_probable_limit_power = mapping_table_id FROM generic_mapping_header WHERE mapping_name = 'UK Probable Limit Deal (Power)';
...
INSERT INTO #temp_generic_mapping ([internal_portfolio], [counterparty_group], [instrument_type], [proj_index_group], [transaction_type]) VALUES ('User Defined Limit-Power', 'None_FT', 'None_FT','Electricity','Out of Scope')
...
SELECT	@mapping_table_id_uk_probable_limit_power [mapping_table_id], 
		sb.[source_book_id],
		sb2.[source_book_id],
		sb1.[source_book_id],
		sb3.[source_book_id],
...
LEFT JOIN generic_mapping_values gmv ON gmv.mapping_table_id = @mapping_table_id_uk_probable_limit_power
