-- DELETE SCRIPT STARTS HERE
				...
				WHERE aut.application_function_id = '10101029'
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '10101029'
				...
				WHERE application_function_id = '10101029'