...
DELETE FROM ssis_configurations WHERE ConfigurationFilter IN('PKG_LoadForecastNominatorRequest', 'PKG_LoadForecastDataParse', 'PRJ_LoadForecastDataImportIS', 'PKG_LoadForecastDataImport')
...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'', '\Package.Variables[User::PS_PackageSubDir].Properties[Value]',	'String'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'1', '\Package.Variables[User::PS_ImportType].Properties[Value]', 'Int16'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'D:\EssentSSIS\load_forecast\NominatorResponseData\', '\Package.Variables[User::PS_HourlyDataSourceFolderLocation].Properties[Value]', 'String'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'D:\EssentSSIS\load_forecast\NominatorOutput\Processed\', '\Package.Variables[User::PS_HourlyDataProcessedFolderLocation].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'D:\EssentSSIS\load_forecast\NominatorOutput\Error\', '\Package.Variables[User::PS_HourlyDataErrorFolderLocation].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PKG_LoadForecastNominatorRequest', 'D:\EssentSSIS\load_forecast\NominatorRequestData\gas', '\Package.Variables[User::PS_RequestFolderPathGas].Properties[Value]', 'String'
UNION ALL
SELECT 'PKG_LoadForecastNominatorRequest', 'D:\EssentSSIS\load_forecast\NominatorRequestData\power', '\Package.Variables[User::PS_RequestFolderPathPower].Properties[Value]', 'String'
