...
update application_functions set document_path = 'Administration/Setup/maintain_definition.htm' where function_id =10101114
...
update application_functions set document_path = 'Back Office/Accounting/Derivative/Ongoing Assessment/Run_What_If_Measurement_Analysis.htm' where function_id =10232610
...
update application_functions set document_path = 'Back Office/Contract Administration/Maintain Contract.htm' where function_id =10211013
...
update application_functions set document_path = 'Front Office/Deal Capture/maintain_transaction_Blotter.htm' where function_id =10131011
...
update application_functions set document_path = 'Middle Office/Valuation and Risk Analysis/Run Counterparty MTM Report.htm' where function_id=10182200
...
update application_functions set document_path = 'Middle Office/Credit Risks and Analysis/import_data.htm' where function_id =10191100
update application_functions set document_path = 'Middle Office/Reporting/Report Writer.htm' where function_id =10201010
update application_functions set document_path = 'Middle Office/Credit Risks and Analysis/Maintain Counterparty.htm' where function_id =10101120
...
--TOC
update application_functions set document_path = '/TOC.htm' where function_id=10000000
