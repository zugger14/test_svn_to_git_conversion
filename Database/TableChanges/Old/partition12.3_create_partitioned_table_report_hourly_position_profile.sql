/****** Object:  Table [dbo].[report_hourly_position_profile]    Script Date: 02/28/2012 10:18:07 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[report_hourly_position_profile]') AND type in (N'U'))
