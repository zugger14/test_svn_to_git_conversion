...
/****** Object:  Table [dbo].[Trayport_Staging_Error]    Script Date: 07/18/2011 23:29:23 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Trayport_Staging_Error]') AND type in (N'U'))
DROP TABLE [dbo].[Trayport_Staging_Error]
GO
...
CREATE TABLE [dbo].[Trayport_Staging_Error](
