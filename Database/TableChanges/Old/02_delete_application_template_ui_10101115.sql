-- DELETE SCRIPT STARTS HERE
				...
				WHERE aut.application_function_id = '10101115'
				...
				DELETE FROM application_ui_filter WHERE application_function_id = '10101115'
				...
				WHERE application_function_id = '10101115'