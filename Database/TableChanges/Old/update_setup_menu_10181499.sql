IF EXISTS (SELECT 1 FROM setup_menu WHERE function_id = 10181499  AND product_category = 10000000)
BEGIN
	DELETE FROM setup_menu WHERE function_id = 10181499  AND product_category = 10000000
END
