...
SET ANSI_PADDING ON
GO
SP_RENAME report_hourly_position_deal , report_hourly_position_deal_non_part
IF OBJECT_ID(N'[dbo].[report_hourly_position_deal]', N'U') IS NULL
...
INSERT INTO report_hourly_position_deal SELECT * FROM report_hourly_position_deal_non_part 
GO

-----------------------------report_hourly_position_profile

SP_RENAME report_hourly_position_profile , report_hourly_position_profile_non_part
IF OBJECT_ID(N'[dbo].[report_hourly_position_profile]', N'U') IS NULL
...
CREATE CLUSTERED INDEX [indx_report_hourly_position_profile] ON [dbo].[report_hourly_position_profile] 
(
	[term_start] ASC
...
ALTER TABLE [dbo].[report_hourly_position_profile] SET (LOCK_ESCALATION = AUTO)
GO

INSERT INTO report_hourly_position_profile SELECT * FROM report_hourly_position_profile_non_part 
GO
-----------------------------report_hourly_position_breakdown

/****** Object:  Table [dbo].[report_hourly_position_breakdown ]    Script Date: 02/28/2012 14:10:49 ******/
SP_RENAME report_hourly_position_breakdown , report_hourly_position_breakdown_non_part
IF OBJECT_ID(N'[dbo].[report_hourly_position_breakdown]', N'U') IS NULL
...
CREATE TABLE [dbo].[report_hourly_position_breakdown](
	[source_deal_header_id]			INT  NULL,
	[curve_id]						INT  NULL,
	[location_id]					INT  NULL,
	[term_start]					DATETIME NOT NULL,
...
CREATE NONCLUSTERED INDEX [indx_report_hourly_position_breakdown_commodity_id] ON [dbo].[report_hourly_position_breakdown ] 
(
	[commodity_id] ASC
...
CREATE NONCLUSTERED INDEX [indx_report_hourly_position_breakdown_counterparty_id] ON [dbo].[report_hourly_position_breakdown ] 
(
	[counterparty_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 90)ON ps_position_report_hourly_position_breakdown(term_start)
...
CREATE NONCLUSTERED INDEX [indx_report_hourly_position_breakdown_deal_date] ON [dbo].[report_hourly_position_breakdown ] 
(
	[deal_date] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 90) ON ps_position_report_hourly_position_breakdown(term_start)
...
CREATE NONCLUSTERED INDEX [indx_report_hourly_position_breakdown_fas_book_id] ON [dbo].[report_hourly_position_breakdown ] 
(
	[fas_book_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 90) ON ps_position_report_hourly_position_breakdown(term_start)
GO
...
CREATE NONCLUSTERED INDEX [indx_report_hourly_position_breakdown_source_system_book_id] ON [dbo].[report_hourly_position_breakdown ] 
(
...
CREATE NONCLUSTERED INDEX [indx_report_hourly_position_breakdown_volume_uom_id] ON [dbo].[report_hourly_position_breakdown ] 
(
...
GO
INSERT INTO report_hourly_position_breakdown SELECT * FROM report_hourly_position_breakdown_non_part 
GO
...
IF OBJECT_ID(N'[dbo].[delta_report_hourly_position]', N'U') IS NULL
...
SP_RENAME report_hourly_position_fixed , report_hourly_position_fixed_non_part
SET ANSI_NULLS ON
GO
...
INSERT INTO report_hourly_position_fixed SELECT * FROM report_hourly_position_fixed_non_part 
GO

-----------------------------report_hourly_position_fixed

SP_RENAME deal_position_break_down , deal_position_break_down_non_part
...
SET ANSI_PADDING ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[deal_position_break_down]') AND type IN (N'U'))
...
ALTER TABLE [dbo].[deal_position_break_down]  WITH NOCHECK ADD  CONSTRAINT [FK_deal_position_break_down_source_deal_header1] FOREIGN KEY([source_deal_header_id])
REFERENCES [dbo].[source_deal_header] ([source_deal_header_id])
GO

ALTER TABLE [dbo].[deal_position_break_down] CHECK CONSTRAINT [FK_deal_position_break_down_source_deal_header1]
GO

ALTER TABLE [dbo].[deal_position_break_down]  WITH NOCHECK ADD  CONSTRAINT [FK_deal_position_break_down_source_price_curve_def1] FOREIGN KEY([curve_id])
REFERENCES [dbo].[source_price_curve_def] ([source_curve_def_id])
GO

ALTER TABLE [dbo].[deal_position_break_down] CHECK CONSTRAINT [FK_deal_position_break_down_source_price_curve_def1]
GO

SET IDENTITY_INSERT deal_position_break_down ON
INSERT INTO deal_position_break_down(breakdown_id,source_deal_header_id,source_deal_detail_id,leg,strip_from,lag,strip_to,curve_id,prior_year,multiplier,create_ts,create_user,derived_curve_id,location_id,volume_uom_id,commodity_id,phy_fin_flag,del_term_start,fin_term_start,fin_expiration_date,del_vol_multiplier,fin_term_end,formula)
 SELECT breakdown_id,source_deal_header_id,source_deal_detail_id,leg,strip_from,lag,strip_to,curve_id,prior_year,multiplier,create_ts,create_user,derived_curve_id,location_id,volume_uom_id,commodity_id,phy_fin_flag,del_term_start,fin_term_start,fin_expiration_date,del_vol_multiplier,fin_term_end,formula
 FROM deal_position_break_down_non_part
SET IDENTITY_INSERT deal_position_break_down OFF
GO

-----------------------------report_hourly_position_fixed

SP_RENAME delta_report_hourly_position_breakdown , delta_report_hourly_position_breakdown_non_part
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[delta_report_hourly_position_breakdown]') AND type IN (N'U'))
...
INSERT INTO delta_report_hourly_position_breakdown SELECT * FROM delta_report_hourly_position_breakdown_non_part 
GO