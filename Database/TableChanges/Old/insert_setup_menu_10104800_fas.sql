IF NOT EXISTS(SELECT 1 FROM setup_menu WHERE function_id = 10106300 AND product_category = 13000000)
BEGIN
    ...
    VALUES (10106300, 'windowDataImportNewUI', 'Data Import/Export New UI', '', 1, 10100000, 13000000, 112, 0)
