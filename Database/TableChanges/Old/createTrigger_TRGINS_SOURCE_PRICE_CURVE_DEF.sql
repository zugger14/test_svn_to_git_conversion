...
IF OBJECT_ID('[dbo].[TRGINS_SOURCE_PRICE_CURVE_DEF]', 'TR') IS NOT NULL
    DROP TRIGGER [dbo].[TRGINS_SOURCE_PRICE_CURVE_DEF]
GO

CREATE TRIGGER [dbo].[TRGINS_SOURCE_PRICE_CURVE_DEF]
