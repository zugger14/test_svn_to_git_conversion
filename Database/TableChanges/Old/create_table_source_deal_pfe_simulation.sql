...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[source_deal_pfe_simulation]') AND type in (N'U'))
DROP TABLE [dbo].[source_deal_pfe_simulation]
GO
...
CREATE TABLE [dbo].[source_deal_pfe_simulation](
