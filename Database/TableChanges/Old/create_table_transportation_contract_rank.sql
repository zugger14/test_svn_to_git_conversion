...
IF OBJECT_ID(N'[dbo].[transportation_contract_rank]', N'U') IS NULL
BEGIN
    CREATE TABLE [dbo].[transportation_contract_rank]
    (
    [transportation_contract_rank_id]		INT IDENTITY(1, 1) PRIMARY KEY,
...
ELSE
BEGIN
    PRINT 'Table transportation_contract_rank EXISTS'
END
