IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition WHERE field_id = 'custom_as_of_date_field' AND application_function_id = 10201900) 
BEGIN
	...
	VALUES(10201900, 'custom_as_of_date_field', 'custom_as_of_date_field', 'Custom As Of Date', 'input','y',1,'n')
END
...
WHERE field_id = 'custom_as_of_date_field' 
	AND application_function_id = 10201900
...
WHERE application_ui_template_id = (
	...
	WHERE application_function_id = 10201900
)
...
BEGIN
	...
	VALUES(@application_group_id,@application_ui_field_id,'','end_date','','','y','input')	
END