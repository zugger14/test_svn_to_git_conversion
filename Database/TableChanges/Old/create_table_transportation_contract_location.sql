...
IF OBJECT_ID(N'[dbo].[transportation_contract_location]', N'U') IS NULL
BEGIN
    CREATE TABLE [dbo].[transportation_contract_location] (
		[transportation_contract_location_id]			INT IDENTITY(1, 1) NOT NULL PRIMARY KEY,
...
ELSE
BEGIN
    PRINT 'Table transportation_contract_location EXISTS'
END
