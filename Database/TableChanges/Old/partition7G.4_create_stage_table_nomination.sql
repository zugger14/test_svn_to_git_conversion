...
/****** Object:  Table [dbo].[stage_deal_detail_hour]    Script Date: 05/23/2012 02:14:21 ******/
SET ANSI_NULLS ON
GO
...
IF OBJECT_ID(N'[dbo].[stage_deal_detail_hour]', N'U') IS NULL
CREATE TABLE [dbo].[stage_deal_detail_hour](
...
ALTER TABLE [dbo].[stage_deal_detail_hour] SET (LOCK_ESCALATION = AUTO)
GO

ALTER TABLE [dbo].[stage_deal_detail_hour] ADD  DEFAULT (getdate()) FOR [create_ts]
GO
