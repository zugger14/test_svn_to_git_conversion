...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[report_hourly_position_breakdown ]') AND type in (N'U'))
DROP TABLE [dbo].[report_hourly_position_breakdown ]
GO
