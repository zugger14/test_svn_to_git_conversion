...
IF EXISTS (SELECT 1 FROM generic_mapping_header WHERE mapping_name = 'Nomination Mapping')
BEGIN
	UPDATE gmh
	SET mapping_name = 'Nomination Mapping',
		total_columns_used = 2
	FROM generic_mapping_header gmh
	WHERE gmh.mapping_name = 'Nomination Mapping'		
END
ELSE 
BEGIN 
