...
/****** Object:  Table [dbo].[report_hourly_position_deal]    Script Date: 09/04/2012 16:19:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[report_hourly_position_financial]') AND type in (N'U'))
DROP TABLE [dbo].[report_hourly_position_financial]
GO
...
CREATE TABLE [dbo].[report_hourly_position_financial](
