IF NOT EXISTS(SELECT 1 FROM application_ui_template_definition WHERE field_id = 'custom_as_of_date_field' AND application_function_id = 10202000) 
BEGIN
	...
	VALUES(10202000, 'custom_as_of_date_field', 'custom_as_of_date_field', 'Custom As Of Date', 'input', 'y', 1, 'n')
END
...
WHERE field_id = 'custom_as_of_date_field' 
	AND application_function_id = 10202000
...
BEGIN
	...
	VALUES(@application_group_id, @application_ui_field_id, '', 'date_to', '', '', 'y', 'input')	
END