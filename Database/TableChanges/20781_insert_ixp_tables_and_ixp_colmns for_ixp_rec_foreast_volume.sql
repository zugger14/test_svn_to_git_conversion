IF NOT EXISTS (SELECT 1 FROM ixp_tables WHERE ixp_tables_name = 'ixp_rec_forecast_volume')
BEGIN
	INSERT INTO ixp_tables (ixp_tables_name, ixp_tables_description, import_export_flag)
	VALUES ('ixp_rec_forecast_volume', 'REC Forecast Volume', 'i')
END
...
FROM ixp_tables
WHERE ixp_tables_name = 'ixp_rec_forecast_volume'
