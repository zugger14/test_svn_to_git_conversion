...
UNION ALL
SELECT 'PKG_ShapedHourlyDealImport', 'D:\EssentSSIS\Shaped Hourly\Data\Shaped Hourly Import Data\', '\Package.Variables[User::PS_DataSourceFolder].Properties[Value]', 'String'
UNION ALL
SELECT 'PKG_ShapedHourlyDealImport', 'D:\EssentSSIS\Shaped Hourly\Data\Processed\', '\Package.Variables[User::PS_DataProcessedFolder].Properties[Value]', 'String'
UNION ALL
SELECT 'PKG_ShapedHourlyDealImport', 'D:\EssentSSIS\Shaped Hourly\Data\Error\', '\Package.Variables[User::PS_DataErrorFolder].Properties[Value]', 'String'
