...
UNION ALL
SELECT 'PKG_PriceCurveVolatilityCorrelationDataImport', '26Nov2012', '\Package.Variables[User::PS_MailServerPassword].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PKG_PriceCurveVolatilityCorrelationDataImport', 'gmail.com,pioneersolutionsglobal.com', '\Package.Variables[User::PS_EmailFromAddressDomain].Properties[Value]', 'String'
UNION ALL
