...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\\emgfsp1.external.essent.local\funcprod$\trmtracker\NominatorResponseData\', '\Package.Variables[User::PS_HourlyDataSourceFolderLocation].Properties[Value]', 'String'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\\emgfsp1.external.essent.local\funcprod$\trmtracker\NominatorOutput\Processed\', '\Package.Variables[User::PS_HourlyDataProcessedFolderLocation].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'D:\Application\TRMTracker\SSISPackage\LoadForecast\DealDetailHourData\', '\Package.Variables[User::PS_HourlyDataFolderLocation].Properties[Value]', 'String'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\\emgfsp1.external.essent.local\funcprod$\trmtracker\NominatorOutput\Error\', '\Package.Variables[User::PS_HourlyDataErrorFolderLocation].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PKG_LoadForecastNominatorRequest', '\\emgfsp1.external.essent.local\funcprod$\trmtracker\NominatorRequestData\gas', '\Package.Variables[User::PS_RequestFolderPathGas].Properties[Value]', 'String'
UNION ALL
SELECT 'PKG_LoadForecastNominatorRequest', '\\emgfst01.et.local\functest$\trmtracker\NominatorRequestData\power', '\Package.Variables[User::PS_RequestFolderPathPower].Properties[Value]', 'String'
UNION ALL
