...
INSERT ssis_configurations(ConfigurationFilter, ConfiguredValue, PackagePath, ConfiguredValueType)
      ...
      UNION ALL
	  SELECT 'PRJ_RDBInterface', 'D:\EssentSSIS\RDB_Output', '\Package.Variables[User::OutputPATH].Properties[Value]', 'String'
	  UNION ALL 
      SELECT 'PRJ_RDBInterface','D:\EssentSSIS\RDB_Output - Copy', '\Package.Variables[User::Copy_OutputPATH].Properties[Value]', 'String'
