...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\load_forecast\Packages', '\Package.Variables[User::PS_PackageSubDir].Properties[Value]',	'String'
UNION ALL
...
UNION ALL
SELECT  'PKG_LoadForecastNominatorRequest', '\load_forecast\Packages', '\Package.Variables[User::PS_PackageSubDir].Properties[Value]', 'String'
