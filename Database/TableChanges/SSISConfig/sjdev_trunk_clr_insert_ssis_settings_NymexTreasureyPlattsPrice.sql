...
UNION
SELECT 'PKG_NymexTreasuryPlattsPriceCurveImport', 'd:\FARRMS_DataSrc\TRMTracker_Trunk_CLR\NymexTreasuryPlattsPriceCurve\Data', '\Package.Variables[User::ps_workspace].Properties[Value]', 'String'
UNION
...
UPDATE connection_string SET import_path = 'D:\FARRMS_SPTFiles\SSIS\TRMTracker_Trunk_CLR'
