...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\\emgfsa01.et.local\funcacce$\trmtracker\UAT\LoadForecast\NominatorResponseData\', '\Package.Variables[User::PS_HourlyDataSourceFolderLocation].Properties[Value]', 'String'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\\emgfsa01.et.local\funcacce$\trmtracker\UAT\LoadForecast\NominatorOutput\Processed\', '\Package.Variables[User::PS_HourlyDataProcessedFolderLocation].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'D:\Application\TRMTracker\SSISPackage_UAT\LoadForecast\DealDetailHourData\', '\Package.Variables[User::PS_HourlyDataFolderLocation].Properties[Value]', 'String'
UNION ALL
SELECT 'PRJ_LoadForecastDataImportIS',	'\\emgfsa01.et.local\funcacce$\trmtracker\UAT\LoadForecast\NominatorOutput\Error\', '\Package.Variables[User::PS_HourlyDataErrorFolderLocation].Properties[Value]', 'String'
UNION ALL
...
UNION ALL
SELECT 'PKG_LoadForecastNominatorRequest', '\\emgfsa01.et.local\funcacce$\trmtracker\UAT\LoadForecast\NominatorRequestData\gas', '\Package.Variables[User::PS_RequestFolderPathGas].Properties[Value]', 'String'
UNION ALL
SELECT 'PKG_LoadForecastNominatorRequest', '\\emgfsa01.et.local\funcacce$\trmtracker\UAT\LoadForecast\NominatorRequestData\power', '\Package.Variables[User::PS_RequestFolderPathPower].Properties[Value]', 'String'
UNION ALL
