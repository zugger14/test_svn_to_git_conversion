...
AS
	...
	begin
		...
		set mvcc.title			=	cc.title
			...
			, mvcc.email_cc		=	cc.email_cc
			, mvcc.email_bcc	=	cc.email_bcc
	...
	--title,name,address1,address2,city,state,zip,country,region,email,comment,telephone,fax,cell_no
		...
		, country_sdv.code [country], region_sdv.code [region], cc.email, cc.comment, cc.telephone, cc.fax, cc.cell_no, cc.email_cc, cc.email_bcc
		from inserted cc
