...
go
if OBJECT_ID('[delta_report_hourly_position_financial_main]') is null
begin
CREATE TABLE [dbo].[delta_report_hourly_position_financial_main](
/**
...
*/
	...
	[rowid] [int] NOT NULL
	, CONSTRAINT PKC_delta_report_hourly_position_financial_main PRIMARY KEY CLUSTERED (term_start,source_deal_detail_id,period,delta_type,as_of_date)
...
ELSE
BEGIN
    PRINT 'Table delta_report_hourly_position_financial_main EXISTS'
END
