IF NOT EXISTS(SELECT 1 FROM ixp_tables WHERE ixp_tables_name = 'ixp_strategy_template')
BEGIN
		INSERT INTO ixp_tables(ixp_tables_name,ixp_tables_description,import_export_flag)
		VALUES('ixp_strategy_template','Strategy','i')
...
FROM ixp_tables
WHERE ixp_tables_name = 'ixp_strategy_template'
...
WHERE  o.[name] = 'fas_strategy' AND ic.ixp_columns_id IS NULL
