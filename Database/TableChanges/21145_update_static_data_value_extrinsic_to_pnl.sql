IF (SELECT 1 FROM static_data_value WHERE code = 'Extrinsic/Other Value' and [type_id] = 225) IS NOT NULL
BEGIN 
...
IF (SELECT 1 FROM static_data_value WHERE code = 'Extrinsic to PNL' and [type_id] = 225) IS NOT NULL
BEGIN
	UPDATE static_data_value
