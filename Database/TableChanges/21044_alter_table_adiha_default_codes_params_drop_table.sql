...
IF OBJECT_ID(N'[dbo].[adiha_default_codes_params]') IS NOT NULL
BEGIN
    DROP TABLE [dbo].adiha_default_codes_params
	--we dont need as table adiha_default_codes_values_adiha_default_codes_params is going to dropped
END
