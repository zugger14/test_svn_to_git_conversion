...
ELSE
BEGIN
	INSERT INTO #insert_output_sdv_external SELECT value_id, [type_id], code FROM static_data_value SDV WHERE code = 'Counterparty'	AND TYPE_ID = 5500
END

IF NOT EXISTS (SELECT 1 FROM static_data_value WHERE [type_id] = 5500 AND code = 'Deal Contract')
BEGIN
	SET IDENTITY_INSERT static_data_value ON
	INSERT INTO static_data_value (value_id, [type_id], code, [description])
	OUTPUT INSERTED.value_id, INSERTED.[type_id], INSERTED.code
	INTO #insert_output_sdv_external
	SELECT '-10000351', '5500', 'Deal Contract', 'Deal Contract'
	SET IDENTITY_INSERT static_data_value OFF
END
ELSE
BEGIN
	INSERT INTO #insert_output_sdv_external SELECT value_id, [type_id], code FROM static_data_value SDV WHERE code = 'Deal Contract'	AND TYPE_ID = 5500
END
...
IF NOT EXISTS (SELECT 1 FROM static_data_value WHERE [type_id] = 5500 AND code = 'Deal Profile')
BEGIN
	SET IDENTITY_INSERT static_data_value ON
	INSERT INTO static_data_value (value_id, [type_id], code, [description])
	OUTPUT INSERTED.value_id, INSERTED.[type_id], INSERTED.code
	INTO #insert_output_sdv_external
	SELECT '-10000350', '5500', 'Deal Profile', 'Deal Profile'
	SET IDENTITY_INSERT static_data_value OFF
END
ELSE
BEGIN
	INSERT INTO #insert_output_sdv_external SELECT value_id, [type_id], code FROM static_data_value SDV WHERE code = 'Deal Profile'	AND TYPE_ID = 5500
END
...
IF NOT EXISTS (SELECT 1 FROM   user_defined_fields_template WHERE  Field_label = 'Deal Contract')
BEGIN
    INSERT INTO user_defined_fields_template
      (
        field_name,
    ...
    SELECT iose.value_id,
           ...
           iose.value_id
    FROM   #insert_output_sdv_external iose
    WHERE  iose.[type_name] = 'Deal Contract'
END
ELSE
BEGIN
    UPDATE user_defined_fields_template
    ...
    WHERE  Field_label = 'Deal Contract'
END

IF NOT EXISTS (SELECT 1 FROM   user_defined_fields_template WHERE  Field_label = 'Deal Profile')
BEGIN
    INSERT INTO user_defined_fields_template
      (
        field_name,
    ...
    SELECT iose.value_id,
           ...
           iose.value_id
    FROM   #insert_output_sdv_external iose
    WHERE  iose.[type_name] = 'Deal Profile'
END
ELSE
BEGIN
    UPDATE user_defined_fields_template
    ...
    WHERE  Field_label = 'Deal Profile'
END
...
SELECT @contract_id = udf_template_id FROM user_defined_fields_template WHERE Field_label = 'Deal Contract'
SELECT @profile_id = udf_template_id FROM user_defined_fields_template WHERE Field_label = 'Deal Profile'
...
BEGIN
	...
	SET 
		...
		clm2_label = 'Deal Contract',
		clm2_udf_id = @contract_id,
		clm3_label = 'Deal Profile',
...
BEGIN
	...
	SELECT 
		...
		'Deal Contract', @contract_id,
		'Deal Profile', @profile_id,
