...
DECLARE @job_name NVARCHAR(500) = @job_db_name + N' - ' + @job_category + N' - Forecast Volume'
...
IF NOT EXISTS(SELECT * FROM batch_process_notifications WHERE process_id = 'zef42e2330j12')
BEGIN
...
BEGIN
	...
	WHERE process_id = 'zef42e2330j12'
END
...
DECLARE @command1 NVARCHAR(4000) = '
		...
		WHERE ir.ixp_rule_hash = ''8AEB347F_A902_4C3A_9114_FC4BCF5C52B6''
		...
		BEGIN
			...
			EXEC spa_run_sp_with_dynamic_params @parameter, ''zef42e2330j12'', NULL
		END
		'
