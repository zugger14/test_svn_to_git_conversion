...
SET @job_name = @db_name + N' - Calculate - Gas Nomination Submission export'
...
EXEC [dbo].[spa_calc_gas_nomination_submission]
'
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@job_name, 
		...
		@job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'calc gas Nomination', 
		@step_id=1, 
