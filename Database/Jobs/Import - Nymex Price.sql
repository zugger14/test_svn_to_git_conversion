...
SET @job_name = @db_name + N' - ' + @job_category + N' - Nymex Price'

SET @command = 'DECLARE @contextinfo varbinary(128)
...
SELECT @rule_id = ixp_rules_id FROM ixp_rules WHERE ixp_rules_name = ''Nymex Price Import''

		SET @sql = 	''
	EXEC spa_run_sp_with_dynamic_params ''''spa_ixp_rules ''''''''r'''''''', NULL, ''''''''''+@rule_id+'''''''''', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ''''''''\\app\shared_docs_TRMTracker_Trunk\temp_Note'''''''', '''''''''''''''', NULL,@batch_process_id="''+@process_id+''",@batch_report_param=''''''''spa_ixp_rules ''''''''''''''''r'''''''''''''''', NULL, ''''''''''''''''''+@rule_id+'''''''''''''''''', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ''''''''''''''''\\app\shared_docs_TRMTracker_Trunk\temp_Note'''''''''''''''', '''''''''''''''''''''''''''''''', NULL'''''''''''',null,NULL
...
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 4/21/2016 3:23:09 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@job_name, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Import from Nymex Price', 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Run nymex', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
