...
DECLARE @job_name NVARCHAR(500) = @job_db_name + N' - ' + @job_category + N' - Shaped Volume Gas'
...
IF NOT EXISTS(SELECT * FROM batch_process_notifications WHERE process_id = 'zef42e2330j16')
BEGIN
...
BEGIN
	...
	WHERE process_id = 'zef42e2330j16'
END
...
DECLARE @command1 NVARCHAR(4000) = '
		...
		WHERE ir.ixp_rule_hash = ''30F320BA_815F_4DB7_9314_B037E84311B6''
		...
		BEGIN
			...
			EXEC spa_run_sp_with_dynamic_params @parameter, ''zef42e2330j16'', NULL
		END
		'
