...
DECLARE @job_name NVARCHAR(500) = @job_db_name + N' - ' + @job_category + N' - Generation Gas ST Forecast'
...
IF NOT EXISTS(SELECT * FROM batch_process_notifications WHERE process_id = 'zef42e2330j13')
BEGIN
...
BEGIN
	...
	WHERE process_id = 'zef42e2330j13'
END
...
DECLARE @command1 NVARCHAR(4000) = '
		...
		WHERE ir.ixp_rule_hash = ''493F3F94_FEC0_4027_B750_7ADED2C35ED9''
		...
		BEGIN
			...
			EXEC spa_run_sp_with_dynamic_params @parameter, ''zef42e2330j13'', NULL
		END
		'
