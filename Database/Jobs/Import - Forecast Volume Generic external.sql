...
DECLARE @job_name NVARCHAR(500) = @job_db_name + N' - ' + @job_category + N' - Forecast Volume Generic external'
...
IF NOT EXISTS(SELECT * FROM batch_process_notifications WHERE process_id = 'zef42e2330j15')
BEGIN
...
BEGIN
	...
	WHERE process_id = 'zef42e2330j15'
END
...
DECLARE @command1 NVARCHAR(4000) = '
		...
		WHERE ir.ixp_rule_hash = ''1B2C3517_8491_48F1_9165_3B6FB0617A92''
		...
		BEGIN
			...
			EXEC spa_run_sp_with_dynamic_params @parameter, ''zef42e2330j15'', NULL
		END
		'
