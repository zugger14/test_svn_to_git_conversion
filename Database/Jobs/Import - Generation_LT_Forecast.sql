...
IF NOT EXISTS(SELECT * FROM batch_process_notifications WHERE process_id = 'zef42e2330j02')
BEGIN
...
BEGIN
	...
	WHERE process_id = 'zef42e2330j02'
END
...
DECLARE @command1 NVARCHAR(4000) = '
		...
		BEGIN
			...
			EXEC spa_run_sp_with_dynamic_params @parameter, ''zef42e2330j02'', NULL
		END
		'
