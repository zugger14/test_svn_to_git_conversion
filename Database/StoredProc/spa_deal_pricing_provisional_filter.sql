IF OBJECT_ID(N'[dbo].[spa_deal_pricing_provisional_filter]', N'P') IS NOT NULL
    DROP PROCEDURE [dbo].[spa_deal_pricing_provisional_filter]
GO
...
-- ===============================================================================================================
CREATE PROCEDURE [dbo].[spa_deal_pricing_provisional_filter]
    @flag CHAR(1),
	@filter_id INT = NULL,
