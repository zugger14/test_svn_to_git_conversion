IF OBJECT_ID(N'[dbo].[spa_deal_pricing_quality_filter]', N'P') IS NOT NULL
    DROP PROCEDURE [dbo].[spa_deal_pricing_quality_filter]
GO
...
--=============================================================
CREATE PROCEDURE [dbo].[spa_deal_pricing_quality_filter]
    @flag CHAR(1),
	@filter_id INT = NULL,
	...
	BEGIN TRY
		...
		BEGIN
			EXEC spa_ErrorHandler 0
					, 'pinned_reports'
					, 'spa_deal_pricing_quality_filter'
					, 'Error' 
