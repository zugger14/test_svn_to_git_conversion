IF OBJECT_ID(N'[dbo].[spa_rfx_report_page_image_dhx]', N'P') IS NOT NULL
    DROP PROCEDURE [dbo].[spa_rfx_report_page_image_dhx]
GO
...
-- Sample Use :: EXEC spa_rfx_report_page_image_dhx 'i', '751FAC2F_F97C_479F_BE6B_CB39EEE7B0EA', NULL, 648, 'IMG_21112012_144048.png', '216572acaa31ca543242634d38824557.png', '2.6666666666666665', '0.7733333333333333', '4.933333333333334', '2.4266666666666667'
-- Sample Use :: EXEC spa_rfx_report_page_image_dhx 'u', '751FAC2F_F97C_479F_BE6B_CB39EEE7B0EA', 123, 648, 'IMG_21112012_144048.png', '216572acaa31ca543242634d38824557.png', '2.6666666666666665', '0.7733333333333333', '4.933333333333334', '2.4266666666666667'
-- ===========================================================================================================
CREATE PROCEDURE [dbo].[spa_rfx_report_page_image_dhx]
    @flag					CHAR(1),
