...
/****** Object:  StoredProcedure [dbo].[spa_Get_Risk_Control_Activities_Trend]    Script Date: 11/07/2008 12:41:37 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spa_Get_Risk_Control_Activities_Trend]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spa_Get_Risk_Control_Activities_Trend]
go

-- EXEC spa_Get_Risk_Control_Activities NULL, @as_of_date, NULL, NULL, NULL, NULL, 'S', 1
create PROC [dbo].[spa_Get_Risk_Control_Activities_Trend]
