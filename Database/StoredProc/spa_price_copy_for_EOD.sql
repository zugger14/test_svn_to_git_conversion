IF OBJECT_ID('[dbo].[spa_price_copy_for_EOD]') IS NOT NULL
BEGIN
    DROP PROCEDURE [dbo].[spa_price_copy_for_EOD]
END
...
CREATE PROC [dbo].[spa_price_copy_for_EOD]
AS
...
-- Changed on 12th March 2012 By SGUPTA as this script is only for source_price_curve and table name has 
----been hardcoded in SP
