...
IF  EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].spa_rfx_get_dependent_parameters_dhx') AND TYPE IN (N'P', N'PC'))
	DROP PROCEDURE [dbo].spa_rfx_get_dependent_parameters_dhx
GO
...
CREATE PROCEDURE [dbo].spa_rfx_get_dependent_parameters_dhx
	@paramset_id	INT
	, @flag			CHAR(2)= NULL
