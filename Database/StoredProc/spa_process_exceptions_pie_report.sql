...
GO
/****** Object:  StoredProcedure [dbo].[spa_process_exceptions_pie_report]    Script Date: 11/20/2008 00:52:47 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spa_process_exceptions_pie_report]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spa_process_exceptions_pie_report]


GO
/****** Object:  StoredProcedure [dbo].[spa_process_exceptions_pie_report]    Script Date: 11/20/2008 00:52:56 ******/
SET ANSI_NULLS ON
GO
...
-- exec spa_process_exceptions_pie_report 'farrms_admin','2006-01-01','2007-12-31','138,201,137,135,136',NULL,NULL,NULL,NULL,NULL,'A',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'n',NULL,NULL,NULL

-- EXEC spa_process_exceptions_pie_report  NULL, '01/01/2004', '12/31/2006', '135', NULL, NULL, NULL, 'n'
-- exec spa_process_exceptions_pie_report 'farrms_admin','2006-01-01','2007-02-09','138,201,137,135,136',NULL,NULL,NULL,NULL,NULL,
...
CREATE procedure [dbo].[spa_process_exceptions_pie_report] 
...
--select  @a_date '@a_date',  @as_of_date_to '@as_of_date_to'
	...
	EXEC spa_Get_Risk_Control_Activities_Pie @user_login_id, @a_date, @sub_id, @run_frequency, @risk_priority, @role_id,
