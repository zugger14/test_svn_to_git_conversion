...
/****** Object:  StoredProcedure [dbo].[spa_Get_Risk_Control_Activities_perform]    Script Date: 04/15/2009 19:36:13 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spa_Get_Risk_Control_Activities_perform]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spa_Get_Risk_Control_Activities_perform]

/****** Object:  StoredProcedure [dbo].[spa_Get_Risk_Control_Activities_perform]    Script Date: 04/15/2009 19:36:18 ******/
SET ANSI_NULLS ON
GO
...
-- EXEC spa_Get_Risk_Control_Activities NULL, '2004-01-31', '135', NULL, NULL, NULL, 'e', 3, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL

-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '2006-12-31', '138,201,137,135,136', NULL, NULL, NULL, 'S', 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL

-- EXEC spa_Get_Risk_Control_Activities 'farrms_admin', '12/31/2006', NULL, NULL, 675, NULL, 'c', 2
-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '1/31/2006', NULL, NULL, 675, NULL, 'e', 3
-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '1/31/2006', '1', NULL, 675, NULL, 'a', 2
-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '1/31/2006', NULL, NULL, NULL, NULL, 'e', 3, NULL, 1

-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '01/31/2006', NULL, NULL, NULL, NULL, 'N', 1, NULL, 0
-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '2006-12-31', '135', NULL, NULL, NULL, A, NULL, NULL,NULL, NULL,NULL, NULL, NULL,NULL, NULL, NULL, NULL,NULL, NULL, NULL 
-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '2006-12-31', '135', NULL, NULL, NULL, A, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
-- EXEC spa_Get_Risk_Control_Activities 'urbaral', '2006-12-31', 135, NULL, NULL, NULL, 'N', 3, 0
-- EXEC spa_Get_Risk_Control_Activities NULL, '01/26/2006', NULL, NULL, NULL, NULL, 'R', 1, NULL, 0

-- EXEC spa_Get_Risk_Control_Activities 'farrms_admin', '2006-12-31', 135, NULL, NULL, NULL, 'N', 1, 0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ashrestha'
-- EXEC spa_Get_Risk_Control_Activities 'farrms_admin', '2006-12-31', '135', NULL, NULL, NULL, 'N', 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ashrestha'
--@call_type = 1 is from run, 2 is from apporve, 3 is read for a date, 4 for monetary penalty 

-- EXEC spa_Get_Risk_Control_Activities NULL, '2007-02-13', NULL, NULL, NULL, NULL, 'R', 1, NULL, 0

CREATE PROC [dbo].[spa_Get_Risk_Control_Activities_perform]
...
SET @sql_stmt = @sql_stmt + ' WHERE (CONVERT(DATETIME,''' + @as_of_date + ''', 102)  between prc.run_effective_date and isnull(prc.run_end_date, CONVERT(DATETIME,''' + @as_of_date + ''', 102)) OR
CONVERT(DATETIME,''' + @as_of_date_to + ''', 102) between prc.run_effective_date and isnull(prc.run_end_date, CONVERT(DATETIME,''' + @as_of_date_to + ''', 102))) '
...
r.risk_control_email_id, k.as_of_date
into #reminder1
from #tempControls a 
INNER JOIN
...
left outer join process_risk_controls_reminders_acknowledge k on 
k.risk_control_reminder_id = r.risk_control_email_id and k.as_of_date = a.as_of_date 
where k.as_of_date is null
group by a.risk_control_id, r.risk_control_email_id, k.as_of_date
...
select r1.risk_control_id, r1.risk_control_email_id, r1.Remind
into #reminder
from
...
CREATE TABLE #tempControls_test (
	...
	[threshold_days] [int]  NULL ,
	[exception_date] [datetime]  NULL,
	[requires_approval] [char](1) COLLATE DATABASE_DEFAULT NULL,
    [activity_status]  int NULL,
    [run_by] [varchar] (50) COLLATE DATABASE_DEFAULT NULL,
	[run_date] [datetime]  NULL,
    [approved_by] [varchar] (200) COLLATE DATABASE_DEFAULT NULL,
    [approved_date] [datetime]  NULL,
    [attach_proof] [varchar] (200) COLLATE DATABASE_DEFAULT NULL, 
    [save_clm] [varchar] (200) COLLATE DATABASE_DEFAULT NULL, 
    [approve_checkbox] [char](1) COLLATE DATABASE_DEFAULT NULL,
    [exception_flag]  [char] (1) COLLATE DATABASE_DEFAULT NULL,
    [activity_status_desc] [varchar] (200) COLLATE DATABASE_DEFAULT NULL,
    [as_of_date_display] [varchar] (50) COLLATE DATABASE_DEFAULT   NULL,
    [as_of_date_argument][varchar] (50) COLLATE DATABASE_DEFAULT  NULL,
    [time_exception] [int] NULL,
	[monetary_value] float NULL,
    [monetary_penalty]float NULL,
	[monetary_value_frequency_id] int null,
	[monetary_value_changes] [varchar] (1) COLLATE DATABASE_DEFAULT null,
	[requires_approval_for_late] [varchar] (1) COLLATE DATABASE_DEFAULT null,
    [force_late_approval] [varchar] (1) COLLATE DATABASE_DEFAULT null,
	[mitigation_plan_required] varchar(1) COLLATE DATABASE_DEFAULT null,
	[requirements_revision_id] int null,
	[sub_name] [varchar] (100) COLLATE DATABASE_DEFAULT  NOT NULL,
	[stra_name] [varchar] (100) COLLATE DATABASE_DEFAULT  NOT NULL,
	...
	risk_control_reminder_id int NULL
 
)



SET @sql_stmt = 'INSERT #tempControls_test
    SELECT 
	#tempControls.subsidiary_id,
	#tempControls.Subsidiary,
	#tempControls.perform_role_id,
	#tempControls.PerformRole,
	case when (''' + @unapporved_flag + ''' = ''R'' AND #reminder.risk_control_id is not null) then #reminder.risk_control_email_id else #tempControls.approve_role_id end approve_role_id,
...
-- 	  case when (isnull(prca.monetary_value, #tempControls.monetary_value) is not null) then '' (Monetary Value: ''+ cast(isnull(prca.monetary_value, #tempControls.monetary_value) as varchar) + '')''else '''' end control_activity,
	...
	CASE when (dbo.FNAGetSQLStandardDate(#tempControls.exception_date) < dbo.FNAGetSQLStandardDate(getdate()) and #tempControls.mitigation_plan_required = ''y'' ) then ''y'' else ''n'' end mitigation_plan_required,
	...
	case when prca.control_status IN (728, 729) then datepart(d,prca.update_ts-prca.exception_date)
	 ...
	 #reminder.risk_control_email_id
...
SET @sql_stmt = @sql_stmt + 
	 case when upper(@unapporved_flag) IN ('R', 'S') then ' WHERE 1=1 ' else -- ' WHERE #tempControls.as_of_date = CONVERT(DATETIME,''' + @as_of_date + ''', 102) ' else
	--	case when upper(@unapporved_flag) IN ('R', 'S') then ' WHERE 1=1 AND #tempControls.as_of_date = CONVERT(DATETIME,''' + @as_of_date + ''', 102) ' else
		' WHERE (isnull(prca.as_of_date, #tempControls.as_of_date) BETWEEN CONVERT(DATETIME,''' + @as_of_date + ''', 102) 
			AND CONVERT(DATETIME,''' + @as_of_date_to + ''', 102))' end
...
BEGIN
	...
	If upper(@unapporved_flag) = 'R'
		 SET @sql_stmt = @sql_stmt + ' AND (CONVERT(DATETIME,''' + @as_of_date + ''', 102) <> CONVERT(DATETIME, #tempControls.as_of_date, 102)
						 AND 
							(
								(prca.control_status IS NULL OR prca.control_status in (725, 726)
							) AND  #reminder.risk_control_id is not null)) '
	--Not completed		
	...
	If  upper(@unapporved_flag) = 'C'
		if @call_type = 2
			SET @sql_stmt = @sql_stmt + ' AND prca.control_status in (727,728) '
		else
	...
	If  upper(@unapporved_flag) = 'E'
		SET @sql_stmt = @sql_stmt + ' AND prca.control_status <> case when (#tempControls.requires_approval = ''n'') then 728 else 729 end '

	-- Completed but Exceeds threshold days 
	If  upper(@unapporved_flag) = 'T'
		SET @sql_stmt = @sql_stmt + ' AND (prca.control_status IN (728, 729) AND prca.update_ts > CONVERT(DATETIME, prca.exception_date, 102)) '

	-- Exceeds threshold days and still not completed - ESCALATION
	If  upper(@unapporved_flag) = 'S'
		SET @sql_stmt = @sql_stmt + ' AND (prca.control_status NOT IN (728, 729) AND getdate() > CONVERT(DATETIME, prca.exception_date, 102)) '
...
If @get_counts IN (1, 2)
  ...
  elsE 	
	SET @sql_stmt = case when @process_table is not null then 'INSERT INTO '+@process_table else '' end + 
		...
		case when (@get_counts = 1) then ' count(*) as total_rows ' else ' sum(cast(monetary_penalty as float)) as total_values' end + 
		',activity_status,sum(exception_days) as exception_days  from (' + @sql_stmt + ') xx
...
SELECT #tempControls_test.Subsidiary [Subsdiary],
       
       dbo.FNAComplianceHyperlink('a',366,#tempControls_test.PerformRole, cast(#tempControls_test.perform_role_id as varchar),default,default,default,default,default,default) [Role],
       #tempControls_test.run_frequency  [Frequency],
       #tempControls_test.risk_priority  [Priority],
       case when (activity_status <> 729 and time_exception > 0) then
       '<IMG SRC=''./adiha_pm_html/process_controls/flag.jpg''>' + ' ' + dbo.FNAComplianceHyperlink('b',401,#tempControls_test.control_activity,'''44''',cast(risk_control_id as varchar),default,default,default,default,default) 
else
       dbo.FNAComplianceHyperlink('b',401,#tempControls_test.control_activity,'''44''',cast(risk_control_id as varchar),default,default,default,default,default) end  [Activity],	
       dbo.FNAComplianceHyperlink('b',367,#tempControls_test.activity_status_desc, cast(risk_control_id as varchar),''''+as_of_date_argument+'''',default,default,default,default,default)  [Status],
	   #tempControls_test.monetary_penalty  [Penalty/Fees],
       #tempControls_test.as_of_date_display  [Date],     
       dbo.FNAComplianceHyperlink('a',368, '<IMG SRC=''./adiha_pm_html/process_controls/steps.jpg''>', cast(risk_control_id as varchar),default,default,default,default,default,default)  [Steps],
       dbo.FNAComplianceHyperlink('d',403,'<IMG SRC=''./adiha_pm_html/process_controls/doc.jpg''>',cast(risk_control_id as varchar),''+as_of_date_argument+'','r',default,default,default,default) [Proof],
    
      

       case when(activity_status_desc = 'Reminder') then 
       dbo.FNAComplianceHyperlink('d',801,'Acknowledge',cast(risk_control_reminder_id as varchar),''+as_of_date_argument+'','1',default,default,default,default) 

       when  (activity_status in (725,726) and upper(mitigation_plan_required) = 'y') then
        dbo.FNAComplianceHyperlink('d',800,'Mitigate',cast(risk_control_id as varchar),''''+as_of_date_argument+'''','1',default,default,default,default) 

         when (activity_status = '725' and requires_proof = 'n' ) then
       dbo.FNAComplianceHyperlink('d',412,'Complete',cast(risk_control_id as varchar),''''+as_of_date_argument+'''','1',default,default,default,default)

        when (activity_status ='725' or activity_status ='726' and requires_proof = 'y'  or upper(force_late_approval) = 'Y') then
       
       dbo.FNAComplianceHyperlink('d',402,'Complete W/Memo',cast(risk_control_id as varchar),''''+as_of_date_argument+'''','''u-1''',default,default,default,default) 
   
      

     when (activity_status = '726') then
       dbo.FNAComplianceHyperlink('d',412,'Re-process',cast(risk_control_id as varchar),''''+as_of_date_argument+'''','2',default,default,default,default)

     when (activity_status = '728') then
       dbo.FNAComplianceHyperlink('d',412,'Un-complete',cast(risk_control_id as varchar),''''+as_of_date_argument+'''','3',default,default,default,default)

      else
       ' '  end [Action]
       
 from #tempControls_test
