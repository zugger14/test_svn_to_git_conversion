...
if OBJECT_ID('spa_get_shift_commodity_value') is not null
drop proc spa_get_shift_commodity_value

go

Create proc dbo.spa_get_shift_commodity_value 
	@as_of_date DATETIME 
...
--			, shift_to
--			, shift_increment) 
--SELECT 	1 rnk, 50 commodity_id
--		,10 shift_from
--		,30 shift_to
--		,10 shift_increment 		  
--union all
--SELECT 	2 rnk, 123 commodity_id
--		,10 shift_from
--		,30 shift_to
--		,10 shift_increment 	
--SELECT * FROM #tmp_commodity_shift		
--		
SET @st1 = '
	INSERT INTO #tmp_commodity_shift (rnk, commodity_id
				, shift_from
...
--select * from 	  #total_val
		
-- select * from #tmp_final_calc
