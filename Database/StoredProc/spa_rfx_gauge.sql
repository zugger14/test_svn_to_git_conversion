...
IF OBJECT_ID(N'[dbo].[spa_rfx_gauge]', N'P') IS NOT NULL
    DROP PROCEDURE [dbo].[spa_rfx_gauge]
GO
...
-- ===========================================================================================================
CREATE PROCEDURE [dbo].[spa_rfx_gauge]
	@flag CHAR(1),
...
BEGIN
	...
	* */ 
	...
	IF @@ERROR <> 0
		EXEC spa_ErrorHandler @@ERROR, 'Reporting FX', 'spa_rfx_gauge', 'DB Error', 'Failed to save data.', ''
	ELSE
		EXEC spa_ErrorHandler 0, 'Reporting FX', 'spa_rfx_gauge', 'Success', 'Data successfully saved.', @report_page_gauge
...
BEGIN
	BEGIN TRY
		...
		EXEC spa_ErrorHandler 0, 'Reporting FX', 'spa_rfx_gauge', 'Success', 'gauge successfully deleted.', @process_id
	...
	BEGIN CATCH
		...
		EXEC spa_ErrorHandler 0, 'Reporting FX', 'spa_rfx_gauge', 'Failed', 'Fail to delete data.', @process_id
	END CATCH	
END
