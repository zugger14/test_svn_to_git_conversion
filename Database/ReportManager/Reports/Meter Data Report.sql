BEGIN TRY
		...
		SELECT TOP 1 'Meter Data Report' [name], 'dev_admin' [owner], 1 is_system, 1 is_excel, 0 is_mobile, '9227AE04_2A51_4E8B_92D9_4FA6F14A4699' report_hash, 'Meter Data Report' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
		FROM sys.objects o
