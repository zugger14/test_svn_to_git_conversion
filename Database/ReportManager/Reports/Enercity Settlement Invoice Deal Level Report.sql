BEGIN TRY
		...
		SELECT TOP 1 'Enercity Settlement Invoice Deal Level Report' [name], 'dev_admin' [owner], 0 is_system, 1 is_excel, 0 is_mobile, '9E9D7C44_21C3_430C_82FC_3E3BCCBA2FBA' report_hash, 'Enercity Settlement Invoice Deal Level Report' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
		FROM sys.objects o
	...
	SELECT @report_id_dest AS report_id, 'Enercity Settlement Invoice Deal Level Report' [name], '9E9D7C44_21C3_430C_82FC_3E3BCCBA2FBA' report_hash, 11.5 width,5.5 height
		...
		SELECT TOP 1 rpage.report_page_id, 'Enercity Settlement Invoice Deal Level Report', '8CDBBF25_4DA0_48AB_B4E5_59532BE3BC37', 2,'','','.xlsx',',', 
		-100000,'n','n',0	
		FROM sys.objects o
