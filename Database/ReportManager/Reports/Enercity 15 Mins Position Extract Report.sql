BEGIN TRY
		...
		set @report_copy_name = isnull(@report_copy_name, 'Copy of ' + 'Enercity 15 Mins Position Extract Report')
		

		INSERT INTO report ([name], [owner], is_system, is_excel, is_mobile, report_hash, [description], category_id)
		SELECT TOP 1 'Enercity 15 Mins Position Extract Report' [name], 'dev_admin' [owner], 0 is_system, 1 is_excel, 0 is_mobile, 'D36A0D9E_8EC2_45FB_881F_8DD8599EB7AC' report_hash, 'Enercity 15 Mins Position Extract Report' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
		FROM sys.objects o
	...
	SELECT @report_id_dest AS report_id, 'Enercity 15 Mins Position Extract Report' [name], 'D36A0D9E_8EC2_45FB_881F_8DD8599EB7AC' report_hash, 11.5 width,5.5 height
		...
		SELECT TOP 1 rpage.report_page_id, 'Enercity 15 Mins Position Extract Report', 'E8963A76_6F82_44E0_A651_CC85C5E3B316', 3,'','','.xlsx',',', 
		-100000,'n','n',0	
		FROM sys.objects o
		INNER JOIN report_page rpage 
			on rpage.[name] = 'Enercity 15 Mins Position Extract Report'
		INNER JOIN report r 
		ON r.report_id = rpage.report_id
			AND r.[name] = 'Enercity 15 Mins Position Extract Report'
		...
		INNER JOIN report_paramset rp 
			ON rp.[name] = 'Enercity 15 Mins Position Extract Report'
		INNER JOIN report_page rpage 
			ON rpage.report_page_id = rp.page_id
			AND rpage.[name] = 'Enercity 15 Mins Position Extract Report'
		INNER JOIN report r 
			ON r.report_id = rpage.report_id
			AND r.[name] = 'Enercity 15 Mins Position Extract Report'
