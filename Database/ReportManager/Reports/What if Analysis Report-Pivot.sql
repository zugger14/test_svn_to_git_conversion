BEGIN TRY
		...
		set @report_copy_name = isnull(@report_copy_name, 'Copy of ' + 'What if Analysis Report-Pivot')
	...
	SELECT @report_id_dest AS report_id, 'What if Analysis Report-Pivot' [name], 'FD4F6F01_4F02_415A_9539_92111B928E66' report_hash, 11.5 width,5.5 height
		...
		SELECT TOP 1 rpage.report_page_id, 'What if Analysis Report-Pivot', '6AFA97A7_BEB7_484E_BD6C_E00B90A29C2D', 3,NULL,NULL,NULL,NULL, 
		NULL,'n','n'	
		FROM sys.objects o
