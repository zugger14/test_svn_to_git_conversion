BEGIN TRY
		...
		SELECT TOP 1 '15 Mins Position Report by Book Enercity' [name], 'dev_admin' [owner], 0 is_system, 1 is_excel, 0 is_mobile, '58808C76_4735_4BD5_833C_F95CD25B1A98' report_hash, '15 Mins Position Report by Book Enercity' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
		FROM sys.objects o
	...
	SELECT @report_id_dest AS report_id, '15 Mins Position Report by Book Enercity' [name], '58808C76_4735_4BD5_833C_F95CD25B1A98' report_hash, 11.5 width,5.5 height
		...
		SELECT TOP 1 rpage.report_page_id AS page_id, rd.report_dataset_id AS root_dataset_id, 'Fifeteen Mins Position Report by Book_tablix' [name], '6.666666666666667' width, '3.7066666666666665' height, '0' [top], '0' [left],2 AS group_mode,1 AS border_style,0 AS page_break,2 AS type_id,4 AS cross_summary,2 AS no_header,'' export_table_name, 0 AS is_global
		FROM sys.objects o
		INNER JOIN report_page rpage 
		ON rpage.[name] = '15 Mins Position Report by Book Enercity'
		INNER JOIN report r 
