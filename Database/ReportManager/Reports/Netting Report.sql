BEGIN TRY
		...
		* */
		...
		BEGIN
			...
			SELECT TOP 1 'Netting Report' [name], 'farrms_admin' [owner], 0 is_system, 'C0B9F9F4_495B_4A51_BBE7_E7A8E9521451' report_hash, 'Netting Report' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
			FROM sys.objects o
...
BEGIN TRY
	...
	IF EXISTS (SELECT 1 
	           FROM data_source 
	           WHERE [name] = 'Netting Data Query'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
			
	BEGIN
		UPDATE data_source
		SET alias = 'ndq', description = NULL
		, [tsql] = CAST('' AS VARCHAR(MAX)) + 'SELECT ' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[as_of_date]) [as_of_date],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[term_start])[term_start],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[term_end])[term_end],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[book_id])[book_id],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[stra_id])[stra_id],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[sub_id])[sub_id],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[sub_book_id])[sub_book_id],' + CHAR(13) + '' + CHAR(10) + 'jev1.[netting_group_id],' + CHAR(13) + '' + CHAR(10) + 'jev1.Counterparty_name,' + CHAR(13) + '' + CHAR(10) + 'ISNULL(jev1.[netting_group_name],jev1.[contract_name]) [netting_group_name],' + CHAR(13) + '' + CHAR(10) + 'SUM(jev1.settlement_value) [Settlement Value],' + CHAR(13) + '' + CHAR(10) + 'ABS(SUM(CASE WHEN jev1.settlement_value< 0 THEN jev1.Settlement_value ELSE 0 END)) [Payable],' + CHAR(13) + '' + CHAR(10) + 'ABS(SUM(CASE WHEN jev1.Settlement_value>= 0 THEN jev1.Settlement_value ELSE 0 END)) [Receivable],' + CHAR(13) + '' + CHAR(10) + 'IIF(ABS(SUM(CASE WHEN jev1.settlement_value< 0 THEN jev1.Settlement_value ELSE 0 END))>ABS(SUM(CASE WHEN jev1.Settlement_value>= 0 THEN jev1.Settlement_value ELSE 0 END)),232012,142022) [ACT],' + CHAR(13) + '' + CHAR(10) + 'DBO.FNAMIN(ABS(SUM(CASE WHEN jev1.settlement_value< 0 THEN jev1.Settlement_value ELSE 0 END)),ABS(SUM(CASE WHEN jev1.Settlement_value>= 0 THEN jev1.Settlement_value ELSE 0 END))) [Net Adj]' + CHAR(13) + '' + CHAR(10) + ' FROM' + CHAR(13) + '' + CHAR(10) + '{jev1} jev1' + CHAR(13) + '' + CHAR(10) + 'GROUP BY ' + CHAR(13) + '' + CHAR(10) + 'jev1.[netting_group_id],' + CHAR(13) + '' + CHAR(10) + 'jev1.Counterparty_name,' + CHAR(13) + '' + CHAR(10) + 'jev1.[netting_group_name],' + CHAR(13) + '' + CHAR(10) + 'ISNULL(jev1.[netting_group_name],jev1.[contract_name])', report_id = @report_id_data_source_dest 
		WHERE [name] = 'Netting Data Query'
			AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1)
	END	
	ELSE
	BEGIN
		...
		SELECT TOP 1 2 AS [type_id], 'Netting Data Query' AS [name], 'ndq' AS ALIAS, NULL AS [description],'SELECT ' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[as_of_date]) [as_of_date],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[term_start])[term_start],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[term_end])[term_end],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[book_id])[book_id],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[stra_id])[stra_id],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[sub_id])[sub_id],' + CHAR(13) + '' + CHAR(10) + 'MAX(jev1.[sub_book_id])[sub_book_id],' + CHAR(13) + '' + CHAR(10) + 'jev1.[netting_group_id],' + CHAR(13) + '' + CHAR(10) + 'jev1.Counterparty_name,' + CHAR(13) + '' + CHAR(10) + 'ISNULL(jev1.[netting_group_name],jev1.[contract_name]) [netting_group_name],' + CHAR(13) + '' + CHAR(10) + 'SUM(jev1.settlement_value) [Settlement Value],' + CHAR(13) + '' + CHAR(10) + 'ABS(SUM(CASE WHEN jev1.settlement_value< 0 THEN jev1.Settlement_value ELSE 0 END)) [Payable],' + CHAR(13) + '' + CHAR(10) + 'ABS(SUM(CASE WHEN jev1.Settlement_value>= 0 THEN jev1.Settlement_value ELSE 0 END)) [Receivable],' + CHAR(13) + '' + CHAR(10) + 'IIF(ABS(SUM(CASE WHEN jev1.settlement_value< 0 THEN jev1.Settlement_value ELSE 0 END))>ABS(SUM(CASE WHEN jev1.Settlement_value>= 0 THEN jev1.Settlement_value ELSE 0 END)),232012,142022) [ACT],' + CHAR(13) + '' + CHAR(10) + 'DBO.FNAMIN(ABS(SUM(CASE WHEN jev1.settlement_value< 0 THEN jev1.Settlement_value ELSE 0 END)),ABS(SUM(CASE WHEN jev1.Settlement_value>= 0 THEN jev1.Settlement_value ELSE 0 END))) [Net Adj]' + CHAR(13) + '' + CHAR(10) + ' FROM' + CHAR(13) + '' + CHAR(10) + '{jev1} jev1' + CHAR(13) + '' + CHAR(10) + 'GROUP BY ' + CHAR(13) + '' + CHAR(10) + 'jev1.[netting_group_id],' + CHAR(13) + '' + CHAR(10) + 'jev1.Counterparty_name,' + CHAR(13) + '' + CHAR(10) + 'jev1.[netting_group_name],' + CHAR(13) + '' + CHAR(10) + 'ISNULL(jev1.[netting_group_name],jev1.[contract_name])' AS [tsql], @report_id_data_source_dest AS report_id
	END 
	...
	IF EXISTS (SELECT 1 
	           FROM data_source_column dsc 
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Netting Data Query'
	            AND dsc.name =  'ACT'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
	...
	BEGIN
		...
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'ACT' AS [name], 'ACT' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 4 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'Net Adj' AS [name], 'Net Adj' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'netting_group_id' AS [name], 'netting_group_id' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 4 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'netting_group_name' AS [name], 'Netting Group Name' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'Payable' AS [name], 'Payable' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Netting Data Query'
	            AND dsc.name =  'Receivable'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Receivable'
			   , reqd_param = 0, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = 1, tooltip = NULL, column_template = 2, key_column = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'Receivable' AS [name], 'Receivable' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'Settlement Value' AS [name], 'Settlement Value' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	FROM data_source_column dsc 
	INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		AND ds.[name] = 'Netting Data Query'
		AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1)
...
COMMIT TRAN
	...
	END CATCH
		...
		IF NOT EXISTS(SELECT 1 FROM report_dataset rd WHERE rd.report_id = @report_id_dest AND rd.[alias] =  'ndq')
		BEGIN
			INSERT INTO report_dataset (source_id, report_id, [alias], root_dataset_id, is_free_from, relationship_sql)
			SELECT TOP 1 ds.data_source_id AS source_id, @report_id_dest AS report_id, 'ndq' [alias], rd_root.report_dataset_id AS root_dataset_id,0 AS is_free_from, 'NULL' AS relationship_sql
			FROM sys.objects o
			INNER JOIN data_source ds ON ds.[name] = 'Netting Data Query'
				AND ISNULL(ds.report_id, @report_id_dest) = @report_id_dest
			LEFT JOIN report_dataset rd_root ON rd_root.[alias] = NULL
	...
	BEGIN
		...
		SELECT CASE WHEN 'e ' = 'p' 
					Then 8029 
					ELSE @report_id_dest 
		       END  AS report_id, 'Netting Report' [name], 'C0B9F9F4_495B_4A51_BBE7_E7A8E9521451' report_hash, 12 width,11.69 height
	END 
	

		INSERT INTO report_paramset(page_id, [name], paramset_hash, report_status_id)
		SELECT TOP 1 rpage.report_page_id, 'Netting Report', '5B5682A4_7C44_4A9E_B8FB_E7248CAC0D6F', 2
		FROM sys.objects o
		INNER JOIN report_page rpage 
			on rpage.[name] = 'Netting Report'
		INNER JOIN report r 
		ON r.report_id = rpage.report_id
			AND r.[name] = 'Netting Report'
		...
		INNER JOIN report_paramset rp 
			ON rp.[name] = 'Netting Report'
		INNER JOIN report_page rpage 
			ON rpage.report_page_id = rp.page_id
			AND rpage.[name] = 'Netting Report'
		INNER JOIN report r 
			ON r.report_id = rpage.report_id
			AND r.[name] = 'Netting Report'
		...
		INNER JOIN report r 
			...
			AND r.[name] = 'Netting Report'
		INNER JOIN report_dataset rd 
			ON rd.report_id = r.report_id AND rd.[alias] = 'ndq' 	
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'Netting Data Query' 	
		INNER JOIN data_source_column dsc 
		...
		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					...
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 2 column_order,NULL aggregation, NULL functions, 'Netting Group' [alias], 1 sortable, NULL rounding, NULL thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 0 render_as,-1 column_template,NULL negative_mark,NULL currency,NULL date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'Netting Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'Netting Data Query' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'Settlement Value' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 4 column_order,NULL aggregation, NULL functions, 'Payable' [alias], 1 sortable, -1 rounding, 0 thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 3 render_as,-1 column_template,0 negative_mark,0 currency,NULL date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'Netting Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'Netting Data Query' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'Payable' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 5 column_order,NULL aggregation, NULL functions, 'Receivable' [alias], 1 sortable, -1 rounding, 0 thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 3 render_as,-1 column_template,0 negative_mark,0 currency,NULL date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'Netting Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'Netting Data Query' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'Receivable' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 6 column_order,NULL aggregation, NULL functions, 'ACT' [alias], 1 sortable, NULL rounding, NULL thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 0 render_as,-1 column_template,NULL negative_mark,NULL currency,NULL date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'Netting Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'Netting Data Query' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'ACT' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 7 column_order,NULL aggregation, NULL functions, 'Net Adj' [alias], 1 sortable, -1 rounding, 0 thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 3 render_as,-1 column_template,0 negative_mark,0 currency,NULL date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'Netting Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'Netting Data Query' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'Net Adj' 
