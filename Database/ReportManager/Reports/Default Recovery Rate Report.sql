BEGIN TRY
		...
		SELECT TOP 1 'Default Recovery Rate Report' [name], 'dev_admin' [owner], 1 is_system, 1 is_excel, 0 is_mobile, 'B11870E4_EC9E_43D9_878B_7C2094897ACD' report_hash, 'Standard Default Recovery Rate Report' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
		FROM sys.objects o
