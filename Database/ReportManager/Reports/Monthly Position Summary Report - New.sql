BEGIN TRY
		...
		set @report_copy_name = isnull(@report_copy_name, 'Copy of ' + 'Monthly Position Summary Report - New')
	...
	SELECT @report_id_dest AS report_id, 'Monthly Position Summary Report - New' [name], '80E4E4B8_F021_417F_8D3C_D7601CD2F6D6' report_hash, 11.5 width,5.5 height
		...
		SELECT TOP 1 rpage.report_page_id AS page_id, rd.report_dataset_id AS root_dataset_id, 'Monthly Position Summary View _ New_tablix' [name], '6.773333333333333' width, '2.6666666666666665' height, '0' [top], '0' [left],2 AS group_mode,1 AS border_style,0 AS page_break,2 AS type_id,1 AS cross_summary,2 AS no_header,'' export_table_name, 0 AS is_global
		FROM sys.objects o
		INNER JOIN report_page rpage 
		ON rpage.[name] = 'Monthly Position Summary Report - New'
		INNER JOIN report r 
