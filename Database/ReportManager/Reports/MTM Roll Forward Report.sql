BEGIN TRY
		...
		FROM report r
		WHERE r.[name] = 'MTM Roll Forward Report'
		...
		* */
		...
		BEGIN
			...
			SELECT TOP 1 'MTM Roll Forward Report' [name], 'farrms_admin' [owner], 0 is_system, 'B6C216EB_476B_4C8A_B7A2_8B487324515E' report_hash, 'Daily MTM Change Report' [description], CAST(sdv_cat.value_id AS VARCHAR(10)) category_id
			FROM sys.objects o
...
BEGIN TRY
	...
	IF EXISTS (SELECT 1 
	           FROM data_source 
	           WHERE [name] = 'MTM Change SQL'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
			
	BEGIN
		UPDATE data_source
		SET alias = 'mtmcs', description = NULL
		, [tsql] = CAST('' AS VARCHAR(MAX)) + 'SELECT mtm_cur.source_deal_header_id [source_deal_header_id]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', ca.as_of_date [as_of_date]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', ca.prior_as_of_date [to_as_of_date]' + CHAR(13) + '' + CHAR(10) + '                     , mtm_prior.und_pnl [prior_mtm]' + CHAR(13) + '' + CHAR(10) + '                     , mtm_cur.und_pnl [cur_mtm]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', mtm_cur.und_pnl - mtm_prior.und_pnl [mtm_change]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', mtm_cur.sub_id [sub_id], mtm_cur.stra_id [stra_id], mtm_cur.book_id [book_id], mtm_cur.sub_book_id ' + CHAR(13) + '' + CHAR(10) + '                     , mtm_cur.commodity, ca.deal_type_name [deal_type_name]' + CHAR(13) + '' + CHAR(10) + ', mtm_cur.deal_id,mtm_cur.term_start,mtm_cur.currency' + CHAR(13) + '' + CHAR(10) + 'FROM (' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'SELECT mtmv1.sub_id, mtmv1.stra_id, mtmv1.book_id, mtmv1.sub_book_id, mtmv1.source_deal_header_id, MAX(mtmv1.deal_type_name) deal_type_name' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', MAX(mtmv1.as_of_date) as_of_date, MIN(mtmv1.to_as_of_date) prior_as_of_date' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'FROM {mtmv1} mtmv1' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'GROUP BY mtmv1.sub_id, mtmv1.stra_id, mtmv1.book_id, mtmv1.sub_book_id, mtmv1.source_deal_header_id' + CHAR(13) + '' + CHAR(10) + ') ca ' + CHAR(13) + '' + CHAR(10) + 'INNER JOIN {mtmv1} mtm_cur ON mtm_cur.source_deal_header_id = ca.source_deal_header_id' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'AND mtm_cur.as_of_date = ca.as_of_date' + CHAR(13) + '' + CHAR(10) + 'INNER JOIN {mtmv1} mtm_prior ON mtm_prior.source_deal_header_id = ca.source_deal_header_id' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'AND mtm_prior.as_of_date = ca.prior_as_of_date AND mtm_prior.term_start = mtm_cur.term_start' + CHAR(13) + '' + CHAR(10) + 'WHERE ca.prior_as_of_date = ''@as_of_date'' AND ca.as_of_date = ''@to_as_of_date''', report_id = @report_id_data_source_dest 
		WHERE [name] = 'MTM Change SQL'
			AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1)
	END	
	ELSE
	BEGIN
		...
		SELECT TOP 1 2 AS [type_id], 'MTM Change SQL' AS [name], 'mtmcs' AS ALIAS, NULL AS [description],'SELECT mtm_cur.source_deal_header_id [source_deal_header_id]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', ca.as_of_date [as_of_date]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', ca.prior_as_of_date [to_as_of_date]' + CHAR(13) + '' + CHAR(10) + '                     , mtm_prior.und_pnl [prior_mtm]' + CHAR(13) + '' + CHAR(10) + '                     , mtm_cur.und_pnl [cur_mtm]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', mtm_cur.und_pnl - mtm_prior.und_pnl [mtm_change]' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', mtm_cur.sub_id [sub_id], mtm_cur.stra_id [stra_id], mtm_cur.book_id [book_id], mtm_cur.sub_book_id ' + CHAR(13) + '' + CHAR(10) + '                     , mtm_cur.commodity, ca.deal_type_name [deal_type_name]' + CHAR(13) + '' + CHAR(10) + ', mtm_cur.deal_id,mtm_cur.term_start,mtm_cur.currency' + CHAR(13) + '' + CHAR(10) + 'FROM (' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'SELECT mtmv1.sub_id, mtmv1.stra_id, mtmv1.book_id, mtmv1.sub_book_id, mtmv1.source_deal_header_id, MAX(mtmv1.deal_type_name) deal_type_name' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + ', MAX(mtmv1.as_of_date) as_of_date, MIN(mtmv1.to_as_of_date) prior_as_of_date' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'FROM {mtmv1} mtmv1' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'GROUP BY mtmv1.sub_id, mtmv1.stra_id, mtmv1.book_id, mtmv1.sub_book_id, mtmv1.source_deal_header_id' + CHAR(13) + '' + CHAR(10) + ') ca ' + CHAR(13) + '' + CHAR(10) + 'INNER JOIN {mtmv1} mtm_cur ON mtm_cur.source_deal_header_id = ca.source_deal_header_id' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'AND mtm_cur.as_of_date = ca.as_of_date' + CHAR(13) + '' + CHAR(10) + 'INNER JOIN {mtmv1} mtm_prior ON mtm_prior.source_deal_header_id = ca.source_deal_header_id' + CHAR(13) + '' + CHAR(10) + '' + CHAR(9) + 'AND mtm_prior.as_of_date = ca.prior_as_of_date AND mtm_prior.term_start = mtm_cur.term_start' + CHAR(13) + '' + CHAR(10) + 'WHERE ca.prior_as_of_date = ''@as_of_date'' AND ca.as_of_date = ''@to_as_of_date''' AS [tsql], @report_id_data_source_dest AS report_id
	END 
	...
	BEGIN
		...
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'MTM Change SQL'
	            AND dsc.name =  'mtm_change'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'MTM Change'
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'mtm_change' AS [name], 'MTM Change' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'to_as_of_date' AS [name], 'To As of Date' AS ALIAS, 1 AS reqd_param, 6 AS widget_id, 2 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 0 AS append_filter, NULL  AS tooltip,4 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'MTM Change SQL'
	            AND dsc.name =  'cur_mtm'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Current MTM'
			   , reqd_param = 0, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = 1, tooltip = NULL, column_template = 2, key_column = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'cur_mtm' AS [name], 'Current MTM' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'prior_mtm' AS [name], 'Prior MTM' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		UPDATE dsc  
		SET alias = 'Commodity'
			   , reqd_param = 0, widget_id = 2, datatype_id = 5, param_data_source = 'SELECT sc.commodity_name [value], sc.commodity_name [label] FROM source_commodity sc', param_default_value = NULL, append_filter = 1, tooltip = NULL, column_template = 0, key_column = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		WHERE ds.[name] = 'MTM Change SQL'
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'commodity' AS [name], 'Commodity' AS ALIAS, 0 AS reqd_param, 2 AS widget_id, 5 AS datatype_id, 'SELECT sc.commodity_name [value], sc.commodity_name [label] FROM source_commodity sc' AS param_data_source, NULL AS param_default_value, 1 AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'currency' AS [name], 'Currency' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 0 AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'deal_id' AS [name], 'Reference ID' AS ALIAS, 0 AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 0 AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'term_start' AS [name], 'Term Start' AS ALIAS, 0 AS reqd_param, 6 AS widget_id, 2 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, 0 AS append_filter, NULL  AS tooltip,4 AS column_template, 1 AS key_column				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
...
COMMIT TRAN
	...
	END CATCH
		...
		IF NOT EXISTS(SELECT 1 FROM report_dataset rd WHERE rd.report_id = @report_id_dest AND rd.[alias] =  'MTMV1')
		BEGIN
			INSERT INTO report_dataset (source_id, report_id, [alias], root_dataset_id, is_free_from, relationship_sql)
			SELECT TOP 1 ds.data_source_id AS source_id, @report_id_dest AS report_id, 'MTMV1' [alias], rd_root.report_dataset_id AS root_dataset_id,0 AS is_free_from, 'NULL' AS relationship_sql
			FROM sys.objects o
		...
		IF NOT EXISTS(SELECT 1 FROM report_dataset rd WHERE rd.report_id = @report_id_dest AND rd.[alias] =  'mtmcs')
		BEGIN
			INSERT INTO report_dataset (source_id, report_id, [alias], root_dataset_id, is_free_from, relationship_sql)
			SELECT TOP 1 ds.data_source_id AS source_id, @report_id_dest AS report_id, 'mtmcs' [alias], rd_root.report_dataset_id AS root_dataset_id,0 AS is_free_from, 'NULL' AS relationship_sql
			FROM sys.objects o
			INNER JOIN data_source ds ON ds.[name] = 'MTM Change SQL'
				AND ISNULL(ds.report_id, @report_id_dest) = @report_id_dest
			LEFT JOIN report_dataset rd_root ON rd_root.[alias] = NULL
	...
	BEGIN
		...
		SELECT CASE WHEN 'e ' = 'p' 
					Then 38789 
					ELSE @report_id_dest 
		       END  AS report_id, 'MTM Roll Forward' [name], 'B6C216EB_476B_4C8A_B7A2_8B487324515E' report_hash, 8 width,8 height
	END 
	

		INSERT INTO report_paramset(page_id, [name], paramset_hash, report_status_id)
		SELECT TOP 1 rpage.report_page_id, 'MTM Roll Forward Report', '113860C0_4A69_43E3_A26A_3E825E0207ED', 2
		FROM sys.objects o
		INNER JOIN report_page rpage 
			on rpage.[name] = 'MTM Roll Forward'
		INNER JOIN report r 
		ON r.report_id = rpage.report_id
			AND r.[name] = 'MTM Roll Forward Report'
	

		INSERT INTO report_dataset_paramset(paramset_id, root_dataset_id, where_part, advance_mode)
		SELECT TOP 1 rp.report_paramset_id AS paramset_id, rd.report_dataset_id AS root_dataset_id, '(  mtmcs.[commodity] = ''@commodity'' AND mtmcs.[deal_type_name] = ''@deal_type_name'')' AS where_part, 0
		FROM sys.objects o
		INNER JOIN report_paramset rp 
			ON rp.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
			ON rpage.report_page_id = rp.page_id
			AND rpage.[name] = 'MTM Roll Forward'
		INNER JOIN report r 
			ON r.report_id = rpage.report_id
			AND r.[name] = 'MTM Roll Forward Report'
		...
		SELECT TOP 1 rdp.report_dataset_paramset_id AS dataset_paramset_id, rd.report_dataset_id AS dataset_id , dsc.data_source_column_id AS column_id, 1 AS operator, '' AS initial_value, '' AS initial_value2, 0 AS optional, 0 AS hidden,0 AS logical_operator, 1 AS param_order, 0 AS param_depth, 'Prior As of Date' AS label
		FROM sys.objects o
		INNER JOIN report_paramset rp 
			ON rp.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
		...
		INSERT INTO report_param(dataset_paramset_id, dataset_id, column_id, operator,
					initial_value, initial_value2, optional, hidden, logical_operator, param_order, param_depth, label)
		SELECT TOP 1 rdp.report_dataset_paramset_id AS dataset_paramset_id, rd.report_dataset_id AS dataset_id , dsc.data_source_column_id AS column_id, 1 AS operator, '' AS initial_value, '' AS initial_value2, 0 AS optional, 0 AS hidden,1 AS logical_operator, 0 AS param_order, 0 AS param_depth, 'Current As of Date' AS label
		FROM sys.objects o
		INNER JOIN report_paramset rp 
			ON rp.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
		...
		SELECT TOP 1 rpage.report_page_id AS page_id, rd.report_dataset_id AS root_dataset_id, 'MTM Roll Forward Report' [name], '7.933333333333334' width, '8.013333333333333' height, '0.013333333333333334' [top], '0.09333333333333334' [left],0 AS group_mode,1 AS border_style,0 AS page_break,1 AS type_id,2 AS cross_summary,2 AS no_header,NULL export_table_name, 1 AS is_global
		FROM sys.objects o
		INNER JOIN report_page rpage 
		ON rpage.[name] = 'MTM Roll Forward'
		INNER JOIN report r 
		...
		INNER JOIN report r 
			...
			AND r.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_dataset rd 
			ON rd.report_id = r.report_id AND rd.[alias] = 'mtmcs' 	
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'MTM Change SQL' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'mtm_change' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 4 column_order,NULL aggregation, NULL functions, 'Invoice Amt Old' [alias], 1 sortable, 2 rounding, 0 thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 2 render_as,-1 column_template,0 negative_mark,NULL currency,NULL date_format,13 cross_summary_aggregation,NULL mark_for_total,13 sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'MTM Change SQL' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'prior_mtm' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 3 column_order,NULL aggregation, NULL functions, 'Invoice Amt New' [alias], 1 sortable, 2 rounding, 0 thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 2 render_as,-1 column_template,0 negative_mark,NULL currency,NULL date_format,13 cross_summary_aggregation,NULL mark_for_total,13 sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
		...
		INNER JOIN data_source ds 
			ON ISNULL(NULLIF(ds.report_id, 0), r.report_id) = r.report_id	AND ds.[name] = 'MTM Change SQL' 	
		INNER JOIN data_source_column dsc 
			ON dsc.source_id = ds.data_source_id AND dsc.[name] = 'cur_mtm' 

		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					, functions, [alias], sortable, rounding, thousand_seperation, font
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 2 column_order,NULL aggregation, NULL functions, 'Delivery Month' [alias], 1 sortable, NULL rounding, NULL thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 4 render_as,-1 column_template,NULL negative_mark,NULL currency,0 date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
		...
		INSERT INTO report_tablix_column(tablix_id, dataset_id, column_id, placement, column_order, aggregation
					...
					, font_size, font_style, text_align, text_color, background, default_sort_order
					, default_sort_direction, custom_field, render_as, column_template, negative_mark, currency, date_format, cross_summary_aggregation, mark_for_total, sql_aggregation)
		SELECT TOP 1 rpt.report_page_tablix_id tablix_id, rd.report_dataset_id dataset_id, dsc.data_source_column_id column_id,1 placement, 1 column_order,NULL aggregation, NULL functions, 'Memo' [alias], 1 sortable, NULL rounding, NULL thousand_seperation, 'Tahoma' font, '8' font_size, '0,0,0' font_style, 'Left' text_align, '#000000' text_color, '#ffffff' background, NULL default_sort_order, NULL sort_direction, 0 custom_field, 0 render_as,-1 column_template,NULL negative_mark,NULL currency,NULL date_format,-1 cross_summary_aggregation,NULL mark_for_total,NULL sql_aggregation
		FROM sys.objects o
		INNER JOIN report_page_tablix rpt 
			ON rpt.[name] = 'MTM Roll Forward Report'
		INNER JOIN report_page rpage 
