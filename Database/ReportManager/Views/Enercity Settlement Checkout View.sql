...
--OUTER APPLY(
--	SELECT gmv.clm10_value vat_type, gmv.clm3_value [counterparty_type], gmv.clm1_value [effective_date], gmv.clm2_value [region_id], r_sdv.code [region], gmv.clm4_value [commodity_id] , scm.commodity_name, gmv.clm12_value [vat_percentage] , gmv.clm13_value [vat_remarks] , gmv.clm8_value [gvm_price]
...
INNER JOIN source_counterparty sc_si ON sco.counterparty_id = sco.counterparty_id
OUTER APPLY (SELECT MAX(create_ts) mx_create_ts FROM stmt_checkout sco1 
				WHERE sco.source_deal_detail_id = sco1.source_deal_detail_id
					AND sco.deal_charge_type_id = sco1.deal_charge_type_id
					AND sco.term_start = sco1.term_start
