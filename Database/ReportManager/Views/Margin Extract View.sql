BEGIN TRY
	...
	BEGIN
		...
		SELECT TOP 1 1 AS [type_id], 'Margin Extract View' AS [name], @new_ds_alias AS ALIAS, 'Customized Margin Extract View' AS [description],null AS [tsql], @report_id_data_source_dest AS report_id,'0' AS [system_defined]
			,'106500' AS [category]
	END
