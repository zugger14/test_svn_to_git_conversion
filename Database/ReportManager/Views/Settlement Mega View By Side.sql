BEGIN TRY
	...
	declare @new_ds_alias varchar(10) = 'smvn'
	/** IF DATA SOURCE ALIAS ALREADY EXISTS ON DESTINATION, RAISE ERROR **/
	if exists(select top 1 1 from data_source where alias = 'smvn' and name <> 'Settlement Mega View By Side')
	begin
		select top 1 @new_ds_alias = 'smvn' + cast(s.n as varchar(5))
		from seq s
		left join data_source ds on ds.alias = 'smvn' + cast(s.n as varchar(5))
	...
	IF NOT EXISTS (SELECT 1 
	           FROM data_source 
	           WHERE [name] = 'Settlement Mega View By Side'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	AND NOT EXISTS (SELECT 1 FROM map_function_category WHERE [function_name] = 'Settlement Mega View By Side' AND '106500' = '106501') 
	BEGIN
		INSERT INTO data_source([type_id], [name], [alias], [description], [tsql], report_id, system_defined,category)
		SELECT TOP 1 1 AS [type_id], 'Settlement Mega View By Side' AS [name], @new_ds_alias AS ALIAS, 'Standard Settlement Mega View By Side' AS [description],null AS [tsql], @report_id_data_source_dest AS report_id,'1' AS [system_defined]
			,'106500' AS [category]
	END

	UPDATE data_source
	SET alias = @new_ds_alias, description = 'Standard Settlement Mega View By Side'
...
DECLARE @_from_as_of_date VARCHAR(50)  --=''2018-01-31'' 
DECLARE @_to_as_of_date VARCHAR(50) --=''2018-01-31'' 
DECLARE @_term_start VARCHAR(50) --=''2017-01-01''
DECLARE @_term_end VARCHAR(50) --=''2017-12-31''

DECLARE @_deal_date_from VARCHAR(50), @_deal_date_to VARCHAR(50), @_source_counterparty_id VARCHAR(max), @_source_deal_type_id VARCHAR(max), @_deal_sub_type_type_id VARCHAR(max), @_physical_financial_flag VARCHAR(20), @_contract_id VARCHAR(max), @_trader_id VARCHAR(max), @_block_definition_id VARCHAR(50), @_location_id VARCHAR(max), @_index_id VARCHAR(max)
, @_source_deal_header_id VARCHAR(50),--=''10292'', --=''82077'' ,
	@_commodity_id VARCHAR(max), @_period_from VARCHAR(50), @_period_to VARCHAR(50), @_buy_sell_flag VARCHAR(20), @_deal_ref_id VARCHAR(50), @_deal_status_id VARCHAR(50), @_confirm_status_id VARCHAR(50), @_pnl_source_value_id VARCHAR(MAX)
...
DECLARE @_default_as_of_date VARCHAR(MAX)

SELECT TOP (1) @_default_as_of_date = custom_as_of_date FROM setup_as_of_date

SET @_from_as_of_date = ISNULL(@_from_as_of_date, @_default_as_of_date)


-- debug input

--SET @_source_deal_header_id = 10290
--SET @_from_as_of_date  = ''2017-10-16''
--SET @_to_as_of_date  = ''2017-10-16''
...
CREATE TABLE #final_values (
	...
	description2 NVARCHAR(500) COLLATE database_default NULL, description3 NVARCHAR(500) COLLATE database_default NULL, description4 NVARCHAR(500) COLLATE database_default NULL, counterparty_id2 INT, counterparty_name2 NVARCHAR(500), ext_deal_id VARCHAR(500) COLLATE database_default NULL, reference NVARCHAR(500) COLLATE database_default NULL, create_by NVARCHAR(500) COLLATE database_default NULL, create_ts DATETIME, update_by NVARCHAR(500) COLLATE database_default NULL, update_ts DATETIME, broker_fixed_cost NUMERIC, confirm_date DATETIME, sub_book_group1_id INT, sub_book_group2_id INT, sub_book_group3_id INT, sub_book_group4_id INT, sub_book_group1 NVARCHAR(500) COLLATE database_default NULL, sub_book_group2 NVARCHAR(500) COLLATE database_default NULL, sub_book_group3 NVARCHAR(500) COLLATE database_default NULL, sub_book_group4 NVARCHAR(500) COLLATE database_default NULL, book_identifier1_id INT, book_identifier2_id INT, book_identifier3_id INT, book_identifier4_id INT, book_identifier1 NVARCHAR(500) COLLATE database_default NULL, book_identifier2 NVARCHAR(500) COLLATE database_default NULL, 
	book_identifier3 NVARCHAR(500) COLLATE database_default NULL, book_identifier4 NVARCHAR(500) COLLATE database_default NULL, deal_price FLOAT, float_price FLOAT, volume FLOAT, close_reference_id INT, charge_type_id INT, charge_type NVARCHAR(500) COLLATE database_default NULL, agg_term NVARCHAR(500) COLLATE database_default NULL, recovery_rate FLOAT, fv_level NVARCHAR(500) COLLATE database_default NULL, current_non_current NVARCHAR(500) COLLATE database_default NULL, deal_category_id INT, deal_category NVARCHAR(500) COLLATE database_default NULL, internal_counterparty_id INT, internal_couterparty NVARCHAR(500) COLLATE database_default NULL, template_id INT, volume_profile VARCHAR(500) COLLATE database_default NULL, price_adder2 FLOAT, volume_multiplier FLOAT, volume_multiplier2 FLOAT, debt_rating VARCHAR(500) COLLATE database_default NULL, volume_frequency VARCHAR(500) COLLATE database_default NULL, currency_id INT, is_expired VARCHAR(10) COLLATE database_default NULL, entire_term_start DATETIME, entire_term_end DATETIME, contract_exipration_date DATETIME, 
	structured_id VARCHAR(500) COLLATE database_default NULL, payment_date DATETIME, pricing_type INT, must_run_volume FLOAT, dispatch_volume FLOAT, must_run_market_value FLOAT, must_run_contract_value FLOAT, dispatch_market_value FLOAT, dispatch_contract_value FLOAT, cash_flow FLOAT, pnl_date DATETIME, settlement_amount_deal FLOAT, settlement_deal_currency VARCHAR(500) COLLATE database_default NULL, settlement_amount_inv FLOAT, settlement_inv_currency VARCHAR(500) COLLATE database_default NULL, value_deal FLOAT, value_deal_currency VARCHAR(500) COLLATE database_default NULL, value_inv FLOAT, value_inv_currency VARCHAR(500) COLLATE database_default NULL, und_pnl_deal FLOAT, und_pnl_deal_currency VARCHAR(500) COLLATE database_default NULL, und_pnl_inv FLOAT, und_pnl_inv_currency VARCHAR(500) COLLATE database_default NULL,deal_price_type_id int null, field_id int null,[value] float 
	)

SET @_sql_select1 = ''
INSERT INTO #final_values -- select * from #final_values 
SELECT books.sub_id sub_id, books.stra_id stra_id, books.book_id book_id, books.sub_name AS subsidiary,
	books.stra_name AS strategy,   books.book_name AS book,	  books.logical_name [sub_book],
	sdh.source_deal_header_id,   sdh.deal_id deal_ref_id,   sdh.deal_date deal_date_from, 
	sdh.deal_date deal_date_to,   st.source_trader_id [trader_id],   st.trader_name,   sc.counterparty_name,
	psc.counterparty_name parent_counterparty_name,   cg.contract_id,   cg.contract_name AS contract_name,
	sdh.source_deal_type_id,   sdt.source_deal_type_name AS deal_type_name,   sdh.deal_sub_type_type_id,
	sdts.source_deal_type_name AS deal_sub_type_name,   sdh.product_id,   sc2.source_commodity_id commodity_id,
	sprod.code product_desc,   sdv_block_def.code AS block_definition,
	(CASE WHEN sdh.header_buy_sell_flag = ''''b'''' THEN ''''Buy''''    ELSE ''''Sell''''   END   ) AS buy_sell_flag, 
	sdd.term_start,   sdd.term_end,   sdv_cnty.value_id country_id,   sdv_cnty.code AS country,
	sdv_grid.code AS grid,   sdv_region.value_id region_id,   sdv_region.code AS region, 
	smjl.source_major_location_ID,   smjl.location_name AS location_group,   sml.source_minor_location_id [location_id],
	sml.location_name,   sml.location_description,   sdpd.pnl_as_of_date from_as_of_date,
	CAST(sdpd.und_pnl AS FLOAT) amount,  CAST(ISNULL(sdpd.und_intrinsic_pnl,0) AS FLOAT) und_intrinsic_pnl,
	CAST(ISNULL(sdpd.und_extrinsic_pnl,0) AS FLOAT) und_extrinsic_pnl,  CAST(ISNULL(sdpd.dis_pnl,0) AS FLOAT) dis_pnl,
	CAST(ISNULL(sdpd.dis_intrinsic_pnl,0) AS FLOAT) dis_intrinsic_pnl,  CAST(ISNULL(sdpd.dis_extrinisic_pnl,0) AS FLOAT) dis_extrinisic_pnl,
	CAST(COALESCE(sdpd.market_value,0) AS FLOAT) market_value,  CAST(COALESCE(sdpd.contract_value,0) AS FLOAT) contract_value,
	CAST(ISNULL(sdpd.dis_market_value,0) AS FLOAT) dis_market_value,  CAST(ISNULL(sdpd.dis_contract_value,0) AS FLOAT) dis_contract_value, 
	CAST(ISNULL(sdpd.discount_factor,0) AS FLOAT) discount_factor,  ISNULL(sdpd.und_pnl, 0) - ISNULL(sdpd.dis_pnl, 0) [discount_amount], 
	sc2.commodity_name AS commodity,   CASE  WHEN sdd.buy_sell_flag = ''''s'''' THEN sdd.deal_volume * (-1) ELSE sdd.deal_volume    END [deal_volume], 
	su.uom_name AS volume_uom,   sdht.template_name AS [template_name],   spcd.curve_name[curve_name],
	sdv_peakness.code [index_tou],   scur.currency_name currency,   fe.formula [formula], sdpd.deal_volume [total_volume],
	puom.uom_name AS [position_uom],   CAST(ISNULL(sdc.cva,0) AS FLOAT) [CVA],CAST(ISNULL(sdc.dva,0) AS FLOAT) [DVA],
	CAST(COALESCE(sdpd.curve_value,0) AS FLOAT) [market_price], sdpd.formula_value [formula_price], 
	CAST(COALESCE(sdpd.price,0) AS FLOAT) [net_price], CASE WHEN sdd.physical_financial_flag = ''''p'''' THEN ''''Physical'''' ELSE ''''Financial''''   END [physical_financial_flag],
	sdh.block_define_id block_definition_id,   sdd.Leg [leg],   sc.source_counterparty_id [source_counterparty_id],
	sc.counterparty_id [counterparty_id],   spcd.source_curve_def_id [index_id],
	...
	DAY(sdd.term_start) [term_start_day],        RIGHT(''''0''''+ CAST(MONTH(sdd.term_start) AS VARCHAR(2)), 2)  [term_start_month],
	DATENAME(m,sdd.term_start) [term_start_month_name], YEAR(sdd.term_start) [term_start_year],
	CAST(YEAR(sdd.term_start) AS VARCHAR(5)) + ''''-'''' + RIGHT(''''0''''+ CAST(MONTH(sdd.term_start) AS VARCHAR(2)), 2)   [term_start_year_month],
	CASE WHEN sdpd.source_deal_header_id is not  null THEN 
		''''Q'''' + CAST(DATEPART(q,sdd.term_start) AS VARCHAR(10)) + ''''-'''' + CAST(YEAR(sdd.term_start) AS VARCHAR(10))
	ELSE ag_t.agg_term END [term_quarter]
	, coalesce(sdpd.pnl_as_of_date,sdp.pnl_as_of_date,ifbs.as_of_date,ifb.as_of_date) to_as_of_date,
	books.[sub_book_id], books.[transaction_type], books.[transaction_type_name], ''''@_period_from'''' [period_from], 
	''''@_period_to'''' [period_to], ISNULL(dp.probability, 0) [probability], ISNULL(sdpd.und_pnl, 0) * ISNULL(dp.probability, 0) * (1 - ISNULL(drr.rate, 0)) [credit_reserve], 
	ISNULL(sdpd.dis_pnl, 0)* ISNULL(dp.probability, 0) * (1 - ISNULL(drr.rate, 0)) [dis_credit_reserve],
	sdpd.und_pnl - (ISNULL(sdpd.und_pnl, 0)* ISNULL(dp.probability, 0) * (1 - ISNULL(drr.rate, 0))) [fair_value], sdpd.dis_pnl - (ISNULL(sdpd.dis_pnl, 0)* ISNULL(dp.probability, 0) * (1 - ISNULL(drr.rate, 0))) [dis_fair_value], 0 [model_reserve]
	, case when sdpd.source_deal_header_id is null then ''''a'''' else ''''f'''' end AS actual_forward, sdpd.pnl_conversion_factor, sdpd.pnl_adjustment_value, sdpd.internal_deal_type_value_id internal_deal_type_id, idtst.internal_deal_type_subtype_type internal_deal_type, sdpd.internal_deal_subtype_value_id internal_deal_sub_type_id, idtst1.internal_deal_type_subtype_type internal_deal_sub_type, sdpd.fixed_cost, CAST(COALESCE(sdpd.fixed_price,sdd.fixed_price, 0) AS FLOAT) fixed_price, sdpd.formula_value, ISNULL(sdpd.price_adder, sdd.price_adder) price_adder, sdpd.price_multiplier, sdpd.strike_price, sdpd.und_pnl_set, sdd.formula_curve_id, formula_curve.curve_name formula_curve_name, sdh.internal_desk_id, idesk.code internal_desk
	,  sdh.internal_portfolio_id, iport.code internal_portfolio,  sdh.broker_id, sbro.counterparty_name broker_name
	, sc.type_of_entity type_of_entity_id, ient.code type_of_entity, sc.int_ext_flag int_ext_flag_id
	, CASE sc.int_ext_flag WHEN ''''b'''' THEN ''''Broker'''' WHEN ''''c'''' THEN ''''Clearing'''' WHEN ''''e'''' THEN ''''External'''' WHEN ''''i'''' THEN ''''Internal'''' ELSE '''''''' END int_ext_flag, sdh.deal_status deal_status_id, ds.code deal_status, sdh.confirm_status_type confirm_status_id, cst.code confirm_status, sdpd.pnl_source_value_id, pnl_sour.code pnl_source_name, sdh.description1, sdh.description2, sdh.description3, sdh.description4
	, sdh.counterparty_id2, sid2.counterparty_name counterparty_name2, sdh.ext_deal_id, sdh.reference, sdh.create_user [create_by]
	, sdh.create_ts, sdh.update_user [update_by], sdh.update_ts, sdh.broker_fixed_cost, cs.as_of_date [confirm_date],  books.sub_book_group1 sub_book_group1_id, books.sub_book_group2 sub_book_group2_id, 
	books.sub_book_group3 sub_book_group3_id,books.sub_book_group4 sub_book_group4_id, sdv_sbg1.code sub_book_group1,sdv_sbg2.code sub_book_group2,sdv_sbg3.code sub_book_group3,  
	sdv_sbg4.code sub_book_group4, sb1.source_book_id book_identifier1_id, sb2.source_book_id  book_identifier2_id,
	sb3.source_book_id  book_identifier3_id, sb4.source_book_id  book_identifier4_id, sb1.source_book_name  book_identifier1,    
	sb2.source_book_name book_identifier2,sb3.source_book_name book_identifier3,sb4.source_book_name  book_identifier4, 
	case when dpt.deal_price_type_id is null then
		CASE WHEN sdpd.deal_volume = 0 THEN sdpd.contract_value ELSE  abs(sdpd.contract_value / ISNULL(sdpd.deal_volume, 1)) END 
	else isnull(ifb.price,ifbs.price)  end deal_price,  0 float_price, isnull(sdpd.deal_volume,sds.volume) Volume,  ''

SET @_sql_select2 = '' sdh.close_reference_id,case when dpt.deal_price_type_id is null then -5500 else isnull(ifb.field_id,ifbs.field_id) end AS  [charge_type_id],case when dpt.deal_price_type_id is null then ''''Commodity'''' else isnull(ifb.field_name,ifbs.field_name) end  AS [charge_type], ag_t.agg_term, ISNULL(drr.rate, 0) recovery_rate, COALESCE(deal_level.code, curve_level.code,''''Level 3'''') fv_level, CASE WHEN ((DATEPART(year, sdd.term_start) - DATEPART(year, '''''' + Cast(@_from_as_of_date AS VARCHAR(100)) + '''''')) * 12 + (DATEPART(month, sdd.term_start) - DATEPART(month, '''''' + Cast(@_from_as_of_date AS VARCHAR(100)) + ''''''))) > 12 THEN ''''Non-Current'''' ELSE ''''Current'''' END [current_non_current], sdh.deal_category_value_id deal_category_id, sdv_dc.code deal_category, books.counterparty_id internal_counterparty_id, cpt_i.counterparty_name internal_counterparty, sdh.template_id , sdv_p.code volume_profile, sdpd.price_adder2, sdpd.volume_multiplier, sdpd.volume_multiplier2, sdv_d.code debt_rating, CASE  WHEN sdd.deal_volume_frequency = ''''h'''' THEN ''''Hourly'''' WHEN sdd.deal_volume_frequency = ''''d'''' THEN ''''Daily'''' WHEN sdd.deal_volume_frequency = ''''m'''' THEN ''''Monthly'''' WHEN sdd.deal_volume_frequency = ''''t'''' THEN ''''Term'''' WHEN sdd.deal_volume_frequency = ''''a'''' THEN ''''Annually'''' WHEN sdd.deal_volume_frequency = ''''x'''' THEN ''''15 Minutes'''' WHEN sdd.deal_volume_frequency = ''''y'''' THEN ''''30 Minutes''''  END [volume_frequency]
	, sdpd.pnl_currency_id currency_id, CASE WHEN sdd.contract_expiration_date < '''''' + Cast(@_from_as_of_date AS VARCHAR(100)) + 
	'''''' THEN ''''Yes'''' ELSE ''''No'''' END is_expired, sdh.entire_term_start, sdh.entire_term_end, sdd.contract_expiration_date, sdh.structured_deal_id, COALESCE(dbo.FNAInvoiceDueDate(sdd.term_start, ISNULL(cca.invoice_due_date,cg.invoice_due_date), cg.holiday_calendar_id,ISNULL(cca.payment_days,cg.payment_days)),sdd.term_end) [payment_date], sdh.pricing_type, sdpd.must_run_volume, sdpd.dispatch_volume, sdpd.must_run_market_value, sdpd.must_run_contract_value, sdpd.dispatch_market_value, sdpd.dispatch_contract_value,CAST(sdpd.und_pnl_set AS FLOAT) cash_flow ,COALESCE(dbo.FNAInvoiceDueDate(sdd.term_start, cg.pnl_date, cg.holiday_calendar_id,10),sdd.term_end) [pnl_date]
	,sds.settlement_amount_deal [settlement_amount_deal],scur1.currency_name [settlement_deal_currency]
	,sds.settlement_amount_inv [settlement_amount_inv],scur2.currency_name [settlement_inv_currency]
	,COALESCE(ifbs.value_deal, ifb.value_deal) [value_deal],COALESCE(scur3.currency_name, scur5.currency_name) [value_deal_currency]
	,COALESCE(ifbs.value_inv, ifb.value_inv) [value_inv],COALESCE(scur4.currency_name, scur6.currency_name) [value_inv_currency]
	,sdp.und_pnl_deal [und_pnl_deal],scur7.currency_name [und_pnl_deal_currency]
	,sdp.und_pnl_inv [und_pnl_inv],scur8.currency_name [und_pnl_inv_currency]
	,dpt.deal_price_type_id, coalesce(ifb.field_id,ifbs.field_id) [field_id]
	,COALESCE(ifbs.value, ifb.value) [value]
 ''
...
FROM source_deal_header sdh 
	...
	--deal price type info join
	left join deal_price_type dpt on dpt.source_deal_detail_id = sdd.source_deal_detail_id and dpt.priority = 1
	LEFT JOIN source_deal_settlement sds ON sds.source_deal_header_id = sdh.source_deal_header_id AND sds.term_start = sdd.term_start AND sds.term_end = sdd.term_end AND sds.leg = sdd.leg
	LEFT JOIN index_fees_breakdown_settlement ifbs ON ifbs.source_deal_header_id = sdh.source_deal_header_id AND ifbs.term_start = sdd.term_start AND ifbs.term_end = sdd.term_end and ifbs.as_of_date = '''''' + @_from_as_of_date + '''''' 
	LEFT JOIN index_fees_breakdown ifb ON ifb.source_deal_header_id = sdh.source_deal_header_id AND ifb.term_start = sdd.term_start AND ifb.term_end = sdd.term_end	
		AND ((dpt.deal_price_type_id is null and ifb.internal_type > 0) or dpt.deal_price_type_id is not null) and ifb.as_of_date = '''''' + @_from_as_of_date + '''''' 
	LEFT JOIN source_deal_pnl sdp ON sdp.source_deal_header_id = sdh.source_deal_header_id 	AND sdp.term_start = sdd.term_start AND sdp.term_end = sdd.term_end
	   AND sdd.term_start = sdp.term_start AND sdd.term_end = sdp.term_end	AND '' 
	 + CASE WHEN @_to_as_of_date IS NULL
			THEN ''sdp.pnl_as_of_date = CAST('''''' + @_from_as_of_date + '''''' AS DATETIME)''
		ELSE ''sdp.pnl_as_of_date  BETWEEN CAST('''''' + @_from_as_of_date + '''''' AS DATETIME) AND CAST('''''' + @_to_as_of_date + '''''' AS DATETIME) ''
		END + CASE 
		WHEN @_term_start IS NULL AND @_term_end IS NULL
			THEN ''''
		WHEN @_term_end IS NULL
			THEN '' AND sdp.term_start >= CAST('''''' + Cast(@_term_start AS VARCHAR(100)) + '''''' AS DATETIME)''
		WHEN @_term_start IS NULL
			THEN '' AND sdp.term_start <= CAST('''''' + Cast(@_term_end AS VARCHAR(100)) + '''''' AS DATETIME)''
		ELSE '' AND sdp.term_start BETWEEN CAST('''''' + Cast(@_term_start AS VARCHAR(100)) + '''''' as DATETIME) 
				AND CAST('''''' + Cast(@_term_end AS VARCHAR(100)) + ''''''as DATETIME)''
		END + ''
	LEFT JOIN source_currency scur1 ON  scur1.source_currency_id = sds.deal_cur_id
	LEFT JOIN source_currency scur2 ON  scur2.source_currency_id = sds.inv_cur_id
	LEFT JOIN source_currency scur3 ON  scur3.source_currency_id = ifbs.deal_cur_id
	LEFT JOIN source_currency scur4 ON  scur4.source_currency_id = ifbs.inv_cur_id
	LEFT JOIN source_currency scur5 ON  scur5.source_currency_id = ifb.deal_cur_id
	LEFT JOIN source_currency scur6 ON  scur6.source_currency_id = ifb.inv_cur_id
	LEFT JOIN source_currency scur7 ON  scur7.source_currency_id = sdp.deal_cur_id
	LEFT JOIN source_currency scur8 ON  scur8.source_currency_id = sdp.inv_cur_id
	LEFT JOIN source_deal_pnl_detail sdpd ON sdpd.source_deal_header_id = sdh.source_deal_header_id 
		AND '' + CASE WHEN @_to_as_of_date IS NULL
			THEN ''sdpd.pnl_as_of_date = CAST('''''' + @_from_as_of_date + '''''' AS DATETIME)''
		ELSE ''sdpd.pnl_as_of_date  BETWEEN CAST('''''' + @_from_as_of_date + '''''' AS DATETIME) AND CAST('''''' + @_to_as_of_date + '''''' AS DATETIME) ''
		END + CASE WHEN @_term_start IS NULL AND @_term_end IS NULL THEN ''''
		WHEN @_term_end IS NULL
			THEN '' AND sdpd.term_start >= CAST('''''' + Cast(@_term_start AS VARCHAR(100)) + '''''' AS DATETIME)''
		WHEN @_term_start IS NULL
			THEN '' AND sdpd.term_start <= CAST('''''' + Cast(@_term_end AS VARCHAR(100)) + '''''' AS DATETIME)''
		...
		END + '' AND sdd.term_start =sdpd.term_start AND sdd.term_end =sdpd.term_end 	AND sdpd.Leg = sdd.leg   
	INNER JOIN #books books ON books.source_system_book_id1 = sdh.source_system_book_id1 AND books.source_system_book_id2 = sdh.source_system_book_id2 AND books.source_system_book_id3 = sdh.source_system_book_id3 AND books.source_system_book_id4 = sdh.source_system_book_id4   
	...
	LEFT JOIN source_commodity sc2 ON  sc2.source_commodity_id = COALESCE(sdd.detail_commodity_id, sdh.commodity_id,spcd.commodity_id)   
	...
	OUTER APPLY(  SELECT probability FROM default_probability WHERE id IN (SELECT MAX(id) FROM default_probability WHERE effective_date <= '''''' 
	+ Cast(@_from_as_of_date AS VARCHAR(100)) + '''''' AND debt_rating = cci.Risk_rating) ) dp 
	OUTER APPLY (
	...
	SELECT cva CVA, dva DVA  FROM source_deal_cva sdc 
		...
		AND sdc.source_deal_header_id = sdpd.source_deal_header_id AND sdc.as_of_date = sdpd.pnl_as_of_date AND sdc.term_start = sdd.term_start 
	) sdc
...
SET @_sql_from3 = '' 
	...
	OUTER APPLY(
		SELECT TOP 1 
			CASE WHEN MONTH(sdd.term_start)< MONTH('''''' + @_from_as_of_date + '''''') 
				AND YEAR(sdd.term_start)<= YEAR('''''' + @_from_as_of_date + '''''') THEN '''' '''' + CAST(YEAR(sdd.term_start) AS VARCHAR) + ''''-YTD'''' 
				WHEN MONTH(sdd.term_start)=MONTH('''''' + @_from_as_of_date + '''''') 
					AND YEAR(sdd.term_start)=YEAR('''''' + @_from_as_of_date + '''''') THEN  CAST(YEAR(sdd.term_start) AS VARCHAR) + '''' - Current'''' 
				WHEN DATEPART(q,'''''' + @_from_as_of_date + '''''') =  DATEPART(q,sdd.term_start) 
			AND YEAR('''''' + @_from_as_of_date + '''''') =  YEAR(sdd.term_start) 
		THEN  convert(varchar(4),sdd.term_start,120) +''''-''''+ ''''M'''' + CAST(DATEDIFF(m,'''''' + @_from_as_of_date + '''''',sdd.term_start) AS VARCHAR) +'''' ''''+ ''''('''' + UPPER(LEFT(DATENAME(MONTH,dateadd(MONTH, MONTH(sdd.term_start),-1)),3)) + '''')'''' 
	WHEN YEAR('''''' + @_from_as_of_date + '''''') =  YEAR(sdd.term_start) 
		THEN  convert(varchar(4),sdd.term_start,120) + ''''-''''+ ''''Q'''' + CAST(DATEPART(q,sdd.term_start) AS VARCHAR) 
	ELSE
		CASE WHEN sdpd.source_deal_header_id is null THEN CAST(YEAR(sdd.term_start) AS VARCHAR)
		ELSE 
			CASE WHEN convert(varchar(4),sdd.term_start,120) = '''''' + CONVERT(VARCHAR(4), Dateadd(yy, 1, @_from_as_of_date), 120) + '''''' THEN convert(varchar(4),sdd.term_start,120) + ''''-''''+ ''''Q'''' + CAST(DATEPART(q,sdd.term_start) AS VARCHAR) ELSE CAST(YEAR(sdd.term_start) AS VARCHAR) END 
		END 
	END agg_term 
...
OUTER APPLY(SELECT MAX(effective_date) effective_date FROM fv_report_group_deal  
	...
	OUTER APPLY (  SELECT fv_level_value_id ,MAX(effective_date) effective_date  FROM fv_report_group_deal  WHERE source_deal_header_id = sdpd.source_deal_header_id   AND sdpd.term_start = term_start   AND effective_date = fv_d_mx.effective_date  GROUP BY fv_level_value_id  
	) frgd 
	LEFT JOIN static_data_value deal_level ON deal_level.value_id = frgd.fv_level_value_id 
	OUTER APPLY( SELECT MAX(effective_date)  effective_date FROM price_curve_fv_mapping WHERE source_curve_def_id = sdpd.curve_id AND sdpd.term_start BETWEEN DATEADD(MM, from_no_of_months, effective_date) AND DATEADD(MM, to_no_of_months, effective_date) AND effective_date <= sdpd.Pnl_as_of_date  
	) P_fv_mx 
	OUTER APPLY ( SELECT fv_reporting_group_id   ,MAX(effective_date) effective_date  FROM price_curve_fv_mapping  WHERE source_curve_def_id = sdpd.curve_id   AND sdpd.term_start BETWEEN DATEADD(MM, from_no_of_months, effective_date) AND DATEADD(MM, to_no_of_months, effective_date)   AND effective_date= P_fv_mx.effective_date  GROUP BY fv_reporting_group_id  
	) pcfm1   
	LEFT JOIN source_currency scur ON  scur.source_currency_id = sdd.fixed_price_currency_id
...
+ CASE WHEN @_physical_financial_flag IS NULL THEN ''''
	ELSE '' AND sdd.physical_financial_flag = '''''' + @_physical_financial_flag + '''''''' END 
...
+ CASE WHEN @_commodity_id IS NULL THEN '''' ELSE '' AND ISNULL(sdd.detail_commodity_id, sdh.commodity_id) IN ('' + @_commodity_id + '')'' END
...
CROSS APPLY (
	SELECT volume volume_s, deal_price deal_price_s, net_price net_price_s, float_price float_price_s, market_value market_value_s, contract_value Contract_value_s, settlement_amount settlement_amount_s, settlement_currency_id, payment_date, - 5500 charge_type_id, scur.currency_name currency, settlement_amount_deal, settlement_amount_inv
	...
	WHERE source_deal_header_id = fv.source_deal_header_id 
		AND term_start = fv.term_start AND term_end = fv.term_end AND leg = fv.leg AND as_of_date = aod.as_of_date
) sds1
...
WHERE scte.charge_type_id IS NULL and fv.charge_type_id IS NULL
...
SELECT source_counterparty_id, commodity_id, contract_id, term_start entire_term_start, term_end entire_term_end, civv1.charge_type_id, Cast(source_counterparty_id AS VARCHAR) + ''-'' + Cast(contract_id AS VARCHAR) + ''-'' + Cast(civv1.charge_type_id AS VARCHAR) charge_type, civv1.value amount, civv1.volume total_volume, civv1.volume Volume, agg_term, civv1.curreny_id, civv1.payment_date, civv1.currency_name currency
INTO #contract_fees --  select * from #contract_fees
FROM #cs_group_info fv
CROSS APPLY (
	SELECT Max(as_of_date) as_of_date FROM CALC_INVOICE_VOLUME_VARIANCE
...
CROSS APPLY (
	SELECT DISTINCT civ.invoice_line_item_id charge_type_id, sdv.code charge_type, civ.volume volume, civ.value value, civ.uom_id uom_id, su.uom_name uom, sc.source_currency_id curreny_id, sc.currency_name currency_name, civvt.payment_date payment_date
...
SELECT sv.source_deal_header_id, sv.term_start, sv.term_end, sv.leg, COALESCE(ifbs.fees, sv.amount, 0) amount, COALESCE(ifbs.fees, sv.amount, 0) contract_value, ifbs.price net_price, ifbs.actual_forward, COALESCE(sv.amount, fv.und_pnl_set, 0) und_pnl_set, ifbs.price deal_price, COALESCE(ifbs.volume, sv.volume) Volume, COALESCE(ifbs.field_id, sv.charge_type_id) charge_type_id, COALESCE(ifbs.field_name, sv.charge_type) charge_type, COALESCE(ifbs.currency_id, sv.currency_id) currency_id, scur.currency_name currency, ifbs.value_deal, scury_deal.currency_name value_deal_currency, ifbs.value_inv, scury_inv.currency_name value_inv_currency, ifbs.[value], ifbs.counterparty_id, ifbs.contract_id
...
LEFT JOIN #final_values fv ON fv.source_deal_header_id = sv.source_deal_header_id AND fv.term_start = sv.term_start AND fv.term_end = sv.term_end AND fv.leg = sv.leg AND fv.charge_type_id = sv.charge_type_id AND fv.charge_type = ''Commodity'' --and coalesce(fv.cash_flow,sv.amount,fv.amount)  IS NOT NULL 
	and sv.field_id = fv.field_id
CROSS APPLY (
	SELECT Max(as_of_date) as_of_date FROM INDEX_FEES_BREAKDOWN_SETTLEMENT
	...
	--	AND ((field_id > 0 and fv.deal_price_type_id is null) or fv.deal_price_type_id is not null)
		AND field_id > 0
	) ifbs_mx
CROSS APPLY (
	SELECT volume, value fees, field_id, field_name, price, contract_value, ''a'' actual_forward, fee_currency_id currency_id, value_deal, value_inv, deal_cur_id, inv_cur_id,[value], counterparty_id, contract_id
	FROM INDEX_FEES_BREAKDOWN_SETTLEMENT
	WHERE source_deal_header_id = sv.source_deal_header_id AND term_start = sv.term_start AND Isnull(leg, 1) = Isnull(sv.leg, 1) AND as_of_date = ifbs_mx.as_of_date 
		AND field_id > 0 and field_id = fv.field_id
) ifbs
LEFT JOIN SOURCE_CURRENCY scur ON scur.source_currency_id = Isnull(ifbs.currency_id, sv.currency_id)
LEFT JOIN SOURCE_CURRENCY scury_deal ON scury_deal.source_currency_id = Isnull(ifbs.deal_cur_id, sv.currency_id)
LEFT JOIN SOURCE_CURRENCY scury_inv ON scury_inv.source_currency_id = Isnull(ifbs.inv_cur_id, sv.currency_id)
WHERE ifbs.field_id IS NOT NULL and fv.deal_price_type_id is null
--return

SELECT fv.source_deal_header_id, fv.term_start, fv.term_end, fv.leg, COALESCE(ifb.value, fv.amount, 0) amount, COALESCE(ifb.value, fv.amount, 0) contract_value, ifb.price net_price, ''f'' actual_forward, COALESCE(ifb.value, fv.amount, fv.und_pnl_set, 0) und_pnl_set, ifb.price deal_price, COALESCE(ifb.volume, fv.volume) Volume, COALESCE(ifb.field_id, fv.charge_type_id) charge_type_id, COALESCE(ifb.field_name, fv.charge_type) charge_type, COALESCE(ifb.fee_currency_id, fv.currency_id) currency_id, scur.currency_name currency, ifb.value_deal, scur_deal.currency_name value_deal_currency, ifb.value_inv, scur_inv.currency_name value_inv_currency, ifb.[value], ifb.counterparty_id, ifb.contract_id
INTO #deal_fees -- select * from #deal_fees
--  select *
FROM #final_values fv
INNER JOIN INDEX_FEES_BREAKDOWN ifb ON ifb.source_deal_header_id = fv.source_deal_header_id AND ifb.term_start = fv.term_start AND Isnull(ifb.leg, 1) = Isnull(fv.leg, 1) AND ifb.as_of_date = Isnull(fv.from_as_of_date, @_from_as_of_date) 
	and ifb.field_id > 0 AND internal_type > 0 
	and ifb.field_id = fv.field_id
...
LEFT JOIN SOURCE_CURRENCY scur_deal ON scur_deal.source_currency_id = Isnull(ifb.deal_cur_id, fv.currency_id)
LEFT JOIN SOURCE_CURRENCY scur_inv ON scur_inv.source_currency_id = Isnull(ifb.inv_cur_id, fv.currency_id)
WHERE ifb.field_id IS NOT NULL
	and fv.deal_price_type_id is null
--return

--and fv.term_start>Isnull(fv.from_as_of_date, @_from_as_of_date)
INSERT INTO #final_values (sub_id, stra_id, book_id, subsidiary, strategy, book, sub_book, charge_type_id, charge_type, counterparty_name, parent_counterparty_name, contract_id, [contract_name], commodity_id, term_start, term_end, from_as_of_date, amount, commodity, total_volume, source_counterparty_id, counterparty_id, term_start_day, term_start_month, term_start_month_name, term_start_year, term_start_year_month, term_quarter, to_as_of_date, sub_book_id, actual_forward, volume, agg_term, currency_id, entire_term_start, entire_term_end, payment_date, currency, pnl_date)
SELECT fv.sub_id, fv.stra_id, fv.book_id, fv.subsidiary, fv.strategy, fv.book, fv.sub_book, cf.charge_type_id, cf.charge_type, fv.counterparty_name, fv.parent_counterparty_name, fv.contract_id, fv.[contract_name], fv.commodity_id, fv.term_start, fv.term_end, fv.from_as_of_date, cf.amount, fv.commodity, cf.volume total_volume, fv.source_counterparty_id, fv.counterparty_id, fv.term_start_day, fv.term_start_month, fv.term_start_month_name, fv.term_start_year, fv.term_start_year_month, fv.term_quarter, isnull(fv.to_as_of_date,@_from_as_of_date), fv.sub_book_id, ''a'' AS actual_forward, cf.volume Volume, cf.agg_term, cf.curreny_id currency_id, term_start entire_term_start, term_end entire_term_end, cf.payment_date, cf.currency, fv.pnl_date
FROM #final_values fv
INNER JOIN #contract_fees cf ON cf.source_counterparty_id = fv.source_counterparty_id AND cf.contract_id = fv.contract_id AND cf.entire_term_start = fv.entire_term_start AND cf.entire_term_end = fv.entire_term_end AND cf.commodity_id = cf.commodity_id AND cf.charge_type_id = fv.charge_type_id

--select ''#contract_fees'' data_from,* from  #final_values
...
INNER JOIN (
	...
	and df.charge_type_id = isnull(fv.field_id, fv.charge_type_id)
...
LEFT JOIN #final_values fv ON fv.source_deal_header_id = sv.source_deal_header_id AND fv.term_start = sv.term_start AND fv.term_end = sv.term_end AND fv.leg = sv.leg AND fv.charge_type_id = sv.charge_type_id
	and fv.field_id = sv.field_id
WHERE fv.charge_type = ''Commodity'' AND COALESCE(fv.cash_flow, sv.amount, fv.amount) IS NOT NULL

--select ''##settlement_value'' data_from,* from  #final_values

DELETE #final_values
WHERE charge_type = ''Commodity'' AND COALESCE(cash_flow, amount) IS NULL AND actual_forward = ''a''
	and deal_price_type_id is null

SELECT fv.sub_id, fv.stra_id, fv.book_id, fv.subsidiary, fv.strategy, fv.book, fv.sub_book, fv.source_deal_header_id, fv.deal_ref_id, fv.deal_date_from, fv.deal_date_to, fv.trader_id, fv.trader_name, fv.counterparty_name, fv.parent_counterparty_name, fv.contract_id, fv.contract_name, fv.source_deal_type_id, fv.deal_type_name, fv.deal_sub_type_type_id, fv.deal_sub_type_name, fv.product_id, fv.commodity_id, fv.product_desc, fv.block_definition,
	--fv.buy_sell_flag,
	case when fv.deal_price_type_id is null then
		CASE 
			WHEN fv.buy_sell_flag = ''Buy'' AND fv.charge_type_id = ''-5500'' AND x.value_category IN (''Contract'', ''Adder'', ''Fixed'') THEN ''Sell''
			WHEN fv.buy_sell_flag = ''Sell'' AND fv.charge_type_id = ''-5500'' AND x.value_category IN (''Contract'', ''Adder'', ''Fixed'') THEN ''Buy''
			WHEN fv.buy_sell_flag = ''Buy'' AND fv.charge_type_id <> ''-5500'' AND x.value_category = ''Contract''
				THEN ''Sell''
			WHEN fv.buy_sell_flag = ''Sell'' AND fv.charge_type_id <> ''-5500'' AND x.value_category = ''Contract''
				THEN ''Buy''
			WHEN fv.buy_sell_flag = ''Buy'' AND fv.charge_type_id = ''-5500'' AND x.value_category = ''Market''
				THEN ''Buy''
			WHEN fv.buy_sell_flag = ''Sell'' AND fv.charge_type_id = ''-5500'' AND x.value_category = ''Market''
				THEN ''Sell''
		END 
	else fv.buy_sell_flag end buy_sell_flag, fv.country_id, fv.country, fv.grid, fv.region_id, fv.region, fv.source_major_location_id, fv.location_group, fv.location_id, fv.location_name, fv.location_description, fv.from_as_of_date, fv.und_intrinsic_pnl, fv.und_extrinsic_pnl, fv.dis_pnl, fv.dis_intrinsic_pnl, fv.dis_extrinisic_pnl,
	--isnull(sv.market_value ,fv.market_value)  market_value                ,
	--isnull(sv.contract_value,fv.contract_value) contract_value                ,
	fv.dis_market_value, fv.dis_contract_value, fv.discount_factor, fv.discount_amount, fv.commodity, fv.deal_volume, fv.volume_uom, fv.template_name,
	-- fv.curve_name,
	--fv.charge_type + iif(fv.charge_type_id = ''-5500'', ''-'' + x.[value_category],'''') [charge_type],
	--x.[value_category] as value_cat,
	case when fv.deal_price_type_id is null then
		CASE WHEN x.[value_category] = ''Contract'' THEN 
				CASE WHEN fv.charge_type_id < 0 THEN 
					CASE WHEN fv.formula_curve_id IS NULL THEN ''Fixed'' ELSE fv.formula_curve_name END
				ELSE ''Fixed'' END
					-- fv.formula_curve_name 
		WHEN x.[value_category] = ''Market'' THEN fv.curve_name ELSE ''Fixed'' END 
	else fv.curve_name end [curve_name], 
	fv.index_tou, fv.formula, fv.total_volume, fv.position_uom, fv.cva, fv.dva, fv.market_price, fv.formula_price, fv.net_price, fv.physical_financial_flag, fv.block_definition_id, fv.leg, fv.source_counterparty_id, fv.counterparty_id, fv.index_id, fv.credit_adjusted_mtm, fv.discounted_credit_adjusted_mtm, fv.term_start_day, fv.term_start_month, fv.term_start_month_name, fv.term_start_year, fv.term_start_year_month, fv.term_quarter, fv.to_as_of_date, fv.sub_book_id, fv.transaction_type, fv.transaction_type_name, fv.period_from, fv.period_to, fv.probability, fv.credit_reserve, fv.dis_credit_reserve, fv.fair_value, fv.dis_fair_value, fv.model_reserve, fv.pnl_conversion_factor, fv.pnl_adjustment_value, fv.internal_deal_type_id, fv.internal_deal_type, fv.internal_deal_sub_type_id, fv.internal_deal_sub_type, fv.fixed_cost, fv.fixed_price, fv.formula_value, fv.price_adder, fv.price_multiplier, fv.strike_price, fv.formula_curve_id, fv.formula_curve_name, fv.internal_desk_id, fv.internal_desk, fv.internal_portfolio_id, fv.internal_portfolio, fv.broker_id, fv.broker_name, fv.type_of_entity_id, fv.type_of_entity, fv.int_ext_flag_id, fv.int_ext_flag, fv.deal_status_id, fv.deal_status, fv.confirm_status_id, fv.confirm_status, fv.pnl_source_value_id, fv.pnl_source_name, fv.description1, fv.description2, fv.description3, fv.description4, fv.counterparty_id2, fv.counterparty_name2, fv.ext_deal_id, fv.reference, fv.create_by, fv.create_ts, fv.update_by, fv.update_ts, fv.broker_fixed_cost, fv.confirm_date, fv.sub_book_group1_id, fv.sub_book_group2_id, fv.sub_book_group3_id, fv.sub_book_group4_id, fv.sub_book_group1, fv.sub_book_group2, fv.sub_book_group3, fv.sub_book_group4, fv.book_identifier1_id, fv.book_identifier2_id, fv.book_identifier3_id, fv.book_identifier4_id, fv.book_identifier1, fv.book_identifier2, fv.book_identifier3, fv.book_identifier4, iif(fv.charge_type_id = ''-5500'', isnull(x.[value],fv.[value]) / nullif(fv.volume, 0), fv.deal_price) [deal_price], fv.float_price, fv.volume, fv.close_reference_id, fv.agg_term, fv.recovery_rate, fv.fv_level, fv.current_non_current, 
	fv.deal_category_id, fv.deal_category, fv.internal_counterparty_id, fv.internal_couterparty, fv.template_id, fv.volume_profile, fv.price_adder2, fv.volume_multiplier, fv.volume_multiplier2, fv.debt_rating, fv.volume_frequency, fv.currency_id, fv.is_expired, fv.entire_term_start, fv.entire_term_end, fv.contract_exipration_date, fv.structured_id, fv.payment_date, fv.pricing_type, fv.must_run_volume, fv.dispatch_volume, fv.must_run_market_value, fv.must_run_contract_value, fv.dispatch_market_value, fv.dispatch_contract_value, fv.charge_type_id,
	--fv.charge_type [charge_type],
	fv.charge_type + iif(fv.charge_type_id = ''-5500'', ''-'' + x.[value_category], '''') [charge_type], fv.actual_forward, Coalesce(fv.settlement_deal_currency, fv.und_pnl_deal_currency, fv.value_deal_currency) [currency], fv.term_start, fv.term_end, fv.und_pnl_set,
	--fv.market_value,
	--fv.contract_value,
	isnull(x.[value],fv.[value]) [value], fv.amount, fv.cash_flow, fv.pnl_date, fv.settlement_amount_deal [deal_currency_amount], fv.settlement_deal_currency [settlement_deal_currency], fv.settlement_amount_inv [invoice_currency_amount], fv.settlement_inv_currency [settlement_inv_currency], fv.value_deal [deal_currency_value], fv.value_deal_currency [value_deal_currency], fv.value_inv [invoice_currency_value], fv.value_inv_currency [value_inv_currency], fv.und_pnl_deal [deal_currency_mtm], fv.und_pnl_deal_currency [und_pnl_deal_currency], fv.und_pnl_inv [invoice_currency_mtm], fv.und_pnl_inv_currency [und_pnl_inv_currency], CONVERT(VARCHAR(7), fv.pnl_date, 120) [PNL_year_month], CONVERT(VARCHAR(7), fv.payment_date, 120) [cash_flow_year_month], CASE 
		WHEN MONTH(fv.payment_date) < MONTH(CAST(@_from_as_of_date AS DATE)) AND YEAR(fv.payment_date) <= YEAR(CAST(@_from_as_of_date AS DATE))
			THEN '' '' + CAST(YEAR(fv.payment_date) AS VARCHAR) + ''-YTD''
		WHEN MONTH(fv.payment_date) = MONTH(CAST(@_from_as_of_date AS DATE)) AND YEAR(fv.payment_date) = YEAR(CAST(@_from_as_of_date AS DATE))
			THEN CAST(YEAR(fv.payment_date) AS VARCHAR) + '' - Current''
		WHEN DATEPART(q, CAST(@_from_as_of_date AS DATE)) = DATEPART(q, fv.payment_date) AND YEAR(CAST(@_from_as_of_date AS DATE)) = YEAR(fv.payment_date)
			THEN convert(VARCHAR(4), fv.payment_date, 120) + ''-'' + ''M'' + CAST(DATEDIFF(m, CAST(@_from_as_of_date AS DATE), fv.payment_date) AS VARCHAR) + '' '' + ''('' + UPPER(LEFT(DATENAME(MONTH, dateadd(MONTH, MONTH(fv.payment_date), - 1)), 3)) + '')''
		WHEN YEAR(CAST(@_from_as_of_date AS DATE)) = YEAR(fv.payment_date)
			THEN convert(VARCHAR(4), fv.payment_date, 120) + ''-'' + ''Q'' + CAST(DATEPART(q, fv.payment_date) AS VARCHAR)
		ELSE CASE 
				WHEN fv.source_deal_header_id IS NULL
					THEN CAST(YEAR(fv.payment_date) AS VARCHAR)
				ELSE CASE 
						WHEN convert(VARCHAR(4), fv.payment_date, 120) = CONVERT(VARCHAR(4), Dateadd(yy, 1, CAST(@_from_as_of_date AS DATE)), 120)
							THEN convert(VARCHAR(4), fv.payment_date, 120) + ''-'' + ''Q'' + CAST(DATEPART(q, fv.payment_date) AS VARCHAR)
						ELSE CAST(YEAR(fv.payment_date) AS VARCHAR)
						END
				END
		END agg_term_cashflow
...
FROM #final_values fv
outer APPLY (
	--select ''Contract'', fv.[contract_value]
	SELECT 1, ''Contract''
	,CASE WHEN fv.formula_curve_id IS NOT NULL AND fv.fixed_price <> 0 THEN 
		fv.[contract_value] + (fv.fixed_price * fv.volume) ELSE fv.contract_value END
	 + CASE WHEN isnull(fv.price_adder, 0) <> 0 THEN (fv.price_adder * fv.volume) ELSE 0 END
	where   fv.deal_price_type_id is null
	UNION ALL
	SELECT 2, ''Fixed'', - 1 * (fv.fixed_price * fv.volume) 
	WHERE fv.formula_curve_id IS NOT NULL AND fv.fixed_price <> 0  and fv.deal_price_type_id is null
	UNION ALL
	SELECT 3, ''Adder'', - 1 * (fv.price_adder * fv.volume) WHERE isnull(fv.price_adder, 0) <> 0
	 and fv.deal_price_type_id is null
	UNION ALL
	SELECT 4, ''Market'', fv.[market_value] WHERE fv.charge_type_id = ''-5500'' AND fv.actual_forward = ''f''
		 and fv.deal_price_type_id is null
	UNION ALL
	SELECT 5, ''Market'', fv.[market_value] 
	WHERE fv.physical_financial_flag = ''Financial'' AND fv.actual_forward = ''a'' AND fv.charge_type_id = ''-5500'' and fv.deal_price_type_id is null
		--union all 
		--select ''Contract'', fv.[contract_value] where fv.charge_type_id = ''-5500''
) x (code, value_category, [value])
where fv.to_as_of_date is not null
', report_id = @report_id_data_source_dest,
	...
	IF EXISTS (SELECT 1 
	           ...
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'agg_term' AS [name], 'Aggregate Term' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'agg_term_cashflow'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Agg Term Cashflow'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'agg_term_cashflow' AS [name], 'Agg Term Cashflow' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		UPDATE dsc  
		SET alias = 'Buy Sell'
			   , reqd_param = NULL, widget_id = 2, datatype_id = 5, param_data_source = 'SELECT ''b'' as value,''Buy'' as Code UNION SELECT ''s'' as value, ''Sell'' as Code', param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		WHERE ds.[name] = 'Settlement Mega View By Side'
	...
	BEGIN
		...
		SET alias = 'Commodity Id'
			   , reqd_param = NULL, widget_id = 9, datatype_id = 4, param_data_source = 'exec spa_source_commodity_maintain ''a''', param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 1, required_filter = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		WHERE ds.[name] = 'Settlement Mega View By Side'
	...
	BEGIN
		...
		SET alias = 'Counterparty ID'
			   , reqd_param = NULL, widget_id = 7, datatype_id = 5, param_data_source = 'browse_counterparty', param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 1, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		WHERE ds.[name] = 'Settlement Mega View By Side'
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'deal_currency_amount'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Deal Currency Amount'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'deal_currency_amount' AS [name], 'Deal Currency Amount' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'deal_currency_mtm'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Deal Currency Mtm'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'deal_currency_mtm' AS [name], 'Deal Currency Mtm' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'deal_currency_value'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Deal Currency Value'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'deal_currency_value' AS [name], 'Deal Currency Value' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'index_id' AS [name], 'Index Id' AS ALIAS, NULL AS reqd_param, 7 AS widget_id, 4 AS datatype_id, 'browse_curve_source' AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, 0 AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'invoice_currency_amount'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Invoice Currency Amount'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'invoice_currency_amount' AS [name], 'Invoice Currency Amount' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'invoice_currency_mtm'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Invoice Currency Mtm'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'invoice_currency_mtm' AS [name], 'Invoice Currency Mtm' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'invoice_currency_value'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Invoice Currency Value'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 3, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'invoice_currency_value' AS [name], 'Invoice Currency Value' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 3 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		SET alias = 'Physical Financial'
			   , reqd_param = NULL, widget_id = 2, datatype_id = 5, param_data_source = 'SELECT ''p'' as value,''Physical'' as Code UNION SELECT ''f'' as value, ''Financial'' as Code', param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		WHERE ds.[name] = 'Settlement Mega View By Side'
	...
	BEGIN
		...
		SET alias = 'Pnl Source Value Id'
			   , reqd_param = NULL, widget_id = 9, datatype_id = 4, param_data_source = 'EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10007', param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 2, key_column = 0, required_filter = 0
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
		WHERE ds.[name] = 'Settlement Mega View By Side'
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'pnl_source_value_id' AS [name], 'Pnl Source Value Id' AS ALIAS, NULL AS reqd_param, 9 AS widget_id, 4 AS datatype_id, 'EXEC spa_StaticDataValues @flag = ''h'', @type_id = 10007' AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, 0 AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'settlement_deal_currency'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Settlement Deal Currency'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'settlement_deal_currency' AS [name], 'Settlement Deal Currency' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'settlement_inv_currency'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Settlement Inv Currency'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'settlement_inv_currency' AS [name], 'Settlement Inv Currency' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'template_id' AS [name], 'Template Id' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 4 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,2 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'und_pnl_deal_currency'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Und Pnl Deal Currency'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'und_pnl_deal_currency' AS [name], 'Und Pnl Deal Currency' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'und_pnl_inv_currency'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Und Pnl Inv Currency'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'und_pnl_inv_currency' AS [name], 'Und Pnl Inv Currency' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'value_deal_currency'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Value Deal Currency'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'value_deal_currency' AS [name], 'Value Deal Currency' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
	...
	IF EXISTS (SELECT 1 
	           ...
	           INNER JOIN data_source ds on ds.data_source_id = dsc.source_id 
	           WHERE ds.[name] = 'Settlement Mega View By Side'
	            AND dsc.name =  'value_inv_currency'
				AND ISNULL(report_id, -1) =  ISNULL(@report_id_data_source_dest, -1))
	BEGIN
		UPDATE dsc  
		SET alias = 'Value Inv Currency'
			   , reqd_param = NULL, widget_id = 1, datatype_id = 5, param_data_source = NULL, param_default_value = NULL, append_filter = NULL, tooltip = NULL, column_template = 0, key_column = 0, required_filter = NULL
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		FROM data_source_column dsc
		INNER JOIN data_source ds ON ds.data_source_id = dsc.source_id 
	...
	BEGIN
		...
		, datatype_id, param_data_source, param_default_value, append_filter, tooltip, column_template, key_column, required_filter)
		OUTPUT INSERTED.data_source_column_id INTO #data_source_column(column_id)
		SELECT TOP 1 ds.data_source_id AS source_id, 'value_inv_currency' AS [name], 'Value Inv Currency' AS ALIAS, NULL AS reqd_param, 1 AS widget_id, 5 AS datatype_id, NULL AS param_data_source, NULL AS param_default_value, NULL AS append_filter, NULL  AS tooltip,0 AS column_template, 0 AS key_column, NULL AS required_filter				
		FROM sys.objects o
		INNER JOIN data_source ds ON ds.[name] = 'Settlement Mega View By Side'
			AND ISNULL(ds.report_id , -1) = ISNULL(@report_id_data_source_dest, -1)
		LEFT JOIN report r ON r.report_id = ds.report_id
