...
Date: 26th Jan 2012
Purpose: This Function  is for Maintenance Script to Select database
...
GO
IF OBJECT_id('[FNADatabaseSelect]') IS NOT NULL
DROP FUNCTION [dbo].[FNADatabaseSelect]
GO

CREATE FUNCTION [dbo].[FNADatabaseSelect] (@DatabaseList nvarchar(max))
