...
SELECT sdh.source_deal_header_id,
       sdh.deal_id,
       ISNULL(sdh_offset_e.source_deal_header_id, sdh_offset.source_deal_header_id) [offset_deal_id],
       ISNULL(sdh_offset_e.deal_id, sdh_offset.deal_id) [offset_ref_id],
	   ...
	   dbo.FNARemoveTrailingZeroes(coalesce(sdd_offset.deal_volume, sdd_offset.vol_only, ROUND(dbo.FNARemoveTrailingZeroes(ISNULL(sdd_offset.volume_multiplier2, 0) * 100), 4), (sdd_offset.vol_only/sdd_original.deal_volume) * 100)) [offset_deal_volume],
