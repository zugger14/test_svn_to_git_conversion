IF NOT EXISTS(SELECT 1 FROM ixp_rules ir WHERE ir.ixp_rules_name = 'Alert_Sql') BEGIN BEGIN TRY BEGIN TRAN
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
							   SELECT @ixp_rules_id_new,
								...
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
...
CREATE TABLE #old_relation (ixp_export_relation_id INT, ixp_rules_id INT, from_data_source INT, to_data_source INT, from_column VARCHAR(1000), to_column varchar(1000), data_source INT)
 ...
 INSERT INTO ixp_data_mapping (ixp_rules_id, table_id, column_name, column_function, column_aggregation, column_filter, insert_type, enable_identity_insert, create_destination_table, source_column, export_folder, export_delim, generate_script, column_alias, main_table )  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'workflow_only', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[workflow_only]', '\\lhotse\users\export\', NULL, 'y', 'workflow_only', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'message', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[message]', '\\lhotse\users\export\', NULL, 'y', 'message', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'notification_type', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[notification_type]', '\\lhotse\users\export\', NULL, 'y', 'notification_type', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'sql_statement', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[sql_statement]', '\\lhotse\users\export\', NULL, 'y', 'sql_statement', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'alert_sql_name', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[alert_sql_name]', '\\lhotse\users\export\', NULL, 'y', 'alert_sql_name', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'is_active', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[is_active]', '\\lhotse\users\export\', NULL, 'y', 'is_active', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'alert_type', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[alert_type]', '\\lhotse\users\export\', NULL, 'y', 'alert_type', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'rule_category', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[rule_category]', '\\lhotse\users\export\', NULL, 'y', 'rule_category', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
								WHERE it.ixp_tables_name = 'ixp_alert_sql'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'system_rule', NULL, NULL, NULL, NULL, NULL, NULL, 'ASQ.[system_rule]', '\\lhotse\users\export\', NULL, 'y', 'system_rule', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_sql'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ASQ'
