IF NOT EXISTS(SELECT 1 FROM ixp_rules ir WHERE ir.ixp_rules_name = 'Counterparty Export (Data)') BEGIN BEGIN TRY BEGIN TRAN
...
INSERT INTO #old_relation(ixp_export_relation_id, ixp_rules_id, from_data_source, to_data_source, from_column, to_column, data_source)          SELECT          73,         @ixp_rules_id_new,         105,         104,         'source_counterparty_id',         'netting_parent_counterparty_id',         105 UNION ALL          SELECT          74,         @ixp_rules_id_new,         106,         104,         'value_id',         'type_of_entity',         106 UNION ALL          SELECT          75,         @ixp_rules_id_new,         107,         104,         'value_id',         'state',         107 UNION ALL          SELECT          76,         @ixp_rules_id_new,         108,         104,         'value_id',         'region',         108 UNION ALL          SELECT          77,         @ixp_rules_id_new,         109,         104,         'value_id',         'country',         109 UNION ALL          SELECT          78,         @ixp_rules_id_new,         110,         104,         'value_id',         'delivery_method',         110
 ...
 INSERT INTO ixp_data_mapping (ixp_rules_id, table_id, column_name, column_function, column_aggregation, column_filter, insert_type, enable_identity_insert, create_destination_table, source_column, export_folder, export_delim, generate_script, column_alias, main_table )  SELECT @ixp_rules_id_new, 
								...
								WHERE it.ixp_tables_name = 'ixp_source_counterparty_template'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'netting_parent_counterparty_id', NULL, NULL, NULL, NULL, NULL, NULL, 'netting.[counterparty_id]', '\\lhotse\users\export', ';', 'n', 'netting_parent_counterparty_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = NULL
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = NULL
								...
								WHERE it.ixp_tables_name = 'ixp_source_counterparty_template'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'type_of_entity', NULL, NULL, NULL, NULL, NULL, NULL, 'type_entity.[code]', '\\lhotse\users\export', ';', 'n', 'type_of_entity', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = NULL
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = NULL
								...
								WHERE it.ixp_tables_name = 'ixp_source_counterparty_template'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'counterparty_contact_id', NULL, NULL, NULL, NULL, NULL, NULL, 'netting.[counterparty_contact_id]', '\\lhotse\users\export', ';', 'n', 'counterparty_contact_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = NULL
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = NULL
								...
								WHERE it.ixp_tables_name = 'ixp_source_counterparty_template'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'city', NULL, NULL, NULL, NULL, NULL, NULL, 'cpty.[city]', '\\lhotse\users\export', ';', 'n', 'city', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = NULL
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = NULL
								WHERE it.ixp_tables_name = 'ixp_source_counterparty_template'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'state', NULL, NULL, NULL, NULL, NULL, NULL, 'state.[code]', '\\lhotse\users\export', ';', 'n', 'state', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = NULL
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = NULL
								...
								WHERE it.ixp_tables_name = 'ixp_source_counterparty_template'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'delivery_method', NULL, NULL, NULL, NULL, NULL, NULL, 'delivery_method.[code]', '\\lhotse\users\export', ';', 'n', 'delivery_method', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = NULL
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = NULL
