IF NOT EXISTS(SELECT 1 FROM ixp_rules ir WHERE ir.ixp_rules_name = 'Alert_Table_Relation') BEGIN BEGIN TRY BEGIN TRAN
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
							   SELECT @ixp_rules_id_new,
								...
								WHERE it.ixp_tables_name = 'ixp_alert_table_relation'
...
INSERT INTO #old_relation(ixp_export_relation_id, ixp_rules_id, from_data_source, to_data_source, from_column, to_column, data_source)          SELECT          1290,         @ixp_rules_id_new,         1592,         1591,         'alert_columns_definition_id',         'from_column_id',         1592 UNION ALL          SELECT          1291,         @ixp_rules_id_new,         1593,         1591,         'alert_rule_table_id',         'from_table_id',         1593 UNION ALL          SELECT          1292,         @ixp_rules_id_new,         1594,         1591,         'alert_rule_table_id',         'to_table_id',         1594 UNION ALL          SELECT          1293,         @ixp_rules_id_new,         1595,         1591,         'alert_columns_definition_id',         'to_column_id',         1595
 ...
 INSERT INTO ixp_data_mapping (ixp_rules_id, table_id, column_name, column_function, column_aggregation, column_filter, insert_type, enable_identity_insert, create_destination_table, source_column, export_folder, export_delim, generate_script, column_alias, main_table )  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'alert_id', NULL, NULL, NULL, NULL, NULL, NULL, 'ATR.[alert_id]', '\\lhotse\users\export\', NULL, 'y', 'alert_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_table_relation'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ATR'
								WHERE it.ixp_tables_name = 'ixp_alert_table_relation'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'from_table_id', NULL, NULL, NULL, NULL, NULL, NULL, 'ART_from_table_id.[alert_rule_table_id]', '\\lhotse\users\export\', NULL, 'y', 'from_table_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_table_relation'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ATR'
								WHERE it.ixp_tables_name = 'ixp_alert_table_relation'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'from_column_id', NULL, NULL, NULL, NULL, NULL, NULL, 'ACD_from_column_id.[alert_columns_definition_id]', '\\lhotse\users\export\', NULL, 'y', 'from_column_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_table_relation'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ATR'
								WHERE it.ixp_tables_name = 'ixp_alert_table_relation'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'to_table_id', NULL, NULL, NULL, NULL, NULL, NULL, 'ART_to_table_id.[alert_rule_table_id]', '\\lhotse\users\export\', NULL, 'y', 'to_table_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_table_relation'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ATR'
								WHERE it.ixp_tables_name = 'ixp_alert_table_relation'
								 UNION ALL  SELECT @ixp_rules_id_new, 
								         it.ixp_tables_id, 'to_column_id', NULL, NULL, NULL, NULL, NULL, NULL, 'ACD_to_column_id.[alert_columns_definition_id]', '\\lhotse\users\export\', NULL, 'y', 'to_column_id', 
										ieds.ixp_export_data_source_id
								FROM ixp_tables it
								LEFT JOIN ixp_exportable_table iet ON iet.ixp_exportable_table_name = 'alert_table_relation'
								LEFT JOIN ixp_export_data_source ieds ON ieds.export_table = iet.ixp_exportable_table_id AND ieds.ixp_rules_id = @ixp_rules_id_new AND ieds.export_table_alias = 'ATR'
