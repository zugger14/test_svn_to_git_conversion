BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = '1E52A721_3630_455C_9746_FB8519F7CBC4'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'GasHourShapedDataManual'
			END
...
',
					...
					23502,
					1,
					'1E52A721_3630_455C_9746_FB8519F7CBC4'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'GasHourShapedDataManual'
