BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = 'C561305D_53FB_412A_B79F_2E3ADF76E1EF'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'GetRecs from GATS PJM'
			END
...
',
					...
					23502,
					1,
					'C561305D_53FB_412A_B79F_2E3ADF76E1EF'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'GetRecs from GATS PJM'
...
',
					...
					LEFT JOIN ixp_clr_functions icf ON icf.ixp_clr_functions_name = 'GatsPjmGetRecs' 
