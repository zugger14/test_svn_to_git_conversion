BEGIN BEGIN TRY 
			...
			WHERE ixp_rule_hash = '45E6881E_0A8F_4767_9D4C_80A0D2975BFB'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Book Structure'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23501,
					1,
					'45E6881E_0A8F_4767_9D4C_80A0D2975BFB'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'Book Structure'
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
								   SELECT @ixp_rules_id_new,
									...
									WHERE it.ixp_tables_name = 'ixp_book_structure'
...
INSERT INTO ixp_import_data_source (rules_id, data_source_type, connection_string, data_source_location, destination_table, delimiter, source_system_id, data_source_alias, is_customized, customizing_query, is_header_less, no_of_columns, folder_location, custom_import, use_parameter, excel_sheet, ssis_package, soap_function_id, is_ftp, ftp_url, ftp_username, ftp_password)
					SELECT @ixp_rules_id_new,
						   ...
						   '',
						   '',
						   0x01000000D9E01961B9970E92026403ADBE0B7BCBF9258BF63DD60398
					FROM ixp_rules ir 
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause )   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'IBS.[Subsidiary]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_structure'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_structure' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'IBS.[Strategy]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_structure'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_structure' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'IBS.[Book]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_structure'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_structure' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'IBS.[Sub Book]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_structure'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'Sub Book' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_book_structure' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'IBS.[Currency]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_structure'
