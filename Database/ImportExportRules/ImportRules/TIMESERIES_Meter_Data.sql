BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = 'E9912C6B_A585_4453_B49E_C365715439E4'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'TIMESERIES_Meter_Data'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23503,
					1,
					'E9912C6B_A585_4453_B49E_C365715439E4'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'TIMESERIES_Meter_Data'
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
								   SELECT @ixp_rules_id_new,
									...
									WHERE it.ixp_tables_name = 'ixp_meter_data_template'
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause ,udf_field_id)   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Meter ID]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_meter_data_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Date]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'date' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_meter_data_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Hour]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_meter_data_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Volume]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_meter_data_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Channel]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_meter_data_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Minute]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'period' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_meter_data_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'md.[Is DST]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_meter_data_template'
