BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = '9D306FA0_7F8C_4E3C_B13D_AFC18CE48E65'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Jurisdiction Market'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23501,
					1,
					'9D306FA0_7F8C_4E3C_B13D_AFC18CE48E65'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'Jurisdiction Market'
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause ,udf_field_id)   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[Jurisdiction Code]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[Description]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[Program Beginning Date]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[Region]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[From Month]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[To Month]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[Program Scope]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'cj.[Current/Next Year]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_compliance_jurisdiction'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'current_next_year' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_compliance_jurisdiction'
