BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = '60D8CDF3_4A27_4776_8C79_F7597CD1EFE8'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Storage PFC'
			END
...
    , @calc_process_table= @output_table
	, @generic_mapping_process = ''Storage''
	--, @debug_mode BIT = 1
...
',
					...
					23502,
					1,
					'60D8CDF3_4A27_4776_8C79_F7597CD1EFE8'
					 )
