BEGIN BEGIN TRY 
			...
			WHERE ixp_rule_hash = '12C73B31_EA7B_4905_8F61_210E1610FD33'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Price Curve Data - Platts'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23503,
					1,
					'12C73B31_EA7B_4905_8F61_210E1610FD33'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'Price Curve Data - Platts'
...
INSERT INTO ixp_import_data_source (rules_id, data_source_type, connection_string, data_source_location, destination_table, delimiter, source_system_id, data_source_alias, is_customized, customizing_query, is_header_less, no_of_columns, folder_location, custom_import, use_parameter, excel_sheet, ssis_package, soap_function_id, is_ftp, ftp_url, ftp_username, ftp_password, clr_function_id, ws_function_name)
					SELECT @ixp_rules_id_new,
						   ...
						   'n',
						   0,
						   'E:\FARRMS_DataSrc\TRMTracker_LADWP\Platts',
						   '0',
						   'n',
						   'Sheet1',
						   ...
						   'sftp.platts.com',
						   'jocelyn_mariano',
						   0x01000000A97D56FCB3833B062F2D8BA0430BA2FF8E0343D102A65923E1571902CC014FF7EDA93362D80B5C84,
						   icf.ixp_clr_functions_id,
						   ''
					FROM ixp_rules ir 
					LEFT JOIN ixp_ssis_configurations isc ON isc.package_name = '' 
					LEFT JOIN ixp_soap_functions isf ON isf.ixp_soap_functions_name = '' 
					LEFT JOIN ixp_clr_functions icf ON icf.ixp_clr_functions_name = 'PlattsPrice' 
