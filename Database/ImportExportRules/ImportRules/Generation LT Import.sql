BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = 'A7904195_03BF_4EAE_9716_40C997A193E7'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Generation LT Import'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23502,
					1,
					'A7904195_03BF_4EAE_9716_40C997A193E7'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'Generation LT Import'
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
								   SELECT @ixp_rules_id_new,
									...
									WHERE it.ixp_tables_name = 'ixp_generation_lt_import'
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause ,udf_field_id)   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Upload Date]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'upload_date' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Reference ID]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Term Start]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Term End]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Deal Volume]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, '', ic.ixp_columns_id, '''Generation''', 'Max', 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Fixed Price]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Index]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'gl.[Product]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_generation_lt_import'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'product' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_generation_lt_import'
