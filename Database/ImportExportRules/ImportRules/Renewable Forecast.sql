BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = '3CEE76B9_49F4_41A4_BCF9_2E3CFE25FC50'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Renewable Forecast'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23502,
					1,
					'3CEE76B9_49F4_41A4_BCF9_2E3CFE25FC50'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'Renewable Forecast'
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
								   SELECT @ixp_rules_id_new,
									...
									WHERE it.ixp_tables_name = 'renewable_forecast_import_template'
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause ,udf_field_id)   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'rf.[Profile Name]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'profile_name' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'renewable_forecast_import_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'rf.[Term]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
									   ...
									   WHERE it.ixp_tables_name = 'renewable_forecast_import_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'rf.[Hour]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
									   ...
									   WHERE it.ixp_tables_name = 'renewable_forecast_import_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'rf.[Minute]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
									   ...
									   WHERE it.ixp_tables_name = 'renewable_forecast_import_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'rf.[Is DST]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
									   ...
									   WHERE it.ixp_tables_name = 'renewable_forecast_import_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'rf.[Volume]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
									   ...
									   WHERE it.ixp_tables_name = 'renewable_forecast_import_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, '', ic.ixp_columns_id, '''Renewable''', 'Max', 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'renewable_forecast_import_template'
