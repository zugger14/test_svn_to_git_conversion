BEGIN BEGIN TRY 
			...
			WHERE ixp_rule_hash = '30C70E51_2CB2_4229_920B_782FCCB44746'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Book'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23501,
					1,
					'30C70E51_2CB2_4229_920B_782FCCB44746'
					 )
...
INSERT INTO ixp_import_data_source (rules_id, data_source_type, connection_string, data_source_location, destination_table, delimiter, source_system_id, data_source_alias, is_customized, customizing_query, is_header_less, no_of_columns, folder_location, custom_import, use_parameter, excel_sheet, ssis_package, soap_function_id, is_ftp, ftp_url, ftp_username, ftp_password)
					SELECT @ixp_rules_id_new,
						   ...
						   '',
						   '',
						   0x01000000B6467132756518D65322CBBEC84680568CB4AFCF75807C40
					FROM ixp_rules ir 
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause )   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Subsidiary]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Book]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Strategy]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[No Link Relationship Type]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Convert UOM]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Cash Approach]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Hypothetical]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   INNER JOIN ixp_columns ic ON ic.ixp_columns_name = 'create_ts' AND ic.ixp_table_id = it2.ixp_tables_id AND (ic.header_detail = 'NULL' OR ic.header_detail IS NULL)
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Legal Entity]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Tax Percentage]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Hedge and Item Same Sign]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Functional Currency]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Accounting Type]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_book_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'b.[Primary Counterparty]', ic.ixp_columns_id, NULL, NULL, 0, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_book_template'
