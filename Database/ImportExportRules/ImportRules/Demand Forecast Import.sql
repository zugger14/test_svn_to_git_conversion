BEGIN 
	BEGIN TRY 
		...
		DECLARE @ixp_rules_id_new INT
			...
			WHERE ixp_rule_hash = '9B268394_B747_4AF8_84FD_F0A1B0CD77D2'

			if @old_ixp_rule_id IS NULL
			BEGIN
				SELECT @old_ixp_rule_id = ixp_rules_id
			FROM ixp_rules ir
			WHERE ir.ixp_rules_name = 'Demand Forecast Import'
			END
		...
		END
			...
			BEGIN
				...
				VALUES( 
					...
					23500,
					1,
					'9B268394_B747_4AF8_84FD_F0A1B0CD77D2'
					 )
		...
		BEGIN
			...
			UPDATE
			ixp_rules
			SET ixp_rules_name = 'Demand Forecast Import'
...
INSERT INTO ixp_export_tables (ixp_rules_id, table_id, dependent_table_id, sequence_number, dependent_table_order, repeat_number)  
								   SELECT @ixp_rules_id_new,
									...
									WHERE it.ixp_tables_name = 'ixp_demand_volume_template'
...
INSERT INTO ixp_import_data_mapping(ixp_rules_id, dest_table_id, source_column_name, dest_column, column_function, column_aggregation, repeat_number, where_clause ,udf_field_id)   SELECT @ixp_rules_id_new, it.ixp_tables_id, 'dem.[Effective Date From]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_demand_volume_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_demand_volume_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'dem.[Effective Date To]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_demand_volume_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_demand_volume_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'dem.[Demand Location]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_demand_volume_template'
									   ...
									   WHERE it.ixp_tables_name = 'ixp_demand_volume_template' UNION ALL  SELECT @ixp_rules_id_new, it.ixp_tables_id, 'dem.[Demand Volume]', ic.ixp_columns_id, NULL, NULL, 0, NULL, NULL 
									   FROM ixp_tables it 
									   INNER JOIN ixp_tables it2 ON it2.ixp_tables_name = 'ixp_demand_volume_template'
