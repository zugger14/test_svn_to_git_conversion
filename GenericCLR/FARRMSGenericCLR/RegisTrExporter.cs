    ...
    class RegisTrExporter : IWebServiceDataDispatcher
    {
        ...
        public ExportStatus DispatchData(ExportWebServiceInfo exportWebServiceInfo, string tableNameorQuery, string exportFileFullPath, string processID)
        {
            ...
            try
            {
                ...
                StoredProcedure.CreateXMLDocument(process_table, "http://pioneersolutionsglobal.com/xml/ns", "RegisTr", "-100000", temp_xml_path, "n", out response_xml);
                ...
                StoredProcedure.TransformXML(temp_xml_path, xls_path, exportStatus.FilePath, "n", "y", out response_xml);
        ...
        /// </summary>
        /// <param name="exportStatus">Success or failed status</param>
