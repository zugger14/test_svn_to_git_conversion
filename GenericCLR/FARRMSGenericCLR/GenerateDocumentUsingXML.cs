...
{
    public class GenerateDocumentUsingXML : DocumentGenerator
    {
        ...
        public GenerateDocumentUsingXML(DocumentGenerationInfo generationInfo, Dictionary<string, ContentControlXmlMetadata> placeHolderNameToContentControlXmlMetadataCollection)
            : base(generationInfo)
        {
