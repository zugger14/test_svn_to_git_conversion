...
{
    #region EgssisEntriesExporter Business logic for EgssisGateway
    /// <summary>
    /// Used for exporting (outbound) report in json format for Egssis Disptach. Uses REST webservices.
    /// </summary>
    class EgssisEntriesExporter : IWebServiceDataDispatcher
    {
        /// <summary>
        ...
        public ExportStatus DispatchData(ExportWebServiceInfo exportWebServiceInfo, string tableNameorQuery, string exportFileFullPath, string processID)
        {
            ...
            try
            {
                ...
                cmd_param.Parameters.Add(new SqlParameter("@primary_column_value", "EgssisEntriesExporter"));
                ...
                if (accessToken != "")
                {
                    ...
                    //{
                       ...
                       string tableName = "";
                        ...
                        using (var cmd1 = new SqlCommand("spa_egssis_entries_exporter", exportWebServiceInfo.Connection)) {
                        ...
                        exportStatus.FileName = "EgssisEntries_" + DateTime.Now.ToString("yyyyddM_HHmmss") + ".txt";
                ...
                BuildEgssisEntriesMessaging(exportStatus, exportWebServiceInfo.Connection);
            }
        ...
        /// <param name="cn"></param>
        private void BuildEgssisEntriesMessaging(ExportStatus exportStatus, SqlConnection cn)
        {
            using (SqlCommand cmd = new SqlCommand("spa_egssis_entries_exporter", cn))
            {
